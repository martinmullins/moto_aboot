...
// Address range: 0x8f6466b0 - 0x8f64671f
int32_t is_hv_charger_present(int32_t a1, int32_t a2) {
    int32_t v1 = g22; // 0x8f6466b0
    g22 = &g16;
    int32_t v2 = g16;
    int32_t v3 = is_charger_smb1359(a1, a2, g20, v2, a1, v2, v1, g17); // 0x8f6466c0
    ...
    if (v3 == 0) {
        ...
        if (v2 == g16) {
            // 0x8f6466dc
            g22 = v1;
            return smb1359_is_hvdcp(v3, a2, v2, v2, v1, g17);
        }
    }
    // 0x8f64670c
    __stack_chk_fail();
