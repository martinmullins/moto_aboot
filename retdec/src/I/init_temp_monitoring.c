...
// Address range: 0x8f603cc8 - 0x8f603d9b
char * init_temp_monitoring(void) {
    int32_t v1;
    int32_t v2 = &v1; // 0x8f603ccc_0
    g20 = v2;
    int32_t v3 = g17;
    int32_t dest_mem = (int32_t)memcpy((char *)&v1, "max17050", 9); // 0x8f603ce8_7
    g20 = dest_mem;
    int32_t v4 = is_battery_max17050(dest_mem, (int32_t)"max17050", 9, v3); // 0x8f603cec
    g20 = v4;
    if (v4 != 0) {
        // 0x8f603cf8
        g20 = v2;
        int32_t v5 = max17042_get_temp_thresholds((char *)&v1, (int32_t)"max17050", 9, v3); // 0x8f603cfc
        g20 = v5;
        if (v5 != 0) {
            // 0x8f603d08
            g20 = (int32_t)&g9;
            timer_initialize((int32_t)&g9, (int32_t)"max17050", 9, v3);
            g20 = (int32_t)&g9;
            // branch -> 0x8f603d58
            // 0x8f603d58
            timer_set_oneshot((int32_t)&g9, 2000, (int32_t)&g2, 0, v1, 0, 0);
            *(char *)&g10 = 1;
            // branch -> 0x8f603d68
        }
        // 0x8f603d68
    ...
    int32_t v6 = is_battery_max17058(0, (int32_t)"max17050", 9, v3); // 0x8f603d24
    g20 = v6;
    if (v6 == 0) {
        // 0x8f603d68
        if (v3 != g17) {
    ...
    // 0x8f603d30
    g20 = (int32_t)"max17058";
    int32_t v7 = max17058_get_temp_thresholds("max17058", (int32_t)"max17050", 9, v3); // 0x8f603d34
    g20 = v7;
    if (v7 != 0) {
        // 0x8f603d40
        g20 = (int32_t)&g9;
        ...
        // branch -> 0x8f603d58
        // 0x8f603d58
        timer_set_oneshot((int32_t)&g9, 2000, (int32_t)&g2, v4, v1, 0, 0);
        *(char *)&g10 = 1;
        // branch -> 0x8f603d68
    }
    // 0x8f603d68
