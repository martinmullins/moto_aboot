...
// Address range: 0x8f61da04 - 0x8f61dacf
int32_t is_ramdump_mode(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = a2; // R1
    int32_t v2 = g18;
    int32_t v3 = v2; // R3
    int32_t v4 = sod_check_crash(a1, a2, a3, v2, a1, v2, a3, g24); // 0x8f61da14
    int32_t v5 = v4; // R4
    int32_t result = 0; // 0x8f61daa0
    if (v4 != 0) {
        // 0x8f61da20
        int32_t v6;
        int32_t v7 = get_powerup_reason((char *)v4, v1, a3, v3, a1, v2, a3, g24, g25, g19, v6, 0, 0, 0, 0, 0, 0); // 0x8f61da20
        int32_t v8; // 0x8f61da88
        int32_t v9; // 0x8f61da88
        if (v7 == 0x8000) {
            // after_if_8f61da28_0.thread
            v9 = 0x8000;
            v8 = 0x8000;
            // branch -> 0x8f61da88
        } else {
            ...
            if (v7 != 0x20000) {
                ...
                if (v7 != 0x400000) {
                    // 0x8f61da3c
                    print_log(1, (int32_t)"unexpected crash detected (POR = 0x%08x)\n", v7, v3, a1, v2, a3, g24, g25, g19, v6, 0, 0);
                    v1 = (int32_t)"rebooting normally...\n";
                    print_log(1, (int32_t)"rebooting normally...\n", v10, v3, a1, v2, a3, g24, g25, g19, v6, 0, 0);
                    int32_t v11 = mdelay(100, v1, v10, v3); // 0x8f61da58
                    v10 = &g5;
                    int32_t v12 = g5;
                    int32_t v13 = v12 + 1; // 0x8f61da64
                    v3 = v13;
                    g5 = v13;
                    int32_t v14 = &g5; // 0x8f61da78
                    int32_t v15 = v11; // 0x8f61da78
                    if (v12 == 0) {
                        // 0x8f61da74
                        v13 = v3;
                        v14 = v10;
                        v15 = function_8f619448(v11);
                        // branch -> 0x8f61da78
                    }
                    // 0x8f61da78
                    platform_uninit((char *)v15, v1, v14, v13);
                    v5 = 0;
                    v9 = v10;
                    v8 = reboot_device(NULL, v1, v10, v3, a1, v2, a3, g24, g25, g19);
                    // branch -> 0x8f61da88
                } else {
                    v9 = 0x400000;
                    v8 = 0x400000;
        ...
        // 0x8f61da88
        print_log(1, (int32_t)"** Entering RAM dump mode for %s!! **\n", sod_reason(v8, v1, v9, v3), v3, a1, v2, a3, g24, g25, g19, v6, 0, 0);
        result = v5;
        // branch -> 0x8f61da9c
    }
    // 0x8f61da9c
