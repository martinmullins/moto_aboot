...
// Address range: 0x8f61e10c - 0x8f61e173
int32_t is_recovery_mode(char * a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g25;
    int32_t v2;
    int32_t v3 = check_reboot_mode(a1, a2, a3, v1, (int32_t)a1, v1, g31, g26, v2, 0, 0, 0); // 0x8f61e11c
    ...
    if (v3 == 0x77665502) {
        ...
        if (v1 == g25) {
            // 0x8f61e13c
            return misc_check_mode(NULL, a2, v1, v1, g31, g26, v2);
        }
    }
    // 0x8f61e160
    __stack_chk_fail();
