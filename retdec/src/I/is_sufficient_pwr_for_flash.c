...
// Address range: 0x8f646b04 - 0x8f646b57
int32_t is_sufficient_pwr_for_flash(char * a1, int32_t a2) {
    int32_t v1 = g22;
    int32_t result = is_usb_attached((int32_t)a1, a2); // 0x8f646b14
    int32_t v2 = g22;
    if (result == 0) {
        // 0x8f646b28
        if (v1 == v2) {
            // 0x8f646b30
            int32_t v3;
            return is_sufficient_pwr_avail(3700, a2, v1, v1, g33, g28, v3, 0, 0, 0, 0, 0, 0, 0, 0);
        }
    } else {
        // 0x8f646b40
        if (v1 == v2) {
