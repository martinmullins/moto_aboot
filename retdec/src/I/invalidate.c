...
// Address range: 0x8f638578 - 0x8f6385df
int32_t invalidate(int32_t a1) {
    int32_t v1 = g38; // 0x8f638578
    int32_t v2 = g40; // 0x8f638578
    g36 = a1;
    int32_t v3 = g32;
    int32_t result = event_signal((int32_t)&g27, a1, v1, v3, a1, v3, v1, v2); // 0x8f638594
    g35 = result;
    g38 = v3;
    int32_t v4 = g32;
    g39 = v4;
    if (a1 == 0) {
        ...
        if (v3 == v4) {
            // 0x8f6385b0
            g40 = v2;
            int32_t result2 = event_wait((int32_t)&g29, a1); // 0x8f6385bc
            g35 = result2;
            return result2;
        }
    }
