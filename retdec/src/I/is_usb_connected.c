...
// Address range: 0x8f645744 - 0x8f645797
int32_t is_usb_connected(int32_t a1, int32_t a2) {
    // 0x8f645744
    g37 = a2;
    int32_t v1 = g40; // 0x8f645744
    int32_t v2 = g33;
    int32_t v3 = is_charger_smb1359(a1, a2, g38, v2, a1, v2, v1, g35); // 0x8f645754
    int32_t v4; // 0x8f645774
    if (v3 == 0) {
        // 0x8f64576c
        int32_t v5;
        v4 = pm8x41_reg_read(0x1309, a2, g38, v2, a1, v2, v1, g35, v5, 0, 0) / 128;
        // branch -> 0x8f645778
    } else {
        // 0x8f645760
        v4 = smb1359_get_power_source(v3, a2, g38) / 2;
        // branch -> 0x8f645778
    }
    // 0x8f645778
    g38 = v2;
