...
// Address range: 0x8f67436c - 0x8f674413
int32_t is_skip_sparse_preflash_validation(int32_t a1, int32_t a2) {
    int32_t v1 = g53; // 0x8f674370
    int32_t v2 = g55; // 0x8f674370
    int32_t v3 = g38;
    int32_t result; // 0x8f674404_2
    int32_t v4;
    int32_t v5;
    if (a1 == 0) {
        // 0x8f674388
        print_log(0, (int32_t)"Partition is NULL\n", v3, (int32_t)&g38, 0, v3, v1, g54, v2, g46, v4, 0, 0);
        g47 = a1;
        // branch -> 0x8f6743ec
        // 0x8f6743ec
        g51 = v3;
    ...
    uint32_t v6 = (int32_t)*(char *)(a1 + 49); // 0x8f674398
    if (v6 % 16 == 0) {
        // if_8f6743a0_0_true
        g47 = 1;
        // branch -> 0x8f6743ec
    ...
    int32_t v7 = get_policy_executor(get_entry_name(a1, a2, v3, v6, a1, v3, v1, g54), a2, v3, v6, a1); // 0x8f6743ac
    if (v7 == 0) {
        // 0x8f6743b8
        print_log(v7, (int32_t)"Failed to get policy executor for %s\n", get_entry_name(a1, a2, v3, v6, a1, v3, v1, g54), v6, a1, v3, v1, g54, v2, g46, v4, 0, 0);
        g47 = v7;
        // branch -> 0x8f6743ec
        // 0x8f6743ec
        g51 = v3;
    ...
    // 0x8f6743d8
    int32_t v8; // 0x8f674404_23
    if ((int32_t)*(char *)v7 > 3) {
        // after_if_8f6743e4_0
        g47 = 0;
        v8 = 0;
        // branch -> 0x8f6743ec
