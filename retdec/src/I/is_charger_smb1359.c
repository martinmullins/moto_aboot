...
// Address range: 0x8f6331a0 - 0x8f633217
int32_t is_charger_smb1359(int32_t a1, int32_t a2) {
    int32_t v1 = g20;
    char v2 = *(char *)&g17; // 0x8f6331bc
    int32_t v3 = v1;
    if (v2 == 0) {
        int32_t v4 = get_charger_offset_by_type((int32_t)"smb1359", (int32_t)v2, (int32_t)&g20, (int32_t)&g17); // 0x8f6331d0
        if (v4 > -1) {
            // if_8f6331d8_0_true
            *(char *)(int32_t)&g19 = 1;
            // branch -> after_if_8f6331dc_0
        }
        // after_if_8f6331dc_0
        *(char *)(int32_t)&g17 = 1;
        v3 = g20;
