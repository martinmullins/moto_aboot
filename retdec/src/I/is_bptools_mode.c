...
// Address range: 0x8f61df38 - 0x8f61df9f
int32_t is_bptools_mode(void) {
    // 0x8f61df38
    int32_t v1;
    ...
    int32_t v2 = g38;
    int32_t v3;
    int32_t v4 = __utag_gets_constprop_3_6((int32_t)"bootmode", (int32_t)&str, 17, v2, v1, 0, 0, 0, 0, v2, g47, g43, v3); // 0x8f61df58
    int32_t result = v4; // R0
    int32_t v5 = 0; // 0x8f61df90_22
    if (v4 != 0) {
        uint32_t strcmp_rc = strcmp((char *)&str, "bp-tools"); // 0x8f61df6c
        int32_t v6 = strcmp_rc > 1 ? 0 : 1 - strcmp_rc; // 0x8f61df70
        result = v6;
        v5 = v6;
        // branch -> 0x8f61df78
    }
