...
// Address range: 0x8f61b17c - 0x8f61b1ef
int32_t insert_in_run_queue_tail(int32_t a1, int32_t a2) {
    int32_t v1 = a1 + 12; // 0x8f61b180
    int32_t v2 = &g5; // R2
    int32_t result = g17;
    int32_t v3 = *(int32_t *)(a1 + 20); // 0x8f61b194
    int32_t v4 = 8 * v3 + (int32_t)&g5; // 0x8f61b198
    *(int32_t *)(a1 + 16) = v4;
    *(int32_t *)v1 = *(int32_t *)v4;
    *(int32_t *)(*(int32_t *)(8 * v3 + v2) + 4) = v1;
    *(int32_t *)(8 * v3 + v2) = v1;
    uint32_t v5 = v3 % 256; // 0x8f61b1c0
    int32_t v6 = v5 == 0 ? 1 : v5 < 32 ? 1 << v5 : 0; // 0x8f61b1c0
    g4 |= v6;
    if (result != g17) {
        // 0x8f61b1d8
        __stack_chk_fail();
