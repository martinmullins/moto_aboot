...
// Address range: 0x8f6745c4 - 0x8f6746bb
int32_t is_moto_hab_signed(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g18;
    if (a1 == 0) {
        // 0x8f6745e0
        print_log(0, (int32_t)"Partition is NULL\n", a3, v1, 0, a2, a3, v1, g25, g26, g27, g29, g30);
        // branch -> 0x8f67468c
        // 0x8f67468c
        if (v1 != g18) {
            // 0x8f6746a0
    ...
    int32_t v2 = get_hab_signature_offset((int32_t)&g11, a1, a3, (int32_t)&g6); // 0x8f6745f8
    if (v2 != -1) {
        char v3 = *(char *)(a1 + 33); // 0x8f674604
        char v4 = *(char *)(a1 + 32); // 0x8f674608
        char v5 = *(char *)(a1 + 37); // 0x8f67460c
        char v6 = *(char *)(a1 + 34); // 0x8f674614
        int32_t v7 = 0x10000 * (int32_t)v6 | (int32_t)v4 | 256 * (int32_t)v3; // 0x8f674618
        char v8 = *(char *)(a1 + 35); // 0x8f67461c
        char v9 = *(char *)(a1 + 36); // 0x8f674624
        char v10 = *(char *)(a1 + 38); // 0x8f67462c
        uint32_t v11 = 512 * v7; // 0x8f674630
        uint32_t v12 = v11 + v2; // 0x8f674638
        int32_t v13 = (int32_t)(v12 < v11) + (v2 >> 31) + (512 * (0x10000 * (int32_t)v10 | (int32_t)v9 | 256 * (int32_t)v5) | (0x1000000 * (int32_t)v8 | v7) / 0x800000); // 0x8f674650
        int32_t v14;
        int32_t result = generic_mmc_read_logical(v12, v13, 512, 0, (int32_t)&g15, a2, a3, v1, g25, g26, g27, g29, g30, g19, v14, 0, 0, 0, 0, 0, 0, 0, 0); // 0x8f674660
        if (result == 0) {
            // 0x8f67466c
            if (v1 == g18) {
                // 0x8f67467c
                return is_like_hab_signature((int32_t)&g15, v13, v1, v1);
            }
            // 0x8f6746a0
            __stack_chk_fail();
            // branch -> 0x8f6746a4
