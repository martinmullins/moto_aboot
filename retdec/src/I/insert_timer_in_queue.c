...
// Address range: 0x8f61bfbc - 0x8f61c05f
int32_t insert_timer_in_queue(int32_t a1, int32_t a2, int32_t a3) {
    // 0x8f61bfbc
    g34 = a1;
    int32_t v1 = &g25; // R2
    ...
    int32_t v6 = g26; // 0x8f61c004
    // branch -> 0x8f61bfe8
    while (true) {
        // 0x8f61bfe8
        if (*(int32_t *)(v2 + 12) - *(int32_t *)(a1 + 12) < 1) {
            int32_t v7 = *(int32_t *)(v2 + 8); // 0x8f61c01c
            if (v7 == (int32_t)&g25) {
                // break -> 0x8f61c028
                break;
            }
            ...
            int32_t v8 = a1 + 4; // 0x8f61c000
            v1 = v8;
            *(int32_t *)(a1 + 8) = v6;
            *(int32_t *)v8 = *(int32_t *)(v2 + 4);
            int32_t v9 = *(int32_t *)(v2 + 4); // 0x8f61c00c
            g35 = v9;
            *(int32_t *)(v9 + 4) = v1;
            *(int32_t *)(v2 + 4) = v1;
            // branch -> 0x8f61c03c
