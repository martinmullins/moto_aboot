...
// Address range: 0x8f633218 - 0x8f63328f
int32_t is_charger_bq24296(int32_t a1, int32_t a2) {
    int32_t v1 = g27;
    char v2 = *(char *)&g15; // 0x8f633234
    int32_t v3 = v1;
    if (v2 == 0) {
        int32_t v4 = get_charger_offset_by_type((int32_t)"bq24296", (int32_t)v2, (int32_t)&g27, (int32_t)&g15); // 0x8f633248
        if (v4 > -1) {
            // if_8f633250_0_true
            *(char *)(int32_t)&g16 = 1;
            // branch -> after_if_8f633254_0
        }
        // after_if_8f633254_0
        *(char *)(int32_t)&g15 = 1;
        v3 = g27;
