...
// Address range: 0x8f676f98 - 0x8f677057
int32_t init_sp_partition(char * a1, int32_t a2) {
    int32_t v1 = (int32_t)a1; // 0x8f676f98_0
    int32_t v2 = g22; // 0x8f676f98
    int32_t v3 = g23; // 0x8f676f98
    int32_t v4 = g17;
    int32_t v5 = g13;
    g20 = v5;
    int32_t v6;
    int32_t v7 = generic_mmc_erase_logical(g4, g5, v5, g14, v1, v4, v2, v3, g24, 0, v6, 0, 0, 0, 0, 0, 0, 0); // 0x8f676fbc
    g23 = v7;
    if (v7 != 0) {
        // if_8f676fc4_0_true
        // branch -> 0x8f677018
        // 0x8f677018
        print_log(-1, (int32_t)"Failed to erase SP partition\n", g20, g14, v1, v4, v2, v3, g24, 0, v6, 0, 0);
        // branch -> 0x8f677020
        // 0x8f677020
        if (v4 != g17) {
            // 0x8f677030
    ...
    // 0x8f676fd0
    g22 = (int32_t)&g6;
    memset((char *)&g6, 0, 552);
    strlcat(g22, (int32_t)"MOTO SP", 8, g14, v1, v4, v2, v3, g24, 0, v6, 0);
    SecProcessorUID((int32_t)&g7, 14, 8, g14, v1, v4, v2, v3, g24, 0, v6);
    g8 = g23;
    int32_t v8 = flush_sp_header(); // 0x8f677004
    int32_t result = v8; // R0
    int32_t v9; // 0x8f677038_26
    if (v8 != 0) {
        // 0x8f677010
        // branch -> 0x8f677018
        // 0x8f677018
        print_log(-1, (int32_t)"Failed to init SP partition\n", g20, g14, v1, v4, v2, v3, g24, 0, v6, 0, 0);
        result = -1;
        v9 = -1;
        // branch -> 0x8f677020
    } else {
