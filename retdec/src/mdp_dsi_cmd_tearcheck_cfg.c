...
// Address range: 0x8f60ef7c - 0x8f60f063
int32_t mdp_dsi_cmd_tearcheck_cfg(int32_t a1, int32_t a2) {
    char * v1 = g23;
    char v2 = *(char *)(a1 + 177); // 0x8f60ef94
    if (v2 != 2) {
        // 0x8f60f034
        if (v1 != v1) {
            // 0x8f60f048
    ...
    char * v3;
    if (*(char *)(a1 + 276) != 0) {
        int32_t v4 = *(int32_t *)(a1 + 4); // 0x8f60efac
        int32_t v5 = *(int32_t *)(a1 + 80); // 0x8f60efb0
        char v6 = *(char *)(a1 + 239); // 0x8f60efb4
        int32_t v7 = *(int32_t *)(a1 + 84); // 0x8f60efbc
        int32_t v8 = *(int32_t *)(a1 + 88); // 0x8f60efc4
        int64_t v9 = (int64_t)(v8 + v7 + v5 + v4) * (int64_t)v6; // 0x8f60efcc
        int32_t v10 = v9; // 0x8f60efcc
        int32_t v11 = v10;
        if (v9 != 0) {
            // 0x8f60efd8
            v11 = 0x124f800 / v10;
        ...
        int32_t v12 = 0x1a71000; // R3
        *(int32_t *)0x1a71004 = v11 * 100 * (int32_t)v6 / (v10 & -0x10000 | 0x1770) | 0x180000;
        *(int32_t *)(v12 + 8) = (int32_t)v2 & -0x10000 | 0xfff0;
        *(int32_t *)(v12 + 16) = *(int32_t *)(a1 + 4);
        *(int32_t *)(v12 + 32) = *(int32_t *)(a1 + 4) + 1;
        *(int32_t *)(v12 + 28) = *(int32_t *)(a1 + 4);
        *(int32_t *)(v12 + 24) = 0x40004;
        *(int32_t *)v12 = 1;
        v3 = g23;
        // branch -> 0x8f60f034
    } else {
