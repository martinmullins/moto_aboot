...
// Address range: 0x8f6247c0 - 0x8f624813
int32_t uh_oh_not_for_sdd(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g29; // 0x8f6247c0
    g29 = &g14;
    int32_t v2 = g14;
    int32_t result = fboot_info("INFO", "Uh-oh, this command is no longer supported since RAM dump file are being saved to SD card on this device", a3, v2); // 0x8f6247d8
    if (v2 != g14) {
        // 0x8f6247ec
        __stack_chk_fail();
        return result;
    ...
    // 0x8f6247f0
    g29 = v1;
    return fboot_info("INFO", "  (see 'fastboot oem ramdump status')", v2, v2);
}
