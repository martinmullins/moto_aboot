...
// Address range: 0x8f640574 - 0x8f6405df
int32_t bd65060_write_reg(int32_t a1, int32_t a2) {
    // 0x8f640574
    g38 = a2;
    int32_t v1 = g31;
    g34 = g13;
    int32_t v2; // 0x8f6405d4_22
    if (g13 == 0) {
        // 0x8f6405b8
        g34 = -3;
        v2 = -3;
        ...
        // 0x8f6405a0
        int32_t v3;
        qup_i2c_write_byte(g13, 100, a1, a2, a1, v1, g39, g33, v3, 0, 0);
        int32_t v4 = g34; // 0x8f6405a8
        int32_t v5 = v4; // 0x8f6405d4_23
        if (v4 > -1) {
            // if_8f6405ac_0_true
            g34 = 0;
            v5 = 0;
            // branch -> after_if_8f6405ac_0
        }
        // after_if_8f6405ac_0
        if (v4 < 0) {
            // if_8f6405b0_0_true
