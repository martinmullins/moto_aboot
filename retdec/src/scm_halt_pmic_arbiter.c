...
// Address range: 0x8f616f08 - 0x8f61704b
char * scm_halt_pmic_arbiter(int32_t a1) {
    int32_t v1 = *(int32_t *)-0x708eed0c; // 0x8f616f1c
    int32_t v2;
    int32_t v3 = &v2; // 0x8f616f2c_0
    int32_t v4 = 64; // R2
    memset((char *)&v2, 0, 64);
    char v5 = *(char *)-0x70947380; // 0x8f616f4c
    if (v5 == 0) {
        // 0x8f616fac
        v4 = 0;
        if (scm_call_atomic((char *)9, 1, 0, (int32_t)v5, g49) == 0) {
            // 0x8f617020
        ...
        // 0x8f616fac
        v2 = 0x2000901;
        scm_call2(v3, 0, v4, v3, g49, g45);
        // branch -> 0x8f616fb8
    }
    char v6 = *(char *)-0x70947380; // 0x8f616fc0
    int32_t v7;
    if (v6 == 0) {
        // 0x8f61700c
        v7 = scm_call_atomic((char *)9, 2, 0, (int32_t)v6, g49);
        // branch -> 0x8f617020
    } else {
        // 0x8f616fcc
        v2 = 0x2000902;
