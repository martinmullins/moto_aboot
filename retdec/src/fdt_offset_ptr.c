...
// Address range: 0x8f64b9a0 - 0x8f64ba23
int32_t fdt_offset_ptr(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g33;
    if (fdt32_to_cpu_99(*(int32_t *)(a1 + 20), a2, a3, v1, a1, v1, g55, g56) >= 17) {
        // 0x8f64b9cc
        if (a2 + a3 > fdt32_to_cpu_99(*(int32_t *)(a1 + 36), a2, a3, v1, a1, v1, g55, g56)) {
            // 0x8f64ba00
            // branch -> 0x8f64ba04
            // 0x8f64ba04
            if (v1 != g33) {
    ...
    int32_t v2 = *(int32_t *)(a1 + 8); // 0x8f64b9e4
    int32_t result = a2 + fdt32_to_cpu_99(v2, a2, a3, v1, a1, v1, g55, g56) + a1; // 0x8f64b9f0
    // branch -> 0x8f64ba04
    // 0x8f64ba04
    if (v1 != g33) {
        // 0x8f64ba14
