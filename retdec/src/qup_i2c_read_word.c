...
// Address range: 0x8f612d58 - 0x8f612dc7
int32_t qup_i2c_read_word(int32_t a1, int32_t a2, int32_t a3) {
    // 0x8f612d58
    g37 = a1;
    int32_t v1 = g41; // 0x8f612d58
    g41 = &g23;
    int32_t v2 = 0x1000000 * a3 / 0x1000000; // bp-41
    int32_t v3 = 0x10000 * a2 / 0x10000; // 0x8f612d6c_0
    int32_t v4 = v3; // bp-36
    int32_t result = g23;
    int32_t v5 = &v4; // 0x8f612d78_0
    g38 = v5;
    int32_t v6;
    qup_i2c_xfer(a1, v5, 2, g40, v6, 0, 0, v3, 1, (int32_t)&v2);
    g39 = result;
    if (result != g23) {
        // 0x8f612db8
        __stack_chk_fail();
