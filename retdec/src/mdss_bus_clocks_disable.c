...
// Address range: 0x8f60273c - 0x8f60277b
int32_t mdss_bus_clocks_disable(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g34; // 0x8f60273c
    g34 = &g25;
    int32_t v2 = g25;
    int32_t result = clk_get((int32_t)"mdss_axi_clk", a2, a3, v2, a1, v2, v1); // 0x8f602750
    if (v2 == g25) {
        // 0x8f602768
        g34 = v1;
        return clk_disable(result, a2, v2, v2, v1, 0);
    }
    // 0x8f602764
    __stack_chk_fail();
    return result;
