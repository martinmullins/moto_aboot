...
// Address range: 0x8f624b54 - 0x8f624c0b
int32_t ptn_stat(char * a1, int32_t * a2, int32_t * a3, int32_t * a4) {
    int32_t str = (int32_t)a1;
    int32_t v1 = (int32_t)a2;
    int32_t v2 = v1; // R1
    int32_t v3 = (int32_t)a3;
    int32_t v4 = (int32_t)a4; // R7
    int32_t v5 = g31;
    int32_t v6 = partition_get_index(str, v1, v3, v5, str, v5); // 0x8f624b74
    int32_t v7; // 0x8f624bc8
    int32_t v8; // 0x8f624bd0
    int32_t v9; // 0x8f624bd8
    if (v6 != -1) {
        int32_t v10 = partition_get_offset(v6, v2, v3); // R4
        int32_t v11 = partition_get_size(v6, v2, v3, v5, str, v5, g38, g39); // R0
        // branch -> 0x8f624bc8
        // 0x8f624bc8
        v7 = v1;
        if (v7 != 0) {
    ...
    if (strcmp((char *)str, "eMMC") == 0) {
        ...
        if (v9 != 0) {
            // if_8f624bdc_0_true
            *(int32_t *)v9 = *(int32_t *)(g32 + 32);
            *(int32_t *)(v9 + 4) = *(int32_t *)(g32 + 36);
            result = 1;
            // branch -> 0x8f624be4
        } else {
            result = 1;
