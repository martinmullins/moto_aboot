...
// Address range: 0x8f6098b4 - 0x8f60995f
char * mmc_sd_set_hs(char * a1) {
    int32_t v1 = g52; // 0x8f6098b4
    int32_t v2 = g54; // 0x8f6098b4
    int32_t v3 = g55; // 0x8f6098b4
    g54 = (int32_t)&g41;
    g55 = 64;
    ...
    memset((char *)&v5, 0, 64);
    v5 = 6;
    int32_t v6 = g52; // 0x8f609908
    int32_t v7 = 0x1000000 * v6 / 0x1000000; // 0x8f60990c_0
    int32_t v8 = sdhci_send_command((char *)v4, (int32_t)&v5, 64, (int32_t)&g23, 6, -0x7f00000f, v7, 0, 0, 0, 0, v6, 0, 0, 0, 0, (int32_t)&g23, g55); // 0x8f609918
    g55 = v8;
    int32_t * v9 = &g52;
    if (v8 == 0) {
        // 0x8f609928
        sdhci_set_uhs_mode(v4, g52, 64, (int32_t)&g23, v5, -0x7f00000f, v7, 0, 0, 0);
        v9 = &g55;
        // branch -> 0x8f609938
    }
    // 0x8f609938
