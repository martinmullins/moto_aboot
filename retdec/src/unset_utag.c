...
// Address range: 0x8f6271f0 - 0x8f62729f
int32_t unset_utag(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g8;
    int32_t v2; // R0
    int32_t result; // 0x8f62728c_2
    int32_t v3; // 0x8f62728c_23
    if (__utag_exists(0, a1, a3, v1) == 0) {
        // if_8f627214_0_true
        v2 = 1;
        v3 = 1;
        // branch -> 0x8f627274
        ...
        // 0x8f62721c
        int32_t v4;
        if (__utag_is_protected(0, a1, a3, v1, a1, v1, a3, g12, g13, 0) == 0) {
            // 0x8f62724c
            if (__utag_delete(0, a1, a3, v1, a1, v1, a3, g12, g13, 0, v4, 0, 0, 0, 0, 0, 0, 0) == 0) {
                // 0x8f62725c
                if (__utags_flush(0, a1, a3, v1, a1, v1, a3, g12) == 0) {
                    // if_8f627264_0_true
                    v2 = 1;
                    v3 = 1;
                    // branch -> 0x8f627274
            ...
            // 0x8f627230
            fboot_info((int32_t)"INFO", (int32_t)"utag is read-only!", a3, v1, a1, v1, a3, g12, g13, 0, v4);
            fboot_info((int32_t)"INFO", (int32_t)"unprotect with 'fastboot oem config unprotect <name>'", a3, v1, a1, v1, a3, g12, g13, 0, v4);
            // branch -> 0x8f627270
        }
        // 0x8f627270
        v2 = 3;
