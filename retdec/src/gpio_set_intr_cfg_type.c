...
// Address range: 0x8f602e14 - 0x8f602e97
int32_t gpio_set_intr_cfg_type(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = 0x1000 * a1; // 0x8f602e20
    int32_t v2 = g28;
    int32_t result = v1 + 0x1000000; // 0x8f602e28
    int32_t v3; // 0x8f602e64
    if (a2 == 1) {
        int32_t * v4 = (int32_t *)(v1 + 0x1000008); // 0x8f602e3c_05
        *v4 = 144;
        v3 = 148;
        // branch -> 0x8f602e5c
        // 0x8f602e5c
        *v4 = (a2 & 8) == 0 ? v3 | 2 : v3 & -3;
        ...
        if (v2 == g28) {
            // 0x8f602e84
            return udelay(5, a2, v2, v2);
        }
        // 0x8f602e80
        __stack_chk_fail();
        return result;
    }
    int32_t * v5 = (int32_t *)(v1 + 0x1000008); // 0x8f602e3c_0
    *v5 = 144;
    switch (a2) {
        default: {
            // if_8f602e54_0_true
