...
// Address range: 0x8f60f538 - 0x8f60f5ff
int32_t dsi_cmd_dma_trigger_for_panel(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g18;
    *(int32_t *)0x1a98110 = 0x3030303;
    *(int32_t *)0x1a98090 = 1;
    int32_t v2 = 0x10000; // 0x8f60f580
    int32_t v3 = *(int32_t *)0x1a98110 % 2; // 0x8f60f570
    // branch -> 0x8f60f570
    int32_t v4;
    int32_t v5; // 0x8f60f580
    while (true) {
        uint32_t v6 = *(int32_t *)0x1a98110; // 0x8f60f5a4
        if (v3 == 1) {
            int32_t v7 = v6 | 0x1000001; // 0x8f60f5b4
            *(int32_t *)0x1a98110 = v7;
            print_log(2, (int32_t)"%s: Panel CMD: command mode dma tested successfully\n", (int32_t)"dsi_cmd_dma_trigger_for_panel", v7, a1, v1, a3, g19, v4, 0, 0, 0, 0);
            // branch -> 0x8f60f5c8
        } else {
            // 0x8f60f57c
            v5 = v2 - 1;
    ...
    // 0x8f60f58c
    print_log(-1, (int32_t)"%s: Panel CMD: command mode dma test failed\n", (int32_t)"dsi_cmd_dma_trigger_for_panel", v5, a1, v1, a3, g19, v4, 0, 0, 0, 0);
    // branch -> 0x8f60f5c8
    // 0x8f60f5c8
    if (v1 != g18) {
        // 0x8f60f5dc
