...
// Address range: 0x8f6330b0 - 0x8f633127
int32_t is_battery_max17050(void) {
    char * v1 = g40;
    char v2 = *(char *)&g19; // 0x8f6330cc
    char * v3 = v1;
    if (v2 == 0) {
        int32_t v4 = get_battery_offset_by_type((int32_t)"max17050", (int32_t)v2, (int32_t)&g40, (int32_t)&g19); // 0x8f6330e0
        if (v4 > -1) {
            // if_8f6330e8_0_true
            *(char *)(int32_t)&g20 = 1;
            // branch -> after_if_8f6330ec_0
        }
        // after_if_8f6330ec_0
        *(char *)(int32_t)&g19 = 1;
        v3 = g40;
    ...
    int32_t result = (int32_t)*(char *)&g20; // 0x8f633100
    g43 = result;
    if (v1 != v3) {
        // 0x8f63310c
        __stack_chk_fail();
