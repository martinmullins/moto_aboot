...
// Address range: 0x8f61e2cc - 0x8f61e333
int32_t is_dev_diag_mode(void) {
    // 0x8f61e2cc
    int32_t v1;
    ...
    int32_t v2 = g23;
    int32_t v3;
    int32_t v4 = __utag_gets_constprop_3_6((int32_t)"bootmode", (int32_t)&str, 17, v2, v1, 0, 0, 0, 0, v2, g30, g24, v3); // 0x8f61e2ec
    int32_t result = v4; // R0
    int32_t v5 = 0; // 0x8f61e324_22
    if (v4 != 0) {
        uint32_t strcmp_rc = strcmp((char *)&str, "on-device-diag"); // 0x8f61e300
        int32_t v6 = strcmp_rc > 1 ? 0 : 1 - strcmp_rc; // 0x8f61e304
        result = v6;
        v5 = v6;
        // branch -> 0x8f61e30c
    }
