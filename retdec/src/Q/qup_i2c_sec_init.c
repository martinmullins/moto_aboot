...
// Address range: 0x8f612bb8 - 0x8f612c2f
int32_t qup_i2c_sec_init(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = g52; // 0x8f612bb8
    g52 = a1;
    *(int32_t *)(a1 + 44) = a2;
    *(int32_t *)(a1 + 48) = a3;
    int16_t * v2 = g41;
    *(int32_t *)(a1 + 16) = 1;
    int32_t v3 = g52; // 0x8f612be8
    *(int32_t *)(v3 + 40) = 0;
    *(int32_t *)(g52 + 52) = 0xf4240 / a2;
    int32_t v4 = *(int32_t *)(g52 + 12); // 0x8f612bf8
    register_int_handler(v4, (int32_t)&g2, v3, 0);
    if (v2 != g41) {
        // 0x8f612c10
        __stack_chk_fail();
        return (int32_t)v2;
    }
    int32_t v5 = *(int32_t *)(g52 + 12); // 0x8f612c14
    g52 = v1;
    return mask_interrupt(v5, (int32_t)&g2);
}
