...
// Address range: 0x8f612e38 - 0x8f612ea3
int32_t qup_i2c_write_word(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = 0x1000000 * a3 / 0x1000000; // 0x8f612e44_0
    int32_t v2 = v1; // bp-16
    int32_t v3 = 0x10000 * a2 / 0x10000; // 0x8f612e4c_0
    int32_t v4 = v3; // bp-28
    int32_t result = g16;
    int32_t v5 = &v2; // 0x8f612e78_0
    int32_t v6;
    qup_i2c_xfer(a1, (int32_t)&v4, 1, v5, v6, v3, 3, v5, v1, result);
    if (result != g16) {
        // 0x8f612e94
        __stack_chk_fail();
        // branch -> 0x8f612e98
