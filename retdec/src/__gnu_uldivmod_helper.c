...
// Address range: 0x8f67b644 - 0x8f67bf1b
int32_t __gnu_uldivmod_helper(uint32_t a1, int32_t a2, int64_t a3, int32_t a4, int32_t * a5, int32_t a6, int32_t a7) {
    uint32_t v1 = (int32_t)a3;
    uint32_t result = a1 / v1;
    uint64_t v2 = (int64_t)result * (a3 & 0xffffffff); // 0x8f67b664
    uint32_t v3 = (int32_t)v2; // 0x8f67b664
    *a5 = a1 - v3;
    *(int32_t *)((int32_t)a5 + 4) = a2 - v1 * a2 - result * a4 - (int32_t)(v2 / 0x100000000) + (int32_t)(v3 > a1);
    return result;
}
