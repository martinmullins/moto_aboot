...
// Address range: 0x8f6755bc - 0x8f67563f
int32_t check_security_version(int32_t a1, uint32_t a2, uint32_t a3) {
    int32_t v1 = g14;
    if (a2 < a3) {
        // 0x8f675618
    ...
    int32_t v2 = check_cid_provisioned(v1); // 0x8f6755d8
    int32_t v3 = v2; // 0x8f6755e8
    int32_t v4;
    if (v2 == 0) {
        int32_t v5 = cid_init(0, a2, a3, (int32_t)&g14, a1, v1, g23, g17, v4, 0); // 0x8f6755e4
        v3 = v5;
        // branch -> 0x8f6755e8
    }
    // 0x8f6755e8
    int32_t result;
    if (is_factory_product(v3, a2, a3, (int32_t)&g14) == 0) {
        // 0x8f675604
        print_log(0, (int32_t)"downgraded version detected!\n", a3, (int32_t)&g14, a1, v1, g23, g17, v4, 0, 0, 0, 0);
        result = -1;
        // branch -> 0x8f675618
    } else {
        // 0x8f6755f4
        print_log(1, (int32_t)"Factory CID - skip SV check\n", a3, (int32_t)&g14, a1, v1, g23, g17, v4, 0, 0, 0, 0);
        result = 0;
        // branch -> 0x8f675618
    }
    // 0x8f675618
