...
// Address range: 0x8f604e34 - 0x8f604eef
int32_t udc_string_desc_alloc(char * str, int32_t a2) {
    ...
    int32_t len = strlen(str); // 0x8f604e6c
    int32_t v5;
    int32_t v6 = udc_descriptor_alloc(3, v3, 2 * len + 2, (int32_t)&g23, v1, v4, g30, g31, g32, g33, g34, g24, v5); // 0x8f604e84
    int32_t result;
    if (v6 != 0) {
        int32_t v7 = v2 + len; // R7
        *(int32_t *)(int32_t)&g9 = g9 + 1;
        if (v2 != v7) {
            int32_t v8 = v6 + 10; // 0x8f604eb0
            while (true) {
                int32_t v9 = (int32_t)*(char *)v2; // R1
                int32_t v10 = v8 + 2; // R3
                *(char *)(v8 + 1) = 0;
                *(char *)(v10 - 2) = (char)v9;
                int32_t v11 = v2 + 1; // 0x8f604ea8
                if (v11 == v7) {
                    // 0x8f604ea8
                    // branch -> 0x8f604ec0
                    // 0x8f604ec0
                    udc_descriptor_register((int32_t *)v6, v9, 0);
                    // branch -> 0x8f604ecc
                    // 0x8f604ecc
                    if (v4 != g23) {
                        // 0x8f604edc
                    ...
                    // 0x8f604ee0
                    return (int32_t)*(char *)(v6 + 4);
                }
                // if_8f604eac_0_true.if_8f604eac_0_true_crit_edge
                v8 = v10;
                v2 = v11;
                // branch -> if_8f604eac_0_true
            }
        }
        // 0x8f604ec0
        udc_descriptor_register((int32_t *)v6, v3, 0);
        result = (int32_t)*(char *)(v6 + 4);
        // branch -> 0x8f604ecc
    } else {
        result = 0;
    }
