...
// Address range: 0x8f639c98 - 0x8f639d5b
int32_t try_load_clogo(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6) {
    int32_t v1 = g52 ? -0x709c73b8 : 0; // 0x8f639c98
    int32_t v2 = g35;
    event_init((int32_t)&g20, 0, 1, v2);
    int32_t v3;
    int32_t result3 = thread_create((int32_t)"key_process", (int32_t)&g5, 0, 16, 0x1000, 0, 0, v2, 0, g57, g58, v1, a5, a6, 0, v3); // 0x8f639cd4
    g27 = result3;
    if (result3 == 0) {
        int32_t result = print_log(1, (int32_t)"%s: clogo loading thread_create fail\n", (int32_t)"try_load_clogo", (int32_t)&g27, 0x1000, 0, 0, v2, 0, g57, g58, v1, a5); // 0x8f639cf8
        return result;
    }
    // 0x8f639d20
    if (v2 == g35) {
        int32_t result2 = thread_resume(result3, (int32_t)&g5, v2, v2, g57, g58, v1, a5); // 0x8f639d3c
        return result2;
    }
    // 0x8f639d30
    __stack_chk_fail();
