...
// Address range: 0x8f66c778 - 0x8f66c80b
int32_t dbval_read_flash_uid(char * a1, int32_t * a2) {
    ...
    int32_t v3 = v2; // R6
    int32_t v4 = g38;
    int32_t v5 = v2; // 0x8f66c7d821
    if (a2 != NULL) {
        // if_8f66c78c_0_true
        v3 = 1;
        v5 = 1;
        // branch -> after_if_8f66c78c_0
    }
    // after_if_8f66c78c_0
    int32_t result; // R0
    if (a1 == NULL) {
        // 0x8f66c7d0
        result = 240;
        // branch -> after_if_8f66c7d8_0
        // after_if_8f66c7d8_0
        if (v5 % 2 == 0) {
            // after_if_8f66c7f0_0.critedge
            // branch -> after_if_8f66c7f0_0
        } else {
            // if_8f66c7e4_0_true
            *(int32_t *)v2 = 16;
            result = 15;
