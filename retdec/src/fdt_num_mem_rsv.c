...
// Address range: 0x8f64bf3c - 0x8f64bf9b
int32_t fdt_num_mem_rsv(int32_t a1) {
    int32_t v1 = g22; // 0x8f64bf3c
    g22 = 0;
    int32_t v2 = *(int32_t *)(a1 + 16); // 0x8f64bf4c
    int32_t v3 = g16;
    int32_t v4 = fdt32_to_cpu_100(v2, g19, g20, v3, a1, v3, v1, g23) + a1; // 0x8f64bf5c
    int32_t v5 = v3; // 0x8f64bf68
    // branch -> 0x8f64bf60
    while (true) {
        int32_t v6 = *(int32_t *)(v4 + 8); // 0x8f64bf60
        int32_t v7 = *(int32_t *)(v4 + 12); // 0x8f64bf60
        int32_t v8;
        int32_t v9 = fdt64_to_cpu(v6, v7, g20, v5, a1, v3, v1, g23, g24, g17, v8, 0, 0, 0, 0); // 0x8f64bf68
        if (v9 == v7) {
            int32_t result = g22; // 0x8f64bf7c
            if (v3 != g16) {
                // 0x8f64bf8c
                __stack_chk_fail();
                // branch -> 0x8f64bf90
