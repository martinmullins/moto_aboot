...
// Address range: 0x8f61dee4 - 0x8f61df37
int32_t factory_mode(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g26; // 0x8f61dee4
    g26 = &g15;
    int32_t v2 = g15;
    int32_t v3;
    int32_t result = print_log(1, (int32_t)"Entering factory mode\n", a3, v2, a1, v2, v1, g19, v3, 0, 0, 0, 0); // 0x8f61defc
    *(char *)&g3 = 4;
    if (v2 == g15) {
        // 0x8f61df20
        g26 = v1;
        return boot_linux_from_flash(result, (int32_t)"Entering factory mode\n", v2, v2, v1, g19, v3, 0, 0);
    }
    // 0x8f61df1c
    __stack_chk_fail();
    return result;
