...
// Address range: 0x8f67b018 - 0x8f67b0cf
int32_t load_partition_by_name(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = g33; // 0x8f67b018
    int32_t v2 = g34; // 0x8f67b018
    int32_t v3 = g35; // 0x8f67b018
    int32_t v4 = g36; // 0x8f67b018
    int32_t v5 = g37; // 0x8f67b018
    int32_t v6 = g38; // 0x8f67b018
    int32_t v7 = g23;
    int32_t result; // R0
    if (a1 == 0) {
        // 0x8f67b044
        print_log(0, (int32_t)"%s: partition name can't be NULL\n", (int32_t)"load_partition_by_name", v7, 0, v7, a3, v1, v2, v3, v4, v5, v6);
        result = -1;
        if (v7 == g23) {
            // 0x8f67b0b8
            return -1;
        ...
        char * v8 = get_partition_by_name(a1, a2, a3, v7, a1, v7, a3, v1, v2, v3, v4); // 0x8f67b054
        int32_t v9 = (int32_t)v8; // 0x8f67b054_12
        result = v9;
        if (v8 == NULL) {
            // 0x8f67b060
            return print_log(v9, (int32_t)"%s: failed to find partition %s\n", (int32_t)"load_partition_by_name", a1, a1, v7, a3, v1, v2, v3, v4, v5, v6);
        }
        // 0x8f67b074
        if (v7 == g23) {
            // 0x8f67b084
            ...
            g37 = v5;
            g38 = v6;
            return load_partition(v9, a2, (int64_t)a3, a4, v1, v2, v3, v4, v5);
        }
    }
    // 0x8f67b0b4
    __stack_chk_fail();
