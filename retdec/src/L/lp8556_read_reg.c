...
// Address range: 0x8f640ba8 - 0x8f640c13
int32_t lp8556_read_reg(int32_t a1, int32_t a2) {
    int32_t v1 = g14; // 0x8f640bb0
    int32_t v2 = g12;
    int32_t v3 = g10; // R0
    int32_t v4; // 0x8f640c08_22
    if (g10 == 0) {
        // 0x8f640bec
        v3 = -3;
        v4 = -3;
        ...
        // 0x8f640bd4
        int32_t v5;
        qup_i2c_read_byte(g10, 44, a1, a2, a1, v2, v1, 0, v5, 0, 0, 0, 0, 0, 0);
        int32_t v6 = v3; // 0x8f640bdc
        int32_t v7 = v6; // 0x8f640c08_23
        if (v6 > -1) {
            // if_8f640be0_0_true
            v3 = 0;
            v7 = 0;
            // branch -> after_if_8f640be0_0
        }
        // after_if_8f640be0_0
        if (v6 < 0) {
            // if_8f640be4_0_true
