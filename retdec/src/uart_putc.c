...
// Address range: 0x8f60d688 - 0x8f60d6f7
int32_t uart_putc(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = 0x1000000 * a2 / 0x1000000; // bp-17
    int32_t result = g30;
    int32_t v2 = *(int32_t *)(4 * a1 + (int32_t)&g21); // 0x8f60d6a4
    int32_t v3 = result;
    if (g20 != 0) {
        // 0x8f60d6b8
        int32_t v4;
        msm_boot_uart_dm_write(v2, (int32_t)&v1, 1, (int32_t)&g30, a1, a2, a3, result, g40, g32, v4, 0, 0, 0, 0);
        v3 = g30;
        // branch -> 0x8f60d6d0
    }
    // 0x8f60d6d0
