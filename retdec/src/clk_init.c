...
// Address range: 0x8f60ccd4 - 0x8f60cd17
int32_t clk_init(int32_t a1, int32_t a2, int32_t a3) {
    // 0x8f60ccd4
    if (a1 == 0) {
        // after_if_8f60ccdc_0.thread
        // branch -> after_if_8f60ccf0_0.thread
        // after_if_8f60ccf0_0.thread
        // branch -> 0x8f60cd08
        // 0x8f60cd08
        return g31;
    }
    int32_t result = g31;
    int32_t v1 = a2 == 0 ? result : (int32_t)&g14;
    if (a2 == 0) {
        // after_if_8f60ccf0_0.thread
        // branch -> 0x8f60cd08
        // 0x8f60cd08
