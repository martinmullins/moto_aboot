...
// Address range: 0x8f64bb48 - 0x8f64bbab
int32_t _fdt_check_node_offset(int32_t a1, int32_t a2) {
    int32_t v1 = g26; // 0x8f64bb48
    int32_t v2 = a2; // bp-20
    int32_t v3 = g15;
    g26 = &g15;
    int32_t v4 = v3;
    ...
    if (a2 > -1 && a2 % 4 == 0) {
        // 0x8f64bb78
        int32_t v5;
        int32_t v6 = fdt_next_tag(a1, a2, (int32_t)&v2, (int32_t)&g15, a1, a2, g24, v3, v1, g19, v5, 0, 0); // 0x8f64bb7c
        v4 = g15;
        result = v6 == 1 ? v2 : -4;
        // branch -> 0x8f64bb8c
    }
