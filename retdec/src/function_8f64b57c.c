...
// Address range: 0x8f64b57c - 0x8f64b5d7
void function_8f64b57c(void) {
    int32_t v1 = g20; // 0x8f64b584
    int32_t v2 = v1 + g21; // 0x8f64b584
    int32_t v3 = g17;
    // branch -> 0x8f64b594
    while (true) {
        int32_t v4 = v1; // R12
        int32_t v5 = v1; // 0x8f64b5a4
        int32_t v6;
        int32_t v7; // 0x8f64b5a41
        int32_t v8; // 0x8f64b5a4
        if (v1 != v2) {
            int32_t v9 = v1; // 0x8f64b5bc
            int32_t v10 = v1; // 0x8f64b5b8
          lab_0x8f64b5b8:;
            int32_t v11 = v9 + 1; // 0x8f64b5bc
            if (*(char *)v10 != 0) {
                // 0x8f64b5b8
                v1 = v11;
                // branch -> 0x8f64b594
