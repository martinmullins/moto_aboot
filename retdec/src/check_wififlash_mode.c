...
// Address range: 0x8f61e624 - 0x8f61e687
int32_t check_wififlash_mode(char * a1, int32_t a2) {
    int32_t v1 = g31; // 0x8f61e624
    g31 = &g17;
    int32_t v2 = g17;
    int32_t v3 = get_current_boot_mode((int32_t)a1, a2, g29, v2); // 0x8f61e634
    if (v3 == 1) {
        // 0x8f61e658
        // branch -> 0x8f61e65c
        // 0x8f61e65c
        ...
        // 0x8f61e670
        g31 = v1;
        return (int32_t)"recovery";
    }
    // 0x8f61e640
    int32_t v4; // R0
    int32_t v5; // 0x8f61e674_22
    if (v3 == 8) {
        // if_8f61e650_0_true
        v4 = (int32_t)"wff";
        v5 = (int32_t)"wff";
