...
// Address range: 0x8f640508 - 0x8f640573
int32_t bd65060_read_reg(int32_t a1, int32_t a2) {
    // 0x8f640508
    g38 = a2;
    int32_t v1 = g31;
    g34 = g13;
    int32_t v2; // 0x8f640568_22
    if (g13 == 0) {
        // 0x8f64054c
        g34 = -3;
        v2 = -3;
        ...
        // 0x8f640534
        int32_t v3;
        qup_i2c_read_byte(g13, 100, a1, a2, a1, v1, g39, g33, v3, 0, 0, 0, 0, 0, 0);
        int32_t v4 = g34; // 0x8f64053c
        int32_t v5 = v4; // 0x8f640568_23
        if (v4 > -1) {
            // if_8f640540_0_true
            g34 = 0;
            v5 = 0;
            // branch -> after_if_8f640540_0
        }
        // after_if_8f640540_0
        if (v4 < 0) {
            // if_8f640544_0_true
