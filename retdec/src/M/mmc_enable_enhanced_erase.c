...
// Address range: 0x8f60b0c4 - 0x8f60b15f
int32_t mmc_enable_enhanced_erase(void) {
    int32_t v1 = g26; // 0x8f60b0c8
    int32_t v2 = g27; // 0x8f60b0c8
    int32_t v3 = g15;
    g26 = g20;
    int32_t v4; // R0
    int32_t result; // 0x8f60b158_2
    int32_t v5; // 0x8f60b158_22
    if (*(char *)(*(int32_t *)(g20 + 80) + 175) == 0) {
        // 0x8f60b0f8
        int32_t v6;
        char * v7 = mmc_switch_cmd((char *)g20, g20 + 48, 3, 175, 1, 0, 0, v3, 0, v1, v2, g19, v6, 0, 0, 0, 0, 0); // 0x8f60b10c
        int32_t v8 = (int32_t)v7; // 0x8f60b10c_20
        v4 = v8;
        if (v7 == NULL) {
            int32_t v9 = mmc_get_ext_csd_isra_11((char *)g26, g26 + 80, 3, 175, 1, 0, 0, v3, 0, v1, v2, g19, v6, 0, 0); // 0x8f60b120
            v4 = v9;
            if (v9 == 0) {
                // 0x8f60b12c
                if (*(char *)(*(int32_t *)(g26 + 80) + 175) == 0) {
                    // 0x8f60b13c
                    v4 = 1000;
                    v5 = 1000;
                    // branch -> 0x8f60b140
