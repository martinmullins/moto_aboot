...
// Address range: 0x8f60e910 - 0x8f60e9e3
int32_t mdss_intf_fetch_start_config(int32_t * a1, int32_t a2) {
    int32_t v1 = (int32_t)a1;
    int32_t result = v1; // R0
    int32_t v2 = g41; // 0x8f60e914
    int32_t v3 = g42; // 0x8f60e914
    g41 = v1;
    int32_t v4 = g23;
    g42 = &g23;
    if (a1 != NULL) {
        // 0x8f60e938
        if (*(int32_t *)0x1a01000 > 0x1004ffff) {
            // 0x8f60e944
            int32_t v5;
            if (*(int32_t *)(v1 + 80) <= 8) {
                int32_t v6 = mdss_mdp_intf_offset(v1, a2); // 0x8f60e950
                int32_t v7 = g41; // 0x8f60e954
                int32_t v8 = *(int32_t *)(v7 + 76); // 0x8f60e958
                uint32_t v9 = *(int32_t *)v7; // 0x8f60e95c
                int32_t v10 = *(int32_t *)(v7 + 72); // 0x8f60e968
                uint32_t v11 = *(int32_t *)(v7 + 84); // 0x8f60e970
                int32_t v12 = v10 + v8 + *(int32_t *)(v7 + 68); // 0x8f60e974
                int32_t v13 = v9; // 0x8f60e980
                if (*(char *)(v7 + 113) != 0) {
                    // if_8f60e978_0_true
                    v13 = v9 / 2;
                    // branch -> after_if_8f60e978_0
                }
                int32_t v14 = *(int32_t *)(v7 + 88); // 0x8f60e984
                int32_t v15 = *(int32_t *)(v7 + 4); // 0x8f60e98c
                int32_t v16 = v15 + v11 + v14 + *(int32_t *)(v7 + 80); // 0x8f60e994
                int32_t v17 = v11; // 0x8f60e9a0
                if (v11 < 12) {
                    // if_8f60e99c_0_true
                    v17 = 12;
                    // branch -> after_if_8f60e99c_0
                }
                int32_t v18 = a2 + v6; // 0x8f60e9ac
                result = v18;
                *(int32_t *)(v18 + 368) = (v16 - v17) * (v13 + v12) + 1;
