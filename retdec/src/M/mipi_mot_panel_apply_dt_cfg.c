...
// Address range: 0x8f643f40 - 0x8f644067
int32_t mipi_mot_panel_apply_dt_cfg(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = a1 + 77; // 0x8f643f44
    int32_t v2 = v1; // R12
    int32_t result = g20;
    int32_t * v3 = (int32_t *)(a1 + 500); // 0x8f643f54_0
    int32_t v4 = *v3; // R2
    char v5 = *(char *)(a1 + 44); // 0x8f643f5c
    int32_t v6 = v5; // R3
    if (v5 == 0) {
        // 0x8f643fdc
        *(int32_t *)(a1 + 48) = *(int32_t *)(a2 + 184);
        *(char *)(a1 + 76) = *(char *)(v4 + 4);
        *(char *)v1 = *(char *)(v4 + 5);
        int32_t v7 = v2; // 0x8f644010
        // branch -> 0x8f643ff8
        while (true) {
            int32_t v8 = v6; // 0x8f644000
            int32_t v9 = v8 + 1; // 0x8f644004
            v6 = v9;
            int32_t v10 = *(int32_t *)(4 * v8 + *(int32_t *)(*v3 + 12) + 28); // 0x8f64400c
            int32_t v11 = v7 + 1; // 0x8f644010
            *(char *)v11 = (char)v10;
            if (v9 == 12) {
                // 0x8f644018
                *(int32_t *)(a1 + 52) = *(int32_t *)(a2 + 72);
                *(int32_t *)(a1 + 56) = *(int32_t *)(a2 + 68);
                *(int32_t *)(a1 + 60) = *(int32_t *)(a2 + 76);
                *(int32_t *)(a1 + 64) = *(int32_t *)(a2 + 84);
                *(int32_t *)(a1 + 68) = *(int32_t *)(a2 + 80);
                *(int32_t *)(a1 + 72) = *(int32_t *)(a2 + 88);
                // branch -> 0x8f644048
                // 0x8f644048
                if (result != g20) {
                    // 0x8f644058
        ...
        // 0x8f643f68
        *(int32_t *)(a2 + 184) = *(int32_t *)(a1 + 48);
        *(char *)(v4 + 4) = *(char *)(a1 + 76);
        *(char *)(*v3 + 5) = *(char *)v1;
        int32_t v12 = *(int32_t *)(*v3 + 12); // 0x8f643f88
        int32_t v13 = v2 + 1; // 0x8f643f907
        *(int32_t *)(v12 + 28) = (int32_t)*(char *)v13;
        int32_t v14 = v12 + 4;
        int32_t v15 = v13 + 1; // 0x8f643f90
        int32_t v16 = 2; // 0x8f643f94
        *(int32_t *)(v14 + 28) = (int32_t)*(char *)v15;
        // branch -> 0x8f643f90
        while (v16 != 12) {
            // 0x8f643f90
            v14 += 4;
        ...
        // 0x8f643fa8
        *(int32_t *)(a2 + 72) = *(int32_t *)(a1 + 52);
        *(int32_t *)(a2 + 68) = *(int32_t *)(a1 + 56);
        *(int32_t *)(a2 + 76) = *(int32_t *)(a1 + 60);
        *(int32_t *)(a2 + 84) = *(int32_t *)(a1 + 64);
        *(int32_t *)(a2 + 80) = *(int32_t *)(a1 + 68);
        *(int32_t *)(a2 + 88) = *(int32_t *)(a1 + 72);
        // branch -> 0x8f644048
    }
    // 0x8f644048
    if (result != g20) {
