...
// Address range: 0x8f674e8c - 0x8f674fd3
int32_t make_product_phone(int32_t a1, int32_t a2) {
    int32_t v1 = g31; // 0x8f674e8c
    int32_t v2 = g32; // 0x8f674e8c
    int32_t v3 = g27 ? -0x709cc008 : 0; // 0x8f674e8c
    int32_t v4 = g16;
    int32_t v5 = get_current_secure_state(a1, a2, g30, v4, a1, v4); // 0x8f674ea0
    int32_t result; // 0x8f674fb0_2
    int32_t v6;
    if (v5 != 1) {
        char v7 = *(char *)&g14; // 0x8f674ebc
        print_log(0, (int32_t)"Invalid current status: %d\n", (int32_t)v7, (int32_t)&g14, a1, v4, v1, v2, g33, v3, v6, 0, 0);
        g28 = 2;
        // branch -> 0x8f674f98
        // 0x8f674f98
        if (v4 != g16) {
    ...
    int32_t v8 = cid_init(1, a2, g30, v4, a1, v4, v1, v2, g33, v3); // 0x8f674ecc
    if (v8 == 0) {
        // 0x8f674efc
        print_log(v5, (int32_t)"CID init failed\n", g30, v4, a1, v4, v1, v2, g33, v3, v6, 0, 0);
        g28 = 4;
        // branch -> 0x8f674f98
        // 0x8f674f98
        if (v4 != g16) {
    ...
    int32_t v9 = get_db_cid(v8); // 0x8f674ed8
    int32_t v10 = v4 & -0x10000; // 0x8f674edc
    if (v9 == (v10 || 0xdead)) {
        // 0x8f674ee8
        print_log(0, (int32_t)"CID is not programmed\n", g30, v9, a1, v4, v1, v2, g33, v3, v6, 0, 0);
        g28 = 3;
        // branch -> 0x8f674f98
        // 0x8f674f98
        if (v4 != g16) {
    ...
    uint32_t v11 = a1 - 1; // 0x8f674f10
    uint32_t v12 = v10 | 1022; // 0x8f674f14
    if (v11 > v12) {
        // 0x8f674f20
        print_log(0, (int32_t)"Invalid Model ID!\n", v11, v12, a1, v4, v1, v2, g33, v3, v6, 0, 0);
        g28 = 5;
        // branch -> 0x8f674f98
        // 0x8f674f98
        if (v4 != g16) {
    ...
    int32_t v13 = SecSetModelID(a1, a2, v11, v12); // 0x8f674f38
    int32_t v14 = SecMakeOutofFactory(a1, a2, v13, v12); // 0x8f674f3c
    if (v14 == 16) {
        // 0x8f674f48
        print_log(-1, (int32_t)"Failed to blow Model ID efuse\n", v13, v12, a1, v4, v1, v2, g33, v3, v6, 0, 0);
        g28 = 6;
        // branch -> 0x8f674f98
        // 0x8f674f98
        if (v4 != g16) {
    ...
    int32_t v15 = SecMakeProduction(v14, a2, v13, v12); // 0x8f674f5c
    int32_t v16; // 0x8f674fb0_23
    if (v15 == 16) {
        // 0x8f674f68
        print_log(-1, (int32_t)"Failed to blow production efuse\n", v13, v12, a1, v4, v1, v2, g33, v3, v6, 0, 0);
        g28 = 7;
        v16 = 7;
        // branch -> 0x8f674f98
    } else {
        int32_t v17 = is_verified_boot_flow(v15, a2, v13, v12) == 0 ? 3 : 6;
        set_current_secure_state(v17, v5, v13, v12, a1, v4, v1);
        g28 = 0;
        v16 = 0;
        // branch -> 0x8f674f98
    }
