...
// Address range: 0x8f671e14 - 0x8f671ecf
int32_t mot_sst_is_feature_enabled(void) {
    int32_t v1 = g32;
    int32_t v2 = -1; // R3
    int32_t v3 = -1; // bp-21
    int32_t v4 = get_db_cid_feature_flag_byte(g35, g36); // R6
    int32_t v5 = mot_sst_pal_get_sbd_dis_otp_bit((int32_t)&v3, g36, g39, v2, g35, v1, g41); // 0x8f671e3c
    if (v5 == 0) {
        // 0x8f671e48
        v2 = 0x1000000 * v3 / 0x1000000;
        // branch -> 0x8f671e5c
    }
    int32_t v6 = check_cid_provisioned(v5); // 0x8f671e5c
    int32_t v7;
    if (v6 == 0) {
        // after_if_8f671e68_0
        // branch -> 0x8f671e98
        // 0x8f671e98
        print_log(2, (int32_t)"CID datblock not installed feature disabled.  Should also be locked if production device\n", g39, v2, g35, v1, g41, g42, g43, g34, v7, 0, 0);
        // branch -> 0x8f671ea0
        // 0x8f671ea0
        if (v1 != g32) {
            // 0x8f671eb0
    ...
    // 0x8f671e70
    int32_t result;
    if (get_db_cid_version_byte(v6, g36, g39) == 0) {
        // if_8f671e78_0_true
        // branch -> 0x8f671e98
        // 0x8f671e98
        print_log(2, (int32_t)"CID datblock v0 installed.  Feature disabled\n", g39, v2, g35, v1, g41, g42, g43, g34, v7, 0, 0);
        result = 0;
        // branch -> 0x8f671ea0
    } else {
        // 0x8f671e84
        if (v4 == 1) {
            ...
            // branch -> 0x8f671e98
            // 0x8f671e98
            print_log(2, (int32_t)"CID flag disable\n", g39, v2, g35, v1, g41, g42, g43, g34, v7, 0, 0);
            result = 0;
            // branch -> 0x8f671ea0
        } else {
            result = 255;
