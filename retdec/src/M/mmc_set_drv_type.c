...
// Address range: 0x8f6095f0 - 0x8f609663
int32_t mmc_set_drv_type(char * a1, int32_t a2, uint32_t a3, int32_t a4) {
    int32_t v1 = g47;
    char v2 = *(char *)(*(int32_t *)(a2 + 32) + 197); // 0x8f609608
    uint32_t v3 = a3 % 256; // 0x8f60960c
    uint32_t v4 = v3 == 0 ? 0 : v3 > 31 ? 31 : v3; // 0x8f60960c
    int32_t v5 = v1;
    int32_t result = 1;
    if (((int32_t)v2 >> v4) % 2 != 0) {
        // 0x8f609620
        int32_t v6;
        int32_t v7 = mmc_switch_cmd(a1, a2, 3, 185, 16 * a3 | 2, a2, a3, v1, g53, g48, v6, 0, 0, 0, 0, 0, 0, 0) == NULL;
        v5 = g47;
        result = v7;
        // branch -> 0x8f609644
    }
