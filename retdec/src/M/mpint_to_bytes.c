...
// Address range: 0x8f670dbc - 0x8f670e23
int32_t mpint_to_bytes(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1; // R0
    int32_t v2 = g41; // 0x8f670dc0
    int32_t v3 = g42; // 0x8f670dc0
    int32_t result = g23;
    g41 = 0;
    g42 = &g23;
    if (a3 > 0) {
        int32_t v4 = 4 * a3 + a2; // 0x8f670de0
        while (true) {
            int32_t v5 = v4 - 4; // 0x8f670de0
            int32_t v6 = *(int32_t *)v5; // 0x8f670de0
            *(char *)(v1 + 3) = (char)v6;
            int32_t v7 = 3; // 0x8f670dec
            char v8 = v6 / 256;
            // branch -> 0x8f670de8
            while (v7 != 1) {
                // 0x8f670de8
            ...
            int32_t v9 = v1; // 0x8f670df8
            v1 = v9 + 4;
            *(char *)v9 = v8;
            int32_t v10 = g41 + 1; // 0x8f670dfc
            g41 = v10;
            if (v10 >= a3) {
                // 0x8f670dd8
                // branch -> 0x8f670e04
