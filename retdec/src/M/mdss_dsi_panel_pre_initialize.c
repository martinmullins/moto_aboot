...
// Address range: 0x8f60fc40 - 0x8f60fcaf
int32_t mdss_dsi_panel_pre_initialize(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = *(int32_t *)(a1 + 24); // 0x8f60fc50
    int32_t v2 = *(int32_t *)(a1 + 28); // 0x8f60fc58
    if (v1 == 0 || v2 == 0) {
        // 0x8f60fca4
        return 0;
    }
    // 0x8f60fc80
    int32_t v3;
    return mdss_dsi_panel_commands_send_part_1(v1, v2, a2, g38, 0, v3, 0, 0, 0);
}
