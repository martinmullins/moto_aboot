...
// Address range: 0x8f60ff00 - 0x8f61004b
int32_t mdss_dsi_cmd_mode_config(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, int32_t a9) {
    int32_t v1 = g47;
    int32_t v2 = 0x1000000 * a7 / 0x1000000; // R7
    int32_t v3 = 0x1000000 * a8 / 0x1000000; // R6
    int32_t v4 = 0x1000000 * a9 / 0x1000000; // R5
    int32_t v5; // R12
    switch ((int16_t)a5) {
        default: {
            // 0x8f60ff4c
            print_log(-1, (int32_t)"unsupported dst format\n", a3, a4, a1, v1, a3, g53, g54, g55, g56, g57, g58);
            // branch -> 0x8f61001c
            // 0x8f61001c
            if (v1 != g47) {
                // 0x8f61002c
    ...
    *(int32_t *)(v6 + 284) = 575;
    *(int32_t *)(v6 + 4) = result;
    *(int32_t *)(v6 + 268) = 0x3f03fe0;
    *(int32_t *)(v6 + 272) = 0x2020202;
    *(int32_t *)(v6 + 64) = v5;
    int32_t v7 = 0x10000 * a4 | a3; // R2
    int32_t v8 = 0x10000 * a3 * 0x1000000 * a6 / 0x1000000 + 0x10000 | 57; // 0x8f60ffd4
    *(int32_t *)(v6 + 88) = v8;
    *(int32_t *)(v6 + 96) = v8;
    *(int32_t *)(v6 + 92) = v7;
    *(int32_t *)(v6 + 100) = v7;
    *(int32_t *)(v6 + 68) = 0x13c2c;
    *(int32_t *)(v6 + 4) = 16 * v2 | 0x40000000 * v3 | 261;
    *(int32_t *)(v6 + 60) = 0x14000000;
    *(int32_t *)(v6 + 160) = 0x10000000;
    int32_t v9 = v4 == result ? v4 - result : 1;
    *(int32_t *)(v6 + 204) = v9;
    // branch -> 0x8f61001c
    // 0x8f61001c
    if (v1 != g47) {
