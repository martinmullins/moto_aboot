...
// Address range: 0x8f664ac8 - 0x8f664baf
int32_t mcs_cert_get_rsa_public_key(char * a1, int32_t a2, int32_t * a3, int32_t a4) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g31;
    int32_t v3;
    if (a1 == NULL || v3 == 0 | a3 == NULL | *a1 != 20) {
        // 0x8f664b84
        // branch -> 0x8f664b90
        // 0x8f664b90
        if (v2 != g31) {
    ...
    int32_t v4 = *(int32_t *)(v1 + 4); // 0x8f664b04
    if (v4 == 0 || *(int32_t *)(v1 + 12) == 0) {
        // 0x8f664b84
        // branch -> 0x8f664b90
        // 0x8f664b90
        if (v2 != g31) {
    ...
    int32_t v5 = *(int32_t *)(v1 + 8); // 0x8f664b1c
    if (a2 == 0) {
        // after_if_8f664b24_0.thread
        *a3 = v5;
        // branch -> after_if_8f664b34_0
    } else {
        // after_if_8f664b24_0
        *a3 = v5;
        if (a4 != 0) {
            ...
            *(int32_t *)v3 = *(int32_t *)(v1 + 16);
            uint32_t v6 = *(int32_t *)(v1 + 8); // 0x8f664b48
            if (*a3 >= v6) {
                uint32_t v7 = *(int32_t *)(v1 + 16); // 0x8f664b54
                if (*(int32_t *)v3 >= v7) {
                    // 0x8f664b60
                    mcs_memcpy(a2, v4, v6, v7);
                    mcs_memcpy(a4, *(int32_t *)(v1 + 12), *(int32_t *)(v1 + 16), v7);
                    // branch -> 0x8f664b90
                    // 0x8f664b90
                    if (v2 != g31) {
                        // 0x8f664ba0
