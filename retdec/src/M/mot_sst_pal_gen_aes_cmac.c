...
// Address range: 0x8f672dd0 - 0x8f672e53
int32_t mot_sst_pal_gen_aes_cmac(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g19;
    int32_t v3;
    print_log(1, (int32_t)"mot_sst_pal_gen_aes_cmac: START\n", a3, v2, v1, v2, g26, g27, g28, g21, v3, 0, 0);
    int32_t result = SecAESEncrypt(a1, a3, a3, v2, v1, v2, g26, g27); // 0x8f672dfc
    if (result == 0) {
        // 0x8f672e0c
        print_log(1, (int32_t)"Success generating cmac\n", a3, v2, v1, v2, g26, g27, g28, g21, v3, 0, 0);
        // branch -> 0x8f672e28
    } else {
        // 0x8f672e1c
        print_log(1, (int32_t)"FAIL generating cmac\n", a3, v2, v1, v2, g26, g27, g28, g21, v3, 0, 0);
        result = 255;
        // branch -> 0x8f672e28
    }
    // 0x8f672e28
