...
// Address range: 0x8f60277c - 0x8f602807
int32_t mdss_bus_clocks_enable(void) {
    // 0x8f60277c
    g34 = (int32_t)"mdss_axi_clk";
    int32_t v1 = g31;
    g38 = v1;
    int32_t v2;
    int32_t v3 = clk_get_set_enable((int32_t)"mdss_axi_clk", 0, 1, v1, v2, 0, 0, v1, 0, g39); // 0x8f6027a0
    g34 = v3;
    int32_t v4 = 0; // 0x8f6027ec_22
    if (v3 != 0) {
        // 0x8f6027ac
        g34 = -1;
        int32_t v5;
        print_log(-1, (int32_t)"failed to set mdss_axi_clk ret = %d\n", v3, v1, v2, 0, 0, v1, 0, g39, g40, g33, v5);
        g34 = g33;
        g38 = (int32_t)&g8 & -0x10000 | 261;
        int32_t v6 = _panic(g33, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/acpuclock.c", (int32_t)&g8 & -0x10000 | 261, (int32_t)&g8, 0, 0); // 0x8f6027d0
        g34 = v6;
        v4 = v6;
        // branch -> 0x8f6027d4
    }
