...
// Address range: 0x8f61004c - 0x8f6100db
int32_t mipi_dsi_on(int32_t a1, int32_t a2) {
    int32_t v1 = g47; // 0x8f61004c
    int32_t v2 = g48; // 0x8f61004c
    int32_t v3 = g49; // 0x8f61004c
    g48 = 0x1a98000;
    int32_t v4 = g31;
    int32_t v5 = *(int32_t *)0x1a98110; // 0x8f610064
    g47 = v5;
    mdelay(10, a2, g45);
    int32_t v6 = v5 & 0x10000; // 0x8f610070
    g47 = v6;
    int32_t v7 = 0x10000; // 0x8f6100a8
    // branch -> 0x8f610074
    int32_t result; // 0x8f6100c8_2
    int32_t v8;
    int32_t v9;
    int32_t v10;
    int32_t v11; // 0x8f610080
    while (true) {
        // 0x8f610074
        if (v6 == 0x10000) {
            // 0x8f6100a0
            print_log(1, (int32_t)"Video lane tested successfully\n", g45, v7, a1, v4, v1, v2, v3, g40, v8, 0, 0);
            v9 = 0;
            // branch -> 0x8f6100b0
        } else {
            // 0x8f61007c
            v11 = v7 - 1;
            int32_t v12 = *(int32_t *)(g48 + 272) & 0x10000; // 0x8f610084
            g47 = v12;
            if (v7 == 1) {
                // break -> 0x8f61008c
                break;
    ...
    // 0x8f61008c
    print_log(-1, (int32_t)"Video lane test failed\n", g45, v11, a1, v4, v1, v2, v3, g40, v8, 0, 0);
    v9 = -1;
    // branch -> 0x8f6100b0
    // 0x8f6100b0
    g41 = v9;
