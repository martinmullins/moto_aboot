...
// Address range: 0x8f66b29c - 0x8f66b303
int32_t mcs_X509Certificate_getSubjectPublicKey(int32_t a1) {
    int32_t * v1 = (int32_t *)(a1 + 96); // 0x8f66b2ac_0
    *(int32_t *)g10 = *(int32_t *)(*v1 + 4);
    *(int16_t *)g11 = *(int16_t *)(*v1 + 2);
    int32_t * v2 = (int32_t *)(a1 + 100); // 0x8f66b2c4_0
    *(int32_t *)g12 = *(int32_t *)(*v2 + 4);
    int32_t v3;
    *(int16_t *)v3 = *(int16_t *)(*v2 + 2);
    // 0x8f66b2f8
    return 0;
}
