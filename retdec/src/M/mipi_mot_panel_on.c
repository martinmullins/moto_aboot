...
// Address range: 0x8f643e4c - 0x8f643edf
int32_t mipi_mot_panel_on(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = a3; // R2
    int32_t v2 = a1; // bp-24
    int32_t v3 = g26; // 0x8f643e4c
    int32_t v4 = &v2; // 0x8f643e4c_1
    int32_t v5 = 1; // R1
    int32_t v6 = g15;
    int32_t v7;
    int32_t v8 = mipi_dsi_cmds_tx((int32_t)&g5, 1, a3, v6, a1, v6, a3, v3, g27, g19, v7, 0); // 0x8f643e64
    g26 = v8;
    int32_t v9 = 0; // 0x8f643e80
    if (v8 != 0) {
        // 0x8f643e70
        v5 = (int32_t)"failed to send power on command. Ret =%d\n";
        v1 = v8;
        v9 = print_log(-1, (int32_t)"failed to send power on command. Ret =%d\n", v8, v6, v2, v6, a3, v3, g27, g19, v7, 0, 0);
        // branch -> 0x8f643e80
    }
    int32_t v10 = g26 + mipi_dsi_cmd_bta_sw_trigger(v9, v5, v1, v6); // 0x8f643e8c
    g26 = v10;
    int32_t v11 = get_panel_info(v4, (int32_t)&g4, 1, v6, v2, v6, a3, v3, g27, g19, v7, 0, 0, 0); // 0x8f643e94
    int32_t result = v11 + v10; // 0x8f643ea0
    g26 = result;
    print_log(1, (int32_t)"MOT panel on and power_mode =0x%x\n", v2, v6, v2, v6, a3, v3, g27, g19, v7, 0, 0);
    if (v6 != g15) {
        // 0x8f643ec0
        __stack_chk_fail();
        // branch -> 0x8f643ec4
