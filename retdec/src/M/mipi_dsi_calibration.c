...
// Address range: 0x8f610d60 - 0x8f610e13
int32_t mipi_dsi_calibration(int32_t a1, int32_t a2, int32_t a3) {
    int32_t result2 = 0; // R0
    int16_t * v1 = g18;
    int32_t v2 = 0x1a98000; // R3
    int32_t v3 = 1; // R2
    *(int32_t *)0x1a98518 = 1;
    *(int32_t *)(v2 + 1332) = result2;
    *(int32_t *)(v2 + 1340) = 90;
    *(int32_t *)(v2 + 1348) = 16;
    *(int32_t *)(v2 + 1352) = v3;
    *(int32_t *)(v2 + 1336) = v3;
    *(int32_t *)(v2 + 1320) = v3;
    v3 = v3 & -0x10000 | 0x1389;
    *(int32_t *)(v2 + 1320) = result2;
    // branch -> 0x8f610db0
    while (true) {
        int32_t result = *(int32_t *)(v2 + 1360);
        result2 = result;
        if ((result & 16) == 0) {
            // 0x8f610dec
            if (v1 == g18) {
    ...
    if (v1 == v5) {
        // 0x8f610dd0
        int32_t v6;
        return print_log(-1, (int32_t)"DSI1 PHY REGULATOR NOT READY,exceeded polling TIMEOUT!\n", (int32_t)v1, (int32_t)v5, g19, v6, 0, 0, 0, 0, 0, 0, 0);
    }
    // 0x8f610dfc
    __stack_chk_fail();
    // branch -> 0x8f610e00
