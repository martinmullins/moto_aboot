...
// Address range: 0x8f66a9c0 - 0x8f66aa47
int32_t mcs_mp_compare(int32_t a1, int32_t a2, int32_t a3) {
    uint16_t v1 = *(int16_t *)(a1 + 4); // 0x8f66a9cc
    int32_t v2 = 4 * (int32_t)v1 - 4; // 0x8f66a9dc
    int32_t v3 = v1; // 0x8f66aa18
    int32_t v4 = 0; // 0x8f66aa04
    // branch -> 0x8f66a9ec
    int32_t result; // 0x8f66aa28
    while (true) {
        uint32_t v5 = *(int32_t *)(v4 + v2 + a2); // 0x8f66a9ec
        uint32_t v6 = *(int32_t *)(v4 + v2 + a3); // 0x8f66a9f0
        if (v5 < v6) {
            // 0x8f66aa18
            result = -1;
            // branch -> 0x8f66aa3c
        ...
        int32_t v7 = (v3 + 0xffff) % 0x10000; // 0x8f66aa08
        if (v7 == 0) {
            result = 0;
            // break -> 0x8f66aa3c
            break;
