...
// Address range: 0x8f6437b8 - 0x8f64385b
int32_t max17058_get_battery_voltage(int32_t a1, int32_t a2) {
    int32_t v1 = &g31; // R3
    int32_t v2 = g31;
    int32_t v3 = 0; // bp-14
    uint32_t v4 = g16;
    int32_t v5;
    uint32_t v6; // 0x8f643818_0
    uint32_t result; // 0x8f643838
    if (v4 == 0) {
        // 0x8f643808
        print_log(-1, (int32_t)"Read max17058 Raw  Battery voltage %d\n", v3 % 0x10000, v1, a1, v2, g42, g37, v5, 0, 0, 0, 0);
        v6 = v3;
        result = (256 * v6 & 0xff00 | v6 / 256 % 256) * (v1 & -0x10000 | 625) / 8;
        if (v2 != g31) {
            // 0x8f643840
            __stack_chk_fail();
            // branch -> 0x8f643844
    ...
    int32_t v7 = &v3; // 0x8f6437ec_0
    v1 = v7;
    qup_i2c_read_word(v4, 54, 2, v7, a1, v2, g42, g37, v5, 0, 0, 0, 0, 0, 0);
    if (v4 <= 0xffffffff) {
        // 0x8f6437fc
        print_log(-1, (int32_t)"Read max17058 error %d\n", v4, v1, a1, v2, g42, g37, v5, 0, 0, 0, 0);
        // branch -> 0x8f643808
    }
    // 0x8f643808
    print_log(-1, (int32_t)"Read max17058 Raw  Battery voltage %d\n", v3 % 0x10000, v1, a1, v2, g42, g37, v5, 0, 0, 0, 0);
