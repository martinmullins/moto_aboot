...
// Address range: 0x8f602538 - 0x8f6026cb
int32_t mdp_clock_enable(void) {
    int32_t v1 = g47; // 0x8f602538
    int32_t v2 = g48; // 0x8f602538
    g48 = &g31;
    int32_t v3 = 0; // R1
    g47 = g40;
    int32_t v4 = g31;
    int32_t v5 = v4; // R3
    int32_t v6;
    int32_t v7 = clk_get_set_enable((int32_t)"mdp_ahb_clk", 0, 1, v4, v6, 0, 0, v4, 0, v1); // 0x8f60255c
    int32_t v8 = v7; // R2
    int32_t v9 = 0; // 0x8f602590
    int32_t v10 = 0; // 0x8f602590
    int32_t v11 = v6;
    int32_t v12;
    if (v7 != 0) {
        // 0x8f602568
        print_log(-1, (int32_t)"failed to set mdp_ahb_clk ret = %d\n", v7, v5, v6, 0, 0, v4, 0, v1, v2, g40, v12);
        v3 = (int32_t)"ASSERT FAILED at (%s:%d): %s\n";
        v8 = (int32_t)"platform/msm8916/acpuclock.c";
        v5 = 205;
        int32_t v13 = _panic(g47, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/acpuclock.c", 205, (int32_t)&g2, 0, 0); // 0x8f60258c
        v9 = v8;
        v10 = v13;
        v11 = &g2;
        // branch -> 0x8f602590
    }
    int32_t v14 = 0x124f8000;
    if (platform_is_msm8939(v10, v3, v9, v5) == 0) {
        // 0x8f6025a8
        v14 = platform_is_msm8929(0, v3, v8, v5) == 0 ? 0x1312d000 : 0x124f8000;
        // branch -> 0x8f6025bc
    }
    int32_t v15 = clk_get_set_enable((int32_t)"mdss_mdp_clk_src", v14, 1, v5, v11, 0, 0, v4, 0, v1); // 0x8f6025c0
    int32_t v16 = v11;
    if (v15 != 0) {
        // 0x8f6025d0
        print_log(-1, (int32_t)"failed to set mdp_clk_src ret = %d\n", v15, v5, v11, 0, 0, v4, 0, v1, v2, g40, v12);
        v5 = 217;
        _panic(g47, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/acpuclock.c", 217, (int32_t)&g2, 0, 0);
        v16 = &g2;
        // branch -> 0x8f6025f8
    }
    int32_t v17 = clk_get_set_enable((int32_t)"mdss_vsync_clk", 0, 1, v5, v16, 0, 0, v4, 0, v1); // 0x8f602604
    int32_t v18 = v16;
    if (v17 != 0) {
        // 0x8f602610
        print_log(-1, (int32_t)"failed to set mdss vsync clk ret = %d\n", v17, v5, v16, 0, 0, v4, 0, v1, v2, g40, v12);
        v5 = 224;
        _panic(g47, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/acpuclock.c", 224, (int32_t)&g2, 0, 0);
        v18 = &g2;
        // branch -> 0x8f602638
    }
    int32_t v19 = clk_get_set_enable((int32_t)"mdss_mdp_clk", 0, 1, v5, v18, 0, 0, v4, 0, v1); // 0x8f602644
    int32_t result = v19; // R0
    int32_t v20 = 0; // 0x8f602690_24
    if (v19 != 0) {
        // 0x8f602650
        print_log(-1, (int32_t)"failed to set mdp_clk ret = %d\n", v19, v5, v18, 0, 0, v4, 0, v1, v2, g40, v12);
        int32_t v21 = _panic(g47, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/acpuclock.c", 231, (int32_t)&g2, 0, 0); // 0x8f602674
        result = v21;
        v20 = v21;
        // branch -> 0x8f602678
    }
