...
// Address range: 0x8f60e6d4 - 0x8f60e74b
int32_t mdp_clk_gating_ctrl(int32_t a1, int32_t a2) {
    int32_t v1 = g45; // 0x8f60e6d4
    int32_t v2 = g47; // 0x8f60e6d4
    int32_t v3 = 0x40000000; // R5
    g47 = &g32;
    g45 = 0x1a01000;
    int32_t v4 = g32;
    *(int32_t *)0x1a012ac = 0x40000000;
    udelay(20, a2, g43, v4);
    *(int32_t *)(g45 + 684) = 0x40000040;
    *(int32_t *)(g45 + 692) = v3;
    *(int32_t *)(g45 + 936) = 0x400000;
    int32_t result = udelay(20, a2, g43, 0x400000); // 0x8f60e710
    *(int32_t *)(g45 + 936) = 0x404000;
    *(int32_t *)(g45 + 944) = v3;
    if (v4 != g32) {
        // 0x8f60e730
        __stack_chk_fail();
