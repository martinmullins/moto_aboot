...
// Address range: 0x8f60ab48 - 0x8f60ac1b
char * mmc_sdhci_write(char * a1, int32_t a2, int32_t a3) {
    int32_t v1;
    int32_t v2 = &v1; // 0x8f60ab4c_0
    int32_t v3 = (int32_t)a1; // R4
    int32_t v4 = g17;
    memset((char *)&v1, 0, 64);
    int32_t v5 = *(int32_t *)(v3 + 72); // 0x8f60ab7c
    int32_t v6 = v5; // R2
    int32_t v7;
    int32_t v8 = v7 == 1 ? 24 : 25;
    char * v9 = (char *)v3;
    v1 = v8;
    int32_t v10; // 0x8f60abd8
    char * v11; // 0x8f60abec
    int32_t v12;
    int32_t v13;
    int32_t v14; // 0x8f60abd0
    if (v5 == 4) {
        // after_if_8f60abb4_0.thread
        // branch -> after_if_8f60abc8_0
        // after_if_8f60abc8_0
        v14 = a3 * *(int32_t *)(v3 + 56);
        v10 = sdhci_send_command(v9, v2, 4, 1, v8, v14, 1, v12, 0, 0, 0, 0, 0, 1, 0, 0, a2, 0);
        if (v10 == 0 || v7 < 2) {
            // 0x8f60abf4
            v13 = mmc_parse_response((char *)v12, v2, v6, 1);
            // branch -> 0x8f60abfc
        } else {
            // 0x8f60abe8
            v11 = mmc_stop_command((char *)v3, v2, v6, 1, v1, v14, 1, v12, 0);
            v13 = (int32_t)v11;
            // branch -> 0x8f60abfc
        }
        // 0x8f60abfc
    ...
    // after_if_8f60abc8_0
    v14 = a3;
    v10 = sdhci_send_command(v9, v2, v15, 1, v8, v14, 1, v12, 0, 0, 0, 0, 0, v15, 0, 0, a2, 0);
    if (v10 == 0 || v7 < 2) {
        // 0x8f60abf4
        v13 = mmc_parse_response((char *)v12, v2, v6, 1);
        // branch -> 0x8f60abfc
