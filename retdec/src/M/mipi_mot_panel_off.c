...
// Address range: 0x8f643ee0 - 0x8f643f3f
int32_t mipi_mot_panel_off(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g26; // 0x8f643ee0
    g26 = &g15;
    int32_t v2 = g15;
    mipi_dsi_cmdmode_enable(a1);
    int32_t v3;
    int32_t v4 = mipi_dsi_cmds_tx((int32_t)&g6, 2, a3, v2, a1, v2, a3, v1, g27, g19, v3, 0); // 0x8f643efc
    int32_t result = 0; // 0x8f643f18
    if (v4 != 0) {
        // 0x8f643f08
        print_log(1, (int32_t)"failed to gracefully shutdown panel\n", a3, v2, a1, v2, a3, v1, g27, g19, v3, 0, 0);
        result = v4;
        // branch -> 0x8f643f14
    }
    // 0x8f643f14
