...
// Address range: 0x8f60afd4 - 0x8f60b027
int32_t mmc_get_wp_group_size(int32_t a1) {
    int32_t v1 = *(int32_t *)(a1 + 80); // 0x8f60afe4
    char v2 = *(char *)(v1 + 224); // 0x8f60afe8
    char v3 = *(char *)(v1 + 221); // 0x8f60afec
    int32_t v4 = 0x80000 * (int32_t)v2 * (int32_t)v3; // 0x8f60aff4
    int32_t v5 = v4; // 0x8f60b00c
    if (v4 < 0) {
        // if_8f60b000_0_true
        v5 = v4 | 511;
        // branch -> 0x8f60b01c
