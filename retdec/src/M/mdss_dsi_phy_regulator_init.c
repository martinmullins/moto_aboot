...
// Address range: 0x8f6110f4 - 0x8f611263
int32_t mdss_dsi_phy_regulator_init(int32_t * a1, int32_t a2) {
    int32_t v1 = (int32_t)a1;
    char v2 = *(char *)(v1 + 156); // 0x8f611100
    int32_t v3 = v2; // 0x8f611100
    int32_t v4 = g38;
    char v5 = *(char *)(v1 + 151); // 0x8f611114
    int32_t v6 = 0x1a98000; // R4
    if (v2 != 0) {
        int32_t v7 = 0; // R7
        int32_t v8 = 0; // 0x8f611134
        int32_t * v9 = (int32_t *)0x1a98780; // 0x8f611134
        if (v5 == 1) {
            // if_8f61112c_0_true
            *a1 = 2;
            v8 = v7;
            v9 = (int32_t *)(v6 + 1920);
            // branch -> after_if_8f611130_0
        }
        // after_if_8f611130_0
        *v9 = v8;
        *(int32_t *)(v6 + 1944) = *(int32_t *)(v1 + 24);
        *(int32_t *)(v6 + 1940) = *(int32_t *)(v1 + 20);
        *(int32_t *)(v6 + 1932) = *(int32_t *)(v1 + 12);
        *(int32_t *)(v6 + 1928) = *(int32_t *)(v1 + 8);
        *(int32_t *)(v6 + 1924) = *(int32_t *)(v1 + 4);
        *(int32_t *)(v6 + 1920) = *a1;
        *(int32_t *)(v6 + 1936) = *(int32_t *)(v1 + 16);
        function_8f61951c();
        if (*(char *)(v1 + 151) == 1) {
            // if_8f611180_0_true
            *(int32_t *)(a2 + 476) = 37;
    ...
    // 0x8f61118c
    *(int32_t *)0x1a98780 = v3;
    int32_t v10 = *(int32_t *)(v1 + 24); // 0x8f611194
    *(int32_t *)(v6 + 1944) = v10;
    udelay(1000, a2, v4, v10);
    if ((int32_t)v5 == 1) {
        // 0x8f6111a4
        *(int32_t *)(v6 + 1940) = *(int32_t *)(v1 + 20);
        *(int32_t *)(v6 + 1932) = *(int32_t *)(v1 + 12);
        ...
        *(int32_t *)(v6 + 1924) = *(int32_t *)(v1 + 4);
        *(int32_t *)(v6 + 1936) = *(int32_t *)(v1 + 16);
        int32_t * v11 = (int32_t *)v6; // 0x8f6111d4_0
        if (*v11 != 0x10030001) {
            // 0x8f6111e4
            int32_t v12; // 0x8f6111f8
            if (*v11 == 0x10030000) {
                // if_8f6111f0_0_true
                v12 = 29;
                // branch -> 0x8f6111f8
