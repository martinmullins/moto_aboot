...
// Address range: 0x8f6432f0 - 0x8f64338b
int32_t max17050_get_battery_voltage(int32_t a1, int32_t a2) {
    int32_t v1 = g22; // 0x8f6432f4
    int32_t v2 = g13;
    int32_t v3 = 0; // bp-14
    int32_t v4; // 0x8f64334c
    int32_t v5;
    int32_t v6;
    int32_t result; // 0x8f643360
    if (g10 == 0) {
        int32_t v7 = &g13; // 0x8f64334c
        v4 = print_log(-1, (int32_t)"Read MAX17050 Raw  Battery voltage %d\n", v3 % 0x10000, v7, a1, v2, v1, g15, v5, 0, 0, 0, 0);
        g20 = v2;
        result = v3 / 8 % 0x2000 * (v4 & -0x10000 | 625);
        g16 = result;
        v6 = g13;
        g21 = v6;
        if (v2 != v6) {
    ...
    int32_t v8 = &v3; // 0x8f643324_0
    qup_i2c_read_word(g10, 54, 9, v8, a1, v2, v1, g15, v5, 0, 0, 0, 0, 0, 0);
    if (g10 <= 0xffffffff) {
        // 0x8f643334
        print_log(-1, (int32_t)"Read MAX17050 error %d\n", g10, v8, a1, v2, v1, g15, v5, 0, 0, 0, 0);
        // branch -> 0x8f643340
    }
    // 0x8f643340
    v4 = print_log(-1, (int32_t)"Read MAX17050 Raw  Battery voltage %d\n", v3 % 0x10000, v8, a1, v2, v1, g15, v5, 0, 0, 0, 0);
    g20 = v2;
    result = v3 / 8 % 0x2000 * (v4 & -0x10000 | 625);
    g16 = result;
    v6 = g13;
