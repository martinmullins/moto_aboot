...
// Address range: 0x8f666d88 - 0x8f666fa7
int32_t mcs_mp_mont_reduce(int32_t * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g23;
    uint16_t v3 = *(int16_t *)(v1 + 4); // 0x8f666d9c
    int32_t v4 = v3; // 0x8f666d9c
    int32_t v5 = v4; // R12
    uint32_t v6 = v4 - 1; // 0x8f666da8
    int32_t v7 = *a1; // R6
    int32_t v8 = *(int32_t *)(v1 + 16); // 0x8f666db4
    int32_t v9 = 2 * v6 + 3; // 0x8f666db8
    int32_t v10 = v8; // 0x8f666de4
    int32_t v11 = v4; // 0x8f666de8
    int32_t v12;
    int32_t result; // 0x8f666f54
    int32_t v13; // R0
    int32_t v14; // R7
    int32_t v15;
    int32_t v16;
    int32_t v17;
    int32_t v18;
    int32_t v19; // 0x8f666e20
    int32_t v20; // 0x8f666dd4
    int32_t v21; // 0x8f666e0058
    int32_t v22; // 0x8f666e20
    int32_t v23; // 0x8f666f40
    int32_t v24; // 0x8f666f4055
    int32_t v25; // 0x8f666e34
    int32_t v26; // 0x8f666eb8
    uint32_t v27; // 0x8f666e40
    int32_t v28; // 0x8f666e5c
    int32_t v29;
    int32_t v30; // 0x8f666e34
    int32_t v31; // 0x8f666df8
    int32_t v32; // 0x8f666df864
    uint32_t v33; // 0x8f666e4c
    int32_t v34; // 0x8f666f24
    uint32_t v35; // 0x8f666e50
    if (v3 > 1) {
        // if_8f666dc4_0_true.preheader
        *(int32_t *)v8 = *(int32_t *)a3;
        int32_t v36 = 1; // 0x8f666dcc71
        if (v36 < v6) {
            int32_t v37 = 4 * v36; // 0x8f666dc4
            *(int32_t *)(v37 + v8) = *(int32_t *)(v37 + a3);
            int32_t v38 = v36 + 1; // 0x8f666dcc
            while (v38 < v6) {
                // if_8f666dc4_0_true.if_8f666dc4_0_true_crit_edge
                v37 = 4 * v38;
                *(int32_t *)(v37 + v8) = *(int32_t *)(v37 + a3);
                v38++;
                // continue -> if_8f666dc4_0_true.if_8f666dc4_0_true_crit_edge
            }
            // 0x8f666dc0
            v10 = v8;
            v11 = v5;
                    ...
                    *(int32_t *)(-4 * v11 + v20 + v18) = 0;
                    ...
                    if (v3 < 2) {
                        ...
                        while (true) {
                          ...
                          lab_0x8f666e5c_3:
                            while (true) {
                                uint32_t v39 = *(int32_t *)(4 * v28 + v7); // 0x8f666e5c
                                int32_t v40 = v28 + 1; // 0x8f666e60
                                v9 = v40;
                                uint32_t v41 = v39 % 0x10000; // 0x8f666e6c
                                uint32_t v42 = v39 / 0x10000; // 0x8f666e70
                                int32_t v43 = v42 * v33; // 0x8f666e7c
                                uint32_t v44 = v42 * v35; // 0x8f666e84
                                uint32_t v45 = v44 + v41 * v33; // 0x8f666e8c
                                int32_t v46 = v43; // 0x8f666e9c
                                if (v45 < v44) {
                                    // if_8f666e98_0_true
                                    v46 = v43 + 0x10000;
                                    // branch -> after_if_8f666e98_0
                                }
                                int32_t v47 = v46 + v45 / 0x10000; // R9
                                int32_t v48 = v14 + 4; // 0x8f666ea8
                                int32_t * v49 = (int32_t *)v48; // 0x8f666ea8_0
                                v14 = v48;
                                *v49 = 0x10000 * v45 + v41 * v35 + v26 + *v49;
                                if (v40 < v6) {
                                    ...
                                    int32_t * v50 = (int32_t *)(v20 - 4 + v5); // 0x8f666ed0_0
                                    int32_t v51 = v47 + *v50; // 0x8f666ed4
                                    *v50 = v51;
                                    int32_t v52; // 0x8f666f0c
                                    int32_t v53; // 0x8f666f10
                                    if (v51 < v47) {
                                        // if_8f666ee0_0_true
                                        v53 = v5;
                                        // branch -> 0x8f666f0c
                                    } else {
                                        int32_t v54 = v51 + 4; // 0x8f666ee811
                                        int32_t v55 = *(int32_t *)v54; // 0x8f666ee813
                                        v9 = v54;
                                        int32_t v56 = v55; // 0x8f666f04
                                        if (v55 == -1) {
                                            *(int32_t *)(v51 + 4) = 0;
                                            int32_t v57 = v9; // 0x8f666efc
                                            int32_t v58 = v57 + 4; // 0x8f666ee8
                                            int32_t v59 = *(int32_t *)v58; // 0x8f666ee8
                                            while (v59 == -1) {
                                                // if_8f666ef4_0_true
                                                *(int32_t *)(v57 + 4) = 0;
                                                v57 = v58;
                                          ...
                                          lab_0x8f666f0c:
                                            ...
                                            v14 = v53;
                                            if (v52 >= v6) {
                                                // break (via goto) -> 0x8f666e2c
                                                goto lab_0x8f666e2c_2;
                                            }
                                            v25 = v53;
                                            // continue (via goto) -> 0x8f666e34
                                            goto lab_0x8f666e34_2;
                                        }
                                        // 0x8f666f04
                                        *(int32_t *)v54 = v56 + 1;
                                        v53 = v5;
                        ...
                        *(int32_t *)a2 = *(int32_t *)(v34 - 4);
                        ...
                        if (v24 <= v6) {
                            ...
                            *(int32_t *)(4 * v24 + a2) = *(int32_t *)(v34 + v29);
                            ...
                            // 0x8f666f48
                            result = mcs_mp_compare(v1, a2, v7, v6, v16, v12, a2);
                            v17 = g23;
                            if (result == -1) {
                                // 0x8f666f90
                                if (v2 == v17) {
                                ...
                                if (v2 == v17) {
                                    // 0x8f666f74
                                    return mcs_mp_subb(v1, a2, v7, 0, g30, g31, g32, g33, g34, g35, g27, g28);
                                }
                            }
                            // 0x8f666f98
                            __stack_chk_fail();
