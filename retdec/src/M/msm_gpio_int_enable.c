...
// Address range: 0x8f603220 - 0x8f60327f
int32_t msm_gpio_int_enable(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g80; // 0x8f603220
    int32_t result = 0x1000 * a1; // 0x8f603224
    g80 = &g73;
    int32_t v2 = result + 0x1000000; // R4
    *(int32_t *)(result + 0x100000c) = 0;
    function_8f61951c();
    int32_t * v3 = (int32_t *)(v2 + 8); // 0x8f603244_0
    *v3 = *v3 & -257;
    int32_t * v4 = (int32_t *)(v2 + 8); // 0x8f603250_0
    *v4 = *v4 | 1;
    // 0x8f603270
    g80 = v1;
    function_8f61951c();
