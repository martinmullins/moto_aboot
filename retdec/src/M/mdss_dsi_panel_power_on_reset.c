...
// Address range: 0x8f60f3fc - 0x8f60f453
int32_t mdss_dsi_panel_power_on_reset(int32_t a1, int32_t a2) {
    // 0x8f60f3fc
    g21 = a2;
    int32_t v1 = g25; // 0x8f60f3fc
    g25 = (int32_t)&g18;
    int16_t * v2 = g18;
    int32_t v3 = (int32_t)v2;
    g24 = v3;
    int32_t v4;
    int32_t v5 = get_current_panel(a1, a2, g23, v3, a1, v3, v1, g19, v4, 0, 0); // 0x8f60f40c
    int32_t result; // 0x8f60f44c_2
    if (v5 == 0) {
        // 0x8f60f430
        g20 = 1;
        // branch -> 0x8f60f434
    ...
    int32_t v6 = *(int32_t *)(v5 + 528); // 0x8f60f418
    g20 = v6;
    g1 = v6 == 0;
    if (v6 != 0) {
        // 0x8f60f424
