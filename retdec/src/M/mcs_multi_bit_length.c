...
// Address range: 0x8f667964 - 0x8f6679d3
int32_t mcs_multi_bit_length(int32_t a1, uint32_t a2) {
    int32_t v1 = *(int32_t *)a1; // 0x8f66797c3
    int32_t result2; // 0x8f6679ac
    int32_t v2; // 0x8f6679a8
    if (v1 != 0) {
        int32_t v3 = 0; // 0x8f667994
        int32_t result = 16 * (a2 - v3); // 0x8f66799c
        if (v3 < a2 || (v1 & 0x8000) != 0) {
            // 0x8f6679c8
            return result;
        }
        v2 = 2 * v1;
    ...
    int32_t v4 = 0; // 0x8f66798c
    while (true) {
        // 0x8f667988
        if (v4 == a2) {
            // 0x8f6679a4
            // branch -> after_if_8f6679ac_0
        } else {
            int32_t v5 = v4 + 1; // 0x8f66798c
            if (*(int32_t *)(4 * v5 + a1) != 0) {
                // break -> 0x8f667994
                break;
            }
            v4 = v5;
    ...
    int32_t v6; // 0x8f6679a822
    v2 = 2 * v6;
    int32_t v7; // 0x8f6679ac21
    result2 = v7 - 1;
    while ((v2 & 0x8000) == 0) {
        // after_if_8f6679ac_0
        v2 *= 2;
