...
// Address range: 0x8f60f7a8 - 0x8f60f887
int32_t mipi_dsi_cmds_tx(int32_t a1, int32_t a2) {
    int32_t v1 = a2; // R1
    int32_t v2 = 0; // R6
    int32_t v3 = 0x1a98000; // R11
    int32_t v4 = a1 + 16; // 0x8f60f7bc
    int32_t v5 = g15;
    int32_t result = 0; // R5
    int32_t v6;
    int32_t v7 = &v6; // R2
    ...
    int32_t v9 = &v8; // R10
    if (a2 > 0) {
        int32_t v10 = a1; // 0x8f60f7f8
        // branch -> 0x8f60f7ec
        while (true) {
            char v11 = *(char *)(a1 + 12); // 0x8f60f7ec
            int32_t v12 = v11; // 0x8f60f7ec
            int32_t v13 = v4; // 0x8f60f810
            char * dest_mem; // 0x8f60f818
            int32_t v14; // 0x8f60f82c
            int32_t v15; // 0x8f60f810
            int32_t v16; // 0x8f60f814
            int32_t v17; // 0x8f60f820
            int32_t v18; // 0x8f60f838
            if (v11 != 0) {
                int32_t v19 = mdss_dsi_wait4_video_done(v10); // 0x8f60f7f8
                int32_t result2 = v19; // 0x8f60f864
                if (v19 == 0) {
                    // 0x8f60f804
                    mdelay(4, v1, v7, v12);
                    v13 = v4;
                    ...
                    v16 = *(int32_t *)(v13 - 16);
                    v7 = v16;
                    dest_mem = memcpy((char *)&v8, (char *)v15, v16);
                    *(int32_t *)(v3 + 72) = v9;
                    v17 = *(int32_t *)(v4 - 16);
                    *(int32_t *)(v3 + 76) = v17;
                    v14 = dsi_cmd_dma_trigger_for_panel((int32_t)dest_mem, v1, v7, v17);
                    result = v19 + v14;
                    v18 = *(int32_t *)(v4 - 8);
                    int32_t v20;
                    if (v18 == 0) {
                      lab_0x8f60f84c:
                        // 0x8f60f84c
                        v20 = udelay(80, v1, v7, v17);
                        // branch -> 0x8f60f854
                    } else {
                      lab_0x8f60f844:
                        // 0x8f60f844
                        v20 = mdelay(v18, v1, v7, v17);
                        // branch -> 0x8f60f854
                    }
                    int32_t v21 = v2 + 1; // 0x8f60f854
                    v2 = v21;
                    if (v21 >= a2) {
                        // 0x8f60f7e4
                        // branch -> 0x8f60f860
