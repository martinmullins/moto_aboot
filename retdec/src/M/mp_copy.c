...
// Address range: 0x8f670e24 - 0x8f670e6f
int32_t mp_copy(int32_t a1, int32_t a2, int32_t a3) {
    int32_t result = g25;
    uint16_t v1 = *(int16_t *)(a1 + 4); // 0x8f670e30
    int32_t v2 = result;
    if (v1 != 0) {
        int32_t v3 = 0; // 0x8f670e40
        *(int32_t *)(v3 + a2) = *(int32_t *)(v3 + a3);
        int32_t v4 = 1; // 0x8f670e48
        while (v4 < (int32_t)v1) {
            // if_8f670e40_0_true
            v3 = 4 * v4;
            *(int32_t *)(v3 + a2) = *(int32_t *)(v3 + a3);
            v4++;
            // continue -> if_8f670e40_0_true
        }
        // 0x8f670e3c
        v2 = g25;
        // branch -> 0x8f670e50
