...
// Address range: 0x8f663e1c - 0x8f663e93
int32_t mcs_array_bit_length(int32_t a1, int32_t a2) {
    int32_t v1 = g36; // 0x8f663e1c
    g36 = a2;
    int32_t v2 = g27;
    if (mcs_array_unpadded_length(a1, a2) != 0x1fffffff) {
        // if_8f663e3c_0_true
        // branch -> 0x8f663e74
        // 0x8f663e74
        if (v2 != g27) {
    ...
    int32_t v3 = g36 - 0x1fffffff; // 0x8f663e4c
    g36 = v3;
    int32_t v4 = (int32_t)*(char *)(v3 + a1); // 0x8f663e50
    int32_t v5; // R0
    int32_t v6; // 0x8f663e8c_25
    if ((v4 & 128) == 0) {
        int32_t v7 = -15; // 0x8f663e6c
        // branch -> 0x8f663e68
        while (v4 >= 2) {
            // 0x8f663e68
            v4 /= 2;
