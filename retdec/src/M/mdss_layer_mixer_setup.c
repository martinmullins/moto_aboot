...
// Address range: 0x8f60e9e4 - 0x8f60eaf3
int32_t mdss_layer_mixer_setup(int32_t a1, int32_t a2) {
    char * v1 = (char *)(a2 + 112); // 0x8f60e9ec_0
    int32_t v2 = g15;
    uint32_t v3 = *(int32_t *)(a1 + 4); // 0x8f60ea00
    int32_t result = 256; // R0
    int32_t v4 = v3; // 0x8f60ea0c
    if (*v1 != 0) {
        // if_8f60ea08_0_true
        v4 = v3 / 2;
        // branch -> after_if_8f60ea08_0
    }
    int32_t v5 = v4 | 0x10000 * *(int32_t *)(a1 + 8); // 0x8f60ea0c
    int32_t v6 = 0x1a45000; // R3
    *(int32_t *)0x1a45004 = v5;
    *(int32_t *)v6 = 0;
    int32_t v7 = 255; // R2
    *(int32_t *)(v6 + 32) = result;
    *(int32_t *)(v6 + 36) = v7;
    *(int32_t *)(v6 + 80) = result;
    *(int32_t *)(v6 + 84) = v7;
    *(int32_t *)(v6 + 128) = result;
    *(int32_t *)(v6 + 132) = v7;
    *(int32_t *)(v6 + 176) = result;
    *(int32_t *)(v6 + 180) = v7;
    int32_t v8; // R4
    int32_t v9; // 0x8f60ea70
    switch (*(int32_t *)(a2 + 28)) {
        default: {
            // if_8f60ea54_0_true
            v8 = 8;
            v9 = 1;
    ...
    int32_t v10 = 0x1a02000; // R12
    *(int32_t *)0x1a02000 = v9;
    if (*v1 == 0) {
        // 0x8f60eac8
        if (v2 != g15) {
            // 0x8f60ead8
