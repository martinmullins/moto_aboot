...
// Address range: 0x8f65aa7c - 0x8f65ab0b
int32_t misc_check_mode(char * a1, int32_t a2) {
    int32_t v1 = (int32_t)a1; // 0x8f65aa7c_0
    int32_t v2 = g23;
    int32_t v3 = get_sector_start(v1, a2, g28, v2); // 0x8f65aa94
    int32_t result = 0;
    if (v3 != 0) {
        int32_t v4 = *(int32_t *)(8 * v1 + (int32_t)&g9 + 4); // 0x8f65aab8
        int32_t v5 = generic_mmc_read_sector(v4 + v3, 1, (int32_t)&g22, v4, v1, v2, g29, g30, g31, 0); // 0x8f65aac0
        if (v5 == 0) {
            int32_t str = *(int32_t *)(8 * v1 + (int32_t)&g9); // 0x8f65aacc
            uint32_t strncmp_rc = strncmp((char *)str, (char *)&g22, 4); // 0x8f65aad8
            result = strncmp_rc > 1 ? 0 : 1 - strncmp_rc;
            // branch -> 0x8f65aae4
        } else {
            result = 0;
        }
