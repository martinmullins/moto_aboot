...
// Address range: 0x8f60fbd0 - 0x8f60fc3f
int32_t mdss_dsi_panel_initialize(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = *(int32_t *)(a1 + 16); // 0x8f60fbe0
    int32_t v2 = *(int32_t *)(a1 + 20); // 0x8f60fbe8
    if (v1 == 0 || v2 == 0) {
        // 0x8f60fc34
        return 0;
    }
    // 0x8f60fc10
    int32_t v3;
    return mdss_dsi_panel_commands_send_part_1(v1, v2, a2, g29, g33, v3, 0, 0, 0);
}
