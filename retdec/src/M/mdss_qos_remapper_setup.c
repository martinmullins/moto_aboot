...
// Address range: 0x8f60ec24 - 0x8f60ecdb
int32_t mdss_qos_remapper_setup(int32_t result, int32_t a2, int32_t a3) {
    int32_t v1 = g23;
    uint32_t v2 = *(int32_t *)0x1a01000; // 0x8f60ec38
    uint32_t v3 = v2 / 0x10000; // 0x8f60ec3c
    if ((v3 & 0xfffd) == 0x1000) {
        // 0x8f60ec94
        // branch -> 0x8f60ecb0
        // 0x8f60ecb0
        *(int32_t *)0x1a011e0 = 233;
        // branch -> 0x8f60ecb8
        // 0x8f60ecb8
        if (v1 != g23) {
            // 0x8f60ecc8
    ...
    // 0x8f60ec4c
    if ((v2 & -0x10000) == 0x10010000) {
        // 0x8f60ec9c
        // branch -> 0x8f60ecb0
        // 0x8f60ecb0
        *(int32_t *)0x1a011e0 = 165;
        // branch -> 0x8f60ecb8
        // 0x8f60ecb8
        if (v1 != g23) {
            // 0x8f60ecc8
    ...
    int32_t v4 = result & -0x10000; // 0x8f60ec5c
    int32_t result2 = v4 | 0x1008; // 0x8f60ec5c
    if ((v2 & -0x10000) == 0x10060000 || v3 == result2) {
        // 0x8f60eca4
        // branch -> 0x8f60ecb0
        // 0x8f60ecb0
        *(int32_t *)0x1a011e0 = 228;
        // branch -> 0x8f60ecb8
        // 0x8f60ecb8
        if (v1 != g23) {
            // 0x8f60ecc8
    ...
    int32_t result3 = v4 | 0x1009; // 0x8f60ec6c2
    int32_t v5;
    if ((v2 & -0x10000) == 0x10050000 || v3 == result3) {
        // 0x8f60ecac
        // branch -> 0x8f60ecb0
        // 0x8f60ecb0
        *(int32_t *)0x1a011e0 = 164;
        v5 = g23;
        // branch -> 0x8f60ecb8
    } else {
        // 0x8f60ec80
        if ((v2 & -0x10000) == 0x10030000) {
            // if_8f60ec88_0_true
            // branch -> 0x8f60ecb0
            // 0x8f60ecb0
            *(int32_t *)0x1a011e0 = 250;
            v5 = g23;
            // branch -> 0x8f60ecb8
        } else {
            v5 = v1;
