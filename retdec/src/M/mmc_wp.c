...
// Address range: 0x8f60bee4 - 0x8f60bf2f
int32_t mmc_wp(void) {
    int32_t v1 = g20; // 0x8f60bee8
    int32_t result = g17;
    int32_t v2 = target_mmc_device(v1); // 0x8f60befc
    g20 = v2;
    if (result == g17) {
        // 0x8f60bf14
        int32_t v3;
        mmc_set_power_on_wp_user(v2, v1, g21, 0, g24, g25, g26, g19, v3, 0, 0, 0, 0, 0, 0, 0, 0, 0);
        return g21;
    }
    // 0x8f60bf10
    __stack_chk_fail();
