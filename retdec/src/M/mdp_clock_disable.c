...
// Address range: 0x8f6026cc - 0x8f60273b
int32_t mdp_clock_disable(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g47; // 0x8f6026cc
    g47 = &g31;
    int32_t v2 = g31;
    clk_disable(clk_get((int32_t)"mdss_vsync_clk", a2, a3, v2, a1, v2, v1), a2, a3, v2, a1, v2);
    clk_disable(clk_get((int32_t)"mdss_mdp_clk", a2, a3, v2, a1, v2, v1), a2, a3, v2, a1, v2);
    clk_disable(clk_get((int32_t)"mdss_mdp_clk_src", a2, a3, v2, a1, v2, v1), a2, a3, v2, a1, v2);
    int32_t result = clk_get((int32_t)"mdp_ahb_clk", a2, a3, v2, a1, v2, v1); // 0x8f602704
    g41 = result;
    if (v2 != g31) {
        // 0x8f602718
        __stack_chk_fail();
    ...
    // 0x8f60271c
    g47 = v1;
    int32_t result2 = clk_disable(result, a2, v2, v2, v1, g40); // 0x8f602724
    g41 = result2;
    return result2;
}
