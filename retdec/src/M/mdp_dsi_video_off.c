...
// Address range: 0x8f60f2a0 - 0x8f60f313
int32_t mdp_dsi_video_off(int32_t a1, int32_t a2, int32_t a3) {
    // 0x8f60f2a0
    g34 = a1;
    int32_t v1 = g31;
    g38 = v1;
    int32_t v2 = target_cont_splash_screen(a1, a2, a3, v1); // 0x8f60f2b0
    g34 = v2;
    if (v2 == 0) {
        int32_t v3 = mdss_mdp_intf_offset(0, a2); // 0x8f60f2bc
        g38 = 0x1a12700;
        *(int32_t *)(v3 + 0x1a12700) = v2;
        g34 = 60;
        g34 = mdelay(60, a2, a3, 0x1a12700);
        g38 = 0x1a01000;
        *(int32_t *)0x1a01018 = -0x8888ed;
        // branch -> 0x8f60f2dc
    }
    // 0x8f60f2dc
    g34 = 0;
