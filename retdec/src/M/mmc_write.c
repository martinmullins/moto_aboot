...
// Address range: 0x8f60b6e8 - 0x8f60b8eb
int32_t mmc_write(int64_t a1) {
    uint32_t v1 = (int32_t)a1;
    int32_t v2 = g40; // 0x8f60b6e8
    g40 = g32;
    int32_t v3 = g38; // R7
    int32_t v4 = g30;
    int32_t v5 = target_mmc_device(v1); // 0x8f60b70c
    g33 = v5;
    int32_t v6 = mmc_get_device_blocksize(); // 0x8f60b714
    int32_t v7 = 0; // R3
    int32_t v8 = v6; // R2
    int32_t v9 = v6; // R6
    int64_t v10 = v6;
    ...
    if (v8 != v7) {
        // 0x8f60b738
        v8 = (int32_t)"platform/msm_shared/mmc_wrapper.c";
        v7 = 125;
        _panic(g40, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm_shared/mmc_wrapper.c", 125, (int32_t)"!(data_addr % block_size)", v11, 0);
        // branch -> 0x8f60b754
    }
    uint32_t v12 = v3; // 0x8f60b754
    uint32_t v13 = v12 / v9;
    uint32_t v14 = v12 % v9;
    if (v14 == 0) {
        // branch -> after_if_8f60b770_0
    } else {
        int32_t v15 = -v9; // 0x8f60b768
        v3 = v12 - 1 + v9 & v15;
        v7 = v15;
        // branch -> after_if_8f60b770_0
    }
    ...
    int32_t v16;
    int32_t v17;
    if (platform_boot_dev_isemmc(v13, v14, v8, v7) == 0) {
        // 0x8f60b860
        function_8f6193d4(g39, v3);
        if (ufs_write(v5, v9, v1, g34) == 0) {
            // if_8f60b890_0_true
            result = 0;
            // branch -> 0x8f60b8ac
        } else {
            // 0x8f60b898
            result = 1;
            print_log(-1, (int32_t)"Error: UFS write failed writing to block: %llu\n", v1, g34, g39, v3 / v9, 0, v17, v1, g34, v6, 0, v16);
            // branch -> 0x8f60b8ac
        }
        // 0x8f60b8ac
        if (v4 != g30) {
    ...
    int32_t v18 = 0; // R4
    int32_t v19 = 0; // R5
    int32_t v20 = 0; // 0x8f60b79c
    int32_t v21 = 0; // 0x8f60b790
    // branch -> 0x8f60b78c
    int32_t v22; // 0x8f60b7b0
    int32_t v23;
    int32_t v24; // 0x8f60b7b4
    while (true) {
        int32_t v25 = v3 - v21; // 0x8f60b790
        result = v25;
        int32_t v26 = g39 + v21; // R10
        int32_t v27 = v21 + v1; // 0x8f60b798
        int64_t v28 = v27;
        int32_t v29 = v20 + g34 + (int32_t)(v27 < v1); // R1
        int32_t v30;
        if (v25 > 0x1fffe00) {
            // 0x8f60b7a8
            v22 = __aeabi_uldivmod(v28, v10);
            v24 = v29;
            v23 = 0x1fffe00 / v9;
            char * v31 = mmc_sdhci_write(v5, v26, v22, v24, v23, v11, 0, 0x1fffe00, v1, g34, v6, 0, v22, v24, 0, v4, 0, v2, g41, g42, g43); // 0x8f60b7d4
            uint32_t v32 = v18; // 0x8f60b7e4
            int32_t v33 = v32 + 0x1fffe00; // 0x8f60b7e4
            v18 = v33;
            int32_t v34 = (int32_t)(v32 > 0xfe0001ff) + v19; // 0x8f60b7e8
            v19 = v34;
            result = (int32_t)v31;
            if (v31 != NULL) {
                // break -> 0x8f60b7f4
            ...
            // 0x8f60b804
            if (v3 != v21) {
                int32_t v35 = __aeabi_uldivmod(v28, v10); // 0x8f60b810
                int32_t v36 = result / v9;
                char * v37 = mmc_sdhci_write(v5, v26, v35, v29, v36, v11, 0, v17, v1, g34, v6, 0, v16, v30, 0, v4, 0, v2, g41, g42, g43); // 0x8f60b83c
                result = (int32_t)v37;
                if (v37 != NULL) {
                    // 0x8f60b848
                    // branch -> 0x8f60b858
                    // 0x8f60b858
                    print_log(-1, (int32_t)"Failed Writing block @ %llx\n", v35, v29, v36, v11, 0, v17, v1, g34, v6, 0, v16);
                    // branch -> 0x8f60b8ac
                }
            }
        }
    ...
    // branch -> 0x8f60b858
    // 0x8f60b858
    print_log(-1, (int32_t)"Failed Writing block @ %llx\n", v22, v24, v23, v11, 0, 0x1fffe00, v1, g34, v6, 0, v22);
    // branch -> 0x8f60b8ac
    // 0x8f60b8ac
    if (v4 != g30) {
        // 0x8f60b8c4
