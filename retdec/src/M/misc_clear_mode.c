...
// Address range: 0x8f65aa14 - 0x8f65aa7b
int32_t misc_clear_mode(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1; // 0x8f65aa14_0
    g25 = v1;
    g26 = a2;
    g29 = a3;
    g31 = v1;
    g30 = &g23;
    int32_t v2 = g23;
    int32_t v3 = get_sector_start(); // 0x8f65aa28
    int32_t result = 0;
    if (v3 != 0) {
        int32_t v4 = *(int32_t *)(8 * g31 + (int32_t)&g13 + 4); // 0x8f65aa44
        uint32_t v5 = generic_mmc_erase_sector(v4 + v3, 1, (int32_t)&g13, v3, v1, v2, a3); // 0x8f65aa4c
        result = v5 > 1 ? 0 : 1 - v5;
        // branch -> 0x8f65aa58
    }
    // 0x8f65aa58
