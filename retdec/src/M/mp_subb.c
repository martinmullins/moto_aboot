...
// Address range: 0x8f670ef8 - 0x8f670f8f
int32_t mp_subb(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t result2 = a2 - 4; // 0x8f670f00
    uint16_t v1 = *(int16_t *)(a1 + 4); // 0x8f670f0c
    int32_t v2 = v1; // R6
    int32_t v3 = a4; // R0
    int32_t v4 = 0; // R3
    int32_t v5 = 0; // 0x8f670f2c7
    if (a4 != 0) {
        // if_8f670f18_0_true
        v3 = 1;
        v5 = 1;
        // branch -> after_if_8f670f18_0
    }
    // after_if_8f670f18_0
    if (v1 != 0) {
        int32_t v6 = 0; // 0x8f670f34
        int32_t v7 = result2; // 0x8f670f64
        while (true) {
            int32_t result = v7 + 4; // 0x8f670f30
            int32_t * v8 = (int32_t *)result; // 0x8f670f30_0
            uint32_t v9 = *v8; // 0x8f670f30
            uint32_t v10 = *(int32_t *)(4 * v6 + a3); // 0x8f670f34
            int32_t v11; // 0x8f670f68
            if (v5 == 0) {
                // 0x8f670f54
                if (v9 < v10) {
                    // if_8f670f5c_0_true
