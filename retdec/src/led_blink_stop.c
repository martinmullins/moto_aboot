...
// Address range: 0x8f65040c - 0x8f65045f
int32_t led_blink_stop(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g47; // 0x8f65040c
    g47 = (int32_t)&g40;
    char * v2 = g40;
    int32_t v3 = (int32_t)v2;
    int32_t result = timer_cancel((int32_t)&g38, a2, a3, v3, a1, v3, v1, g42); // 0x8f650420
    g43 = result;
    *(char *)&g36 = 0;
    *(char *)&g37 = 0;
    if (v2 != g40) {
