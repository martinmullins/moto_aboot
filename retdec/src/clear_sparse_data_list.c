...
// Address range: 0x8f676448 - 0x8f6764af
int32_t clear_sparse_data_list(int32_t a1, int32_t a2) {
    // 0x8f676448
    g22 = a1;
    int32_t result = g17;
    g23 = 0;
    int32_t v1 = *(int32_t *)(a1 + 4); // 0x8f6764644
    int32_t v2 = result;
    if (v1 != a1) {
        int32_t * v3 = (int32_t *)v1; // 0x8f676470_0
        int32_t * v4 = (int32_t *)(v1 + 4); // 0x8f676470_1
        int32_t v5 = *v4; // 0x8f676470
        *(int32_t *)v5 = *v3;
        int32_t v6 = *v3; // 0x8f676478
        *(int32_t *)(v6 + 4) = v5;
        *v4 = g23;
        *v3 = g23;
        free_sparse_data((char *)v1, v6);
        int32_t v7 = g22; // 0x8f676464
        int32_t v8 = *(int32_t *)(v7 + 4); // 0x8f676464
        while (v8 != v7) {
            // 0x8f676470
            v1 = v8;
            v3 = (int32_t *)v1;
