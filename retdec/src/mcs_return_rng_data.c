...
// Address range: 0x8f667c70 - 0x8f667d07
int32_t mcs_return_rng_data(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = g11;
    if (a1 == NULL) {
        // 0x8f667cfc
    ...
    char v2 = *a1; // 0x8f667c98
    int32_t result;
    int32_t v3;
    if (a3 != 0 && a2 != 0 && v2 == 18) {
        // 0x8f667cb0
        int32_t v4;
        int32_t v5 = &v4; // 0x8f667cb8_0
        mcs_memset(v5, 0, 20, (int32_t)v2);
        int32_t v6;
        mcs_Random_secure_generate(v5, 20, a2, a3, (int32_t)a1 + 1, 0, v4, 0, 0, 0, 0, v1, 0, g18, g19, g20, g21, g12, v6, 0);
        v3 = g11;
        result = 0;
        // branch -> 0x8f667ce8
    } else {
