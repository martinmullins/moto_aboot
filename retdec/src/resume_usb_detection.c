...
// Address range: 0x8f634c60 - 0x8f634ce3
int32_t resume_usb_detection(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t result = g33;
    int32_t v1 = enable_shutdown_timer(a1, a2, a3); // 0x8f634c70
    if (is_charger_smb1359(v1, a2, a3, result, a1, result, g55, g48) != 0) {
        // 0x8f634c80
        smb135x_enable_usbin_valid_irq((int32_t)&g3, a2, a3, result);
        return result;
    }
    int32_t result2 = g33;
    if (result == result2) {
        // 0x8f634cc4
        enable_usbin_valid_irq((int32_t)&g3, a2, result, result, g55);
        return result2;
    }
    // 0x8f634cc0
    __stack_chk_fail();
