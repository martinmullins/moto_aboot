...
// Address range: 0x8f61a810 - 0x8f61a8cf
int32_t target_display_panel_node(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1; // 0x8f61a810_0
    int32_t v2 = g15;
    int32_t v3 = get_current_panel(v1, a2, a3, v2, v1, v2, a3, g23, g24, g25, g26); // 0x8f61a828
    int32_t v4 = 0; // 0x8f61a84c
    if (v3 != 0) {
        int32_t v5 = strlen((char *)*(int32_t *)(v3 + 96)) + 9; // 0x8f61a83c
        if (a2 < v5) {
            // 0x8f61a8ac
            if (v2 != g15) {
                // 0x8f61a8bc
    ...
    int32_t v6 = display_get_state(v4, a2, a3); // R0
    *(char *)(v1 + 1) = 58;
    int32_t v7 = v6 == 0 ? 49 : 48;
    *(char *)v1 = (char)v7;
    if (v3 != 0) {
        // 0x8f61a87c
        if (is_bare_board(v7, a2, a3, 58) == 0) {
            int32_t v8 = *(int32_t *)(v3 + 92); // 0x8f61a888
            strlcat(v1, v8, a2, 58, v1, v2, a3, g23, g24, g25, g26, g16);
            int32_t v9 = *(int32_t *)(v3 + 96); // 0x8f61a8a4
            // branch -> 0x8f61a8a0
            // 0x8f61a8a0
            strlcat(v1, v9, a2, 58, v1, v2, a3, g23, g24, g25, g26, g16);
            // branch -> 0x8f61a8ac
            // 0x8f61a8ac
            if (v2 != g15) {
                // 0x8f61a8bc
    ...
    // branch -> 0x8f61a8a0
    // 0x8f61a8a0
    strlcat(v1, (int32_t)"dsi:0:qcom,mdss_dsi_mot_dummy_qhd_video", a2, 58, v1, v2, a3, g23, g24, g25, g26, g16);
    // branch -> 0x8f61a8ac
    // 0x8f61a8ac
    if (v2 != g15) {
        // 0x8f61a8bc
