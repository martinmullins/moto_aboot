...
// Address range: 0x8f60e64c - 0x8f60e6d3
int32_t mdss_mdp_intf_offset(int32_t a1) {
    int32_t v1 = *(int32_t *)0x1a01000; // 0x8f60e668
    switch (v1) {
        default: {
            // 0x8f60e684
            if ((v1 & -0x20001) == 0x10000000) {
                // 0x8f60e6b4
                return 0;
            }
            // 0x8f60e690
            int32_t result; // 0x8f60e6b8_25
            if (v1 == 0x10010000) {
                // if_8f60e698_0_true
                result = 0xec00;
                // branch -> 0x8f60e6b4
