...
// Address range: 0x8f66aae0 - 0x8f66ab5f
int32_t mcs_unit_modular_inverse(int64_t a1) {
    ...
    int32_t v2 = 1; // 0x8f66ab24
    int32_t v3 = 2; // 0x8f66ab281
    // branch -> 0x8f66ab08
    int32_t v4; // 0x8f66ab34
    while (true) {
        uint32_t v5 = v3 - 1; // 0x8f66ab14
        int32_t v6 = v3 + 1; // 0x8f66ab18
        v4 = v2;
        if (((1 << v3) - 1 & v2 * v1) >> v5 != 0) {
            // if_8f66ab24_0_true
            v4 = (1 << v5) + v2;
            // branch -> after_if_8f66ab24_0
        }
        // after_if_8f66ab24_0
        if (v6 == 32) {
            // break -> 0x8f66ab30
