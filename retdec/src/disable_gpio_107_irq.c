...
// Address range: 0x8f6036e4 - 0x8f603723
int32_t disable_gpio_107_irq(int32_t a1) {
    int32_t v1 = g25; // 0x8f6036e4
    g18 = 107;
    g25 = &g15;
    int32_t v2 = g15;
    unregister_msm_gpio_int_handler(107, g19, g23, v2, a1, v2);
    if (v2 != g15) {
        // 0x8f60370c
        __stack_chk_fail();
        return 107;
    ...
    // 0x8f603710
    g25 = v1;
    int32_t result = msm_gpio_int_disable(107, g19, v2, v2, v1, g17); // 0x8f60371c
    g18 = result;
    return result;
}
