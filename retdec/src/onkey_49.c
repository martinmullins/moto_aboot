...
// Address range: 0x8f63eeb0 - 0x8f63ef27
int32_t onkey_49(int32_t a1, int32_t a2) {
    int32_t v1 = a1; // R0
    int32_t v2 = g69; // 0x8f63eeb8
    char * v3 = g44;
    int32_t v4 = (int32_t)v3;
    g69 = (int32_t)&g44;
    int32_t result; // 0x8f63ef18_2
    if (a2 == 0) {
        // 0x8f63ef00
        if (v3 != v3) {
            // 0x8f63ef10
    ...
    // 0x8f63eecc
    int32_t v5; // 0x8f63eefc
    char * v6;
    if (a1 >= 277) {
        // 0x8f63eed4
        if (a1 > ((int32_t)&g44 & -0x10000 || 278)) {
            // 0x8f63eee0
            if (a1 != ((int32_t)&g44 & -0x10000 || 278) + 232) {
                // 0x8f63ef00
                if (v3 != v3) {
                    // 0x8f63ef10
                    __stack_chk_fail();
        ...
        // 0x8f63eeec
        int32_t v7;
        v5 = show((int32_t)"fastboot_screen", 0, v4, (int32_t)&g4, a1, v4, v2, g62, v7, 0, 0, 0, 0, 0, 0);
        v1 = v5;
        v6 = g44;
        // branch -> 0x8f63ef00
    } else {
