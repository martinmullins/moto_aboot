...
// Address range: 0x8f62ad44 - 0x8f62adaf
int32_t write_protect_enabled_on_eng_hw(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t str = a1; // bp-24
    int32_t v1 = g20;
    int32_t v2;
    __utag_gets(0, (int32_t)"WPDisable", (int32_t)&str, 10, a1, a2, a3, v1, g27, g22, v2, 0, 0, 0, 0, 0, 0, 0, 0, 0);
    int32_t len = strlen("wpdisable"); // 0x8f62ad6c
    int32_t result = memcmp((char *)&str, "wpdisable", len) != 0;
    if (v1 != g20) {
        // 0x8f62ad98
        __stack_chk_fail();
        // branch -> 0x8f62ad9c
