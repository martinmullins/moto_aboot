...
// Address range: 0x8f61bc38 - 0x8f61bd0f
int32_t wait_queue_block(int32_t a1, int32_t a2) {
    int32_t v1 = a1; // R0
    int32_t v2 = g26; // 0x8f61bc3c
    g26 = a2;
    int32_t v3 = g15;
    int32_t v4;
    int32_t v5 = &v4; // 0x8f61bc48_0
    int32_t v6 = v3;
    int32_t result = -13;
    if (a2 != 0) {
        int32_t v7 = a1 + 4; // 0x8f61bc60
        int32_t v8 = g16; // R3
        int32_t v9 = g16 + 12; // 0x8f61bc6c
        int32_t v10 = v9; // R1
        *(int32_t *)v9 = *(int32_t *)v7;
        *(int32_t *)(v8 + 16) = v7;
        *(int32_t *)(*(int32_t *)(v1 + 4) + 4) = v10;
        int32_t v11 = v1; // 0x8f61bc80
        *(int32_t *)(v11 + 4) = v10;
        *(int32_t *)(v1 + 12) = *(int32_t *)(v11 + 12) + 1;
        *(int32_t *)(v8 + 36) = v1;
        *(char *)(v8 + 24) = 3;
        int32_t v12 = 0; // R2
        *(int32_t *)(v8 + 40) = 0;
        int32_t v13; // 0x8f61bcc4
        if (a2 == -1) {
            // 0x8f61bc58
            v13 = v10;
            // branch -> 0x8f61bcc4
            ...
            // 0x8f61bca8
            timer_initialize(v5, v10, v12, v8);
            v1 = v5;
            v12 = &g1;
            v8 = g16;
            int32_t v14 = timer_set_oneshot(v5, g26, (int32_t)&g1, g16, v4, 0, 0); // 0x8f61bcc0
            v10 = v14;
            v13 = v14;
            // branch -> 0x8f61bcc4
        }
        // 0x8f61bcc4
        thread_block(v1, v13, v12, v8, v4, 0);
        if (g26 != -1) {
            // 0x8f61bcd0
            timer_cancel(v5, v10, v12, v8, v4, 0, 0, 0);
            // branch -> 0x8f61bcd8
        }
        // 0x8f61bcd8
        v6 = g15;
        result = *(int32_t *)(g16 + 40);
        // branch -> 0x8f61bce8
    }
    // 0x8f61bce8
    if (v3 != v6) {
