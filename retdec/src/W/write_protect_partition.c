...
// Address range: 0x8f673c8c - 0x8f673cf7
int32_t write_protect_partition(int32_t a1, int32_t a2) {
    char * v1 = g40;
    int32_t v2 = (int32_t)v1;
    int32_t v3;
    char * v4 = get_partition_by_name(a1, a2, g45, v2, a1, v2, g47, g42, v3, 0, 0); // 0x8f673c9c
    int32_t v5; // R0
    int32_t v6; // 0x8f673ce8_23
    if (v4 == NULL) {
        // 0x8f673ca8
        print_log(-1, (int32_t)"Could not get partition info\n", g45, v2, a1, v2, g47, g42, v3, 0, 0, 0, 0);
        v5 = -1;
        v6 = -1;
        // branch -> 0x8f673cd0
    } else {
        int32_t v7 = write_protect_on_partition((int32_t)v4, a2, g45, v2, a1, v2); // 0x8f673cbc
        v5 = v7;
        if (v7 == 0) {
            // if_8f673cc4_0_true
            *(char *)&g39 = 1;
