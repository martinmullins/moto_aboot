...
// Address range: 0x8f646158 - 0x8f6461df
int32_t pm8x41_get_is_cold_boot(void) {
    int32_t v1 = g33; // 0x8f646158
    int32_t v2 = g40; // 0x8f646158
    int32_t v3 = g30;
    int32_t result; // 0x8f6461cc_2
    int32_t v4;
    int32_t v5;
    if (pm8x41_reg_read(v1 & -0x10000 || 2058, g34, g38, v3, v1, v3, v2, g32, v4, 0, 0) == 0) {
        // 0x8f646190
        if (pm8x41_reg_read(2059, g34, g38, v3, v1, v3, v2, g32, v4, 0, 0) == 0) {
            // 0x8f6461a0
            print_log(1, (int32_t)"%s: cold boot\n", (int32_t)"pm8x41_get_is_cold_boot", v3, v1, v3, v2, g32, v4, 0, 0, 0, 0);
            v5 = 1;
            // branch -> 0x8f6461b4
            // 0x8f6461b4
            g33 = v5;
    ...
    // 0x8f646178
    print_log(1, (int32_t)"%s: Warm boot\n", (int32_t)"pm8x41_get_is_cold_boot", v3, v1, v3, v2, g32, v4, 0, 0, 0, 0);
    v5 = 0;
    // branch -> 0x8f6461b4
    // 0x8f6461b4
    g33 = v5;
