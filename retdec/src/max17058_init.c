...
// Address range: 0x8f6436c4 - 0x8f6437b7
int32_t max17058_init(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = a2; // bp-28
    int32_t v2 = a3; // bp-24
    int32_t result = g30;
    if (g28 == 0) {
        int32_t v3 = get_battery_offset_by_type((int32_t)"max17058", a2, 0, (int32_t)&g30); // 0x8f6436f4
        int32_t v4;
        if (v3 > -1) {
            int32_t v5 = get_int_prop((int32_t)"blsp", v3, (int32_t)&v1, (int32_t)&g30, a1, a2, a3); // 0x8f643724
            if (v5 == 0) {
                int32_t v6 = get_int_prop((int32_t)"qup", v3, (int32_t)&v2, (int32_t)&g30, a1, v1, a3); // 0x8f64373c
                if (v6 != 0) {
                    // 0x8f643730
                    // branch -> 0x8f643700
                    // 0x8f643700
                    print_log(-1, (int32_t)"DT settings for \"%s\" missing or incomplete\n", (int32_t)"max17058", (int32_t)&g30, a1, v1, v2, result, g40, g41, g42, g32, v4);
                    // branch -> 0x8f643778
                    // 0x8f643778
                    if (result != g30) {
                        // 0x8f643788
                ...
                int32_t v7 = v1; // 0x8f643748_0
                int32_t v8 = v2; // 0x8f64374c_0
                int32_t v9 = qup_blsp_i2c_init(0x1000000 * v7 / 0x1000000, 0x1000000 * v8 / 0x1000000, 0x61a80, 0x124f800, a1, v7, v8, result, g40, g41, g42, g32, v4, 0, 0, 0, 0); // 0x8f643758
                *(int32_t *)(int32_t)&g28 = v9;
                if (v9 == 0) {
                    // 0x8f643768
                    print_log(-1, (int32_t)"Failed initializing I2C to max17058\n", 0x61a80, 0x124f800, a1, v1, v2, result, g40, g41, g42, g32, v4);
                    // branch -> 0x8f643778
                }
                // 0x8f643778
                if (result != g30) {
        ...
        // 0x8f643700
        print_log(-1, (int32_t)"DT settings for \"%s\" missing or incomplete\n", (int32_t)"max17058", (int32_t)&g30, a1, v1, a3, result, g40, g41, g42, g32, v4);
        // branch -> 0x8f643778
    }
    // 0x8f643778
    if (result != g30) {
