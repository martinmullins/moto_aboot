...
// Address range: 0x8f60cd18 - 0x8f60cdc3
int32_t clk_get(char * str2) {
    int32_t str4 = (int32_t)str2;
    int32_t v1 = g31;
    int32_t str = g14;
    int32_t v2 = str; // R4
    int32_t v3;
    if (str == 0 || g15 == 0) {
        // 0x8f60cd4c
        print_log(-1, (int32_t)"Alert!! clock list not defined!\n", (int32_t)&g14, (int32_t)&g31, str4, v1, g37, g38, g39, g40, g41, g32, v3);
        // branch -> 0x8f60cd98
        // 0x8f60cd98
        if (v1 != g31) {
            // 0x8f60cda8
    ...
    int32_t v4 = 0; // R5
    if (strcmp((char *)*(int32_t *)str, str2) == 0) {
        // if_8f60cd6c_0_true
        // branch -> 0x8f60cd98
    } else {
        while (true) {
            int32_t v5 = v4 + 1; // 0x8f60cd74
            v4 = v5;
            int32_t str3 = v2 + 8; // 0x8f60cd78
            v2 = str3;
            if (v5 == g15) {
                // 0x8f60cd84
                print_log(-1, (int32_t)"Alert!! Requested clock \"%s\" is not supported!", str4, (int32_t)&g31, str4, v1, g37, g38, g39, g40, g41, g32, v3);
                // branch -> 0x8f60cd98
            } else {
                // 0x8f60cd74
                if (strcmp((char *)*(int32_t *)str3, (char *)str4) == 0) {
                    // break -> if_8f60cd6c_0_true
                    break;
                }
                // continue -> 0x8f60cd74
                continue;
