...
// Address range: 0x8f633794 - 0x8f6337f7
int32_t panel_manager_init(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g26; // 0x8f633798
    int32_t result = g15;
    g26 = (int32_t)&g12;
    char v2 = *(char *)&g12; // 0x8f6337ac
    int32_t v3 = result;
    if (v2 == 0) {
        // 0x8f6337b8
        g18 = &g17;
        g17 = &g17;
        int32_t v4;
        init_panels(a1, a2, (int32_t)v2, (int32_t)&g17, a1, result, a3, v1, g27, g19, v4);
        *(char *)g26 = 1;
        v3 = g15;
        // branch -> 0x8f6337d0
    }
