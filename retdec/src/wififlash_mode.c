...
// Address range: 0x8f61e0b4 - 0x8f61e10b
int32_t wififlash_mode(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g30;
    int32_t v2;
    int32_t result = power_check(print_log(1, (int32_t)"Entering wififlash mode\n", a3, v1, a1, v1, g40, g32, v2, 0, 0, 0, 0), (int32_t)"Entering wififlash mode\n", a3, v1, a1); // 0x8f61e0d0
    *(char *)&g14 = 8;
    if (v1 == g30) {
        // 0x8f61e0f4
        return boot_linux_from_flash(result, (int32_t)"Entering wififlash mode\n", v1, v1, g40, g32, v2, 0, 0);
    }
    // 0x8f61e0f0
    __stack_chk_fail();
    return result;
