...
// Address range: 0x8f60668c - 0x8f6066fb
int32_t target_mmc_erase_content(int32_t a1, int32_t a2) {
    // 0x8f60668c
    g34 = a1;
    g38 = &g31;
    int32_t v1;
    int32_t result; // 0x8f6066ec_2
    int32_t v2;
    int32_t v3;
    int32_t v4; // 0x8f6066984
    if (a2 == 0) {
        // after_if_8f606694_0.thread
        v3 = g31;
        v4 = g39;
        // branch -> 0x8f6066d4
        // 0x8f6066d4
        g34 = -1;
        print_log(-1, (int32_t)"%s: mmc not recognized correctly\n", (int32_t)"target_mmc_erase_content", (int32_t)&g31, a1, v3, v4, g33, v2, 0, 0, 0, 0);
        g34 = 255;
        v1 = g31;
        g38 = v1;
        if (v3 != v1) {
    ...
    int32_t v5 = g31;
    if (a1 != 0) {
        int32_t result2 = *(char *)(a2 + 181) == 0 ? 0 : 255;
        g34 = result2;
        g38 = v5;
        // branch -> 0x8f6066e8
        // 0x8f6066e8
