...
// Address range: 0x8f64a354 - 0x8f64a44f
int32_t longlong_to_string_constprop_0(int32_t a1, int32_t a2, int64_t a3, int32_t a4) {
    int32_t v1 = a3;
    int32_t v2 = a4; // R5
    int32_t v3 = v1; // R4
    ...
    *(char *)(a1 + 31) = 0;
    int32_t v6 = 31; // R3
    int32_t v7 = v2; // 0x8f64a3bc
    // branch -> 0x8f64a3a8
    while (true) {
        bool v8 = false; // 0x8f64a3b4
        bool v9 = true; // 0x8f64a3b4
        if (v7 == 0) {
            uint32_t v10 = v3; // 0x8f64a3ac
            v8 = v10 == 9;
            v9 = v10 > 8;
            // branch -> after_if_8f64a3ac_0
        }
        int32_t v11 = v6 - 1; // 0x8f64a3b0
        if (v8 || v9 ^ true) {
            int32_t v12 = v11; // R0
            *(char *)(a1 + v11) = (char)(v3 + 48);
            int32_t v13; // 0x8f64a40c
            if (v4 == 0) {
                // 0x8f64a418
                if ((v5 & 128) != 0) {
                    // 0x8f64a428
        ...
        // 0x8f64a3b8
        __aeabi_uldivmod((int64_t)v3, 10);
        int32_t v14 = v2; // 0x8f64a3d0
        int32_t v15 = __aeabi_uldivmod((int64_t)v3, 10); // 0x8f64a3e0
        v6 = v11;
        *(char *)(a1 + v11) = 58;
        v3 = v15;
        v2 = v14;
