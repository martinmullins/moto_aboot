...
// Address range: 0x8f672f08 - 0x8f672faf
int32_t write_protect_on_partition(int32_t a1, int32_t a2) {
    int32_t v1 = g61; // 0x8f672f08
    char v2 = *(char *)(a1 + 33); // 0x8f672f14
    char v3 = *(char *)(a1 + 41); // 0x8f672f18
    int32_t v4 = g49;
    char v5 = *(char *)(a1 + 32); // 0x8f672f24
    char v6 = *(char *)(a1 + 34); // 0x8f672f2c
    int32_t v7 = (int32_t)*(char *)(a1 + 35); // 0x8f672f34
    char v8 = *(char *)(a1 + 40); // 0x8f672f38
    char v9 = *(char *)(a1 + 42); // 0x8f672f40
    int32_t v10 = 0x10000 * (int32_t)v6 | (int32_t)v5 | 256 * (int32_t)v2 | 0x1000000 * v7; // 0x8f672f44
    char v11 = *(char *)(a1 + 43); // 0x8f672f4c
    int32_t v12 = 1 - v10 + (0x1000000 * (int32_t)v11 | 0x10000 * (int32_t)v9 | (int32_t)v8 | 256 * (int32_t)v3); // 0x8f672f5c
    int32_t v13 = generic_mmc_do_write_protect(v10, v12, 0, v7, a1, v4, g59, v1, g62); // 0x8f672f64
    g55 = v13;
    int32_t v14 = 0; // 0x8f672fa4_22
    if (v13 != 0) {
        // 0x8f672f70
        int32_t v15;
        print_log(0, (int32_t)"Failed to write protect on %s\n", get_entry_name(a1, v12, 0, v7, a1, v4, g59, v1), v7, a1, v4, g59, v1, g62, g54, v15, 0, 0);
        g55 = -1;
        v14 = -1;
        // branch -> 0x8f672f8c
    }
