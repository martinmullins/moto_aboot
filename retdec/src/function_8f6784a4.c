...
// Address range: 0x8f6784a4 - 0x8f678527
void function_8f6784a4(void) {
    // 0x8f6784a4
    int32_t v1;
    int32_t v2 = v1; // bp-36
    int32_t v3;
    int32_t v4 = v3; // bp-32
    int32_t v5 = &v2; // 0x8f6784b0_0
    int32_t v6 = g44;
    int32_t v7;
    if (rtc_get(v5, g47, g51, v6, v7, v1, v3) == 0) {
        // 0x8f6784d0
        int32_t v8;
        int32_t v9;
        if (__utag_sizeof(NULL, (int32_t)"time.offset", g51, v6, v7, v2, v3, v9, v8) == 8) {
            // 0x8f6784e4
            int32_t v10;
            int32_t v11 = __utag_read((char *)&v2, (int32_t)"time.offset", (int32_t)&v4, v5, v7, v2, v3, v9, v8, v6, v10, g53, g54); // 0x8f6784f0
            if (v11 != 0) {
                // 0x8f6784fc
                // branch -> 0x8f678504
            }
