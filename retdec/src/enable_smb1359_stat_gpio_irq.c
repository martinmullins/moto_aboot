...
// Address range: 0x8f603830 - 0x8f60387b
int32_t enable_smb1359_stat_gpio_irq(int32_t a1, int32_t a2, int32_t a3) {
    // 0x8f603830
    g20 = 62;
    int32_t v1 = g17;
    int32_t v2;
    int32_t result = register_msm_gpio_int_handler(62, (int32_t)&g1, a1, v1, a1, v1, g24, g19, v2, 0, 0, 0); // 0x8f60384c
    g20 = result;
    if (v1 != g17) {
        // 0x8f603860
        __stack_chk_fail();
    ...
    // 0x8f603864
    g20 = 62;
    int32_t result2 = msm_gpio_int_enable(62, (int32_t)&g1, v1, v1, g24, g19); // 0x8f603870
    g20 = result2;
    return result2;
}
