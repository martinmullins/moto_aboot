...
// Address range: 0x8f6390e4 - 0x8f63912b
int32_t dbr_timeout_handler(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g52 ? -0x709c73b8 : 0; // 0x8f6390e8
    int32_t v2 = g35;
    // branch -> 0x8f6390f4
    while (true) {
      lab_0x8f6390f4:;
        int32_t v3 = event_wait((int32_t)&g26, a2); // 0x8f6390f8
        if (is_display_on(v3) != 0) {
            // break -> 0x8f639108
            break;
        }
        // continue -> 0x8f6390f4
    }
    int32_t v4 = mutex_acquire((int32_t)&g22, a2, a3, v2, a1, v2, a3, v1, 0, 0, 0); // 0x8f63910c
    display_turn_off(v4, a2, a3, v2, a1, v2);
    mutex_release((int32_t)&g22, a2, a3, v2, a1, v2, a3);
    // branch -> 0x8f6390f4
    goto lab_0x8f6390f4;
}
