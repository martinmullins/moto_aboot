...
// Address range: 0x8f624614 - 0x8f6246c3
int32_t oem_backlight_usage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g29; // 0x8f624614
    g29 = &g14;
    int32_t v2 = g14;
    fboot_info("INFO", "usage: fastboot oem backlight [options]", a3, v2);
    fboot_info("INFO", (char *)&g9, a3, v2);
    fboot_info("INFO", "options:", a3, v2);
    fboot_info("INFO", "  on            turn on backlight", a3, v2);
    fboot_info("INFO", "  off           turn off backlight", a3, v2);
    fboot_info("INFO", "  <number>           set backlight level", a3, v2);
    int32_t result = fboot_info("INFO", "  help          show usage", a3, v2); // 0x8f624674
    if (v2 != g14) {
        // 0x8f624688
        __stack_chk_fail();
        return result;
