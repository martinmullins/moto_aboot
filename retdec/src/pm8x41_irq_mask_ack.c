...
// Address range: 0x8f645ba8 - 0x8f645c03
int32_t pm8x41_irq_mask_ack(uint32_t a1, uint32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    uint32_t v1 = a2 % 256; // 0x8f645bb4
    int32_t v2 = v1 == 0 ? 1 : v1 < 32 ? (1 << v1) % 256 : 0; // 0x8f645bbc
    int32_t v3 = g33;
    int32_t v4 = 256 * a1 / 8; // 0x8f645bc4
    int32_t result = pm8x41_reg_write(v4 | 22, v2, a3, v3, a1, v3, g55, g56, g57, g48, a5); // 0x8f645bd4
    if (v3 == g33) {
        // 0x8f645bec
        return pm8x41_reg_write(v4 + 20, v2, v3, v3, g55, g56, g57, g48, a5, 0, 0);
    }
    // 0x8f645be8
    __stack_chk_fail();
    return result;
