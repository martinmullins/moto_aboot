...
// Address range: 0x8f6062c0 - 0x8f60639f
int32_t bs_set_timestamp(int32_t a1) {
    int32_t v1 = g65; // 0x8f6062c0
    int32_t v2 = g66; // 0x8f6062c0
    int32_t v3 = g67; // 0x8f6062c0
    int32_t v4 = g68; // 0x8f6062c0
    int32_t v5 = g57;
    int32_t result = get_bs_info_addr(a1); // 0x8f6062dc
    if (result == 0) {
        // 0x8f60636c
        if (v5 != g57) {
            // 0x8f60637c
    ...
    // 0x8f6062e8
    int32_t result2; // 0x8f606360
    if (a1 >= 6) {
        // 0x8f6062f0
        int32_t v6;
        print_log(-1, (int32_t)"bad bs id: %u, max: %u\n", a1, 6, v6, 0, 0, v5, 0, v1, v2, v3, v4);
        int32_t v7 = _panic(g58, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm_shared/boot_stats.c", 46, (int32_t)&g13, 0, 0); // 0x8f60631c
        // branch -> 0x8f606360
        // 0x8f606360
        result2 = platform_get_sclk_count(v7, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm_shared/boot_stats.c", 46);
        if (result2 != 0) {
            // if_8f606368_0_true
            *(int32_t *)(4 * a1 + result) = result2;
            // branch -> 0x8f60636c
        }
        // 0x8f60636c
        if (v5 != g57) {
    ...
    switch (a1) {
        case 4: {
            // 0x8f60632c
            g34 = platform_get_sclk_count(result, g60, g63, v5);
            // branch -> 0x8f60636c
            break;
        }
        case 5: {
            int32_t v8 = platform_get_sclk_count(result, g60, g63, v5); // 0x8f606344
            if (v8 != 0) {
                // if_8f60634c_0_true
                *(int32_t *)(result + 12) = v8 - g34;
                // branch -> 0x8f60636c
            }
            break;
        }
    ...
    // 0x8f606360
    result2 = platform_get_sclk_count(result, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm_shared/boot_stats.c", v5);
    if (result2 != 0) {
        // if_8f606368_0_true
        *(int32_t *)(4 * a1 + result) = result2;
        // branch -> 0x8f60636c
