...
// Address range: 0x8f64f9c4 - 0x8f64fac7
int32_t display_clear_rect(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g20;
    char * v2 = g23;
    ...
    if (v1 == 0) {
        // 0x8f64fa10
        return print_log(2, (int32_t)"Display not initialized\n", v3, v3, g30, g31, g32, g33, g34, g35, g27, g28, 0);
    }
    char v4 = *(char *)&g21; // 0x8f64fa28
    int32_t v5; // 0x8f64fa74
    int32_t result; // 0x8f64fa5c
    int32_t v6; // 0x8f64fa64
    int32_t v7; // 0x8f64fa70
    int32_t v8; // 0x8f64fa60
    if (v4 == 0) {
        // if_8f64fa30_0_true
        v5 = 1 - a1 + a3;
        v7 = a2;
        ...
        int32_t v9 = display_get_screen_height(a1, a2, v3, (int32_t)v4) - a4; // 0x8f64fa54
        v5 = a4 - a2;
        v7 = a1;
        v6 = v9;
        v8 = a3 - a1;
    ...
    // 0x8f64fa58
    gfx_fillrect(result, v6, v7, v5, v8, g19, 0, v3, 0, g30, g31, g32, g33, g34);
    char * v10 = g23;
    int32_t v11;
    if (0x1000000 * v11 / 0x1000000 == 0) {
        // 0x8f64faa0
        if (v2 == v10) {
            // 0x8f64faac
            return result;
        ...
        if (v2 == v10) {
            // 0x8f64fa90
            return gfx_flush(g20, v6, v3, (int32_t)v10, g30, g31, g32);
        }
    }
    // 0x8f64faa8
    __stack_chk_fail();
