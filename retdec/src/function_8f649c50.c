...
// Address range: 0x8f649c50 - 0x8f649d23
void function_8f649c50(void) {
    int32_t v1 = g30;
    int32_t v2 = g33; // 0x8f649cc0
    int32_t v3 = 0;
    int32_t v4; // R4
    switch (*(char *)g33) {
        case 48: {
            ...
            if (*(char *)(g33 + 1) == 120) {
                ...
                v4 = 0;
                int32_t v5 = g33 + 3; // R5
                char v6 = *(char *)(g33 + 2); // 0x8f649c808
                if (v6 != 0) {
                    int32_t c = v6; // 0x8f649c8011
                    while (true) {
                        // 0x8f649c8c
                        if (isxdigit(c) != 0) {
                            char v7 = *(char *)(v5 - 1); // 0x8f649c98
                            v4 = hexval((int32_t)v7, g34) + 16 * v4;
                            int32_t v8 = v5; // 0x8f649c80
                            v5 = v8 + 1;
                            char v9 = *(char *)v8; // 0x8f649c80
                            if (v9 == 0) {
                                // break (via goto) -> 0x8f649d00
                                goto lab_0x8f649d00;
                            }
                            c = v9;
                            // continue -> 0x8f649c8c
    ...
    v4 = 0;
    int32_t v10 = v2 + 1; // R6
    char v11 = *(char *)v2; // 0x8f649ccc15
    if (v11 != 0) {
        int32_t c2 = v11; // 0x8f649ccc18
        while (true) {
            // 0x8f649ce4
            if (isdigit(c2) != 0) {
                int32_t v12 = v10; // 0x8f649cf0
                char v13 = *(char *)(v12 - 1); // 0x8f649cf0
                v4 = (int32_t)v13 - 48 + 10 * v4;
                v10 = v12 + 1;
                char v14 = *(char *)v12; // 0x8f649ccc
                if (v14 == 0) {
                    // break (via goto) -> 0x8f649cd8
                    goto lab_0x8f649cd8;
                }
                c2 = v14;
                // continue -> 0x8f649ce4
