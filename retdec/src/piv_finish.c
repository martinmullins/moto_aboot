...
// Address range: 0x8f65afec - 0x8f65b093
int32_t piv_finish(int32_t a1, int32_t a2) {
    int32_t v1 = g79; // 0x8f65afec
    int32_t v2 = g80; // 0x8f65afec
    int32_t v3 = g81; // 0x8f65afec
    int32_t v4 = g75 ? -0x709aede4 : 0; // 0x8f65afec
    g80 = (int32_t)&g63;
    char v5 = *(char *)&g63; // 0x8f65aff8
    int32_t result = v5; // 0x8f65aff8
    int32_t v6 = g73;
    int32_t v7;
    if (v5 == 0) {
        // 0x8f65b010
        print_log(result, (int32_t)"PIV process not started\n", v6, (int32_t)&g73, a1, v6, v1, v2, v3, v4, v7, 0, 0);
        // branch -> 0x8f65b060
        // 0x8f65b060
        if (v6 != g73) {
            // 0x8f65b070
    ...
    char v8 = *(char *)&g69; // 0x8f65b028
    int32_t result2; // R0
    if (v8 == 2) {
        // 0x8f65b048
        memset((char *)&g57, 0, 0x20000);
        result2 = 0;
        *(char *)g80 = 0;
        // branch -> 0x8f65b060
    } else {
        // 0x8f65b034
        print_log(0, (int32_t)"PIV process not done\n", v6, (int32_t)v8, a1, v6, v1, v2, v3, v4, v7, 0, 0);
        result2 = -1;
        // branch -> 0x8f65b060
    }
    // 0x8f65b060
