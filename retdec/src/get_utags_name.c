...
// Address range: 0x8f6792e4 - 0x8f679357
int32_t get_utags_name(int32_t a1, int32_t a2) {
    int32_t v1 = g7;
    int32_t result;
    int32_t v2;
    if (a1 < 2) {
        // 0x8f67931c
        v2 = v1;
        result = *(int32_t *)(96 * a1 + (int32_t)&g6);
        // branch -> 0x8f67932c
    } else {
        int32_t v3 = g8 ? -0x70987650 : 0; // 0x8f6792ec
        int32_t v4;
        print_log(-1, (int32_t)"%s: failed uspace = [%d]\n", (int32_t)"get_utags_name", a1, a1, v1, g13, v3, v4, 0, 0, 0, 0);
        v2 = g7;
        result = 0;
        // branch -> 0x8f67932c
    }
