...
// Address range: 0x8f6430b8 - 0x8f64312f
int32_t keys_get_state(uint32_t a1) {
    int32_t v1 = g45; // 0x8f6430c0
    int32_t v2 = g32;
    g45 = &g32;
    int32_t result;
    int32_t v3;
    if ((v2 & -0x10000 || 510) < a1) {
        int32_t v4 = g41 ? -0x709e6520 : 0; // 0x8f6430c0
        int32_t v5;
        print_log(1, (int32_t)"Invalid keycode requested: %d\n", a1, (int32_t)&g32, a1, v2, v1, v4, v5, 0, 0, 0, 0);
        v3 = g32;
        result = -1;
        // branch -> 0x8f643108
    } else {
        uint32_t v6 = *(int32_t *)(4 * a1 / 32 + (int32_t)&g26); // 0x8f6430fc
        v3 = v2;
        result = (v6 >> a1 % 32) % 2;
        // branch -> 0x8f643108
    }
