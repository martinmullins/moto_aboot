...
// Address range: 0x8f654f64 - 0x8f654ff3
int32_t index_value_cb(int32_t a1, int32_t * a2) {
    int32_t v1 = (int32_t)a2;
    int32_t v2 = g22; // 0x8f654f6c
    int32_t v3 = g13;
    g22 = v1;
    int32_t v4 = *a2; // 0x8f654f84
    int32_t * v5 = (int32_t *)(v1 + 4); // 0x8f654f84_1
    int32_t v6 = *v5; // 0x8f654f84
    int32_t result;
    if (v4 == v6) {
        int32_t v7 = g16 ? -0x709ad7a4 : 0; // 0x8f654f6c
        int32_t v8 = *(int32_t *)(v1 + 8); // 0x8f654fa4
        int32_t v9;
        strlcpy(v8, a1, *(int32_t *)(v1 + 12), v4, v9);
        int32_t v10 = g22; // 0x8f654fac
        int32_t v11 = *(int32_t *)(v10 + 8); // 0x8f654fac
        int32_t v12 = *(int32_t *)v10; // 0x8f654fc0
        int32_t v13;
        print_log(2, (int32_t)"DEBUG: %s: index = %d val = [%s]\n", (int32_t)"index_value_cb", v12, v11, 0, 0, v3, 0, v2, g23, v7, v13);
        result = 1;
        // branch -> 0x8f654fcc
    } else {
        // if_8f654f8c_0_true
