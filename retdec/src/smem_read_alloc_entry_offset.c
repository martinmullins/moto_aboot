...
// Address range: 0x8f604504 - 0x8f6045bb
int32_t smem_read_alloc_entry_offset(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g43; // 0x8f604504
    int32_t v2 = g45; // 0x8f604504
    g45 = a3;
    g43 = a2;
    int32_t v3 = g38;
    int32_t v4 = platform_get_smem_base_addr(a1); // 0x8f604524
    uint32_t v5 = g45; // 0x8f60452c
    g17 = v4;
    if (v5 % 4 == 0) {
        uint32_t v6 = g43; // 0x8f60453c
        int32_t result = v6 % 4; // 0x8f60453c
        if (result == 0) {
            // 0x8f604544
            ...
            int32_t v7 = 16 * (a1 + 13) + v4; // 0x8f604558
            if (*(int32_t *)v7 == 0) {
                // 0x8f604594
                // branch -> 0x8f604598
                // 0x8f604598
            ...
            int32_t v8 = *(int32_t *)(v7 + 4) + v4 + a4; // 0x8f604570
            g45 = v8 + v5;
            g43 = v6 - v8;
            if (v5 != 0) {
                // 0x8f604584
                *(int32_t *)v6 = *(int32_t *)v8;
                int32_t v9 = v8 + 4; // 0x8f60458c12
                if (g45 != v9) {
                    *(int32_t *)(v9 + g43) = *(int32_t *)v9;
                    int32_t v10 = v9 + 4; // 0x8f60458c
                    while (g45 != v10) {
                        // 0x8f604584
                        v9 = v10;
                        *(int32_t *)(v9 + g43) = *(int32_t *)v9;
