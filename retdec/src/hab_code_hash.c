...
// Address range: 0x8f66cc48 - 0x8f66ccff
int32_t hab_code_hash(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = 0x10000 * a1 / 0x10000; // bp-26
    int32_t v2 = g49;
    int32_t v3 = 0; // bp-24
    hab_hash_decision(a2, (int32_t)&v3, (int32_t)&v1, 0, a1);
    uint32_t v4 = v1 % 0x10000; // 0x8f66cc7c
    int32_t v5; // 0x8f66ccd4
    int32_t v6; // R0
    int32_t result; // 0x8f66ccf8_2
    int32_t v7; // 0x8f66ccf8_25
    int32_t v8;
    switch ((int16_t)v1) {
        case 1: {
            // if_8f66cc84_0_true
        ...
        case 65: {
            // 0x8f66cccc
            v5 = hab_sahara_hash(a2, v4, a3, 0, a1, a2, v3, v2, g61, g62, g63, g54, v8, 0, 0);
            v6 = v5;
            v7 = 240;
            if (v5 != 240) {
                // 0x8f66ccc4
