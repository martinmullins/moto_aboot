...
// Address range: 0x8f63902c - 0x8f63908f
int32_t stop_16(int32_t a1, int32_t a2) {
    int32_t result = a1; // R0
    int32_t v1 = g35;
    char v2 = *(char *)&g29; // 0x8f639044
    int32_t v3 = a1; // 0x8f63907c_22
    int32_t v4 = v1;
    if (v2 == 1) {
        int32_t v5 = g52 ? -0x709c73b8 : 0; // 0x8f639030
        int32_t v6 = timer_cancel((int32_t)&g28, a2, (int32_t)v2, (int32_t)&g35, a1, v1, g57, v5); // 0x8f639054
        result = v6;
        v3 = v6;
        v4 = g35;
        // branch -> 0x8f639058
