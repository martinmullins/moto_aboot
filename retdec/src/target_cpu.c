...
// Address range: 0x8f600d34 - 0x8f600e67
int32_t target_cpu(void) {
    int32_t v1 = g47; // 0x8f600d34
    int32_t v2 = g48; // 0x8f600d34
    g47 = (int32_t)&g15;
    int32_t v3 = g31;
    int32_t v4 = *(int32_t *)0x1110010; // 0x8f600d58
    g48 = v4;
    *(char *)&g16 = 0;
    snprintf((char *)&g15, 63, "unknown (device id: 0x%08X)", v4);
    uint32_t v5 = g48; // 0x8f600d70
    if ((v5 & (v4 & -0x10000 || 4094)) == 224 && v5 % 2 != 0) {
        uint32_t v6 = v5 / 0x1000 % 0x10000; // 0x8f600d84
        if (v6 != ((int32_t)"unknown (device id: 0x%08X)" & -0x10000 || 1801)) {
            // 0x8f600d94
            if (v6 <= ((int32_t)"unknown (device id: 0x%08X)" & -0x10000 || 1801)) {
                // 0x8f600d98
                if (v6 == (((int32_t)"unknown (device id: 0x%08X)" & -0x10000 || 1801) & -0x10000 || 1797)) {
                    // 0x8f600dec
                    // branch -> 0x8f600e18
                    // 0x8f600e18
                    strlcpy(g47, (int32_t)"MSM8916", 64, v6, g41);
                    // branch -> 0x8f600e20
                } else {
                    // 0x8f600da4
                    if (v6 == (((int32_t)"unknown (device id: 0x%08X)" & -0x10000 || 1801) & -0x10000 || 1797) + 2) {
                        // if_8f600dac_0_true
                        // branch -> 0x8f600e18
                        // 0x8f600e18
                        strlcpy(g47, (int32_t)"MSM8216", 64, v6, g41);
                        // branch -> 0x8f600e20
                    }
                }
                // 0x8f600e20
            ...
            // 0x8f600dbc
            if (v6 == (((int32_t)"unknown (device id: 0x%08X)" & -0x10000 || 1801) & -0x10000 || 2315)) {
                // 0x8f600e04
                // branch -> 0x8f600e18
                // 0x8f600e18
                strlcpy(g47, (int32_t)"MSM8939", 64, v6, g41);
                // branch -> 0x8f600e20
                // 0x8f600e20
                g45 = v3;
                if (v3 != g31) {
            ...
            // 0x8f600dc8
            if (v6 == (((int32_t)"unknown (device id: 0x%08X)" & -0x10000 || 1801) & -0x10000 || 2315) + 76) {
                // 0x8f600e10
                // branch -> 0x8f600e18
                // 0x8f600e18
                strlcpy(g47, (int32_t)"MSM8239", 64, v6, g41);
                // branch -> 0x8f600e20
            } else {
                // 0x8f600dd4
                if (v6 == ((((int32_t)"unknown (device id: 0x%08X)" & -0x10000 || 1801) & -0x10000 || 2315) + 76 & -0x10000 || 2314)) {
                    // 0x8f600de0
                    // branch -> 0x8f600e18
                    // 0x8f600e18
                    strlcpy(g47, (int32_t)"MSM8936", 64, v6, g41);
                    // branch -> 0x8f600e20
                }
            }
            // 0x8f600e20
        ...
        // branch -> 0x8f600e18
        // 0x8f600e18
        strlcpy(g47, (int32_t)"MSM8616", 64, v6, g41);
        // branch -> 0x8f600e20
    }
    // 0x8f600e20
    g45 = v3;
