...
// Address range: 0x8f6309d0 - 0x8f630a4f
int32_t get_int_prop(int32_t a1, int32_t a2) {
    int32_t v1 = g33;
    int32_t v2 = fdt_getprop((int32_t)&g3, a2, a1, 0, a1, v1, g39, g40, g41, g35); // 0x8f6309f4
    int32_t result; // R0
    if (v2 == 0) {
        // 0x8f630a00
        int32_t v3;
        print_log(2, (int32_t)"Not found setting for %s\n", a1, 0, a1, v1, g39, g40, g41, g35, v3, 0, 0);
        result = -1;
        // branch -> 0x8f630a28
    } else {
        // 0x8f630a18
        result = 0;
        *(int32_t *)g37 = llvm_bswap_i32(*(int32_t *)v2);
        // branch -> 0x8f630a28
    }
    // 0x8f630a28
    if (v1 != g33) {
