...
// Address range: 0x8f6389cc - 0x8f638aaf
int32_t screen_manager_init(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = g52; // 0x8f6389cc
    g52 = (int32_t)&g41;
    int16_t * v2 = g41;
    int32_t v3 = (int32_t)v2;
    g37 = &g36;
    g36 = &g36;
    event_init((int32_t)&g33, 0, 1, (int32_t)&g36);
    event_init((int32_t)&g35, 0, 1, (int32_t)&g36);
    mutex_init((int32_t)&g34, 0, 1, (int32_t)&g36);
    timer_initialize((int32_t)&g29, 0, 1, (int32_t)&g36);
    int32_t result2 = thread_create((int32_t)"key_handler", (int32_t)&g3, 0, 16, 0x1000, a2, a3, v3, v1, g45, a5, 0, 0, 0, 0, 0); // 0x8f638a30
    g32 = result2;
    int16_t * v4 = g41;
    ...
    if (result2 == 0) {
        ...
        if (v2 == v4) {
            // 0x8f638a6c
            g52 = v1;
            return print_log(1, (int32_t)"%s: key_handler thread_create fail\n", (int32_t)"screen_manager_init", v5, v1, g45, a5, 0, 0, 0, 0, 0, 0);
        }
    } else {
        // 0x8f638a4c
        if (v2 == v4) {
            // 0x8f638a54
            g52 = v1;
            int32_t result = thread_resume(result2, (int32_t)&g3, v3, v5, v1, g45, a5, 0); // 0x8f638a5c
            return result;
        }
    }
    // 0x8f638a68
