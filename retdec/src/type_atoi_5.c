...
// Address range: 0x8f61d6f0 - 0x8f61d7f3
int32_t type_atoi_5(char * str, int32_t a2, int32_t a3) {
    int32_t result = (int32_t)str;
    int32_t v1 = g31; // 0x8f61d6f4
    g31 = result;
    int32_t v2 = g17;
    int32_t v3;
    if (str == NULL) {
    ...
    // 0x8f61d798
    int32_t v4; // R0
    int32_t v5; // 0x8f61d7d0_28
    if (strcmp((char *)g31, "ullong") == 0) {
        // if_8f61d7ac_0_true
        v4 = 7;
        v5 = 7;
        // branch -> 0x8f61d7b8
