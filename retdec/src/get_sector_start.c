...
// Address range: 0x8f65a990 - 0x8f65aa13
int32_t get_sector_start(void) {
    int32_t v1 = g31; // 0x8f65a990
    int32_t v2 = g23;
    int32_t v3;
    char * v4 = get_partition_by_name((int32_t)"misc", g26, g29, v2, g25, v2, g29, g30, v1, g24, v3); // 0x8f65a9a4
    int32_t v5 = (int32_t)v4; // 0x8f65a9a4_12
    int32_t result;
    if (v4 == NULL) {
        // 0x8f65a9b0
        print_log(-1, (int32_t)"%s: failed to find partition %s\n", (int32_t)"get_sector_start", (int32_t)"misc", g25, v2, g29, g30, v1, g24, v3, 0, 0);
        result = v5;
        // branch -> 0x8f65a9e8
    } else {
        char v6 = *(char *)(v5 + 33); // 0x8f65a9cc
        char v7 = *(char *)(v5 + 32); // 0x8f65a9d0
        char v8 = *(char *)(v5 + 34); // 0x8f65a9d8
        char v9 = *(char *)(v5 + 35); // 0x8f65a9dc
        int32_t v10 = 0x10000 * (int32_t)v8 | (int32_t)v7 | 256 * (int32_t)v6 | 0x1000000 * (int32_t)v9; // 0x8f65a9e4
        result = v10;
        // branch -> 0x8f65a9e8
    }
    // 0x8f65a9e8
