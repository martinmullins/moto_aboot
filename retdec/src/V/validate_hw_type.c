...
// Address range: 0x8f673b44 - 0x8f673ba7
int32_t validate_hw_type(char * a1, int32_t a2) {
    int32_t v1 = g30;
    int32_t result = SecReadFuse(106, a2, g38, v1); // 0x8f673b58
    int32_t result2 = result; // R0
    if (result == 0) {
        int32_t v2 = mdelay(10, a2, g38, v1); // 0x8f673b68
        result2 = v2;
        if (v1 == g30) {
            // 0x8f673b7c
            return SecMakeEngineering(v2, a2, v1);
        }
    } else {
        // 0x8f673b88
        if (v1 == g30) {
