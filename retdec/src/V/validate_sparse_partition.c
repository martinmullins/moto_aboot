...
// Address range: 0x8f67319c - 0x8f673227
int32_t validate_sparse_partition(int32_t a1, int32_t a2) {
    // 0x8f67319c
    g56 = a2;
    int32_t v1 = g61; // 0x8f6731a0
    int32_t v2 = g62; // 0x8f6731a0
    int32_t v3 = g63; // 0x8f6731a0
    int32_t v4 = g54; // 0x8f6731a0
    g61 = a1;
    int32_t v5 = g49;
    g59 = v5;
    g63 = &g49;
    ...
    if (a1 == 0) {
        // 0x8f6731b8
        print_log(0, (int32_t)"Invalid partition parameter!\n", v5, (int32_t)&g49, 0, v5, v1, v2, v3, v4, v6, 0, 0);
        // branch -> 0x8f6731ec
        // 0x8f6731ec
        g55 = -1;
        // branch -> 0x8f673200
    ...
    int32_t v8 = get_entry_name(a1, a2, v5, (int32_t)&g49, a1, v5, v1, v2); // 0x8f6731c4
    int32_t v9 = get_policy_executor((char *)v8); // 0x8f6731c8
    g55 = v9;
    g62 = v9;
    if (v9 == 0) {
        int32_t v10 = get_entry_name(g61, a2, v5, (int32_t)&g49, a1, v5, v1, v2); // 0x8f6731d8
        print_log(g62, (int32_t)"Not found executor for %s\n", v10, (int32_t)&g49, a1, v5, v1, v2, v3, v4, v6, 0, 0);
        // branch -> 0x8f6731ec
        // 0x8f6731ec
        g55 = -1;
        // branch -> 0x8f673200
    } else {
        int32_t v11 = *(int32_t *)(v9 + 16); // 0x8f6731f4
        g60 = v11;
        int32_t v12 = g61; // 0x8f6731f8
        g56 = v12;
        g54 = -0x7098ce00;
        ((int32_t (*)(int32_t, int32_t))v11)(v12, v11);
        // branch -> 0x8f673200
    }
    // 0x8f673200
    v7 = g49;
