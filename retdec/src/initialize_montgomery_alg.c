...
// Address range: 0x8f67046c - 0x8f6704b7
int32_t initialize_montgomery_alg(int32_t * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g23; // 0x8f67046c
    g23 = v1;
    int32_t v3 = g15;
    int32_t v4 = *a1; // 0x8f670480
    int32_t v5 = unit_modular_inverse(*(int32_t *)v4, a2, a3, v4, v1, v3); // 0x8f670488
    *(int32_t *)(v1 + 24) = -v5;
    if (v3 != g15) {
        // 0x8f6704a8
        __stack_chk_fail();
