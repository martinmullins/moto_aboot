...
// Address range: 0x8f6259bc - 0x8f625aaf
int32_t oem_build_sig(int32_t a1, int32_t a2) {
    int32_t (*v1)() = g15;
    int32_t v2 = (int32_t)v1;
    int32_t v3;
    fboot_info((int32_t)"INFO", (int32_t)"%s:", (int32_t)"sbl1", v2, a1, v2, g27, g22, v3, 0, 0);
    build_sig_for_all((int32_t)"sbl1", (int32_t)&g6, 0, v2, a1, v2, g27, g22, v3, 0, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"%s:", (int32_t)"rpm", v2, a1, v2, g27, g22, v3, 0, 0);
    build_sig_for_all((int32_t)"rpm", (int32_t)&g6, 0, v2, a1, v2, g27, g22, v3, 0, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"%s:", (int32_t)"tz", v2, a1, v2, g27, g22, v3, 0, 0);
    build_sig_for_all((int32_t)"tz", (int32_t)&g6, 0, v2, a1, v2, g27, g22, v3, 0, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"%s:", (int32_t)"hyp", v2, a1, v2, g27, g22, v3, 0, 0);
    build_sig_for_all((int32_t)"hyp", (int32_t)&g6, 0, v2, a1, v2, g27, g22, v3, 0, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"%s:", (int32_t)"aboot", v2, a1, v2, g27, g22, v3, 0, 0);
    build_sig_for_all((int32_t)"aboot", (int32_t)&g6, 0, v2, a1, v2, g27, g22, v3, 0, 0, 0);
    if (v1 != g15) {
        // 0x8f625a80
        __stack_chk_fail();
        // branch -> 0x8f625a84
