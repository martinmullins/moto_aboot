...
// Address range: 0x8f636ee0 - 0x8f636f3f
int32_t SecSetSVNum(uint32_t a1, uint32_t a2, int32_t a3) {
    // 0x8f636ee0
    int32_t result; // bp+218
    if (a1 > a2) {
        // after_if_8f636eec_0.thread
        result = 0;
        // branch -> 0x8f636f34
    } else {
        int32_t v1 = 0; // 0x8f636f1c
        if (a1 != 0) {
            int32_t v2 = 0; // 0x8f636f1415
            uint32_t v3 = v2 % 256; // 0x8f636f1013
            int32_t v4 = v3 == 0 ? 1 : v3 < 32 ? 1 << v3 : 0; // 0x8f636f10
            while (v2 + 1 < a1) {
                // if_8f636f10_0_true
                v2++;
                v3 = v2 % 256;
                v4 |= (v3 == 0 ? 1 : v3 < 32 ? 1 << v3 : 0);
                // continue -> if_8f636f10_0_true
            }
            // 0x8f636f0c
            v1 = v4;
            // branch -> 0x8f636f1c
