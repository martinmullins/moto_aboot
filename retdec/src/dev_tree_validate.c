...
// Address range: 0x8f614be0 - 0x8f614ca7
int32_t dev_tree_validate(int32_t * a1, int32_t a2) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g28;
    if (*a1 != 0x54444351) {
        // 0x8f614c04
        print_log(-1, (int32_t)"ERROR: Bad magic in device tree table \n", g36, a2, v1, v2, g38, g39, g40, g42, g43, g33, g34);
        // branch -> 0x8f614c7c
        // 0x8f614c7c
        if (v2 != g28) {
            // 0x8f614c8c
    ...
    int32_t v3 = *(int32_t *)(v1 + 4); // 0x8f614c14
    int64_t v4; // 0x8f614c68
    switch (v3) {
        default: {
            // 0x8f614c34
            print_log(-1, (int32_t)"ERROR: Unsupported version (%d) in DT table \n", v3, a2, v1, v2, g38, g39, g40, g42, g43, g33, g34);
            // branch -> 0x8f614c7c
            // 0x8f614c7c
            if (v2 != g28) {
                // 0x8f614c8c
    ...
    uint32_t v5 = *(int32_t *)(v1 + 8); // 0x8f614c58
    *(int32_t *)g36 = (int32_t)((int64_t)v5 * v4) + a2 + 11 & -a2;
    // branch -> 0x8f614c7c
    // 0x8f614c7c
    if (v2 != g28) {
        // 0x8f614c8c
