...
// Address range: 0x8f60d258 - 0x8f60d2bf
int32_t clock_lib2_rcg_set_rate_hid(int32_t * a1, int32_t a2, int32_t a3) {
    int32_t result = g47;
    int32_t * v1 = (int32_t *)*(int32_t *)((int32_t)a1 + 4); // 0x8f60d270_0
    *v1 = *v1 & -800 | *(int32_t *)(a2 + 8);
    int32_t v2 = *a1; // 0x8f60d284
    int32_t * v3 = (int32_t *)v2; // 0x8f60d288_0
    *v3 = *v3 | 1;
    // branch -> 0x8f60d294
    while (*(int32_t *)v2 % 2 != 0) {
        // 0x8f60d294
        // continue -> 0x8f60d294
    }
    // 0x8f60d2a0
