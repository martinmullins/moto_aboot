...
// Address range: 0x8f61b65c - 0x8f61b6fb
int32_t thread_yield(int32_t a1, int32_t a2) {
    // 0x8f61b65c
    g20 = a1;
    int32_t result = g17;
    ...
    *(char *)(g18 + 24) = 1;
    *(int32_t *)(g18 + 32) = 0;
    int32_t v4 = insert_in_run_queue_tail(g18, a2, v3, 0, a1, result); // 0x8f61b6a4
    int32_t v5;
    g20 = thread_resched(g18, a2, v4, 0, a1, result, g22, g24, g25, g19, v5, 0);
    int32_t v6 = g7 - 1; // 0x8f61b6b4
    *(int32_t *)v2 = v6;
    int32_t v7 = g17;
    if (v6 == 0) {
        // 0x8f61b6c8
