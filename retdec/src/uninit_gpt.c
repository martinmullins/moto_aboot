...
// Address range: 0x8f652c14 - 0x8f652cdb
int32_t uninit_gpt(char * a1, int32_t a2) {
    int32_t v1 = g38; // 0x8f652c18
    int32_t v2 = g40; // 0x8f652c18
    int32_t v3 = g29;
    g40 = &g29;
    char * v4 = g25;
    int32_t set_mem; // 0x8f652c94_6
    if (v4 == NULL) {
        // 0x8f652c88
        set_mem = (int32_t)memset((char *)&g22, 0, 0x8000);
        g17 = 0;
        *(char *)&g19 = 0;
        if (v3 != g29) {
            // 0x8f652cbc
    ...
    // 0x8f652c38
    g38 = 0;
    int32_t v5 = 0; // 0x8f652c48
    // branch -> 0x8f652c44
    char * v6;
    while (true) {
        int32_t v7 = *(int32_t *)((int32_t)v4 + v5); // 0x8f652c48
        v6 = v4;
        int32_t v8 = v5; // 0x8f652c60
        if (v7 != 0) {
            // 0x8f652c54
            free((char *)v7);
            *(int32_t *)(g38 + (int32_t)g25) = 0;
            v6 = g25;
            v8 = g38;
            // branch -> 0x8f652c60
        }
        int32_t v9 = v8 + 4; // 0x8f652c60
        g38 = v9;
        if (v9 == 512) {
            // break -> 0x8f652c6c
            break;
