...
// Address range: 0x8f6458d4 - 0x8f645927
int32_t power_source_detected(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g25;
    int32_t result = is_charger_smb1359(a1, a2, a3, v1, a1, v1, g34, g28 ? -0x709af928 : 0); // 0x8f6458e4
    int32_t v2 = g25;
    if (result == 0) {
        // 0x8f64590c
        if (v1 == v2) {
            // 0x8f645918
            return is_usb_connected(0, a2, v1, v1);
        }
    } else {
        // 0x8f6458f8
        if (v1 == v2) {
            // 0x8f645900
            smb1359_power_source_detected(result, a2, v1, v1, g34);
            return result;
        }
    }
    // 0x8f645914
