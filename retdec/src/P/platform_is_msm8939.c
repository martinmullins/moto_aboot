...
// Address range: 0x8f601d78 - 0x8f601dd7
int32_t platform_is_msm8939(int32_t a1, int32_t a2) {
    uint32_t v1 = board_platform_id(a1, a2) - 233; // 0x8f601d8c
    int32_t result = 0;
    if (v1 <= 30) {
        uint32_t v2 = v1 % 256; // 0x8f601da0
        int32_t v3 = v2 == 0 ? 1 : v2 < 32 ? 1 << v2 : 0; // 0x8f601da0
        result = (v3 & 0x400007c1) != 0;
        // branch -> 0x8f601db4
    }
    // 0x8f601dc8
    return result;
