...
// Address range: 0x8f6461e0 - 0x8f64621f
int32_t pm8x41_uninit(int32_t a1) {
    int32_t v1 = g40; // 0x8f6461e0
    g40 = &g30;
    int32_t v2 = g30;
    int32_t v3 = disable_resin_n_irq(a1, g34); // 0x8f6461f0
    int32_t v4 = disable_kpdpwr_n_irq(v3, g34); // 0x8f6461f4
    int32_t result = disable_usbin_valid_irq(v4, g34); // 0x8f6461f8
    g33 = result;
    if (v2 != g30) {
        // 0x8f64620c
        __stack_chk_fail();
    ...
    // 0x8f646210
    g40 = v1;
    int32_t result2 = pmic_charger_cleanup(result, g34, v2, v2); // 0x8f646218
    g33 = result2;
    return result2;
}
