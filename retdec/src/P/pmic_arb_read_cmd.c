...
// Address range: 0x8f611ca4 - 0x8f611dfb
int32_t pmic_arb_read_cmd(char * a1) {
    int32_t v1 = (int32_t)a1;
    char * v2 = g40;
    int32_t result = (int32_t)v2;
    int32_t v3 = 0; // bp-21
    int32_t v4; // 0x8f611cf0
    if (g15 > 0x2000ffff) {
        char v5 = *(char *)(v1 + 2); // 0x8f611cdc
        char v6 = *(char *)(v1 + 3); // 0x8f611ce0
        char v7 = *(char *)(((int32_t)v6 | 256 * (int32_t)v5) + g17); // 0x8f611cf0
        v4 = v7;
        g16 = v4;
        // branch -> 0x8f611cf8
    } else {
    ...
    int32_t v8 = 0x8000 * v4; // 0x8f611d04
    int32_t v9 = v8 + 0x2c00000; // R3
    *(int32_t *)(v8 + 0x2c00004) = 0;
    *(char *)v1 = 1;
    char v10 = *(char *)(v1 + 4); // 0x8f611d18
    uint32_t v11 = (int32_t)*(char *)(g44 + 4) - 1; // 0x8f611d1c
    char v12 = *(char *)(v1 + 1); // 0x8f611d20
    int32_t v13 = v11 % 256; // R1
    *(char *)(v1 + 5) = (char)v11;
    *(int32_t *)v9 = 16 * (int32_t)v10 | 0x4000000 * (int32_t)v12 | 0x8000000 | v13;
    int32_t v14 = *(int32_t *)(v9 + 8); // 0x8f611d40
    // branch -> 0x8f611d40
    while (v14 == 0) {
        // 0x8f611d40
        v14 = *(int32_t *)(v9 + 8);
    ...
    int32_t v15 = v14 ^ 1; // 0x8f611d4c
    int32_t v16;
    if (v14 != 1) {
        char v17 = *(char *)v1; // 0x8f611d5c
        print_log(-1, (int32_t)"SPMI read command failure: \t\t\tcmd_id = %u, error = %u\n", (int32_t)v17, v15, v1, result, g47, g48, g49, g42, v16, 0, 0);
        // branch -> 0x8f611dc8
        // 0x8f611dc8
        if (v2 != g40) {
            // 0x8f611dd8
    ...
    char v18 = *(char *)(g44 + 4); // 0x8f611d70
    int32_t v19 = &v3; // 0x8f611d74_0
    int32_t v20 = *(int32_t *)g44; // 0x8f611d78
    read_rdata_into_array(v20, v15, (int32_t)v18, v19, v1, result, g47, g48, g49, g42, v16, 0, 0, 0);
    uint32_t v21 = (int32_t)*(char *)(g44 + 4); // 0x8f611d84
    int32_t v22 = v3; // 0x8f611d88_0
    int32_t v23 = v22; // 0x8f611da8_0
    int32_t v24 = g44; // 0x8f611db4
    if (0x1000000 * v22 / 0x1000000 >= v21) {
        int32_t v25 = *(int32_t *)g44; // 0x8f611d94
        read_rdata_into_array(v25, 1, v21, v19, v1, result, g47, g48, g49, g42, v16, 0, 0, 0);
        v23 = v3;
        v24 = g44;
        // branch -> 0x8f611da4
    }
    uint32_t v26 = (int32_t)*(char *)(v24 + 4); // 0x8f611da4
    if (0x1000000 * v23 / 0x1000000 >= v26) {
        int32_t v27 = *(int32_t *)v24; // 0x8f611db4
        read_rdata_into_array(v27, 2, v26, v19, v1, result, g47, g48, g49, g42, v16, 0, 0, 0);
        // branch -> 0x8f611dc8
    }
    // 0x8f611dc8
    if (v2 != g40) {
