...
// Address range: 0x8f646d0c - 0x8f646d6f
int32_t pmic_charger_cleanup(int32_t a1, int32_t a2) {
    int32_t v1 = g24;
    int32_t v2 = get_accessory_type(a1, a2); // 0x8f646d1c
    ...
    if (v2 == 3) {
        ...
        // 0x8f646d28
        result = pmic_set_iusb_max(500, a2, g30, v1);
        if (v1 == g24) {
            // 0x8f646d40
            return pmic_set_chg_set_mode(0, a2, v1, v1, g32);
        }
    }
    // 0x8f646d60
    __stack_chk_fail();
