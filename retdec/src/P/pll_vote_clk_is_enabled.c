...
// Address range: 0x8f60cf1c - 0x8f60cf63
int32_t pll_vote_clk_is_enabled(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = *(int32_t *)*(int32_t *)(a1 - 12); // 0x8f60cf30
    int32_t v2 = a1; // 0x8f60cf5c_23
    if (v1 == *(int32_t *)(a1 - 8)) {
        // if_8f60cf44_0_true
        v2 = 0;
        // branch -> after_if_8f60cf44_0
    }
    // after_if_8f60cf44_0
    int32_t result; // 0x8f60cf5c_22
    if (v1 != 0) {
        // if_8f60cf48_0_true
        result = 1;
        // branch -> 0x8f60cf58
