...
// Address range: 0x8f6187b4 - 0x8f61882b
int32_t panel_power_on_reset(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g30; // 0x8f6187b4
    g30 = &g20;
    int32_t v2 = g20;
    int32_t v3;
    print_log(2, (int32_t)"%s is called\n", (int32_t)"panel_power_on_reset", v2, a1, v2, v1, g25, v3, 0, 0, 0, 0);
    int32_t result = set_power_supply_list((int32_t)&g23, g6, 0, (int32_t)&g6, a1, v2, v1, g25, v3, 0, 0, 0, 0, 0, 0, 0, 0); // 0x8f6187e4
    if (v2 == g20) {
        // 0x8f6187fc
        g30 = v1;
        return print_log(2, (int32_t)"%s is done \n", (int32_t)"panel_power_on_reset", v2, v1, g25, v3, 0, 0, 0, 0, 0, 0);
    }
    // 0x8f6187f8
    __stack_chk_fail();
    return result;
