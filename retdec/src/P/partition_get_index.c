...
// Address range: 0x8f6539b0 - 0x8f653a27
int32_t partition_get_index(int32_t a1, int32_t a2) {
    int32_t v1 = g38; // 0x8f6539b0
    int32_t v2 = g39; // 0x8f6539b0
    g38 = (int32_t)&g18;
    int32_t v3 = g29;
    g39 = &g29;
    char * v4 = g18;
    ...
    if (v4 == NULL) {
        // 0x8f6539d4
        int32_t v6;
        print_log(v5, (int32_t)"no any partition found!\n", (int32_t)&g29, v5, a1, v3, g37, v1, v2, g33, v6, 0, 0);
        // branch -> 0x8f653a00
        // 0x8f653a00
        if (v3 != g29) {
            // 0x8f653a10
    ...
    char * v7 = get_partition_by_name((char *)a1); // 0x8f6539e4
    int32_t result;
    if (v7 != NULL) {
        // if_8f6539ec_0_true
        result = ((int32_t)v7 - (int32_t)g18) / 128;
        // branch -> 0x8f653a00
    } else {
        result = -1;
    }
