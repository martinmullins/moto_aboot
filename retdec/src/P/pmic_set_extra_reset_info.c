...
// Address range: 0x8f646d70 - 0x8f646de3
int32_t pmic_set_extra_reset_info(uint32_t result2, uint32_t a2) {
    // 0x8f646d70
    g49 = result2;
    int32_t v1 = g53; // 0x8f646d70
    int32_t v2 = g48; // 0x8f646d70
    uint32_t v3 = result2 % 256; // 0x8f646d7c
    g53 = result2;
    int32_t v4 = g47;
    if (v3 != 0) {
        int32_t result = pm8x41_masked_reg_write(result2 & -0x10000 | 2189, v3, a2 % 256, v4, result2, v4, v1, g54, g55); // 0x8f646d98
        g49 = result;
        return result;
    }
    // 0x8f646d9c
    ...
    g48 = v2;
    int32_t v5;
    int32_t result3 = pm8x41_masked_reg_write(result2 & -0x10000 | 2190, result2 / 256, a2 / 256, v4, v1, g54, g55, v2, v5); // 0x8f646dc8
    g49 = result3;
    return result3;
}
