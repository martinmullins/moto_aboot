...
// Address range: 0x8f646c0c - 0x8f646ccf
int32_t pmic_set_chg_set_mode(char a1, int32_t a2, int32_t a3) {
    int32_t v1 = a1;
    int32_t v2 = g23; // 0x8f646c0c
    int32_t v3 = v1; // R4
    g23 = &g15;
    int32_t v4 = g15;
    int32_t result;
    if (is_charger_smb1359(v1, a2, a3, v4, v1, v4, a3, g22) == 0) {
        // 0x8f646c38
        int32_t v5; // 0x8f646c6c
        int32_t v6;
        if (v3 == 0) {
            // 0x8f646c60
            v5 = 0x1049;
            ...
            // 0x8f646c40
            v5 = pm8x41_masked_reg_write(0x1642, 128, 128, v4, v1, v4, a3, g22, v2) & -0x10000 | 0x1049;
            v6 = 128;
            // branch -> 0x8f646c6c
        }
        // 0x8f646c6c
        result = pm8x41_masked_reg_write(v5, 128, v6, v4, v1, v4, a3, g22, v2);
        // branch -> 0x8f646c70
    } else {
        // 0x8f646c2c
        result = smb135x_temp_charging(0x1000000 * v3 / 0x1000000, a2, a3, v4, v1, v4, a3);
        // branch -> 0x8f646c70
    }
    char v7 = v3; // 0x8f646c78
    *(char *)&g14 = v7;
    int32_t v8 = (int32_t)"disabled"; // 0x8f646cb4
    if (v7 != 0) {
        // if_8f646c8c_0_true
        v8 = (int32_t)"enabled";
        // branch -> after_if_8f646c8c_0
    }
    // after_if_8f646c8c_0
    if (v4 == g15) {
        // 0x8f646ca0
        g23 = v2;
        int32_t v9;
        return print_log(1, (int32_t)"%s: charging is %s\n", (int32_t)"pmic_set_chg_set_mode", v8, g22, v2, g16, v9, 0, 0, 0, 0, 0);
    }
    // 0x8f646c9c
    __stack_chk_fail();
    return result;
