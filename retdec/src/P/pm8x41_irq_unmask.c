...
// Address range: 0x8f645c04 - 0x8f645c4f
int32_t pm8x41_irq_unmask(uint32_t a1, uint32_t a2) {
    int32_t result = g33;
    uint32_t v1 = a2 % 256; // 0x8f645c30
    int32_t v2 = v1 == 0 ? 1 : v1 < 32 ? (1 << v1) % 256 : 0; // 0x8f645c3c
    int32_t v3;
    pm8x41_reg_write(256 * a1 / 8 | 21, v2, result, 1, g48, v3, 0, 0, 0, 0, 0);
    return result;
}
