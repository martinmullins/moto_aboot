...
// Address range: 0x8f602d60 - 0x8f602dcf
int32_t platform_clock_init(int32_t a1) {
    int32_t result = g55;
    if (platform_is_msm8939(a1, g59, g61, result) != 0) {
        // 0x8f602d7c
        *(int32_t *)((int32_t)&g10 + 24) = (int32_t)&g26;
        // branch -> 0x8f602d98
        // 0x8f602d98
        if (result == g55) {
            // 0x8f602dac
            return clk_init((int32_t)&g15, 26, result, result);
        }
        // 0x8f602da8
        __stack_chk_fail();
        return result;
    ...
    // 0x8f602d8c
    if (platform_is_msm8929(0, g59, g61, result) != 0) {
        // 0x8f602d7c
        *(int32_t *)((int32_t)&g10 + 24) = (int32_t)&g26;
        // branch -> 0x8f602d98
    }
