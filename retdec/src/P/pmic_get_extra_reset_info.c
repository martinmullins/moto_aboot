...
// Address range: 0x8f646de4 - 0x8f646e33
int32_t pmic_get_extra_reset_info(int32_t a1, int32_t a2) {
    int32_t v1 = g12;
    int32_t v2;
    int32_t v3 = pm8x41_reg_read(a1 & -0x10000 | 2190, a2, g15, v1, a1, v1, g16, g17, g18, 0, v2); // 0x8f646dfc
    int32_t result = (pm8x41_reg_read(v3 & -0x10000 | 2189, a2, g15, v1, a1, v1, g16, g17, g18, 0, v2) | 256 * v3) & a1; // 0x8f646e1c
    if (v1 != g12) {
        // 0x8f646e24
        __stack_chk_fail();
        // branch -> 0x8f646e28
