...
// Address range: 0x8f6492f4 - 0x8f64934f
int32_t putpixel16(int32_t * a1, int32_t a2, int32_t a3, uint32_t a4) {
    int32_t v1 = *(int32_t *)((int32_t)a1 + 24); // 0x8f649310
    int32_t result = *a1; // 0x8f649318
    *(int16_t *)(2 * (v1 * a3 + a2) + result) = (int16_t)(a4 / 8 % 32 | 2048 * a4 / 0x80000 | 32 * (a4 / 1024 % 64));
    return result;
}
