...
// Address range: 0x8f645928 - 0x8f645993
int32_t pm8x41_reset_configure(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g25;
    pm8x41_masked_reg_write(a1 & -0x10000 | 2139, 128, 0, v1, a1, v1, a3, g34, g35);
    int32_t result = pm8x41_masked_reg_write(udelay(300, 128, 0, v1) & -0x10000 | 2138, 15, a1, v1, a1, v1, a3, g34, g35); // 0x8f645960
    if (v1 == g25) {
        int32_t v2 = g28 ? -0x709af928 : 0; // 0x8f645928
        int32_t v3;
        return pm8x41_masked_reg_write(result & -0x10000 | 2139, 128, 128, v1, g34, g35, v2, v3, 0);
    }
    // 0x8f645974
    __stack_chk_fail();
    return result;
