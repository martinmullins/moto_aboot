...
// Address range: 0x8f653b20 - 0x8f653bc7
int32_t partition_get_offset(uint32_t a1, int32_t a2) {
    int32_t v1 = g13;
    if (a1 == -1 || g11 > a1) {
        // 0x8f653b98
    ...
    int32_t v2 = g12 + 128 * a1; // 0x8f653b54
    char v3 = *(char *)(v2 + 33); // 0x8f653b58
    char v4 = *(char *)(v2 + 32); // 0x8f653b5c
    char v5 = *(char *)(v2 + 37); // 0x8f653b60
    char v6 = *(char *)(v2 + 34); // 0x8f653b68
    int32_t v7 = 0x10000 * (int32_t)v6 | (int32_t)v4 | 256 * (int32_t)v3; // 0x8f653b6c
    char v8 = *(char *)(v2 + 35); // 0x8f653b70
    char v9 = *(char *)(v2 + 36); // 0x8f653b78
    char v10 = *(char *)(v2 + 38); // 0x8f653b80
    int32_t result = 512 * v7; // 0x8f653b84
    g16 = result;
    int32_t v11 = 512 * (0x10000 * (int32_t)v10 | (int32_t)v9 | 256 * (int32_t)v5) | (0x1000000 * (int32_t)v8 | v7) / 0x800000; // 0x8f653b90
    // branch -> 0x8f653bb4
    // 0x8f653bb4
    g17 = v11;
    g20 = v1;
