...
// Address range: 0x8f61c4ac - 0x8f61c533
int32_t pmic_get_version(int32_t a1) {
    int32_t v1 = g38; // 0x8f61c4ac
    int32_t v2 = g39; // 0x8f61c4ac
    int32_t v3 = g30;
    int32_t v4;
    int32_t v5;
    int32_t v6 = pm8x41_reg_read(a1 & -0x10000 | 259, g35, g36, v3, v5, v4, 0, v3, 0, v1, v2); // 0x8f61c4c4
    int32_t v7 = pm8x41_reg_read(v6 & -0x10000 | 258, g35, g36, v3, v5, v4, 0, v3, 0, v1, v2); // 0x8f61c4d0
    int32_t v8 = pm8x41_reg_read(v7 & -0x10000 | 257, g35, g36, v3, v5, v4, 0, v3, 0, v1, v2); // 0x8f61c4dc
    int32_t v9 = pm8x41_reg_read(256, g35, g36, v3, v5, v4, 0, v3, 0, v1, v2); // 0x8f61c4e8
    sprintf((char *)&g28, "%x.%x.%x.%x", v6, v7, v8, v9);
    if (v3 != g30) {
        // 0x8f61c51c
        __stack_chk_fail();
        // branch -> 0x8f61c520
