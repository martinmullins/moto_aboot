...
// Address range: 0x8f65b094 - 0x8f65b223
int32_t piv_init(char * a1, int32_t a2, char * a3) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = (int32_t)a3;
    int32_t v3 = g79; // 0x8f65b094
    int32_t v4 = g80; // 0x8f65b094
    int32_t v5 = g81; // 0x8f65b094
    int32_t v6 = g82; // 0x8f65b094
    int32_t v7 = 0; // 0x8f65b094
    g79 = v1;
    g81 = a2;
    g80 = v2;
    int32_t v8 = g73;
    char v9 = *(char *)&g63; // 0x8f65b0b4
    int32_t v10 = v9; // 0x8f65b0b4
    int32_t v11 = a2; // 0x8f65b0d8
    if (v9 == 1) {
        // 0x8f65b0c0
        piv_finish(v1, a2);
        v11 = g81;
    ...
    if (v11 < 0x20000) {
        ...
        // branch -> 0x8f65b0f0
        // 0x8f65b0f0
        print_log(3, (int32_t)"Invalid PIV block length", v2, v10, v1, v8, v3, v4, v5, v6, g83, g84, v7);
        // branch -> 0x8f65b0f4
        // 0x8f65b0f4
        // branch -> 0x8f65b1c4
        // 0x8f65b1c4
    ...
    // 0x8f65b0d4
    if (is_piv_magic(g79, v11, v2, v10) == 0) {
        // 0x8f65b0e8
        // branch -> 0x8f65b0f0
        // 0x8f65b0f0
        print_log(3, (int32_t)"Invalid PIV block", v2, v10, v1, v8, v3, v4, v5, v6, g83, g84, v7);
        // branch -> 0x8f65b0f4
    } else {
        int32_t v12 = &g64; // R10
        g64 = g79;
        if (strncmp((char *)(g79 + 28), (char *)g80, 32) == 0) {
            int32_t v13 = 0x1000000 * strncmp((char *)(g79 + 8), "MOT_PIV_FULL256", 16);
            int32_t result = v13 / 0x1000000; // R6
            if ((v13 || 0xffffff) >= 0x1ffffff) {
                // 0x8f65b13c
                // branch -> 0x8f65b164
                // 0x8f65b164
                print_log(3, (int32_t)"Invalid PIV signature for %s", g80, v10, v1, v8, v3, v4, v5, v6, g83, g84, v7);
                // branch -> 0x8f65b0f4
                // 0x8f65b0f4
                // branch -> 0x8f65b1c4
                // 0x8f65b1c4
            ...
            int32_t v14 = *(int32_t *)(g79 + 60); // 0x8f65b14c
            g82 = v14;
            if (v14 == 1) {
                // 0x8f65b16c
                g80 = (int32_t)&g57;
                int32_t v15 = 0; // R4
                memcpy((char *)&g57, (char *)g79, 0x20000);
                *(int32_t *)v12 = g80;
                *(char *)(int32_t)&g63 = (char)g82;
                g68 = &g58;
                g80 = 0;
                g66 = v15;
                g67 = 0;
                ...
                g61 = v15;
                g62 = 0;
                *(char *)&g69 = (char)result;
                // branch -> 0x8f65b1c4
            } else {
                // 0x8f65b158
                // branch -> 0x8f65b164
                // 0x8f65b164
                print_log(3, (int32_t)"Invalid PIV hash entry number %d", g82, v10, v1, v8, v3, v4, v5, v6, g83, g84, v7);
                // branch -> 0x8f65b0f4
                // 0x8f65b0f4
                result = -1;
                // branch -> 0x8f65b1c4
        ...
        // branch -> 0x8f65b164
        // 0x8f65b164
        print_log(3, (int32_t)"Mismatched PIV partition name for %s", g80, v10, v1, v8, v3, v4, v5, v6, g83, g84, v7);
        // branch -> 0x8f65b0f4
    }
    // 0x8f65b0f4
    // branch -> 0x8f65b1c4
