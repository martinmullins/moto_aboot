...
// Address range: 0x8f672c38 - 0x8f672c8b
int32_t mot_sst_pal_get_processor_uid(int32_t a1, int32_t a2) {
    int32_t v1 = g31; // 0x8f672c40
    int32_t result; // 0x8f672c84_2
    if (a1 == 0) {
        // after_if_8f672c44_0.thread
        g28 = 255;
        // branch -> 0x8f672c6c
        result = 255;
        // 0x8f672c80
    ...
    int32_t v2 = g27 ? -0x709cc008 : 0; // 0x8f672c40
    int32_t v3 = g16;
    int32_t v4;
    int32_t v5 = SecProcessorUID(a1, 16, v3, (int32_t)&g16, a1, v3, v1, v2, v4, 0, 0); // 0x8f672c5c
    int32_t v6; // 0x8f672c84_22
    if (v5 == 16) {
        // if_8f672c64_0_true
        g28 = 255;
        v6 = 255;
