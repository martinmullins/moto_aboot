...
// Address range: 0x8f66c6cc - 0x8f66c777
int32_t dbval_read_processor_uid(char * a1, int32_t * a2) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = (int32_t)a2;
    g48 = v2;
    int32_t v3 = g53; // 0x8f66c6d0
    int32_t v4 = g54; // 0x8f66c6d0
    int32_t v5 = g55; // 0x8f66c6d0
    int32_t v6 = g56; // 0x8f66c6d0
    int32_t v7 = v2; // R7
    int32_t v8 = g38;
    if (a2 != NULL) {
        // if_8f66c6e0_0_true
        v7 = 1;
        // branch -> after_if_8f66c6e0_0
    }
    // after_if_8f66c6e0_0
    int32_t result; // R0
    if (a1 == NULL) {
        ...
        // 0x8f66c73c
        if (v1 != 0) {
            // after_if_8f66c744_0.thread
            // branch -> after_if_8f66c75c_0.critedge
            // after_if_8f66c75c_0.critedge
            // branch -> after_if_8f66c75c_0
            // after_if_8f66c75c_0
            if (v8 != g38) {
                // 0x8f66c768
                __stack_chk_fail();
    ...
    memset(a1, 0, 16);
    g48 = 14;
    if (SecProcessorUID(v1, 14, 16, v9, v1, v8, g51, v3, v4, v5, v6) == 0) {
        // if_8f66c730_0_true
        result = 15;
        *(int32_t *)v2 = 16;
        // branch -> 0x8f66c73c
