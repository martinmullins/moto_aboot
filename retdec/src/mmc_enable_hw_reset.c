...
// Address range: 0x8f60b028 - 0x8f60b0c3
int32_t mmc_enable_hw_reset(void) {
    int32_t v1 = g40; // 0x8f60b02c
    int32_t v2 = g41; // 0x8f60b02c
    int32_t v3 = g33;
    int32_t v4 = g36; // 0x8f60b038
    int32_t result; // 0x8f60b0bc_2
    int32_t v5; // 0x8f60b0bc_22
    int32_t v6;
    if (*(char *)(*(int32_t *)(v4 + 80) + 162) == 1) {
        // 0x8f60b054
        g36 = 0;
        v5 = 0;
        // branch -> 0x8f60b0a4
        ...
        // 0x8f60b05c
        int32_t v7;
        char * v8 = mmc_switch_cmd((char *)v4, v4 + 48, 3, 162, 1, 0, 0, v3, 0, v1, v2, g35, v7, 0, 0, 0, 0, 0); // 0x8f60b070
        int32_t v9 = (int32_t)v8; // 0x8f60b070_20
        g36 = v9;
        if (v8 == NULL) {
            int32_t v10 = mmc_get_ext_csd_isra_11((char *)v4, v4 + 80, 3, 162, 1, 0, 0, v3, 0, v1, v2, g35, v7, 0, 0); // 0x8f60b084
            g36 = v10;
            if (v10 == 0) {
                // 0x8f60b090
                if (*(char *)(*(int32_t *)(v4 + 80) + 162) == 1) {
