...
// Address range: 0x8f633128 - 0x8f63319f
int32_t is_charger_fan54046(void) {
    int32_t v1 = g21;
    char v2 = *(char *)&g15; // 0x8f633144
    int32_t v3 = v1;
    if (v2 == 0) {
        int32_t v4 = get_charger_offset_by_type((int32_t)"fan54046", (int32_t)v2, (int32_t)&g21, (int32_t)&g15); // 0x8f633158
        if (v4 > -1) {
            // if_8f633160_0_true
            *(char *)(int32_t)&g16 = 1;
            // branch -> after_if_8f633164_0
        }
        // after_if_8f633164_0
        *(char *)(int32_t)&g15 = 1;
        v3 = g21;
