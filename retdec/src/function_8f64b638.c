...
// Address range: 0x8f64b638 - 0x8f64b69f
void function_8f64b638(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = 0;
    // branch -> 0x8f64b650
    while (true) {
        int32_t v2 = v1; // R3
        char v3 = *(char *)(v1 + a1); // 0x8f64b650
        int32_t v4; // 0x8f64b660
        if (v3 == 0) {
            v4 = v1;
          lab_0x8f64b65c:
            // 0x8f64b65c
        ...
        int32_t v6 = a2 - 1; // 0x8f64b678
        // branch -> 0x8f64b678
        while (true) {
            int32_t v7 = v6 + 1; // 0x8f64b678
            char v8 = *(char *)v7; // 0x8f64b678
            int32_t v9 = v8; // 0x8f64b678
            if (v8 == 0) {
                // 0x8f64b65c
                v4 = v2;
                // branch -> 0x8f64b65c
