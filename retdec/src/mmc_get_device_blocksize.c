...
// Address range: 0x8f60b698 - 0x8f60b6e7
int32_t mmc_get_device_blocksize(void) {
    int32_t v1 = g30;
    int32_t v2 = platform_boot_dev_isemmc(g33, g34, g38, v1); // 0x8f60b6a8
    int32_t v3 = target_mmc_device(v2); // 0x8f60b6c0
    int32_t v4;
    if (v2 == 0) {
        // 0x8f60b6c0
        v4 = ufs_get_page_size(v3, g34);
        // branch -> 0x8f60b6c8
    } else {
        // 0x8f60b6b4
        v4 = *(int32_t *)(v3 + 56);
