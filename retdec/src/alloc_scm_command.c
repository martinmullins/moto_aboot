...
// Address range: 0x8f616464 - 0x8f616533
int32_t alloc_scm_command(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = a2 + a1; // 0x8f616490
    int32_t v2 = v1 + 28; // 0x8f616494
    char * v3 = memalign(64, v1 + 91 & -64); // 0x8f6164b0
    int32_t result = (int32_t)v3; // 0x8f6164b0_5
    if (v3 != NULL) {
        // 0x8f6164c8
        memset(v3, 0, v2);
        *(int32_t *)v3 = v2;
        int32_t * v4 = (int32_t *)(result + 4); // 0x8f6164ec_0
        *v4 = 16;
        *(int32_t *)(result + 8) = *v4 + a1;
        // branch -> 0x8f616508
    }
    // 0x8f616508
