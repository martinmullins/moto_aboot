...
// Address range: 0x8f612dc8 - 0x8f612e37
int32_t qup_i2c_read_byte(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = 0x1000000 * a3 / 0x1000000; // bp-41
    int32_t v2 = 0x10000 * a2 / 0x10000; // 0x8f612ddc_0
    int32_t v3 = v2; // bp-36
    char * v4 = g21;
    int32_t v5;
    qup_i2c_xfer(a1, (int32_t)&v3, 2, g25, v5, 0, 0, v2, 1, (int32_t)&v1);
    if (v4 != g21) {
        // 0x8f612e28
        __stack_chk_fail();
        // branch -> 0x8f612e2c
