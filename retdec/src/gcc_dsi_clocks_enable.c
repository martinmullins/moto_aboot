...
// Address range: 0x8f602880 - 0x8f6029c7
int32_t gcc_dsi_clocks_enable(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = 0x184d000; // R12
    int32_t v2 = g35;
    *(int32_t *)0x184d048 = 256;
    *(int32_t *)(v1 + 68) = 1;
    *(int32_t *)(v1 + 148) = 1;
    *(int32_t *)(v1 + 4) = 256;
    *(int32_t *)v1 = 1;
    ...
    *(int32_t *)(v1 + 16) = a4;
    int32_t v3;
    int32_t v4 = clk_get_set_enable((int32_t)"mdss_esc0_clk", 0, 1, 256, v3, 0, 0, v2, 0, g40); // 0x8f6028e0
    int32_t v5 = v4; // R0
    int32_t v6 = 0; // 0x8f6029a0_23
    int32_t v7 = v3;
    if (v4 != 0) {
        // 0x8f6028ec
        print_log(-1, (int32_t)"failed to set esc0_clk ret = %d\n", v4, 256, v3, 0, 0, v2, 0, g40, g41, g42, g43);
        int32_t v8 = _panic(g37, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/acpuclock.c", (int32_t)&g5 & -0x10000 | 302, (int32_t)&g5, 0, 0); // 0x8f602910
        v5 = v8;
        v6 = v8;
        v7 = &g5;
        // branch -> 0x8f602914
    ...
    *(int32_t *)(v1 + 196) = a3;
    *(int32_t *)(v1 + 200) = a4;
    int32_t v9 = clk_get_set_enable((int32_t)"mdss_esc1_clk", 0, 1, 256, v7, 0, 0, v2, 0, g40); // 0x8f602954
    v5 = v9;
    int32_t v10; // 0x8f602984
    if (v9 != 0) {
        // 0x8f602960
        print_log(-1, (int32_t)"failed to set esc1_clk ret = %d\n", v9, 256, v7, 0, 0, v2, 0, g40, g41, g42, g43);
        v10 = _panic(g37, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/acpuclock.c", (int32_t)&g5 & -0x10000 | 325, (int32_t)&g5, 0, 0);
        v5 = v10;
        // branch -> 0x8f602988
    } else {
        v10 = 0;
