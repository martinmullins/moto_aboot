...
// Address range: 0x8f605000 - 0x8f6050bf
int32_t udc_endpoint_alloc(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g31;
    int32_t v2 = 0; // 0x8f605080
    int32_t v3 = 1; // 0x8f605080
    int32_t v4; // 0x8f605080
    int32_t result; // 0x8f605080
    int32_t v5;
    int32_t v6;
    if (a1 != 1) {
        // 0x8f60501c
        if (a1 != 2) {
            ...
            while (true) {
                // 0x8f605058
                if (1 << (v3 == 0 ? v4 : v4 + 16) == v6) {
                    // 0x8f605080
                    result = _udc_endpoint_alloc(v4, v3, a2, v2, a1, v1, a3, g37, g38, g39, g40, g32, v5, 0, 0, 0);
                    if (result != 0) {
                        // if_8f605090_0_true
                        *(int32_t *)(int32_t)&g1 = v6 | g1;
                        // branch -> 0x8f60509c
                    }
                } else {
                  lab_0x8f605070_2:;
                    int32_t v7 = v4 + 1; // 0x8f605070
                    if (v7 == 16) {
                        // break -> 0x8f605098
                        break;
                    }
