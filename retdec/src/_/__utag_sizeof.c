...
// Address range: 0x8f6798a8 - 0x8f67994f
int32_t __utag_sizeof(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1; // 0x8f6798a8_0
    int32_t v2 = g66; // 0x8f6798ac
    int32_t v3 = g67; // 0x8f6798ac
    int32_t v4 = g68; // 0x8f6798ac
    int32_t v5 = g57;
    int32_t v6 = &g28; // R4
    int32_t v7 = g28;
    int32_t v8 = v7 + 1; // 0x8f6798cc
    g28 = v8;
    if (v7 == 0) {
        // 0x8f6798dc
    ...
    // 0x8f6798e0
    int32_t v9;
    int32_t result = __find_first_utag(v1, a2, v8, (int32_t)&g57, v1, v5, a3, g65, v2, v3, v4, g58, v9, 0); // 0x8f6798e8
    int32_t v10 = g28;
    int32_t result2; // R5
    int32_t v11;
    if (result == 0) {
        int32_t v12 = v10 - 1; // 0x8f6798f8
        result2 = v12;
        *(int32_t *)v6 = v12;
        if (result2 != 0) {
            // 0x8f67992c
    ...
    // 0x8f67990c
    result2 = *(int32_t *)(result + 32);
    int32_t v13 = v10 - 1; // 0x8f679914
    *(int32_t *)v6 = v13;
    if (v13 != 0) {
        // 0x8f679928
        // branch -> 0x8f67992c
