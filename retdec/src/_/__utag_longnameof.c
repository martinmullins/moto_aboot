...
// Address range: 0x8f67a04c - 0x8f67a0f7
int32_t __utag_longnameof(void) {
    int32_t v1 = g46; // 0x8f67a04c
    int32_t v2 = g53; // 0x8f67a04c
    int32_t v3 = g54; // 0x8f67a04c
    int32_t v4 = g55; // 0x8f67a04c
    int32_t v5 = g56; // 0x8f67a04c
    int32_t v6 = g57; // 0x8f67a04c
    int32_t v7 = g44;
    int32_t v8 = g21;
    int32_t v9 = &g21; // R6
    g21 = v8 + 1;
    ...
    // 0x8f67a08c
    int32_t v10;
    int32_t v11 = __find_first_utag(v1, g47, (int32_t)&g44, (int32_t)&g21, v1, v7, v2, v3, v4, v5, v6, g45, v10, 0); // 0x8f67a094
    int32_t v12 = v11 == 0 ? g47 : v11;
    strlcpy(g51, v12, 32, (int32_t)&g21, v1);
    *(char *)(g51 + 31) = 0;
    int32_t v13 = g21 - 1; // 0x8f67a0bc
    *(int32_t *)v9 = v13;
    if (v13 == 0) {
        // 0x8f67a0cc
        function_8f619438();
