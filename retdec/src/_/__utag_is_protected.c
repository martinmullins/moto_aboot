...
// Address range: 0x8f67a490 - 0x8f67a53b
int32_t __utag_is_protected(int32_t a1, int32_t a2) {
    int32_t v1 = g11;
    int32_t v2 = &g1; // R4
    int32_t v3 = g1;
    int32_t v4 = v3 + 1; // 0x8f67a4b4
    g1 = v4;
    if (v3 == 0) {
        // 0x8f67a4c4
    ...
    // 0x8f67a4c8
    int32_t v5;
    int32_t result = __find_first_utag(a1, a2, v4, (int32_t)&g11, a1, v1, g16, g18, g19, g20, g21, g12, v5, 0); // 0x8f67a4d0
    int32_t v6 = g1;
    if (result == 0) {
        int32_t result2 = v6 - 1; // 0x8f67a500
        *(int32_t *)v2 = result2;
        if (result2 != 0) {
            // 0x8f67a518
            if (v1 != g11) {
    ...
    int32_t v7 = v6 - 1; // 0x8f67a4e4
    *(int32_t *)v2 = v7;
    int32_t result3 = *(int32_t *)(result + 36) % 2; // 0x8f67a4f0
    if (v7 != 0) {
        // 0x8f67a514
        // branch -> 0x8f67a518
        // 0x8f67a518
