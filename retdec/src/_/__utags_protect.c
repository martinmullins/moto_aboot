...
// Address range: 0x8f67a0f8 - 0x8f67a1ab
int32_t __utags_protect(int32_t a1, int32_t a2) {
    int32_t v1 = g44;
    int32_t v2 = get_utags(a1, a2, g51); // 0x8f67a10c
    int32_t v3; // R6
    int32_t v4;
    int32_t v5;
    int32_t v6; // 0x8f67a12c
    int32_t v7; // 0x8f67a164
    int32_t v8; // 0x8f67a170
    int32_t v9; // 0x8f67a15c
    if (*(int32_t *)(v2 + 12) != 0) {
        // 0x8f67a120
        v4 = g21;
        v3 = &g21;
    ...
    // 0x8f67a144
    int32_t v10;
    if (__utags_init(a1, a2, g51, 0, a1, v1, g53, g54, g55, g45, v10, 0, 0) != 0) {
        // 0x8f67a188
        if (v1 != g44) {
            // 0x8f67a198
            __stack_chk_fail();
