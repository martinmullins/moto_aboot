...
// Address range: 0x8f67a690 - 0x8f67a78b
int32_t __utag_define(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t result = g15;
    int32_t v1 = get_utags(a1, a2, a3); // R5
    char * mem = calloc(1, 564); // 0x8f67a6c4
    int32_t v2 = (int32_t)mem; // 0x8f67a6c4_5
    int32_t v3 = v2; // R4
    if (mem == NULL) {
        // 0x8f67a6d0
        print_log(-1, (int32_t)"ERROR: out of memory!\n", a3, result, a1, result, a3, g36, g37, g38, g39, g40, g41);
        // branch -> 0x8f67a764
    } else {
        // 0x8f67a6e4
        strlcpy(v2 + 8, a2, 32, result, a1);
        int32_t v4 = strlcat(v3 + 40, a3, 512, result, a1, result, a3, g36, g37, g38, g39, g40); // 0x8f67a700
        int32_t v5 = &g4; // R3
        int32_t v6;
        *(int32_t *)(v3 + 560) = v6;
        *(int32_t *)(v3 + 552) = a4;
        *(int32_t *)(v3 + 556) = a5;
        int32_t v7 = g4 + 1; // 0x8f67a71c
        *(int32_t *)v5 = v7;
        if (v7 == 1) {
            // 0x8f67a72c
        ...
        int32_t v8 = v1 + 56; // 0x8f67a734
        *(int32_t *)v3 = *(int32_t *)v8;
        *(int32_t *)(v3 + 4) = v8;
        *(int32_t *)(*(int32_t *)(v1 + 56) + 4) = v3;
        *(int32_t *)(v1 + 56) = v3;
        int32_t v9 = g4 - 1; // 0x8f67a74c
        *(int32_t *)v5 = v9;
        if (v9 == 0) {
            // 0x8f67a75c
            function_8f619438();
