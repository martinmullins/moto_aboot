...
// Address range: 0x8f64bbac - 0x8f64bc0f
int32_t _fdt_check_prop_offset(int32_t a1) {
    int32_t v1 = g26; // 0x8f64bbac
    int32_t v2 = g21; // bp-20
    int32_t v3 = g15;
    g26 = &g15;
    int32_t v4 = v3;
    int32_t result = -4;
    if (g21 > -1 && g21 % 4 == 0) {
        // 0x8f64bbdc
        int32_t v5;
        int32_t v6 = fdt_next_tag(a1, g21, (int32_t)&v2, (int32_t)&g15, a1, g21, g24, v3, v1, g19, v5, 0, 0); // 0x8f64bbe0
        v4 = g15;
        result = v6 == 3 ? v2 : -4;
        // branch -> 0x8f64bbf0
    }
