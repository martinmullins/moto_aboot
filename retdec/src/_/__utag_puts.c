...
// Address range: 0x8f628168 - 0x8f628287
char * __utag_puts(int32_t a1, char * str2) {
    int32_t str;
    int32_t v1 = &str; // 0x8f62817c_0
    int32_t v2 = 31; // R2
    int32_t v3 = g8;
    strncpy((char *)&str, str2, 31);
    int32_t v4 = 58; // R1
    char * found_char_pos = strrchr((char *)&str, 58); // 0x8f6281a0
    int32_t v5;
    int32_t v6 = type_atoi_9((int32_t)(found_char_pos != NULL) + (int32_t)found_char_pos, v4, v2, 0, v5, str); // 0x8f6281ac
    int32_t v7; // 0x8f628200
    int32_t v8; // 0x8f628220
    int32_t v9; // 0x8f628254
    int32_t v10;
    if (v6 != 0) {
        // 0x8f6281f8
        if (v6 == 255) {
            // 0x8f628200
            v7 = type_itoa_8(255, v4, v2);
            print_log(-1, (int32_t)"Error: not a string type: %s\n", v7, 0, v5, str, 0, 0, 0, 0, 0, 0, 0);
            // branch -> 0x8f62823c
            // 0x8f62823c
            // branch -> 0x8f628258
            // 0x8f628258
        ...
        // 0x8f628218
        v8 = strnlen((char *)g10, 1024);
        if (v8 == 1024) {
            // 0x8f628230
            print_log(-1, (int32_t)"Error: string too long\n", v2, 1024, v5, str, 0, 0, 0, 0, 0, 0, 0);
            // branch -> 0x8f62823c
            // 0x8f62823c
            v10 = 0;
            // branch -> 0x8f628258
            ...
            // 0x8f628244
            v9 = __utag_write(a1, v1, g10, v8 + 1, v5, str, 0, 0, 0, 0, 0, 0, 0, v3, g12, g13, g14);
            v10 = v9;
            // branch -> 0x8f628258
        }
        // 0x8f628258
    ...
    if (a1 != 1) {
        // 0x8f6281c0
        strlcat(v1, (int32_t)&g3, 31, 0, v5, str, 0, 0, 0, 0, 0, 0);
        v2 = 31;
        strlcat(v1, (int32_t)"str", 31, 0, v5, str, 0, 0, 0, 0, 0, 0);
        v4 = 58;
        char * found_char_pos2 = strrchr((char *)&str, 58); // 0x8f6281e8
        // branch -> 0x8f6281f8
        // 0x8f6281f8
        if (type_atoi_9((int32_t)(found_char_pos2 != NULL) + (int32_t)found_char_pos2, v4, v2, 0, v5, str) == 255) {
            // 0x8f628200
            v7 = type_itoa_8(255, v4, v2);
            print_log(-1, (int32_t)"Error: not a string type: %s\n", v7, 0, v5, str, 0, 0, 0, 0, 0, 0, 0);
            // branch -> 0x8f62823c
