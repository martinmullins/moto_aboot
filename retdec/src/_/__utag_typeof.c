...
// Address range: 0x8f67a63c - 0x8f67a68f
char * __utag_typeof(void) {
    // 0x8f67a63c
    int32_t v1;
    int32_t str = v1; // bp-44
    int32_t v2 = &str; // 0x8f67a648_0
    int32_t v3 = g23;
    int32_t v4;
    __utag_longnameof(g25, g26, v2, v3, v4, v1);
    char * found_char_pos = strrchr((char *)&str, 58); // 0x8f67a660
    char * result = (char *)type_atoi_106((char *)((int32_t)(found_char_pos != NULL) + (int32_t)found_char_pos), 58, v2, v3, v4);
    if (v3 != g23) {
        // 0x8f67a680
        __stack_chk_fail();
        // branch -> 0x8f67a684
