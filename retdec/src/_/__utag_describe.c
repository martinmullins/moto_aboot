...
// Address range: 0x8f67ab88 - 0x8f67ac3f
int32_t __utag_describe(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g23; // 0x8f67ab88
    int32_t v2 = g25; // 0x8f67ab88
    g25 = a2;
    int32_t v3 = g15;
    int32_t v4 = get_utags(a1, a2, a3); // 0x8f67aba0
    int32_t v5 = g3;
    g23 = &g3;
    int32_t v6 = v5 + 1; // 0x8f67abb0
    g3 = v6;
    int32_t v7 = v4; // 0x8f67abc8
    if (v5 == 0) {
        // 0x8f67abc4
    ...
    int32_t v8 = *(int32_t *)(v7 + 60); // 0x8f67abc8
    int32_t v9 = v8; // R4
    int32_t v10 = v7 + 56; // 0x8f67abcc
    int32_t v11; // 0x8f67ac04
    if (v8 == v10) {
        // 0x8f67abfc
        // branch -> 0x8f67ac00
        // 0x8f67ac00
    ...
    while (true) {
        int32_t v12 = names_match(v8 + 8, g25, v6, (int32_t)&g3); // 0x8f67abe0
        int32_t v13 = v9;
        if (v12 != 0) {
            int32_t v14 = v13 + 40; // 0x8f67abec
            int32_t result = v14; // R6
            if (v14 != 0) {
                // 0x8f67ac00
                v11 = g3 - 1;
                *(int32_t *)g23 = v11;
        ...
        int32_t v15 = *(int32_t *)(v13 + 4); // 0x8f67abf4
        v9 = v15;
        if (v15 == v10) {
            // break -> 0x8f67abfc
            break;
