...
// Address range: 0x8f679d80 - 0x8f679e5b
int32_t __utags_walk_existing(int32_t a1, int32_t (*a2)(int32_t, int32_t, int32_t), int32_t a3) {
    int32_t v1 = (int32_t)a2;
    g49 = v1;
    g52 = a3;
    int32_t v2 = g54; // 0x8f679d80
    int32_t v3 = g55; // 0x8f679d80
    int32_t v4 = g56; // 0x8f679d80
    int32_t v5 = g57; // 0x8f679d80
    int32_t v6 = g58; // 0x8f679d80
    int32_t v7 = g59; // 0x8f679d80
    g57 = v1;
    g56 = a1;
    g59 = a3;
    int32_t v8 = g43;
    g58 = &g43;
    int32_t v9 = get_utags(a1, v1, a3); // 0x8f679da0
    int32_t result = -1;
    if (g57 != 0) {
        int32_t v10 = *(int32_t *)(v9 + 12); // 0x8f679db8
        int32_t v11;
        int32_t v12;
        int32_t v13; // 0x8f679dc4
        int32_t v14; // 0x8f679e00
        int32_t v15; // 0x8f679dd0
        int32_t v16; // 0x8f679df0
        if (v10 == 0) {
            // 0x8f679ddc
            result = -1;
            if (__utags_init(g56, g49, g52, 0, a1, v8, a3, v2, v3, v4, v5, v6, v7) == 0) {
                // 0x8f679ddc
                // branch -> 0x8f679dc4
                // 0x8f679dc4
                v13 = v9 + 20;
                g55 = v13;
                mutex_acquire(v13, g49, g52, v10, a1, v8, a3, v2, v3, v4, v5);
                v15 = *(int32_t *)(v9 + 12);
                g53 = v15;
                v12 = *(int32_t *)(v15 + 48);
                g54 = v12;
                if (v12 != 0) {
                    ...
                    while (true) {
                        ...
                        if (v16 == 0) {
                            ...
                            // branch -> 0x8f679e30
                            // 0x8f679e30
                            mutex_release(g55, g49, g52, g53, v11, 0, 0);
                            // branch -> 0x8f679e3c
                            // 0x8f679e3c
                            if (v8 != g43) {
                                // 0x8f679e4c
                      ...
                      lab_0x8f679dfc:;
                        int32_t v17 = g56; // 0x8f679dfc
                        g48 = v17;
                        g49 = v14;
                        int32_t v18 = g59; // 0x8f679e04
                        g52 = v18;
                        g47 = -0x709861f4;
                        ((int32_t (*)(int32_t, int32_t, int32_t))g57)(v17, v14, v18);
                        if (g48 == 0) {
                            int32_t v19 = *(int32_t *)(g54 + 48);
                            g54 = v19;
                            if (v19 == 0) {
                                // break -> 0x8f679e30
                                break;
