...
// Address range: 0x8f61d7f4 - 0x8f61d993
int32_t __utag_gets_constprop_3_6(char * a1, int32_t a2) {
    // 0x8f61d7f4
    int32_t v1;
    int32_t str = v1; // bp-68
    int32_t v2 = (int32_t)a1;
    int32_t v3 = g31; // 0x8f61d7f4
    int32_t v4 = g33; // 0x8f61d7f4
    g33 = v2;
    g32 = a2;
    int32_t v5 = g17;
    g30 = v5;
    int32_t v6;
    uint32_t v7 = __utag_sizeof(NULL, v2, g29, v5, v6, v1, 0, 0, 0); // 0x8f61d81c
    g31 = v7;
    if (v7 == 0) {
        // after_if_8f61d834_0.thread
        // branch -> 0x8f61d944
        // 0x8f61d944
        if (v7 > g29) {
            // 0x8f61d94c
    ...
    // 0x8f61d840
    if (__utag_read(NULL, g33, g32, v7, v6, v1, 0, 0, 0, 0, 0, 0, 0) == 0) {
        // 0x8f61d95c
        if (v5 != g17) {
            // 0x8f61d96c
            __stack_chk_fail();
    ...
    int32_t v8 = g31; // 0x8f61d85c
    int32_t v9 = g32 + v8; // 0x8f61d85c
    int32_t v10; // 0x8f61d884_0
    char * found_char_pos; // 0x8f61d89c
    int32_t v11; // 0x8f61d8a8
    char * found_char_pos2; // 0x8f61d8dc
    int32_t v12; // 0x8f61d8e8
    int32_t v13; // 0x8f61d91c
    int32_t result;
    int32_t v14; // 0x8f61d8ec
    if (*(char *)(v9 - 1) == 0) {
        // 0x8f61d87c
        v10 = &str;
        strncpy((char *)&str, (char *)g33, 31);
        found_char_pos = strrchr((char *)&str, 58);
        v11 = type_atoi_5((char *)((int32_t)(found_char_pos != NULL) + (int32_t)found_char_pos), 58, 31);
        v14 = v11;
        if (v11 == 0) {
            // 0x8f61d8b4
            strlcat(v10, (int32_t)&g5, 31, g30, v6, str, 0, 0, 0, 0, 0, 0);
            strlcat(v10, (int32_t)"str", 31, g30, v6, str, 0, 0, 0, 0, 0, 0);
            found_char_pos2 = strrchr((char *)&str, 58);
            v12 = type_atoi_5((char *)((int32_t)(found_char_pos2 != NULL) + (int32_t)found_char_pos2), 58, 31);
            v14 = v12;
            // branch -> 0x8f61d8ec
        }
        // 0x8f61d8ec
        ...
        // 0x8f61d90c
        v13 = __utag_validate(NULL, v10, g32, g31, v6, str, 0, 0, 0, 0, 0, 0, 0, v5);
        g31 = v13;
        if (v13 == 0) {
            // 0x8f61d92c
