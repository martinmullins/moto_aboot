...
// Address range: 0x8f67a3d0 - 0x8f67a48f
int32_t __utag_unprotect(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g11;
    int32_t v2 = &g1; // R4
    int32_t v3 = g1;
    int32_t v4 = v3 + 1; // 0x8f67a3f4
    g1 = v4;
    if (v3 == 0) {
        // 0x8f67a404
    ...
    // 0x8f67a408
    int32_t v5;
    int32_t v6 = __find_first_utag(a1, a2, v4, (int32_t)&g11, a1, v1, a3, g18, g19, g20, g21, g12, v5, 0); // 0x8f67a410
    int32_t v7 = g1;
    int32_t result;
    if (v6 == 0) {
        int32_t v8 = v7 - 1; // 0x8f67a420
        *(int32_t *)v2 = v8;
        if (v8 == 0) {
            // 0x8f67a430
            function_8f619438();
        ...
        int32_t * v9 = (int32_t *)(v6 + 36); // 0x8f67a43c_0
        int32_t v10 = v7 - 1; // 0x8f67a440
        *(int32_t *)v2 = v10;
        *v9 = *v9 & -2;
        if (v10 == 0) {
            // 0x8f67a458
