...
// Address range: 0x8f612158 - 0x8f6121db
int32_t spmi_irq(int32_t a1, int32_t a2) {
    int32_t v1 = g31; // 0x8f61215c
    int32_t v2 = g34; // 0x8f61215c
    g32 = 0;
    int32_t v3 = g23;
    g34 = &g23;
    g35 = &g11;
    int32_t v4 = 0; // 0x8f612178
    // branch -> 0x8f612174
    while (true) {
        int32_t v5 = 8 * v4; // 0x8f612178
        g33 = v5;
        int32_t v6 = g11 + 0x3900; // 0x8f61217c
        int32_t v7 = *(int32_t *)(0x1000 * v6 + v4); // 0x8f612180
        g31 = v7;
        int32_t v8 = v4; // 0x8f6121a8
        if (v7 != 0) {
            while (true) {
                int32_t v9 = v5; // 0x8f6121a0
                uint32_t v10 = v7; // 0x8f61219c
                if (v7 % 2 != 0) {
                    // 0x8f612194
                    spmi_acc_irq(v5, a2, v3, v6, a1, v3, v1);
                    v9 = g33;
                    v10 = g31;
                    // branch -> 0x8f61219c
                }
                int32_t v11 = v10 / 2; // 0x8f61219c
                g31 = v11;
                int32_t v12 = v9 + 1; // 0x8f6121a0
                g33 = v12;
                if (v10 < 2) {
                    // break -> 0x8f612184
                    break;
