...
// Address range: 0x8f61dad0 - 0x8f61db1b
int32_t ramdump_mode(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g18;
    *(char *)&g6 = 7;
    int32_t result = pmic_set_chg_set_mode(0, a2, 7, (int32_t)&g6, a1); // 0x8f61daf0
    if (v1 == g18) {
        // 0x8f61db08
        int32_t v2;
        return sod_ramdump_run(result, a2, v1, v1, g24, g19, v2, 0, 0, 0);
    }
    // 0x8f61db04
    __stack_chk_fail();
    return result;
