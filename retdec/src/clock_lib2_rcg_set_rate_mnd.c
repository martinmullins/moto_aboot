...
// Address range: 0x8f60d1c0 - 0x8f60d257
int32_t clock_lib2_rcg_set_rate_mnd(int32_t * a1, int32_t a2) {
    int32_t v1 = (int32_t)a1;
    *(int32_t *)*(int32_t *)(v1 + 8) = *(int32_t *)(a2 + 12);
    int32_t * v2 = (int32_t *)(a2 + 16); // 0x8f60d1e0_0
    *(int32_t *)*(int32_t *)(v1 + 12) = *v2;
    *(int32_t *)*(int32_t *)(v1 + 16) = *(int32_t *)(a2 + 20);
    int32_t result = *v2; // 0x8f60d1fc
    int32_t * v3 = (int32_t *)*(int32_t *)(v1 + 4); // 0x8f60d200_0
    int32_t v4 = *v3 & -0x3320 | *(int32_t *)(a2 + 8); // 0x8f60d210
    *v3 = result == 0 ? v4 : v4 | 0x2000;
    int32_t v5 = *a1; // 0x8f60d21c
    int32_t * v6 = (int32_t *)v5; // 0x8f60d220_0
    *v6 = *v6 | 1;
    // branch -> 0x8f60d22c
    while (*(int32_t *)v5 % 2 != 0) {
        // 0x8f60d22c
        // continue -> 0x8f60d22c
    }
    // 0x8f60d24c
