...
// Address range: 0x8f645e44 - 0x8f645edf
int32_t enable_usbin_valid_irq(int32_t a1, int32_t a2) {
    int32_t v1 = g65; // 0x8f645e44
    int32_t v2 = g66; // 0x8f645e44
    g65 = &g57;
    g66 = a1;
    int32_t v3 = g57;
    int32_t v4;
    int32_t v5 = pm8x41_masked_reg_write(a1 & -0x10000 | 0x1311, 2, 2, v3, v4, 0, 0, v3, 0); // 0x8f645e68
    pm8x41_masked_reg_write(pm8x41_masked_reg_write(v5 & -0x10000 | 0x1312, 2, 2, v3, v4, 0, 0, v3, 0) & -0x10000 | 0x1313, 2, 2, v3, v4, 0, 0, v3, 0);
    int32_t v6;
    register_spmi_int_handler(5, 1, 153, (int32_t)&g10, a1, 0, 0, v3, 0, v1, v2, g58, v6, 0, 0);
    g60 = 1;
    int32_t result = pm8x41_irq_mask_ack(153, 1, 153, (int32_t)&g10, a1, 0, 0, v3); // 0x8f645eac
    g59 = result;
    g63 = v3;
    int32_t v7 = g57;
    g64 = v7;
    ...
    g65 = v1;
    g66 = v2;
    int32_t result2 = pm8x41_reg_write(result & -0x10000 | 0x1315, 2, v3, v3, v1, v2, g58, v6, 0, 0, 0); // 0x8f645ed4
    g59 = result2;
    return result2;
}
