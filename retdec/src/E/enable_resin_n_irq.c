...
// Address range: 0x8f645d4c - 0x8f645dfb
int32_t enable_resin_n_irq(int32_t a1) {
    int32_t v1 = g23;
    int32_t v2;
    int32_t v3 = pm8x41_reg_read(a1 & -0x10000 | 2065, g27, g29, v1, a1, g27, g29, v1, g31, g25, v2); // 0x8f645d60
    int32_t v4 = v3 & 253 | 2; // 0x8f645d6c
    int32_t v5 = pm8x41_reg_write(v3 & -0x10000 | 2065, v4, g29, v1, a1, g27, g29, v1, g31, g25, v2); // 0x8f645d70
    int32_t v6 = pm8x41_reg_read(v5 & -0x10000 | 2066, v4, g29, v1, a1, g27, g29, v1, g31, g25, v2); // 0x8f645d78
    int32_t v7 = v6 & 253 | 2; // 0x8f645d84
    int32_t v8 = pm8x41_reg_write(v6 & -0x10000 | 2066, v7, g29, v1, a1, g27, g29, v1, g31, g25, v2); // 0x8f645d88
    int32_t v9 = pm8x41_reg_read(v8 & -0x10000 | 2067, v7, g29, v1, a1, g27, g29, v1, g31, g25, v2); // 0x8f645d90
    pm8x41_reg_write(v9 & -0x10000 | 2067, v9 & 253 | 2, g29, v1, a1, g27, g29, v1, g31, g25, v2);
    register_spmi_int_handler(1, 1, 65, (int32_t)&g1, 0, g27, g29, v1, g31, g25, v2, 0, 0, 0, 0);
    int32_t result = pm8x41_irq_mask_ack(65, 1, 65, (int32_t)&g1, 0, g27, g29, v1); // 0x8f645dc8
    if (v1 == g23) {
        // 0x8f645de0
        return pm8x41_reg_write(result & -0x10000 | 2069, 2, v1, v1, g31, g25, v2, 0, 0, 0, 0);
    }
    // 0x8f645ddc
    __stack_chk_fail();
    return result;
