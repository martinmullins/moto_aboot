...
// Address range: 0x8f6347dc - 0x8f634847
int32_t enable_shutdown_timer(int32_t a1) {
    int32_t v1 = g30; // 0x8f6347dc
    int32_t v2 = g24; // 0x8f6347dc
    int32_t v3 = g22;
    int32_t result = get_current_boot_mode(a1, g26, g28, v3); // 0x8f6347ec
    g28 = v3;
    int32_t v4 = g22;
    g29 = v4;
    if (result == 6) {
        ...
        if (v3 == v4) {
            ...
            g24 = v2;
            int32_t v5;
            int32_t v6 = timer_set_oneshot((int32_t)&g9, 0x493e0, (int32_t)&g1, 0, v1, v2, v5); // 0x8f634820
            g26 = v6;
            return &g9;
        }
    } else {
