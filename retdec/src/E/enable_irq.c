...
// Address range: 0x8f6476fc - 0x8f647763
int32_t enable_irq(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = g32; // 0x8f6476fc
    g32 = &g26;
    int32_t result = g26;
    int32_t v2 = smb1359_masked_write_reg(a1, a2, a3 == 0 ? 0 : a2); // 0x8f647718
    int32_t v3 = g26;
    if (v2 == 0) {
        // 0x8f647748
        if (result == v3) {
        ...
        if (result == v3) {
            // 0x8f647734
            int32_t v4;
            print_log(-1, (int32_t)"smb1359 enable IRQ failed\n", result, result, v1, g27, v4, 0, 0, 0, 0, 0, 0);
            return result;
        }
    }
    // 0x8f647750
