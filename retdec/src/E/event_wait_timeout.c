...
// Address range: 0x8f61ab98 - 0x8f61ac4b
int32_t event_wait_timeout(int32_t a1, int32_t a2) {
    int32_t v1 = g45; // 0x8f61ab98
    int32_t v2 = g47; // 0x8f61ab98
    int32_t v3 = g48; // 0x8f61ab98
    g47 = a1;
    int32_t v4 = g31;
    int32_t v5 = g6;
    g48 = &g6;
    int32_t v6 = v5 + 1; // 0x8f61abc0
    g6 = v6;
    int32_t v7 = a1; // 0x8f61abec
    if (v5 == 0) {
        // 0x8f61abd0
    ...
    char * v8 = (char *)(v7 + 4); // 0x8f61abd4_0
    char v9 = *v8; // 0x8f61abd4
    int32_t v10;
    int32_t v11; // 0x8f61ac10
    int32_t result; // 0x8f61ac28
    if (v9 == 0) {
        int32_t v12 = wait_queue_block(v7 + 12, a2, (int32_t)&g31, (int32_t)v9, a1, v4, v1, v2, v3); // 0x8f61ac04
        g47 = v12;
        // branch -> 0x8f61ac0c
        // 0x8f61ac0c
        v11 = g6 - 1;
