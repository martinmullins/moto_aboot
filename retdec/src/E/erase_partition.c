...
// Address range: 0x8f622518 - 0x8f6225bb
int32_t erase_partition(int32_t a1) {
    int32_t v1 = g18;
    int32_t result = partition_get_index(a1, g21, g22, v1, a1, v1); // 0x8f62252c
    if (result == -1) {
        // 0x8f62253c
        fboot_info((int32_t)"INFO", (int32_t)"Partition not found", g22, v1, a1, v1, g22, g24, g25, g26, g27);
        // branch -> 0x8f622590
        // 0x8f622590
        if (v1 != g18) {
            // 0x8f6225a0
    ...
    int32_t v2 = partition_get_offset(result, g21, g22); // 0x8f622550
    int32_t v3 = partition_get_size(result, g21, g22, v1, a1, v1, g22, g24); // 0x8f622560
    int32_t v4;
    int32_t v5 = generic_mmc_erase_logical(v2, g21, v3, g21, a1, v1, g22, g24, g25, g26, g27, g19, v4, 0, 0, 0, 0, 0); // 0x8f622574
    int32_t result2 = v5; // R0
    int32_t v6; // 0x8f6225a8_22
    if (v5 != 0) {
        // 0x8f622580
        fboot_info((int32_t)"INFO", (int32_t)"Failed to erase partition", v3, g21, a1, v1, g22, g24, g25, g26, g27);
        result2 = -1;
        v6 = -1;
        // branch -> 0x8f622590
    } else {
