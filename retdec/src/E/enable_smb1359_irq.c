...
// Address range: 0x8f647fb0 - 0x8f64804b
int32_t enable_smb1359_irq(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g34; // 0x8f647fb0
    int32_t v2 = g29 ? -0x709a9838 : 0; // 0x8f647fb0
    g34 = &g27;
    int32_t v3 = g27;
    smb1359_stat_gpio_config(a1);
    memset((char *)&g23, 0, 112);
    thread_sleep(1, 0, 112, v3, a1, v3, v1, v2);
    int32_t v4;
    int32_t result = smb1359_masked_write_reg(23, 19, 16, v3, a1, v3, v1, v2, v4, 0, 0, 0); // 0x8f647fe8
    if (result == 0) {
        // 0x8f647ff4
        return smb1359_write_reg(7, 0);
    }
    // 0x8f64801c
    if (v3 == g27) {
        // 0x8f648030
        return enable_smb1359_stat_gpio_irq((int32_t)&g1, result, v3, v3);
    }
    // 0x8f64802c
    __stack_chk_fail();
    return result;
