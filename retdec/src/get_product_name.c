...
// Address range: 0x8f6314ac - 0x8f63153b
int32_t get_product_name(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g13;
    int32_t v2 = g4;
    int32_t v3;
    int32_t result;
    if (v2 > -1) {
        int32_t v4 = get_string_prop((int32_t)"product_name", v2, (int32_t)&g4, (int32_t)&g13, a1, v1, a3, g22); // 0x8f6314e8
        if (v4 == 0) {
            // 0x8f6314f8
            print_log(2, (int32_t)"Not found setting for %s\n", (int32_t)"product_name", (int32_t)&g13, a1, v1, a3, g22, g23, g15, v3, 0, 0);
            result = 0;
            // branch -> 0x8f63150c
        } else {
            result = v4;
        ...
        // 0x8f6314d0
        print_log(-1, (int32_t)"No product setting\n", (int32_t)&g4, (int32_t)&g13, a1, v1, a3, g22, g23, g15, v3, 0, 0);
        result = 0;
        // branch -> 0x8f63150c
    }
    // 0x8f63150c
