...
// Address range: 0x8f6634e4 - 0x8f66371f
// Used cryptographic patterns:
//  - CRC_32_IEEE_802_3_poly_0x04C11DB7 (32-bit, little endian)
int32_t dbval_sigrsp_verify_outer(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1;
    char * v2 = g23;
    dbval_debug_print2((int32_t)"Checking SigRsp Version", a2, a3);
    int32_t v3;
    *(char *)v3 = 14;
    int32_t result = 85;
    if (*(char *)(v1 + 2) == 1) {
        // 0x8f663534
        dbval_debug_print2((int32_t)"Checking SigRsp Version - Success", a2, a3);
        dbval_debug_print2((int32_t)"Checking SigRsp Message ID", a2, a3);
        *(char *)v3 = 15;
        if (*(char *)(v1 + 3) == 6) {
            // 0x8f663558
            dbval_debug_print2((int32_t)"Checking SigRsp Message ID - Success", a2, a3);
            dbval_debug_print2((int32_t)"Checking SigRsp Status", a2, a3);
            *(char *)v3 = 16;
            int32_t v4 = (int32_t)*(char *)(v1 + 4); // 0x8f663570
            if ((int32_t)*(char *)(v1 + 5) == 256 * v4) {
                // 0x8f663580
                dbval_debug_print2((int32_t)"Checking SigRsp Status - Success", a2, v4);
                dbval_debug_print2((int32_t)"Checking SigRsp CRC", a2, v4);
                *(char *)v3 = 10;
                char v5 = *(char *)(v1 + 1); // 0x8f6635a0
                int32_t v6 = (int32_t)v5 | 256 * (int32_t)*(char *)v1; // 0x8f6635a8
                int32_t v7 = v6 - 4; // 0x8f6635b0
                int32_t v8 = 0; // 0x8f6635e0
                if (v7 != 0) {
                    int32_t v9 = v6 - 5;
                    uint32_t v10 = -1; // 0x8f6635d0
                    int32_t v11 = v1; // 0x8f6635c0
                    unsigned char v12 = *(char *)v11; // 0x8f6635c0
                    int32_t v13 = *(int32_t *)(4 * ((int32_t)v12 ^ v10 % 256) + (int32_t)&CRC_32_IEEE_802_3_poly_0x04C11DB7_at_8f6a5fe0); // 0x8f6635cc
                    int32_t v14 = v13 ^ v10 / 256; // 0x8f6635d0
                    while (v9 != 0) {
                        // 0x8f6635c0
                        v9--;
                        v10 = v14;
                        v11++;
                        v12 = *(char *)v11;
                        v13 = *(int32_t *)(4 * ((int32_t)v12 ^ v10 % 256) + (int32_t)&CRC_32_IEEE_802_3_poly_0x04C11DB7_at_8f6a5fe0);
                        v14 = v13 ^ v10 / 256;
                        // continue -> 0x8f6635c0
                    }
                    // 0x8f6635b8
                ...
                int32_t v15 = v7 + v1; // 0x8f6635d8
                char v16 = *(char *)v15; // 0x8f6635dc
                char v17 = *(char *)(v15 + 1); // 0x8f6635e4
                char v18 = *(char *)(v15 + 3); // 0x8f6635f0
                int32_t v19 = 0x10000 * (int32_t)v17 | 0x1000000 * (int32_t)v16 | (int32_t)v18; // 0x8f6635f8
                if ((256 * (int32_t)*(char *)(v15 + 2) || v19) == v8) {
                    int32_t v20 = (int32_t)*(char *)(v1 + 1) | 256 * (int32_t)*a1; // 0x8f663608
                    int32_t v21 = v20 - 2536; // 0x8f663618
                    int32_t v22 = v21 + v1; // R11
                    dbval_debug_print2((int32_t)"Checking SigRsp CRC - Success", v19, v21);
                    *(char *)v3 = 6;
                    dbval_debug_print2((int32_t)"CID OVERRIDE: SigRsp Serial Number Type & Length", v19, v21);
                    dbval_debug_print2((int32_t)"Checking SigRsp IMEI - Success", v19, v21);
                    *(char *)v3 = 12;
                    dbval_debug_print2((int32_t)"dbval_sigrsp_verify_outer - Check SigRsp Signature", v19, v21);
                    int32_t v23 = v22 - v1; // 0x8f66365c
                    int32_t v24 = dbval_validate_signature(v1, v23, v22, 128, v1 + v20 - 2408, 0, 0, (int32_t)v2, 0, g30, g31, g32, g33, g34, g35, g27, g28, 0, v3, 0, 0, 0); // 0x8f663668
                    if (v24 == 15) {
                        // 0x8f663678
                        *(char *)v3 = 7;
                        dbval_debug_print2((int32_t)"dbval_sigrsp_verify_outer - Check Nonce", v23, v22);
                        if (dbval_memcmp(v1 + 136, a2, 16, 7) == 0) {
                            // 0x8f6636a0
                            *(char *)v3 = 9;
                            dbval_debug_print2((int32_t)"dbval_sigrsp_verify_outer - Number of DB", a2, 16);
                            char v25 = *(char *)(v1 + 152); // 0x8f6636b0
                            char v26 = *(char *)(v1 + 153); // 0x8f6636b4
                            int32_t v27 = a3 == ((int32_t)v26 | 256 * (int32_t)v25) ? v24 : 85;
                            result = v27;
                            // branch -> 0x8f6636c8
                        } else {
                            result = 85;
