...
// Address range: 0x8f628104 - 0x8f628167
int32_t is_utags_ext_locked_constprop_30(int32_t a1, int32_t a2) {
    int32_t v1 = g8;
    int32_t v2 = __utags_is_protected(1, a2, g10, v1, a1, v1, g12, 0); // 0x8f628118
    int32_t result = v2; // R0
    int32_t v3 = 0; // 0x8f628158_22
    if (v2 != 0) {
        // 0x8f628124
        int32_t v4;
        fboot_info((int32_t)"INFO", (int32_t)"utags [%s] is locked", get_utags_name(1, a2, g10, v1), v1, a1, v1, g12, 0, v4, 0, 0);
        result = -1;
        v3 = -1;
        // branch -> 0x8f628140
    }
