...
// Address range: 0x8f60077c - 0x8f60088b
int32_t target_serialno(char * a1, int32_t a2) {
    int32_t str = (int32_t)a1; // 0x8f60077c_0
    int32_t v1 = g26; // 0x8f60077c
    g26 = &g15;
    int32_t v2 = g15;
    int32_t v3;
    int32_t v4 = __utag_gets_constprop_3((int32_t)"serialno", str, g24, v2, str, v2, v1, g27, g28, g19, v3, 0); // 0x8f60079c
    int32_t dest_str = v4; // R0
    int32_t v5 = v4; // 0x8f600870_22
    if (v4 == 0) {
        int32_t v6 = __utag_gets_constprop_3((int32_t)"barcode", str, g24, v2, str, v2, v1, g27, g28, g19, v3, 0); // 0x8f6007b0
        dest_str = v6;
        if (v6 == 0) {
            int32_t str2 = fti_serialno(0, str, g24, v2, str, v2, v1, g27, g28, g19, v3); // 0x8f6007bc
            if (str2 != 0) {
                // 0x8f6007c8
                if (v2 == g15) {
                    // 0x8f6007d8
                    g26 = v1;
                    return (int32_t)strncpy((char *)str, (char *)str2, 17);
                }
                // 0x8f600868
                __stack_chk_fail();
                // branch -> 0x8f60086c
            ...
            int32_t v7 = target_is_emmc_boot(0, 0, g24, v2); // 0x8f6007ec
            if (v7 == 0) {
                // 0x8f600828
                dest_str = (int32_t)strcpy((char *)str, "(null)");
                if (v2 == g15) {
                    // 0x8f600844
                    g26 = v1;
                    return print_log(v7, (int32_t)"Error: failed to read device SN\n", v2, v2, v1, g27, g28, g19, v3, 0, 0, 0, 0);
                }
            } else {
                int32_t v8 = mmc_get_psn(v7, 0, g24, v2); // 0x8f6007f8
                dest_str = v8;
                if (v2 == g15) {
                    // 0x8f600810
                    g26 = v1;
                    return snprintf((char *)str, 13, "%x", v8);
                }
            }
            // 0x8f600868
            __stack_chk_fail();
