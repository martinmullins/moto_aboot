...
// Address range: 0x8f61e22c - 0x8f61e277
int32_t is_charger_mode(char * a1, int32_t a2) {
    int32_t v1 = g42; // 0x8f61e22c
    g42 = &g31;
    int32_t v2 = g31;
    int32_t result = 0;
    int32_t v3;
    if (get_powerup_reason(a1, a2, g40, v2, (int32_t)a1, v2, v1, g37, v3, 0, 0, 0, 0, 0, 0, 0, 0) == 256) {
        // 0x8f61e24c
        result = disable_charger_mode(256, a2) % 256 ^ 1;
        // branch -> 0x8f61e258
    }
    // 0x8f61e258
    if (v2 != g31) {
