...
// Address range: 0x8f646fe0 - 0x8f64707f
int32_t oem_smb1359_usage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g26;
    int32_t v2;
    fboot_info((int32_t)"INFO", (int32_t)"usage: fastboot oem smb1359 [options]", a3, v1, a1, v1, g32, g27, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)&g2, a3, v1, a1, v1, g32, g27, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"options:", a3, v1, a1, v1, g32, g27, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  rd <reg>          read a register", a3, v1, a1, v1, g32, g27, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  wr <reg> <value>  write a register", a3, v1, a1, v1, g32, g27, v2, 0, 0);
    int32_t result2 = fboot_info((int32_t)"INFO", (int32_t)"  help              show usage", a3, v1, a1, v1, g32, g27, v2, 0, 0); // 0x8f647034
    if (v1 == g26) {
        int32_t result = fboot_info((int32_t)"INFO", (int32_t)&g2, v1, v1, g32, g27, v2, 0, 0, 0, 0); // 0x8f64705c
        return result;
    }
    // 0x8f647048
    __stack_chk_fail();
