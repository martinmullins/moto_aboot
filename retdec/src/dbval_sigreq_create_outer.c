...
// Address range: 0x8f6633d4 - 0x8f6634e3
int32_t dbval_sigreq_create_outer(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1; // R4
    int32_t v2 = g11;
    int32_t v3;
    int32_t v4 = dbval_pal_get_serial_num_type((int32_t)&v3, a2, a3, v2); // 0x8f6633f8
    *(char *)(v1 + 83) = (char)g17;
    *(char *)(v1 + 70) = (char)v3;
    *(char *)(v1 + 1) = 1;
    uint32_t v5 = g17 / 256; // 0x8f663414
    *(char *)(v1 + 82) = (char)v5;
    dbval_debug_print2((int32_t)"dbval_sigreq_create_outer: Generate Rand", a2, v4);
    if (dbval_pal_rand(a2, 16, v4, v5) != 15) {
        // 0x8f6634ac
        // branch -> 0x8f6634b0
        // 0x8f6634b0
        if (v2 != g11) {
    ...
    int32_t v6 = v1 + 2; // R6
    dbval_memcpy(v1 + 66, a2, 16, v5);
    dbval_memset(v6, 0, 64, v5);
    dbval_debug_print2((int32_t)"dbval_sigreq_create_outer: Read Serial Number Data", 0, 64);
    int32_t v7;
    int32_t result = &v7; // 0x8f663468_0
    *(char *)v1 = 2;
    if (dbval_pal_get_primary_serial_number(result, 0, 64, 2) == 15) {
        // 0x8f663480
        dbval_debug_print2((int32_t)"dbval_sigreq_create_outer - Success", 0, 64);
        *(char *)v1 = 0;
        dbval_memcpy(v6, result, 8, 0);
        // branch -> 0x8f6634b0
    } else {
        // 0x8f6634a4
        dbval_debug_print2((int32_t)"dbval_sigreq_create_outer - ERROR getting PSN", 0, 64);
        // branch -> 0x8f6634ac
        // 0x8f6634ac
        result = 85;
        // branch -> 0x8f6634b0
