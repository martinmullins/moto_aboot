...
// Address range: 0x8f63c4cc - 0x8f63c5cb
int32_t screen_ondraw(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t result = 0; // R5
    int32_t v1 = g47;
    mutex_acquire((int32_t)&g43, a2, a3, v1, a1, v1, g51, g52, g53, 0, a5);
    int32_t v2 = g44; // R4
    g44 = result;
    int32_t result3 = mutex_release((int32_t)&g43, a2, a3, (int32_t)&g44, a1, v1, g51); // 0x8f63c4f8
    if (v2 < result) {
        // 0x8f63c504
    ...
    // 0x8f63c510
    if ((v2 & 0x1000000) != 0) {
        int32_t result2 = display_clear_rows(0, g42, 0, (int32_t)&g42, a1, v1, g51, g52, g53, 0, a5, 0, 0); // 0x8f63c528
        return result2;
    }
    // 0x8f63c568
    if ((v2 & 0x2000000) != 0) {
        // 0x8f63c570
        return menu_ondraw(result3, a2, a3, g26, a1, v1, g51, g52, g53, 0, a5);
    }
    // 0x8f63c580
    if (v1 == g47) {
        // 0x8f63c594
