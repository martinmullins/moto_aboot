...
// Address range: 0x8f6501bc - 0x8f6502a7
int32_t display_set_margin(int32_t a1, int32_t a2) {
    int32_t v1 = (bool)(a1 == 4); // 0x8f6501dc
    if ((a1 & 251) == 0) {
        // if_8f6501e4_0_true
        g12 = a2;
        // branch -> after_if_8f6501e4_0
    }
    // after_if_8f6501e4_0
    if ((v1 || (int32_t)(a1 == 1)) != 0) {
        // if_8f6501fc_0_true
        g13 = a2;
        // branch -> after_if_8f6501fc_0
    }
    // after_if_8f6501fc_0
    if ((a1 - 3) % 256 < 2) {
        // if_8f650208_0_true
        g15 = a2;
        // branch -> after_if_8f650208_0
    }
    // after_if_8f650208_0
    if ((v1 || (int32_t)(a1 == 2)) != 0) {
        // if_8f650228_0_true
        g14 = a2;
        // branch -> after_if_8f650228_0
    }
    char result = *(char *)&g18; // 0x8f65022c
    if (g13 + g12 < (result == 0 ? g17 : g16)) {
        // if_8f650250_0_true
        g12 = 0;
        g13 = 0;
        // branch -> after_if_8f650258_0
    }
    int32_t v2 = g17; // 0x8f65026c
    if (result == 0) {
        // if_8f650264_0_true
        v2 = g16;
        // branch -> after_if_8f650264_0
    }
    // after_if_8f650264_0
    if (g14 + g15 < v2) {
        // if_8f650270_0_true
