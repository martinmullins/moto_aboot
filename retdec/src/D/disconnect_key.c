...
// Address range: 0x8f638764 - 0x8f6387bf
int32_t disconnect_key(void) {
    int32_t v1 = g40; // 0x8f638764
    int32_t v2 = g32;
    int32_t v3 = timer_cancel((int32_t)&g22, g36, g38, v2, g35, v2, v1, g34); // 0x8f638778
    int32_t result = is_key_connected(v3, g36); // 0x8f63877c
    g38 = v2;
    int32_t v4 = g32;
    g39 = v4;
    if (result == 0) {
        ...
        if (v2 == v4) {
            // 0x8f638798
            g40 = v1;
            g38 = disconnect_from_key(result, g36, v2);
            return result;
        }
    }
    // 0x8f6387ac
