...
// Address range: 0x8f61e1c8 - 0x8f61e22b
int32_t disable_charger_mode(int32_t a1, int32_t a2) {
    int32_t str = a2; // bp-20
    int32_t v1 = g31;
    int32_t v2;
    int32_t v3 = __utag_gets_constprop_3_6((int32_t)"charger_disable", (int32_t)&str, 8, v1, a1, a2, g40, v1, g42, g37, v2, 0, 0); // 0x8f61e1e4
    int32_t result = v3; // R0
    int32_t v4 = 0; // 0x8f61e21c_22
    if (v3 != 0) {
        uint32_t strcmp_rc = strcmp((char *)&str, "true"); // 0x8f61e1f8
        int32_t v5 = strcmp_rc > 1 ? 0 : 1 - strcmp_rc; // 0x8f61e1fc
        result = v5;
        v4 = v5;
        // branch -> 0x8f61e204
    }
