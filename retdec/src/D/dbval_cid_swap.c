...
// Address range: 0x8f662e60 - 0x8f662f07
int32_t dbval_cid_swap(int32_t a1, int32_t a2, char * str) {
    int32_t v1 = g80; // 0x8f662e60
    int32_t v2 = g82; // 0x8f662e60
    int32_t v3; // bp-32
    int32_t v4 = &v3; // 0x8f662e60_1
    g80 = &g73;
    g82 = a2;
    int32_t v5 = g73;
    v3 = 0;
    int32_t result;
    if (strcmp(str, "factory") == 0) {
        // 0x8f662ec0
        result = 85;
        if (g82 >= 98) {
            // 0x8f662ecc
            dbval_memcpy(a1 + 126, v4, 2, -1);
            result = 15;
            // branch -> 0x8f662ee0
        }
        // 0x8f662ee0
    ...
    // 0x8f662ea0
    if (strcmp((char *)(int32_t)str, "google") != 0) {
        // 0x8f662ee0
        if (v5 != g73) {
            // 0x8f662ef0
            __stack_chk_fail();
