...
// Address range: 0x8f6500ec - 0x8f65017f
int32_t display_turn_off(int32_t a1, int32_t a2) {
    int32_t v1 = g46; // 0x8f6500ec
    int32_t v2 = g47; // 0x8f6500ec
    g47 = &g27;
    int32_t v3 = g27;
    int32_t v4;
    int32_t result2 = print_log(2, (int32_t)"%s is called \n", (int32_t)"display_turn_off", v3, a1, v3, v1, v2, g48, g41, v4, 0, 0); // 0x8f650108
    g48 = &g6;
    if (g6 == 0) {
        // 0x8f650124
        if (g7 == 1) {
            // 0x8f650130
            g7 = 0;
            int32_t v5 = backlight_turn_off(result2, 1, 0); // 0x8f650134
            int32_t result = display_shutdown(v5, 1, 0, (int32_t)&g7, a1, v3, v1); // 0x8f650138
            // branch -> 0x8f650148
            // 0x8f650148
            *(int32_t *)g48 = 2;
            if (v3 != g27) {
