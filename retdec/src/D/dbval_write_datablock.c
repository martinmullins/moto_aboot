...
// Address range: 0x8f66c674 - 0x8f66c6cb
int32_t dbval_write_datablock(int32_t a1, int32_t a2, uint32_t a3) {
    // 0x8f66c674
    if (a1 != 8) {
        // after_if_8f66c680_0
    ...
    int32_t v1 = g30;
    int32_t v2;
    int32_t v3 = dbval_write_partition(a2, a3 % 0x10000, a3, (int32_t)&g30, 8, v1, g40, g32, v2); // 0x8f66c69c
    int32_t v4; // R0
    int32_t v5; // 0x8f66c6c4_22
    if (v3 == 1) {
        // if_8f66c6a4_0_true
        v4 = 15;
        v5 = 15;
