...
// Address range: 0x8f64f730 - 0x8f64f84f
int32_t display_draw_text_at_line_with_color(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6) {
    int32_t v1 = g57 ? -0x709aeed8 : 0; // 0x8f64f730
    int32_t v2 = g55;
    int32_t result; // 0x8f64f794
    if (g30 != 0) {
        // 0x8f64f784
        result = print_log(-1, (int32_t)"Display is not initialized!\n", v2, v2, g63, g64, g65, g66, g67, g68, g60, v1, a5);
        return result;
    }
    int32_t v3 = g37;
    if (v3 == 0) {
    ...
    if (a1 != 0) {
        // 0x8f64f7a0
        return font_get_x(a1, a2, v3, (int32_t)*(char *)&g38);
    }
    // 0x8f64f7f4
    if (a3 == 0) {
        // 0x8f64f82c
        return display_render_done(0, a2, v2, v2, g63, g64, g65);
    }
    // 0x8f64f7fc
    return gfx_flush(v3, a2, v3, (int32_t)&g37, 0, v2, g63);
}
