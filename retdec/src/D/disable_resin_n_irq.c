...
// Address range: 0x8f645dfc - 0x8f645e43
int32_t disable_resin_n_irq(int32_t a1) {
    int32_t v1 = g33;
    int32_t result = unregister_spmi_int_handler(1, 1, g38, v1, a1, v1, g40, g35); // 0x8f645e14
    if (v1 == g33) {
        // 0x8f645e2c
        int32_t v2;
        return pm8x41_irq_mask_ack(65, 1, v1, v1, g40, g35, v2, 0);
    }
    // 0x8f645e28
    __stack_chk_fail();
    return result;
