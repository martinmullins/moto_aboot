...
// Address range: 0x8f64f890 - 0x8f64f9c3
int32_t display_clear_rows(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = a1; // R7
    char * v2 = g23;
    ...
    if (v4 == 0) {
        // 0x8f64f8d0
        int32_t v5;
        return print_log(2, (int32_t)"Display not initialized\n", v3, v3, g30, g31, g32, g33, g34, g35, g27, 0, v5);
    }
    char v6 = *(char *)&g21; // 0x8f64f8ec
    int32_t v7 = v6; // 0x8f64f8ec
    int32_t v8; // R10
    int32_t v9; // R4
    int32_t v10;
    if (v6 == 0) {
        // 0x8f64f8f8
        v8 = g18;
        int32_t v11 = font_get_y(a1, a2, v4, v7); // 0x8f64f8fc
        v1 = v1 * v11 + g17;
        int32_t v12 = display_get_screen_width(v11, a2, v4, g17); // 0x8f64f908
        v9 = v12;
        v10 = a2 * font_get_y(v12, a2, v4, g17);
        // branch -> 0x8f64f948
    } else {
        int32_t v13 = display_get_screen_height(a1, a2, v4, v7); // 0x8f64f91c
        int32_t v14 = font_get_y(v13, a2, v4, v7); // 0x8f64f928
        v8 = g18 + v13 - (v1 + a2) * v14;
        v1 = g17;
        int32_t v15 = font_get_y(v14, a2, v4, g18); // 0x8f64f93c
        v9 = a2 * v15;
        v10 = display_get_screen_width(v15, a2, v4, g18);
        // branch -> 0x8f64f948
    }
    int32_t result = g20;
    gfx_fillrect(result, v8, v1, v9, v10, g19, a3, v3, g30, g31, g32, g33, g34, g35);
    char * v16 = g23;
    if (a3 == 0) {
        // 0x8f64f998
        if (v2 == v16) {
        ...
        // 0x8f64f97c
        if (v2 == v16) {
            int32_t result2 = gfx_flush(g20, v8, v3, (int32_t)&g20, g30, g31, g32); // 0x8f64f994
            return result2;
        }
    }
    // 0x8f64f9a0
