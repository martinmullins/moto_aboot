...
// Address range: 0x8f66c3f4 - 0x8f66c517
int32_t dbval_read_partition(char * a1, int32_t a2) {
    int32_t v1 = g33;
    int32_t v2 = v1; // R3
    char * mem = malloc(0x1000); // 0x8f66c418
    int32_t v3 = (int32_t)mem; // R4
    int32_t v4;
    if (mem == NULL) {
        // if_8f66c420_0_true
        // branch -> 0x8f66c4b4
        // 0x8f66c4b4
        print_log(1, (int32_t)"Malloc for DBVC: db_len %x failed!\n", a2, v2, v4, 0, 0, v1, 0, g40, g41, g42, g43);
        // branch -> 0x8f66c4d8
        // 0x8f66c4d8
        if (v1 != g33) {
            // 0x8f66c4e8
    ...
    int32_t v5 = partition_get_index((int32_t)"cid", a2, g38, v2, v4, 0); // 0x8f66c434
    if (v5 == -1) {
        // 0x8f66c444
        print_log(1, (int32_t)"No CID partition found!\n", g38, v2, v4, 0, 0, v1, 0, g40, g41, g42, g43);
        // branch -> 0x8f66c4d8
        // 0x8f66c4d8
        if (v1 != g33) {
            // 0x8f66c4e8
    ...
    // 0x8f66c458
    g27 = partition_get_offset(v5, a2, g38);
    g28 = (char *)a2;
    int32_t v6 = partition_get_size(v5, a2, g38, v2, v4, 0, 0, v1); // 0x8f66c468
    v2 = &g25;
    g25 = v6;
    g26 = (char *)a2;
    int32_t v7 = partition_get_index((int32_t)"cid", a2, g38, (int32_t)&g25, v4, 0); // 0x8f66c478
    if (v7 == -1) {
        // if_8f66c480_0_true
        // branch -> 0x8f66c4b4
        // 0x8f66c4b4
        print_log(-1, (int32_t)"%s: failed to find partition boot\n", (int32_t)"dbval_read_partition", v2, v4, 0, 0, v1, 0, g40, g41, g42, g43);
        // branch -> 0x8f66c4d8
        // 0x8f66c4d8
        if (v1 != g33) {
            // 0x8f66c4e8
    ...
    int32_t v8;
    int32_t result;
    if (generic_mmc_read_logical(g27, (int32_t)g28, 0x1000, 0, v3, 0, 0, v1, 0, g40, g41, g42, g43, g44, g45, g35, v8, 0, 0, 0, 0, 0, 0) == 0) {
        // 0x8f66c4bc
        memcpy((char *)(int32_t)a1, (char *)v3, a2);
        free((char *)v3);
        result = 1;
        // branch -> 0x8f66c4d8
    } else {
        ...
        // branch -> 0x8f66c4b4
        // 0x8f66c4b4
        print_log(-1, (int32_t)"failed to read CID 1st part of block for partition %s\n", (int32_t)"cid", 0, v3, 0, 0, v1, 0, g40, g41, g42, g43);
        result = 0;
        // branch -> 0x8f66c4d8
    }
    // 0x8f66c4d8
