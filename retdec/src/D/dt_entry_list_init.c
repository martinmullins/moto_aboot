...
// Address range: 0x8f613088 - 0x8f613147
int32_t dt_entry_list_init(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    char * mem = malloc(12); // 0x8f6130a0
    int32_t result = (int32_t)mem; // 0x8f6130a0_3
    if (mem == NULL) {
        // 0x8f6130ac
        _panic(g19, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm_shared/dev_tree.c", 113, (int32_t)"dt_node_member", a2, a3);
        // branch -> 0x8f6130c8
    }
    // 0x8f6130c8
    *(int32_t *)(result + 4) = 0;
    *(int32_t *)result = 0;
    char * mem2 = malloc(40); // 0x8f6130d8
    *(int32_t *)(result + 8) = (int32_t)mem2;
    if (mem2 == NULL) {
        // 0x8f6130e8
        _panic(g19, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm_shared/dev_tree.c", 118, (int32_t)"dt_node_member->dt_entry_m", a2, a3);
        // branch -> 0x8f613104
    }
    // 0x8f613104
    memset((char *)*(int32_t *)(result + 8), 0, 40);
    if (g18 != g18) {
        // 0x8f613128
        __stack_chk_fail();
        // branch -> 0x8f61312c
