...
// Address range: 0x8f61aa8c - 0x8f61ab4b
int32_t dpc_queue(int32_t a1, int32_t a2, int32_t a3) {
    int32_t result = g15;
    int32_t mem = (int32_t)malloc(16); // 0x8f61aaac_3
    *(int32_t *)(mem + 8) = a1;
    *(int32_t *)(mem + 12) = a2;
    int32_t v1 = g4;
    int32_t v2 = &g4; // 0x8f61aac8
    int32_t v3 = v1 + 1; // 0x8f61aacc
    *(int32_t *)v2 = v3;
    if (v1 == 0) {
        // 0x8f61aadc
    ...
    int32_t v4 = g3; // 0x8f61aaec
    g3 = mem;
    *(int32_t *)mem = v4;
    *(int32_t *)(mem + 4) = (int32_t)&g3;
    *(int32_t *)(v4 + 4) = mem;
    event_signal((int32_t)&g6, a3 % 2 ^ 1, a3, (int32_t)&g3, a1, result, g22, g23);
    int32_t v5 = g4 - 1; // 0x8f61ab08
    *(int32_t *)v2 = v5;
    if (v5 == 0) {
        // 0x8f61ab18
        function_8f619438();
