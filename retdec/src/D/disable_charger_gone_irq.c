...
// Address range: 0x8f645fb4 - 0x8f645ffb
int32_t disable_charger_gone_irq(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g52; // 0x8f645fb4
    g52 = (int32_t)&g41;
    int16_t * v2 = g41;
    int32_t v3 = (int32_t)v2;
    int32_t result = unregister_spmi_int_handler(5, 2, a3, v3, a1, v3, v1, g45); // 0x8f645fcc
    g46 = result;
    int16_t * v4 = g41;
    if (v2 != v4) {
        // 0x8f645fe0
    ...
    g52 = v1;
    int32_t v5;
    int32_t result2 = pm8x41_irq_mask_ack(153, 2, v3, (int32_t)v4, v1, g45, v5, 0); // 0x8f645ff4
    g46 = result2;
    return result2;
}
