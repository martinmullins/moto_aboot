...
// Address range: 0x8f64fac8 - 0x8f64fb8f
int32_t display_draw_vertical_line(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g25; // 0x8f64fac8
    int32_t v2 = g27; // 0x8f64fac8
    g27 = a4;
    g25 = a1;
    char * v3 = g19;
    int32_t v4 = (int32_t)v3;
    int32_t v5 = display_get_screen_height(a1, a2, a3, v4); // 0x8f64faf0
    int32_t v6 = v5 < a3 ? v5 : a3;
    int32_t v7; // 0x8f64fb60
    int32_t v8; // 0x8f64fb604
    int32_t v9;
    int32_t v10;
    if (*(char *)&g14 == 0) {
        // 0x8f64fb18
    ...
    int32_t result = g13;
    int32_t v11;
    gfx_fillrect(result, v7, v10, v9, v8, v11, 0, v4, 0, v1, g26, v2, g28, g29);
    if (v3 != g19) {
        // 0x8f64fb74
        __stack_chk_fail();
        // branch -> 0x8f64fb78
