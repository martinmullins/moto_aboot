...
// Address range: 0x8f60f888 - 0x8f60f927
int32_t mdss_dsi_panel_commands_send_part_1(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = 0x1a98000; // R4
    int16_t * v2 = g18;
    int32_t v3 = (int32_t)v2;
    print_log(2, (int32_t)"Send panel DSI commands, size=%d\n", a2, v3, a1, v3, a3, g25, g26, g27, g28, g29, g30);
    int32_t * v4 = (int32_t *)(v1 + 4); // 0x8f60f8b8_0
    int32_t v5 = *v4; // 0x8f60f8b8
    int32_t v6 = v5 | 4; // 0x8f60f8c0
    *v4 = v6;
    int32_t result; // R0
    if (a3 == 0) {
        // 0x8f60f8ec
        result = mipi_dsi_cmds_tx(a1, a2, a2, v6, a1, v3, 0, g25, g26, g27, g28, g29);
        *(int32_t *)(v1 + 4) = v5;
        // branch -> 0x8f60f8fc
    } else {
        // 0x8f60f8cc
        result = a1;
        *(int32_t *)0x1aa0004 = v6;
        int32_t v7;
        mdss_dual_dsi_cmds_tx(result, a2, a2, v6, a1, v3, a3, g25, g26, g27, g28, g29, g30, g19, v7, 0, 0);
        *(int32_t *)(v1 + 4) = v5;
        *(int32_t *)0x1aa0004 = v5;
        // branch -> 0x8f60f8fc
    }
    // 0x8f60f8fc
    if (v2 != g18) {
