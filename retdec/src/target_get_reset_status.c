...
// Address range: 0x8f600990 - 0x8f6009d7
int32_t target_get_reset_status(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = *(int32_t *)0x8600024; // 0x8f6009c0
    int32_t v2;
    return print_log(1, (int32_t)"GCC_RESET_STATUS = 0x%x\n", v1, 0x8600000, g27, v2, 0, 0, 0, 0, 0, 0, 0);
}
