...
// Address range: 0x8f649350 - 0x8f6493db
int32_t gfx_fillrect(int32_t a1, uint32_t a2, uint32_t a3, int32_t a4, int32_t a5) {
    // 0x8f649350
    g6 = a1;
    g7 = a2;
    ...
    int32_t result = g4;
    g14 = &g4;
    uint32_t v2 = *(int32_t *)(a1 + 16); // 0x8f649370
    g13 = v2;
    if (v2 > a2) {
        // 0x8f6493d0
        return result;
    }
    uint32_t v3 = *(int32_t *)(a1 + 20); // 0x8f64937c
    g12 = v3;
    if (v3 > a3 || a5 == 0) {
        // 0x8f6493d0
        return result;
    ...
    if (a4 != 0) {
        ...
        if (a4 + a2 > v2) {
            // if_8f6493a4_0_true
            g11 = v2 - a2;
            // branch -> after_if_8f6493a4_0
        }
        // after_if_8f6493a4_0
        if (a5 + a3 > v3) {
            // if_8f6493ac_0_true
            // branch -> after_if_8f6493ac_0
        }
        // after_if_8f6493ac_0
        g5 = -0x709b6c44;
        ((int32_t (*)())*(int32_t *)(a1 + 44))();
        v4 = g4;
        // branch -> 0x8f6493bc
    } else {
        v4 = result;
