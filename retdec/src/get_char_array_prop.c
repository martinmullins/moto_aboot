...
// Address range: 0x8f631420 - 0x8f6314ab
int32_t get_char_array_prop(char a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = a1;
    int32_t v2 = g13;
    int32_t v3;
    int32_t v4 = fdt_get_property((int32_t)&g1, a2, v1, (int32_t)&a1, v1, v2, g22, g23, g24, g15, v3, 0, 0); // 0x8f631448
    if (v4 != 0) {
        if (a4 == (int32_t)a1) {
            int32_t v5 = v4 + 12; // 0x8f631460
            if (a1 == 0) {
                // 0x8f631488
                if (v2 != g13) {
                    // 0x8f631498
            ...
            // if_8f63146c_0_true.preheader
            *(char *)a3 = *(char *)v5;
            int32_t v6 = 1; // 0x8f63147422
            if (v6 == a4) {
                // 0x8f631488
                if (v2 != g13) {
                    // 0x8f631498
            ...
            *(char *)(a3 + v6) = *(char *)(v5 + v6);
            int32_t v7 = v6 + 1; // 0x8f631474
            while (v7 != a4) {
                // if_8f63146c_0_true.if_8f63146c_0_true_crit_edge
                v6 = v7;
                *(char *)(a3 + v6) = *(char *)(v5 + v6);
                v7++;
                // continue -> if_8f63146c_0_true.if_8f63146c_0_true_crit_edge
            }
            // 0x8f631488
            if (v2 != g13) {
                // 0x8f631498
