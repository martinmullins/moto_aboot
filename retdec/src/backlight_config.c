...
// Address range: 0x8f63f964 - 0x8f63fa13
int32_t backlight_config(char * a1, int32_t a2) {
    int32_t str2 = (int32_t)a1;
    int32_t v1 = g31;
    int32_t v2 = (int32_t)"lm3697"; // R4
    int32_t v3;
    if ((int32_t)"lm3697" == -0x7094e744) {
        // 0x8f63f9d4
        print_log(-1, (int32_t)"Not able to find %s backlight driver!", str2, (int32_t)&g31, str2, v1, g37, g38, g39, g40, g41, g32, v3);
        // branch -> 0x8f63f9e8
    } else {
        int32_t str = (int32_t)"lm3697"; // 0x8f63f990
        while (true) {
            // 0x8f63f990
            int32_t result; // R5
            if (strncmp((char *)str, (char *)str2, 15) == 0) {
                char * mem = malloc(52); // 0x8f63f9ac
                result = (int32_t)mem;
                memcpy(mem, (char *)v2, 52);
                *(int32_t *)(result + 44) = a2;
                // branch -> 0x8f63f9e8
            } else {
                int32_t v4 = v2 + 52; // 0x8f63f9cc
                v2 = v4;
                if (v4 == -0x7094e744) {
                    // break -> 0x8f63f9d4
                    break;
