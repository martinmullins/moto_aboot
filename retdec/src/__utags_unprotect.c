...
// Address range: 0x8f67a1ac - 0x8f67a25f
int32_t __utags_unprotect(int32_t a1, int32_t a2) {
    int32_t v1 = g16;
    int32_t v2 = get_utags(a1, a2, g22); // 0x8f67a1c0
    int32_t v3; // R6
    int32_t result; // 0x8f67a254_2
    int32_t v4;
    int32_t v5;
    int32_t v6;
    int32_t v7; // 0x8f67a1e0
    int32_t v8; // 0x8f67a218
    int32_t v9; // 0x8f67a224
    int32_t v10; // 0x8f67a210
    if (*(int32_t *)(v2 + 12) != 0) {
        // 0x8f67a1d4
        v5 = g10;
        v3 = &g10;
        ...
        v8 = v6 - 1;
        *(int32_t *)v9 = v8;
        *(int32_t *)(v10 + 36) = *(int32_t *)(v10 + 36) & -2;
        v4 = 0;
        if (v8 == 0) {
            // 0x8f67a234
            function_8f619438();
    ...
    // 0x8f67a1f8
    int32_t v11;
    if (__utags_init(a1, a2, g22, 0, a1, v1, g24, g25, g26, g17, v11, 0, 0) != 0) {
        v4 = -1;
        // 0x8f67a23c
        g18 = v4;
        if (v1 != g16) {
