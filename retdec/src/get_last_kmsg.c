...
// Address range: 0x8f6563dc - 0x8f65647f
int32_t get_last_kmsg(int32_t * a1, int32_t a2) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g15;
    if (*(int32_t *)-0x50fe0000 == 0x43474244) {
        uint32_t v3 = *(int32_t *)-0x50fdfffc; // 0x8f656408
        int32_t v4 = &g15; // 0x8f656428
        int32_t v5;
        if (v3 <= 0x40000) {
            uint32_t v6 = *(int32_t *)-0x50fdfff8; // 0x8f656418
            if (v6 < 0x40001) {
                // 0x8f656430
                print_log(1, (int32_t)"last_kmsg detected, start=%u, size=%u\n", v3, v6, v1, v2, g23, g24, g25, g16, v5, 0, 0);
                *(int32_t *)v1 = *(int32_t *)-0x50fdfff8;
                // branch -> 0x8f65644c
                // 0x8f65644c
                if (v2 != g15) {
                    // 0x8f65645c
        ...
        // 0x8f656424
        print_log(1, (int32_t)"Invalid last_kmsg detected\n", v3, v4, v1, v2, g23, g24, g25, g16, v5, 0, 0);
        // branch -> 0x8f656448
    }
    // 0x8f656448
    // branch -> 0x8f65644c
