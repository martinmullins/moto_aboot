...
// Address range: 0x8f61eafc - 0x8f61ebbb
int32_t get_sku(char * a1, int32_t a2) {
    int32_t str = (int32_t)a1; // 0x8f61eafc_0
    int32_t v1 = a2; // R2
    int32_t v2 = str; // R1
    int32_t v3 = g12;
    int32_t v4 = 0; // R3
    *a1 = 0;
    int32_t v5;
    if (__utag_gets_constprop_5("sku", v2, v1, v4, str, v3, g16, g17, g18, 0, v5, 0, 0, 0, 0, 0, 0) != 0) {
        // 0x8f61eb34
        v2 = (int32_t)"SKU: %s\n";
        v1 = str;
        print_log(1, (int32_t)"SKU: %s\n", str, v4, str, v3, g16, g17, g18, 0, v5, 0, 0);
        // branch -> 0x8f61eb44
    }
    int32_t len = strlen((char *)str); // 0x8f61eb48
    int32_t v6; // 0x8f61eb60
    int32_t result; // R0
    char v7;
    if (len == 0) {
        // 0x8f61eb44
        // branch -> 0x8f61eb60
        // 0x8f61eb60
        v6 = get_hw_sku(len, v2, v1, v4, str, v3, g16);
        result = v6;
        v7 = v6;
        if (v6 == 0) {
            // 0x8f61eb90
            *(char *)str = v7;
            ...
            if (v3 == g12) {
                // 0x8f61eb7c
                return strlcpy(str, (int32_t)v7, a2, v3, g16);
            }
        }
        // 0x8f61eba4
        __stack_chk_fail();
    ...
    // 0x8f61eb60
    v6 = get_hw_sku(len, v2, v1, (int32_t)v8, str, v3, g16);
    result = v6;
    v7 = v6;
    if (v6 == 0) {
        // 0x8f61eb90
