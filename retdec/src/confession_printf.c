...
// Address range: 0x8f652104 - 0x8f65220b
int32_t confession_printf(char * a1, int32_t a2) {
    int32_t format = (int32_t)a1;
    int32_t v1 = g28 ? -0x709af928 : 0; // 0x8f652108
    int32_t v2 = g25;
    int32_t v3 = g18;
    int32_t v4; // 0x8f65215c_0
    int32_t chars_printed; // 0x8f65217c
    int32_t result; // R4
    int32_t v5;
    int32_t v6;
    int32_t v7;
    int32_t v8; // 0x8f6521c4
    if (v3 != 0) {
        // 0x8f652158
        v4 = &a2;
        v7 = g19;
        chars_printed = vsnprintf((char *)(v7 + v3), 0x1fff - v7, (char *)format, v4);
        ...
        if (chars_printed >= 1) {
            ...
            if (*(char *)&g17 != 0) {
                ...
                v5 = g18;
                v6 = g19;
                *(char *)(v5 + chars_printed + v6) = 0;
                print_log(11, (int32_t)"%s", v6 + v5, v6, v4, v2, g34, g35, g36, g37, g38, v1, format);
                v8 = result;
                // branch -> 0x8f6521c0
            }
            // 0x8f6521c0
            *(int32_t *)(int32_t)&g19 = g19 + v8;
            // branch -> 0x8f6521cc
        }
        // 0x8f6521cc
        if (v2 != g25) {
    ...
    char * mem = malloc(0x2000); // 0x8f652134
    int32_t v9 = (int32_t)mem; // 0x8f652134_3
    result = v9;
    *(int32_t *)(int32_t)&g18 = v9;
    if (mem == NULL) {
        // 0x8f652148
        print_log(1, (int32_t)"ERROR: out of memory\n", g32, 0, format, v2, g34, g35, g36, g37, g38, v1, format);
        // branch -> 0x8f6521cc
    } else {
        // 0x8f652130
        // branch -> 0x8f652158
        ...
        v4 = &a2;
        v7 = g19;
        chars_printed = vsnprintf((char *)(v7 + g18), 0x1fff - v7, (char *)format, v4);
        result = chars_printed;
        if (chars_printed >= 1) {
            // 0x8f652188
            v8 = chars_printed;
