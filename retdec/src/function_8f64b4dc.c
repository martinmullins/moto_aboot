...
// Address range: 0x8f64b4dc - 0x8f64b57b
void function_8f64b4dc(void) {
    int32_t v1 = g27;
    int32_t v2;
    if (g46 == 0) {
        // after_if_8f64b4fc_0.thread
        v2 = v1;
        // branch -> 0x8f64b558
    } else {
        int32_t v3 = 0; // R6
        char v4 = *(char *)g42; // 0x8f64b50c17
        char v5 = *(char *)g43; // 0x8f64b51020
        int32_t c2 = v5; // R4
        if (v4 != 0) {
            int32_t c = v4; // 0x8f64b50c26
            int32_t v6 = 0; // 0x8f64b51024
            int32_t v7 = g46; // 0x8f64b550723
            while (true) {
                // 0x8f64b51c
                if (v5 != 0) {
                    // 0x8f64b524
                    int32_t v8; // 0x8f64b54c
                    int32_t v9; // 0x8f64b550
                    if (v4 == v5) {
                        v9 = v7;
                        v8 = v6;
                      lab_0x8f64b54c:;
                        int32_t v10 = v8 + 1; // 0x8f64b54c
                        v3 = v10;
                        if (v9 != v10) {
                            char v11 = *(char *)(g42 + v10); // 0x8f64b50c
                            char v12 = *(char *)(v10 + g43); // 0x8f64b510
                            c2 = v12;
                            if (v11 == 0) {
                                // break -> 0x8f64b558
                                break;
                        ...
                        int32_t v13 = tolower(c) % 256; // 0x8f64b544
                        if (v13 == tolower(c2) % 256) {
                            // 0x8f64b52c
                            v9 = g46;
                            v8 = v3;
                            // branch -> 0x8f64b54c
