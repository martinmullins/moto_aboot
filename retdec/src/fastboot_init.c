...
// Address range: 0x8f623f54 - 0x8f624043
int32_t fastboot_init(int32_t a1, int32_t a2) {
    int32_t v1 = g31; // 0x8f623f54
    int32_t v2 = g34; // 0x8f623f54
    int32_t v3 = (int32_t)&g24; // R4
    int32_t v4 = g23;
    int32_t v5 = v4; // R3
    mutex_init((int32_t)&g14, a2, g29, v4);
    set_gpt_opts((char *)&g3, a2, g29, v5);
    int32_t v6 = 0; // R1
    char * set_mem = memset((char *)v3, 0, 16); // 0x8f623f90
    *(int32_t *)v3 = a1;
    g25 = a2;
    int32_t v7;
    int32_t v8 = fboot_usb_init((int32_t)set_mem, v6, 16, v5, v7, 0, 0, v4, 0, v1, g32); // 0x8f623f9c
    v3 = v8;
    int32_t result; // 0x8f624018_2
    int32_t v9;
    if (v8 != 0) {
        // if_8f623fa4_0_true
        // branch -> 0x8f623fe8
        // 0x8f623fe8
        print_log(1, (int32_t)"%s: fastboot usb init fail\n", (int32_t)"fastboot_init", v5, v7, 0, 0, v4, 0, v1, g32, g33, v2);
        v9 = -1;
        // branch -> 0x8f624000
        // 0x8f624000
        g27 = v9;
    ...
    int32_t v10 = g26 ? -0x709fccd8 : 0; // 0x8f623f54
    fastboot_init_validators(0, v6, 16, v5, v7, 0, 0);
    v5 = 16;
    int32_t v11;
    int32_t v12 = thread_create((int32_t)"fastboot", (int32_t)&g1, v3, 16, 0x2000, 0, 0, v4, 0, v1, g32, g33, v2, v10, v11, 0); // 0x8f623fcc
    g16 = v12;
    if (v12 == 0) {
        // 0x8f623fe0
        // branch -> 0x8f623fe8
        // 0x8f623fe8
        print_log(1, (int32_t)"%s: fastboot thread_create fail\n", (int32_t)"fastboot_init", v5, 0x2000, 0, 0, v4, 0, v1, g32, g33, v2);
        v9 = -1;
        // branch -> 0x8f624000
    } else {
        // 0x8f623ff8
        thread_resume(v12, (int32_t)&g1, (int32_t)&g16, v5, 0x2000, 0, 0, v4);
        v9 = v3;
        // branch -> 0x8f624000
    }
    // 0x8f624000
