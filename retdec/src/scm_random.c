...
// Address range: 0x8f6171cc - 0x8f61731f
char * scm_random(int32_t a1, int32_t a2) {
    int32_t v1 = *(int32_t *)-0x708eed0c; // 0x8f6171e8
    int32_t v2;
    int32_t v3 = &v2; // 0x8f6171f0_0
    memset((char *)&v2, 0, 64);
    if (*(char *)-0x70947380 == 1) {
        // 0x8f617284
        v2 = 0x2000a01;
        scm_call2(v3, 0, 64, v3, g33, g30);
        int32_t v4;
        print_log(-1, -0x7097f2b4, v3, v3, g33, g30, v4, 0, 0, 0, 0, 0, 0);
        // branch -> 0x8f6172f4
    } else {
        int32_t v5 = a1;
        function_8f6193d4(a1, a2);
        int32_t v6 = scm_call(10, 1, (int32_t)&v5, 8, 0); // 0x8f617268
        function_8f6193d4(a1, a2);
        v3 = v6;
        // branch -> 0x8f6172f4
    }
