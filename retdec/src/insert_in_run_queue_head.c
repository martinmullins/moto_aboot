...
// Address range: 0x8f61b1f0 - 0x8f61b263
int32_t insert_in_run_queue_head(int32_t a1) {
    int32_t v1 = a1 + 12; // 0x8f61b1f4
    int32_t v2 = g30; // 0x8f61b1f8
    int32_t v3 = *(int32_t *)(a1 + 20); // 0x8f61b200
    int32_t v4 = 8 * v3; // 0x8f61b20c
    int32_t v5 = v4 + (int32_t)&g17; // 0x8f61b20c
    int32_t v6 = *(int32_t *)(v4 + (int32_t)&g17 + 4); // 0x8f61b210
    g30 = v6;
    *(int32_t *)v1 = v5;
    *(int32_t *)(a1 + 16) = v6;
    ...
    *(int32_t *)(v5 + 4) = v1;
    int32_t result = g16;
    uint32_t v7 = v3 % 256; // 0x8f61b234
    g16 = (v7 == 0 ? 1 : v7 < 32 ? 1 << v7 : 0) | result;
    int32_t v8 = g20;
    g29 = v8;
    if (g20 != v8) {
        // 0x8f61b24c
