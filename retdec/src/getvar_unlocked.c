...
// Address range: 0x8f62ca88 - 0x8f62cb0f
int32_t getvar_unlocked(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g10; // 0x8f62ca88
    int32_t v2 = g11; // 0x8f62ca88
    g10 = a1;
    g11 = &g6;
    int32_t v3 = g6;
    int32_t v4 = get_current_secure_state(a1, a2, a3, v3, a1, v3); // 0x8f62ca9c
    uint32_t v5 = (v4 + 255) % 256; // 0x8f62caa4
    if (v5 < 2) {
        // 0x8f62cad0
        // branch -> 0x8f62cad8
        // 0x8f62cad8
        strlcpy(g10, (int32_t)"Not supported", 64, v5, a1);
        if (v3 != g6) {
            // 0x8f62caf4
            __stack_chk_fail();
            // branch -> 0x8f62caf8
