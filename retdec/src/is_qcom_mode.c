...
// Address range: 0x8f61dff4 - 0x8f61e05b
int32_t is_qcom_mode(void) {
    // 0x8f61dff4
    int32_t v1;
    int32_t str = v1; // bp-32
    int32_t v2 = g28 ? -0x709af928 : 0; // 0x8f61dff4
    int32_t v3 = g25;
    int32_t v4;
    int32_t v5 = __utag_gets_constprop_3_6((int32_t)"bootmode", (int32_t)&str, 17, v3, v1, 0, 0, 0, 0, v3, g34, v2, v4); // 0x8f61e014
    int32_t result = v5; // R0
    int32_t v6 = 0; // 0x8f61e04c_22
    if (v5 != 0) {
        uint32_t strcmp_rc = strcmp((char *)&str, "qcom"); // 0x8f61e028
        int32_t v7 = strcmp_rc > 1 ? 0 : 1 - strcmp_rc; // 0x8f61e02c
        result = v7;
        v6 = v7;
        // branch -> 0x8f61e034
    }
