...
// Address range: 0x8f603280 - 0x8f6032d3
int32_t msm_gpio_int_disable(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    // 0x8f603280
    g50 = a2;
    int32_t v1 = g53; // 0x8f603280
    int32_t v2 = g54; // 0x8f603280
    int32_t result = 0x1000 * a1; // 0x8f603284
    g54 = &g47;
    g53 = result + 0x1000000;
    int32_t v3 = g47;
    int32_t * v4 = (int32_t *)(result + 0x1000008); // 0x8f603298_0
    *v4 = *v4 & -2;
    function_8f61951c();
    *(int32_t *)(g53 + 12) = 0;
    g51 = v3;
