...
// Address range: 0x8f61d5f8 - 0x8f61d69f
int32_t boot_handler(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    // 0x8f61d5f8
    g47 = a2;
    g50 = a3;
    int32_t v1 = g52; // 0x8f61d5fc
    int32_t v2 = g53; // 0x8f61d5fc
    int32_t v3 = g54; // 0x8f61d5fc
    int32_t v4 = g45; // 0x8f61d5fc
    g52 = &g12;
    g54 = &g28;
    g53 = &g12;
    // branch -> 0x8f61d614
    while (true) {
        int32_t v5 = event_wait((int32_t)&g42, a2); // 0x8f61d618
        stop(v5, g47, g50, (int32_t)&g4, a1);
        backlight_set_brightness_level(100, g47);
        int32_t v6 = enable_cont_splash_screen(100, g47); // 0x8f61d62c
        g50 = v6;
        int32_t v7 = stop_usb_detection(100, g47, v6); // 0x8f61d630
        g46 = v7;
        int32_t v8 = g28;
        if (v8 != 0) {
            int32_t v9 = *(int32_t *)(v8 + 76); // 0x8f61d640
            g51 = v9;
            g46 = 0;
            g45 = -0x709e29b4;
            ((int32_t (*)(int32_t, int32_t))v9)(0, v9);
            v7 = g46;
            // branch -> 0x8f61d64c
        }
        // 0x8f61d64c
        g28 = 0;
        resume_usb_detection(v7, g47, 0);
        disable_cont_splash_screen(g46, g47, 0);
        show("fastboot_screen", 1, backlight_set_brightness_level(50, g47));
        g47 = (int32_t)"Boot up failed";
        print_log(6, (int32_t)"Boot up failed", g50, (int32_t)&g5, a1, (int32_t)g41, v1, v2, v3, v4, a5, 0, 0);
        a2 = g47;
        // branch -> 0x8f61d614
    }
}
