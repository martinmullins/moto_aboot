...
// Address range: 0x8f60d8e8 - 0x8f60d9ab
int32_t board_get_ddr_subtype(void) {
    int32_t v1 = g47;
    int32_t v2 = v1; // R3
    int32_t v3;
    int32_t v4 = smem_ram_ptable_init_v1(g49, g50, g51, v1, v3, 0); // 0x8f60d904
    int32_t v5 = v4; // 0x8f60d92c
    if (v4 == 0) {
        // 0x8f60d910
        g50 = (int32_t)"ASSERT FAILED at (%s:%d): %s\n";
        v2 = 243;
        v5 = _panic(g48, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm_shared/board.c", 243, (int32_t)"smem_ram_ptable_init_v1()", 0, 0);
        // branch -> 0x8f60d92c
    }
    int32_t v6 = smem_get_ram_ptable_len(v5, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm_shared/board.c", v2); // 0x8f60d92c
    int32_t v7 = 0; // R4
    int32_t v8 = 0; // R5
    int32_t result = 0; // 0x8f60d974
    if (v6 != 0) {
        // 0x8f60d944
        int32_t v9;
        int32_t v10 = &v9; // 0x8f60d944_0
        int32_t v11 = 0; // 0x8f60d948
        // branch -> 0x8f60d944
        while (true) {
            // 0x8f60d944
            g50 = v11;
            smem_get_ram_ptable_entry(v10, v11, (int32_t)"platform/msm_shared/board.c", v2);
            int32_t v12;
            int32_t v13 = v12; // 0x8f60d94c7
            if (v12 == 14) {
                // 0x8f60d95c
                int32_t v14;
                if (v14 == 1) {
