...
// Address range: 0x8f641c5c - 0x8f641ce7
int32_t bq24296_get_ibuslim(int32_t a1, int32_t a2) {
    int32_t v1 = g40; // 0x8f641c60
    int32_t v2 = g41; // 0x8f641c60
    int32_t v3 = g30;
    int32_t v4 = 0; // bp-21
    int32_t v5 = g24;
    g33 = v5;
    int32_t result; // 0x8f641cd8_2
    if (v5 == 0) {
        // 0x8f641cc0
        g38 = v3;
        if (v3 != g30) {
    ...
    // 0x8f641c88
    int32_t v6;
    qup_i2c_read_byte(v5, 107, 0, (int32_t)&v4, a1, v3, v1, v2, g42, g32, v6, 0, 0, 0, 0);
    int32_t v7 = g33; // 0x8f641c98
    int32_t v8; // 0x8f641ca0
    if (v7 > -1) {
        // if_8f641c9c_0_true
        v8 = v4 % 8;
        g33 = v8;
        ...
        // 0x8f641ca8
        print_log(-1, (int32_t)"BQ24296: Couldn't read reg: %X (%d)\n", 0, v7, a1, v3, v1, v2, g42, g32, v6, 0, 0);
        g33 = v7;
        v8 = v7;
        // branch -> 0x8f641cc0
    }
