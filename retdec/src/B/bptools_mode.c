...
// Address range: 0x8f61dfa0 - 0x8f61dff3
int32_t bptools_mode(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g28 ? -0x709af928 : 0; // 0x8f61dfa0
    int32_t v2 = g25;
    int32_t v3;
    int32_t result = print_log(1, (int32_t)"Entering BP tools mode\n", a3, v2, a1, v2, g34, v1, v3, 0, 0, 0, 0); // 0x8f61dfb8
    *(char *)&g4 = 2;
    if (v2 == g25) {
        // 0x8f61dfdc
        return boot_linux_from_flash(result, (int32_t)"Entering BP tools mode\n", v2, v2, g34, v1, v3, 0, 0);
    }
    // 0x8f61dfd8
    __stack_chk_fail();
    return result;
