...
// Address range: 0x8f6502a8 - 0x8f650323
int32_t blink_callback(int32_t a1, int32_t a2) {
    char v1 = g26; // 0x8f6502c0
    char v2 = *(char *)&g25; // 0x8f6502c4
    int32_t v3 = v2; // 0x8f6502c4
    int32_t v4 = v1 == v2 ? 0 : v3; // 0x8f6502c4
    char v5 = v4;
    g26 = v5;
    if (v5 == 0) {
        // 0x8f6502e8
        platform_led_off((int32_t)v1, v3, v4, v4);
        // branch -> 0x8f6502fc
    } else {
        // 0x8f6502f0
        platform_led_on(v4, v3, v4, (int32_t)&g25);
        // branch -> 0x8f6502fc
    }
    // 0x8f650314
    return 0;
