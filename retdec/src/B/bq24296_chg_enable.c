...
// Address range: 0x8f641734 - 0x8f64189b
int32_t bq24296_chg_enable(int32_t result, int32_t a2, int32_t a3) {
    int32_t v1 = g25;
    if (g23 == 0) {
        // 0x8f641874
    ...
    int32_t v2;
    int32_t v3;
    set_power_supply_list((int32_t)&g24, g17, result ^ 1, (int32_t)&g17, result, v1, g31, g32, g33, g26, v2, v3, 0, 0, 0, 0, 0);
    int32_t result3; // 0x8f64185c
    if (result != 0) {
        int32_t result2 = bq24296_modify(4, 43, 2, 6, result, v1, g31, g32, g33, g26, v2, v3, 0, 0, 0); // 0x8f641788
        if (result2 == 0) {
            // 0x8f6417b0
            return bq24296_modify(1, 1, 4, 1, result, v1, g31, g32, g33, g26, v2, v3, 0, 0, 0);
        }
        // 0x8f641794
        if (v1 != g25) {
            // 0x8f641870
        ...
        // 0x8f641854
        result3 = print_log(-1, (int32_t)"BQ24296: Error resetting Voreg\n", v1, v1, g31, g32, g33, g26, v2, v3, 0, 0, 0);
        return result3;
    }
    int32_t result4 = bq24296_modify(1, 0, 4, 1, result, v1, g31, g32, g33, g26, v2, v3, 0, 0, 0); // 0x8f641830
    if (result4 > -1) {
        // 0x8f641820
        // branch -> 0x8f641860
        // 0x8f641860
        ...
        if (v1 == g25) {
            // 0x8f641854
            result3 = print_log(-1, (int32_t)"BQ24296: Error setting chg disable\n", v1, v1, g31, g32, g33, g26, v2, v3, 0, 0, 0);
            return result3;
        }
    }
    // 0x8f641870
