...
// Address range: 0x8f64f650 - 0x8f64f72f
int32_t display_draw_text_with_color(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8) {
    int32_t v1 = g34; // 0x8f64f650
    int32_t v2 = g35; // 0x8f64f650
    int32_t v3 = g36; // 0x8f64f650
    int32_t v4 = g37; // 0x8f64f650
    int32_t v5 = g26; // 0x8f64f650
    g36 = a4;
    g34 = (int32_t)&g24;
    int32_t v6 = (int32_t)g24;
    int32_t result; // 0x8f64f6ac
    if (g4 != 0) {
        // 0x8f64f69c
        result = print_log(-1, (int32_t)"Display is not initialized!\n", v6, v6, v1, v2, v3, v4, v5, a5, a6, a7, a8);
        return result;
    }
    // 0x8f64f678
    g31 = &g11;
    ...
    if (a1 != 0) {
        ...
        if (*(char *)&g12 == 0) {
            // 0x8f64f6c8
            return draw_text_in_portrait(v8, a2, a3, a5);
        }
        // 0x8f64f6d0
        return draw_text_in_landscape(v8, a2, a3, a5);
    }
    // 0x8f64f6d4
    if (a4 != 0) {
        // 0x8f64f6dc
        return gfx_flush(v7, a2, a3, a5, 0, v6, a3);
    }
    // 0x8f64f70c
    g32 = v6;
    g34 = v1;
    ...
    g37 = v4;
    g26 = v5;
    return display_render_done(0, a2);
}
