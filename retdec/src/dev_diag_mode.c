...
// Address range: 0x8f61e334 - 0x8f61e387
int32_t dev_diag_mode(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g23;
    int32_t v2;
    int32_t result = print_log(1, (int32_t)"Entering DIAG mode\n", a3, v1, a1, v1, g30, g24, v2, 0, 0, 0, 0); // 0x8f61e34c
    *(char *)&g10 = 9;
    if (v1 == g23) {
        // 0x8f61e370
        return boot_linux_from_flash(result, (int32_t)"Entering DIAG mode\n", v1, v1, g30, g24, v2, 0, 0);
    }
    // 0x8f61e36c
    __stack_chk_fail();
    return result;
