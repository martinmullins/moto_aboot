...
// Address range: 0x8f60bf30 - 0x8f60bfa7
int32_t mmc_sdhci_get_wp_status(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = (int32_t)&g11; // R4
    int32_t result = g17;
    g20 = (int32_t)&g11;
    int32_t set_mem = (int32_t)memset((char *)&g11, 0, 8); // 0x8f60bf54_6
    g20 = set_mem;
    int32_t v2 = target_mmc_device(set_mem); // 0x8f60bf58
    g20 = v2;
    int32_t v3;
    char * v4 = mmc_get_wp_status(v2, a1, v1, result, a1, a2, a3, result, g24, g25, g26, g19, v3, 0, 0, 0, 0); // 0x8f60bf64
    char v5 = *(char *)&g11; // 0x8f60bf68
    g20 = 1;
    g20 = print_log(1, (int32_t)"emmc cmd 31 type: 0x%x 0x%x rc 0x%x\n", (int32_t)v5, (int32_t)g12, (int32_t)v4, a2, a3, result, g24, g25, g26, g19, v3);
    if (result != g17) {
        // 0x8f60bf90
        __stack_chk_fail();
        // branch -> 0x8f60bf94
