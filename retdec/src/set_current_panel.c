...
// Address range: 0x8f633b3c - 0x8f633baf
int32_t set_current_panel(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g27 ? -0x709a999c : 0; // 0x8f633b3c
    int32_t v2 = g23;
    int32_t result; // 0x8f633ba0_2
    if (a1 == 0) {
        // 0x8f633b88
        result = 0;
        // branch -> 0x8f633b9c
        ...
        // 0x8f633b54
        g19 = a1;
        int32_t v3 = init_panel_power_list(a1, a2, a3, (int32_t)&g19, a1, v2, a3, g33); // 0x8f633b5c
        if (v2 == g23) {
            // 0x8f633b70
            int32_t v4;
            return print_log(1, (int32_t)"set current panel to %s!", a1 + 8, v2, g33, g34, v1, v4, 0, 0, 0, 0, 0);
        }
        // 0x8f633b98
        __stack_chk_fail();
        result = v3;
