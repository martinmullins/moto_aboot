...
// Address range: 0x8f61a43c - 0x8f61a4c3
int32_t target_hwrev(void) {
    int32_t v1 = g52; // 0x8f61a43c
    g52 = &g24;
    int32_t v2 = g24;
    int32_t result = v2; // R0
    int16_t * v3 = g41;
    int32_t v4 = (int32_t)v3;
    int32_t v5 = v2; // 0x8f61a4b0_27
    int16_t * v6 = v3;
    if (v2 <= 0) {
        char * v7 = hwrev_from_utag(v2, g47, v4, (int32_t)&g41, g46, v4); // 0x8f61a460
        int32_t v8 = (int32_t)v7; // 0x8f61a460_7
        int32_t v9 = v8; // R2
        *(int32_t *)g52 = v8;
        int32_t v10; // 0x8f61a490
        if (v7 == NULL) {
            int32_t v11 = get_hw_rev(v8, g47, v9, (int32_t)&g41, g46, v4, g50); // 0x8f61a47c
            v9 = v11;
            *(int32_t *)g52 = v11;
            v10 = (int32_t)"HW rev. from FDT: 0x%04X\n";
            // branch -> 0x8f61a490
        } else {
            // if_8f61a470_0_true
            v10 = (int32_t)"HW rev. from UTAG: 0x%04X\n";
            // branch -> 0x8f61a490
        }
        // 0x8f61a490
        int32_t v12;
        print_log(1, v10, v9, (int32_t)&g41, g46, v4, g50, v1, g53, g45, v12, 0, 0);
        int32_t v13 = g24;
        result = v13;
        v5 = v13;
        v6 = g41;
