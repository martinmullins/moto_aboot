...
// Address range: 0x8f61b6fc - 0x8f61b7a7
int32_t thread_resume(int32_t a1, int32_t a2) {
    int32_t v1 = g37;
    int32_t result = -10;
    if (((int32_t)*(char *)(a1 + 24) + 255) % 256 >= 2) {
        int32_t v2 = g15;
        int32_t v3 = &g15; // R5
        int32_t v4 = v2 + 1; // 0x8f61b734
        g15 = v4;
        int32_t v5 = a1; // 0x8f61b74c
        if (v2 == 0) {
            // 0x8f61b744
        ...
        // 0x8f61b748
        *(char *)(v5 + 24) = 1;
        thread_yield(insert_in_run_queue_head(v5, a2, v4), a2, v4, 1, a1, v1);
        int32_t v6 = g15 - 1; // 0x8f61b760
        *(int32_t *)v3 = v6;
        if (v6 == 0) {
            // 0x8f61b770
            function_8f619438();
