...
// Address range: 0x8f60f454 - 0x8f60f537
int32_t mdss_dual_dsi_cmd_dma_trigger_for_panel(int32_t a1, int32_t a2, int32_t a3) {
    int16_t * v1 = g18;
    int32_t v2 = (int32_t)v1;
    int32_t v3 = 0x1a98000; // R3
    *(int32_t *)0x1a98110 = 0x3030303;
    *(int32_t *)(v3 + 144) = 1;
    *(int32_t *)(v3 + 0x8110) = 0x3030303;
    *(int32_t *)(0x8090 + v3) = 1;
    int32_t v4 = 0x10000; // 0x8f60f4b4
    // branch -> 0x8f60f4a4
    int32_t v5;
    int32_t v6; // 0x8f60f4b4
    while (true) {
        // 0x8f60f4a4
        if (*(int32_t *)0x1aa0110 % 2 == 1) {
            int32_t v7 = *(int32_t *)0x1aa0110 | 0x1000001; // 0x8f60f4e8
            *(int32_t *)0x1aa0110 = v7;
            print_log(2, (int32_t)"%s: Panel CMD: command mode dma tested successfully\n", (int32_t)"mdss_dual_dsi_cmd_dma_trigger_for_panel", v7, a1, v2, a3, g19, v5, 0, 0, 0, 0);
            // branch -> 0x8f60f4fc
        } else {
            // 0x8f60f4b0
            v6 = v4 - 1;
    ...
    // 0x8f60f4c0
    print_log(-1, (int32_t)"%s: Panel CMD: command mode dma test failed\n", (int32_t)"mdss_dual_dsi_cmd_dma_trigger_for_panel", v6, a1, v2, a3, g19, v5, 0, 0, 0, 0);
    // branch -> 0x8f60f4fc
    // 0x8f60f4fc
    if (v1 != g18) {
        // 0x8f60f510
