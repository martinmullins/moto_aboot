...
// Address range: 0x8f648934 - 0x8f6489db
int32_t font_set_type(char * str, int32_t a2, int32_t a3) {
    // 0x8f648934
    if ((int32_t)&g5 == (int32_t)&g6) {
        // 0x8f6489a4
        int32_t v1;
        int32_t v2;
        return print_log(-1, (int32_t)"unsupported font type %s\n", (int32_t)str, g12, g16, g17, g18, g19, 0, v1, v2, 0, 0);
    }
    // 0x8f648958
    return strncmp(str, (char *)((int32_t)&g5 + 4), 16);
}
