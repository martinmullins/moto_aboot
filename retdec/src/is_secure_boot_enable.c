...
// Address range: 0x8f617514 - 0x8f617657
char * is_secure_boot_enable(int32_t a1) {
    int32_t v1 = 0; // bp-4
    int32_t v2;
    int32_t v3 = &v2; // 0x8f617538_0
    memset((char *)&v2, 0, 64);
    int32_t v4; // bp-96
    int32_t v5 = &v4; // 0x8f617550_0
    v4 = 0;
    int32_t v6; // R2
    uint32_t v7;
    int32_t v8;
    int32_t v9; // 0x8f61762c3
    if (v7 % 256 == 1) {
        // 0x8f6175b8
        v2 = 0x2000604;
        v6 = v3;
        v8 = v4;
        v9 = scm_call2(v3, v5, v3, v5, g27, v1);
        // branch -> 0x8f6175e4
    } else {
        int32_t v10 = &v8; // 0x8f617594_0
        v6 = v10;
        v9 = scm_call_atomic2(6, 4, v10, 8, g27);
        // branch -> 0x8f6175e4
    }
    // 0x8f6175e4
    int32_t v11; // 0x8f61762c2
    if (v9 == 0) {
        uint32_t v12 = v8; // 0x8f6175f0
        if (v12 % 2 == 0) {
            // 0x8f617600
            v11 = (v12 & 4) == 0;
            // branch -> 0x8f61762c
        ...
        // 0x8f61761c
        int32_t v13;
        print_log(-1, -0x7097f210, v6, v9, g27, v1, v13, 0, 0, 0, 0, 0, 0);
        v11 = v9;
        // branch -> 0x8f61762c
    }
    // 0x8f61762c
