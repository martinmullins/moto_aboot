...
// Address range: 0x8f66a974 - 0x8f66a9bf
int32_t mcs_mp_copy(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g28;
    uint16_t v2 = *(int16_t *)(a1 + 4); // 0x8f66a980
    int32_t result = v2; // 0x8f66a980
    g31 = result;
    int32_t v3 = v1;
    if (v2 != 0) {
        int32_t v4 = 0; // 0x8f66a990
        *(int32_t *)(v4 + a2) = *(int32_t *)(v4 + a3);
        int32_t v5 = 1; // 0x8f66a998
        while (v5 < result) {
            // if_8f66a990_0_true
            v4 = 4 * v5;
            *(int32_t *)(v4 + a2) = *(int32_t *)(v4 + a3);
            v5++;
            // continue -> if_8f66a990_0_true
        }
        // 0x8f66a98c
        v3 = g28;
        // branch -> 0x8f66a9a0
