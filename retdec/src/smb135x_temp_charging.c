...
// Address range: 0x8f647d54 - 0x8f647dcf
int32_t smb135x_temp_charging(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g36; // 0x8f647d54
    int32_t v2 = g37; // 0x8f647d54
    int32_t v3 = g15;
    int32_t v4;
    print_log(1, (int32_t)"charging enable = %d\n", a1, v3, a1, v3, a3, v1, v2, g30, v4, 0, 0);
    g32 = 2;
    int32_t v5 = a1 == 0 ? 2 : 0;
    int32_t v6 = smb1359_masked_write_reg(66, 2, v5, v3, a1, v3, a3, v1, v2, g30, v4, 0); // 0x8f647d8c
    int32_t result = v6; // 0x8f647da8
    if (v6 <= 0xffffffff) {
        // 0x8f647d98
        g32 = (int32_t)"smb1359 temp charging change failed\n";
        print_log(-1, (int32_t)"smb1359 temp charging change failed\n", v5, v3, a1, v3, a3, v1, v2, g30, v4, 0, 0);
        result = v6;
        // branch -> 0x8f647da4
    }
    // 0x8f647da4
