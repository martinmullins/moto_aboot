...
// Address range: 0x8f62d738 - 0x8f62d7e7
int32_t fastboot_notify(int32_t result, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g9;
    switch (a2) {
        case 1: {
            // 0x8f62d758
            return event_signal((int32_t)&g10, 0, a3, v1, result, v1, a3, g19);
        }
        case 2: {
            // 0x8f62d78c
            if (g6 != 1) {
            ...
            // 0x8f62d7b4
            g6 = 0;
            return send_usb_status_command(1, (int32_t)&g9, v1, v1, g19, g20, g12);
        }
    }
    // 0x8f62d7d4
    return result;
