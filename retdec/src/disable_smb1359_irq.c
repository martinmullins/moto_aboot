...
// Address range: 0x8f64804c - 0x8f6480e3
int32_t disable_smb1359_irq(int32_t a1) {
    int32_t result = g22;
    int32_t v1;
    if (smb1359_write_reg(7, 0, g32, result) != 0) {
        // 0x8f648070
        print_log(-1, (int32_t)"smb1359 disable IRQ failed\n", g32, result, a1, result, g33, g28, v1, 0, 0, 0, 0);
        // branch -> 0x8f64807c
    }
    // 0x8f64807c
    if (smb1359_write_reg(8, 0, g32, result) != 0) {
        // 0x8f648090
        print_log(-1, (int32_t)"smb1359 disable IRQ failed\n", g32, result, a1, result, g33, g28, v1, 0, 0, 0, 0);
        // branch -> 0x8f64809c
    }
    // 0x8f64809c
    if (smb1359_write_reg(9, 0, g32, result) != 0) {
        // 0x8f6480b0
        print_log(-1, (int32_t)"smb1359 disable IRQ failed\n", g32, result, a1, result, g33, g28, v1, 0, 0, 0, 0);
        return g32;
    }
    ...
    if (result == g22) {
        // 0x8f6480d0
        return disable_smb1359_stat_gpio_irq(0, 0, result, result);
    }
    // 0x8f6480cc
    __stack_chk_fail();
    return result;
