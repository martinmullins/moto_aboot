...
// Address range: 0x8f6747e0 - 0x8f6748bf
int32_t unlock_phone(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g61; // 0x8f6747e0
    int32_t v2 = g62; // 0x8f6747e0
    g61 = &g49;
    int32_t v3 = g49;
    g62 = &g49;
    int32_t v4 = mot_sst_oem_unlock_handler(a1, a2, a3, v3, a1, v3, a3, v1); // 0x8f6747f4
    if (v4 == 255) {
        // 0x8f67487c
        set_current_secure_state(4, 1, a3);
        // branch -> 0x8f67488c
        // 0x8f67488c
        if (v3 != g49) {
            // 0x8f67489c
    ...
    int32_t v5 = get_last_status(v4); // R4
    int32_t v6;
    print_log(0, (int32_t)"Failed to unlock phone!", a3, v3, a1, v3, a3, v1, v2, g54, v6, 0, 0);
    uint32_t v7 = v5 - 3; // 0x8f674814
    if (v7 <= 3) {
        // 0x8f674824
        print_log(1, (int32_t)"unlock failed in sst oem unlock handler %02x\n", v5, v7, a1, v3, a3, v1, v2, g54, v6, 0, 0);
        // branch -> 0x8f67488c
        // 0x8f67488c
        if (v3 != g49) {
            // 0x8f67489c
    ...
    // 0x8f674838
    int32_t v8; // R0
    int32_t v9; // 0x8f6748a4_22
    switch (v5) {
        default: {
            // 0x8f674868
            print_log(1, (int32_t)"general failure in sst oem unlock handler %02x\n", v5, v7, a1, v3, a3, v1, v2, g54, v6, 0, 0);
            v8 = 19;
            v9 = 19;
            // branch -> 0x8f67488c
            break;
        ...
        case 7: {
            // 0x8f674840
            print_log(1, (int32_t)"Password incorrect\n", a3, v7, a1, v3, a3, v1, v2, g54, v6, 0, 0);
            v8 = 21;
            v9 = 21;
            // branch -> 0x8f67488c
            break;
        ...
        case 8: {
            // 0x8f674858
            print_log(1, (int32_t)"Cannot provide unlock data\n", a3, v7, a1, v3, a3, v1, v2, g54, v6, 0, 0);
            v8 = 22;
            v9 = 22;
            // branch -> 0x8f67488c
            break;
