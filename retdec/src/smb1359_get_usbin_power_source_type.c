...
// Address range: 0x8f647188 - 0x8f647203
int32_t smb1359_get_usbin_power_source_type(int32_t a1) {
    int32_t v1 = g34; // 0x8f64718c
    int32_t v2 = g25;
    g34 = &g25;
    int32_t v3 = 0; // bp-13
    if (g22 == 0) {
    ...
    int32_t v4 = &v3; // 0x8f6471bc_0
    int32_t v5;
    qup_i2c_read_byte(g22, 28, 75, v4, a1, v2, v1, 0, v5, 0, 0, 0, 0, 0, 0);
    if (g22 <= 0xffffffff) {
        // 0x8f6471cc
        print_log(-1, (int32_t)"Read SMB1359 error %d\n", g22, v4, a1, v2, v1, 0, v5, 0, 0, 0, 0);
        // branch -> 0x8f6471d8
    }
    // 0x8f6471d8
    if (v2 != g25) {
