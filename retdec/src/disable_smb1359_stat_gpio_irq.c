...
// Address range: 0x8f60387c - 0x8f6038bb
int32_t disable_smb1359_stat_gpio_irq(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g13; // 0x8f60387c
    g9 = 62;
    g13 = &g7;
    int32_t result = g7;
    unregister_msm_gpio_int_handler(62, a2, a3, result, a1, result);
    if (result != g7) {
        // 0x8f6038a4
        __stack_chk_fail();
        return result;
    ...
    // 0x8f6038a8
    g13 = v1;
    g9 = msm_gpio_int_disable(62, a2, result, result, v1, g8 ? -0x70987650 : 0);
    return result;
}
