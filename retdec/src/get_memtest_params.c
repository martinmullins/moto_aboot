...
// Address range: 0x8f61ec38 - 0x8f61ed4f
char * get_memtest_params(char * a1, int32_t a2) {
    int32_t v1 = g36; // 0x8f61ec38
    int32_t v2 = g37; // 0x8f61ec38
    int32_t str4 = (int32_t)a1; // R5
    g37 = a2;
    int32_t v3 = g27;
    g36 = &g27;
    int32_t str;
    ...
    *(char *)str4 = 0;
    ...
    char str3 = 0; // bp-52
    int32_t v4;
    int32_t v5 = __utag_gets_constprop_5("memtest_mode", (int32_t)&str, 16, 0, v4, 0, 0, 0, 0, 0, 0, str, 0, 0, 0, v3, 0); // 0x8f61ec8c
    int32_t v6 = v5; // R0
    int32_t v7 = 0; // 0x8f61ed30_23
    if (v5 != 0) {
        int32_t strcmp_rc = strcmp((char *)&str, "auto"); // 0x8f61eca0
        v6 = strcmp_rc;
        if (strcmp_rc == 0) {
            int32_t v8 = __utag_gets_constprop_5("memtest_cycles", (int32_t)&str2, 8, 0, v4, 0, 0, 0, 0, 0, 0, str, 0, 0, 0, v3, 0); // 0x8f61ecb8
            int32_t v9 = 0;
            if (v8 == 0) {
                // 0x8f61ecc4
                strncpy(&str2, g4, 8);
            ...
            int32_t v10 = &str3;
            if (__utag_gets_constprop_5("memtest_blocks", v10, 8, 0, v4, 0, 0, (int32_t)str2, 0, v9, 0, str, 0, 0, 0, v3, 0) == 0) {
                // 0x8f61ecf0
                strncpy(&str3, g4, 8);
                // branch -> 0x8f61ed00
            }
            int32_t chars_printed = snprintf((char *)str4, g37, "%s:%s", &str2, (char *)v10);
            v6 = chars_printed;
            v7 = chars_printed;
            // branch -> 0x8f61ed18
        } else {
