...
// Address range: 0x8f67b608 - 0x8f67b643
int32_t __gnu_ldivmod_helper(uint32_t a1, int32_t a2, int64_t a3, int32_t a4) {
    int32_t v1 = a3;
    int32_t result = a1 / v1;
    uint64_t v2 = (int64_t)result * (a3 & 0xffffffff); // 0x8f67b628
    uint32_t v3 = (int32_t)v2; // 0x8f67b628
    int32_t v4;
    *(int32_t *)v4 = a1 - v3;
    *(int32_t *)(v4 + 4) = a2 - v1 * a2 - result * a4 - (int32_t)(v2 / 0x100000000) + (int32_t)(v3 > a1);
    return result;
}
