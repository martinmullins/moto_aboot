...
// Address range: 0x8f624044 - 0x8f62409f
int32_t is_fastboot_busy(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g57;
    int32_t v2;
    mutex_acquire((int32_t)&g41, a2, a3, v1, a1, v1, a3, g65, g66, g58, v2);
    mutex_release((int32_t)&g41, a2, a3, (int32_t)&g42, a1, v1, a3);
    int32_t result = g42 == 1; // 0x8f62407c
    g59 = result;
    if (v1 != g57) {
        // 0x8f624088
        __stack_chk_fail();
