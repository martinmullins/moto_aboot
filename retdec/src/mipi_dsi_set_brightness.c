...
// Address range: 0x8f644068 - 0x8f644117
int32_t mipi_dsi_set_brightness(char a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7) {
    int32_t v1 = a1;
    char * v2 = g21;
    int32_t v3 = (int32_t)v2;
    int32_t result = mipi_dsi_cmdmode_enable(print_log(2, (int32_t)"%s: set brightness to %d,bit=%d\n", (int32_t)"mipi_dsi_set_brightness", v1, 0x1000000 * a2 / 0x1000000, a2, a3, v3, g26, g27, g28, 0, a5)); // 0x8f644098
    int32_t v4;
    if (a2 == 8) {
        // 0x8f6440a4
        *(char *)&g6 = (char)v1;
        ...
        v4 = &g8;
        // 0x8f6440ec
        return mipi_dsi_cmds_tx(v4, 1, v3, v3, g26, g27, g28, 0, a5, a6, a7, 0);
    }
    // 0x8f6440c4
    *(char *)&g10 = (char)v1;
    *(char *)&g9 = (char)(v1 / 256) % 16;
    char * v5 = g21;
    if (v2 != v5) {
        // 0x8f6440e8
        __stack_chk_fail();
    ...
    v4 = &g7;
    // 0x8f6440ec
    return mipi_dsi_cmds_tx(v4, 1, v3, (int32_t)v5, g26, g27, g28, 0, a5, a6, a7, 0);
}
