...
// Address range: 0x8f64b2c0 - 0x8f64b353
int32_t strlcpy(int32_t a1, char * str) {
    ...
    int32_t v2 = 0; // R4
    int32_t v3 = g46 - 1; // 0x8f64b2dc
    int32_t v4 = 0; // 0x8f64b324
    if (v3 != 0) {
        int32_t v5 = 0; // 0x8f64b310
        int32_t v6; // 0x8f64b314
        while (true) {
            char v7 = *(char *)(v5 + v1); // 0x8f64b304
            if (v7 != 0) {
                // 0x8f64b310
                *(char *)(a1 + v5) = v7;
                v6 = v2 + 1;
    ...
    // 0x8f64b320
    *(char *)(a1 + v4) = 0;
    int32_t result = v2 + strlen((char *)(v2 + v1)); // 0x8f64b33c
    // 0x8f64b348
    return result;
}
