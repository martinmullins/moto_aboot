...
// Address range: 0x8f607220 - 0x8f6072cb
int32_t SecGetRndData(char * a1, unsigned char a2) {
    int32_t v1 = (int32_t)a1; // 0x8f607220_0
    int32_t v2 = a2;
    int32_t v3 = g15;
    if (a2 < 65) {
        int32_t v4 = (int32_t)&g7; // R5
        clock_ce_enable(1, v2, v3, (int32_t)&g15, v1, v3, g23);
        memset((char *)&g7, 0, 128);
        int32_t v5;
        char * v6 = mot_tzbsp_call(16, (int32_t)&g7, v2, (int32_t)&g15, v1, v3, g23, g24, g25, g26, g27, g16, v5); // 0x8f607274
        int32_t v7 = (int32_t)v6; // R8
        if (v6 == NULL) {
            // 0x8f607280
            cache_inv_range(v4, 0x1000000 * v2 / 0x1000000, v2, (int32_t)&g15);
            if (v7 == v2) {
                // 0x8f6072a8
                if (v3 != g15) {
                    // 0x8f6072b8
            ...
            char v8 = *(char *)(v4 + v7); // 0x8f607294
            *(char *)(v1 + v7) = v8;
            int32_t v9 = v7 + 1; // 0x8f60729c
            while (v9 != v2) {
                // if_8f607294_0_true
                v7 = v9;
                v8 = *(char *)(v4 + v7);
