...
// Address range: 0x8f6422f8 - 0x8f6423e7
int32_t fan54046_ibuslim_unlimited(void) {
    int32_t v1 = g76; // 0x8f6422f8
    int32_t v2 = g80; // 0x8f6422f8
    int32_t v3 = g75 ? -0x709aede4 : 0; // 0x8f6422f8
    int32_t v4 = g73;
    g80 = &g73;
    int32_t result; // 0x8f6423d8_2
    if (g56 == 0) {
        // 0x8f6423c0
        if (v4 != g73) {
            // 0x8f6423d0
    ...
    // 0x8f64231c
    int32_t v5;
    int32_t v6 = fan54046_modify(1, 1, 2, 1, v1, v4, g78, g79, v2, v3, v5, 0, 0); // 0x8f64232c
    g76 = v6;
    if (v6 > -1) {
        int32_t v7 = fan54046_modify(1, 3, 6, 2, v1, v4, g78, g79, v2, v3, v5, 0, 0); // 0x8f64236c
        g76 = v7;
        int32_t v8 = v7; // 0x8f6423d8_24
        if (v7 >= 0) {
            int32_t v9 = fan54046_modify(2, 35, 2, 6, v1, v4, g78, g79, v2, v3, v5, 0, 0); // 0x8f642388
            g76 = v9;
            if (v9 >= 0) {
                // 0x8f642394
                if (v4 == g73) {
                    // 0x8f6423a4
                    g80 = v2;
                    return fan54046_modify(19, 1, 1, 1, g79, v2, v3, v5, 0, 0, 0, 0, 0);
                }
                // 0x8f6423d0
                __stack_chk_fail();
                // branch -> 0x8f6423d4
        ...
        if (v4 == g73) {
            // 0x8f642348
            g80 = v2;
            return print_log(-1, (int32_t)"fan540xx: Error setting CE_#\n", v4, v4, g79, v2, v3, v5, 0, 0, 0, 0, 0);
        }
        // 0x8f6423d0
        __stack_chk_fail();
        result = g76;
