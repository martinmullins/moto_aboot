...
// Address range: 0x8f63c470 - 0x8f63c4cb
int32_t set_content_to_show_33(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = g47;
    int32_t result = mutex_acquire((int32_t)&g43, a2, a3, v1, a1, v1, a3, g51, g52, 0, a5); // 0x8f63c488
    g44 |= a1;
    if (v1 == g47) {
        // 0x8f63c4b0
        return mutex_release((int32_t)&g43, a2, v1, v1, g51, g52, 0);
    }
    // 0x8f63c4ac
    __stack_chk_fail();
    return result;
