...
// Address range: 0x8f64829c - 0x8f6483af
int32_t tps65132_config(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g31 ? -0x709c0700 : 0; // 0x8f64829c
    int32_t v2 = g29;
    int32_t result = tps65132_init(a1, a2, a3, v2, a1, v2); // 0x8f6482b0
    if (result != 0) {
        // 0x8f64837c
        if (v2 != g29) {
            // 0x8f64838c
    ...
    int32_t v3 = a2 % 256; // 0x8f6482c0
    uint32_t v4 = (g14 / 0x186a0 + 216) % 256; // 0x8f6482e4
    int32_t v5 = qup_i2c_write_byte(g16, v3, 0, v4, a1, v2, a3, g37, g38, g39, g40); // 0x8f6482e8
    int32_t v6;
    if (g16 <= 0xffffffff) {
        // 0x8f6482f4
        print_log(2, (int32_t)"qup_i2c error!\n", v5, v4, a1, v2, a3, g37, g38, g39, g40, v1, v6);
        // branch -> 0x8f648300
    }
    uint32_t v7 = (g15 / 0x186a0 + 216) % 256; // 0x8f648320
    int32_t v8 = qup_i2c_write_byte(g16, v3, 1, v7, a1, v2, a3, g37, g38, g39, g40); // 0x8f648324
    if (g16 <= 0xffffffff) {
        // 0x8f648330
        print_log(2, (int32_t)"qup_i2c error!\n", v8, v7, a1, v2, a3, g37, g38, g39, g40, v1, v6);
        // branch -> 0x8f64833c
    }
    // 0x8f64833c
    qup_i2c_write_byte(g16, v3, 3, 3, a1, v2, a3, g37, g38, g39, g40);
    if (g16 > 0xffffffff) {
        // 0x8f64837c
        if (v2 != g29) {
            // 0x8f64838c
    ...
    if (v2 == g29) {
        // 0x8f648368
        return print_log(2, (int32_t)"qup_i2c error!\n", v2, v2, g37, g38, g39, g40, v1, v6, 0, 0, 0);
    }
    // 0x8f64838c
    __stack_chk_fail();
    // branch -> 0x8f648390
