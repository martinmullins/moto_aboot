...
// Address range: 0x8f6010a4 - 0x8f601103
int32_t set_blankflash_magic(char * a1, int32_t a2) {
    int32_t v1 = g19;
    int32_t result = set_download_mode(1, a2, g23, v1); // 0x8f6010b8
    int32_t v2 = g19;
    if (result == 0) {
        // 0x8f6010e8
        if (v1 == v2) {
        ...
        if (v1 == v2) {
            // 0x8f6010d4
            int32_t v3;
            return print_log(-1, (int32_t)"dload mode not supported by target\n", v1, v1, g25, 0, v3, 0, 0, 0, 0, 0, 0);
        }
    }
    // 0x8f6010f0
    __stack_chk_fail();
