...
// Address range: 0x8f624574 - 0x8f624613
int32_t oem_logo_usage(int32_t a1) {
    int32_t v1 = g29; // 0x8f624574
    g29 = &g14;
    int32_t v2 = g14;
    fboot_info("INFO", "usage: fastboot oem logo [options]", g27, v2);
    fboot_info("INFO", (char *)&g9, g27, v2);
    fboot_info("INFO", "options:", g27, v2);
    fboot_info("INFO", "  show <name>    Show specified logo", g27, v2);
    fboot_info("INFO", "  list           List all logos", g27, v2);
    int32_t result = fboot_info("INFO", "  help           Show this usage", g27, v2); // 0x8f6245c8
    g24 = result;
    g27 = v2;
    int32_t v3 = g14;
    g28 = v3;
    ...
    // 0x8f6245e0
    g29 = v1;
    int32_t result2 = fboot_info("INFO", (char *)&g9, v2, v2); // 0x8f6245f0
    g24 = result2;
    return result2;
}
