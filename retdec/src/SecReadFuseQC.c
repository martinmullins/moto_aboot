...
// Address range: 0x8f606e68 - 0x8f606ecb
int32_t SecReadFuseQC(int32_t a1) {
    int32_t v1 = g19;
    int32_t v2 = get_tz_buffer(); // 0x8f606e7c
    *(int16_t *)v2 = -1;
    int32_t v3;
    mot_tzbsp_call(1, a1, v2, -1, a1, v1, g25, g26, g27, 0, v3, 0, 0);
    cache_inv_range(v2, 4, v2, -1);
    if (v1 != g19) {
        // 0x8f606ebc
        __stack_chk_fail();
        // branch -> 0x8f606ec0
