...
// Address range: 0x8f63a38c - 0x8f63a44b
int32_t ramdump_view_init(int32_t a1, int32_t a2) {
    int32_t v1 = g52 ? -0x709c73b8 : 0; // 0x8f63a38c
    int32_t v2 = g35;
    timer_initialize((int32_t)&g31, a2, g56, v2);
    int32_t v3;
    int32_t result = show(0, 0, g56, (int32_t)&g2, a1, v2, g57, g58, g59, v1, v3, 0, 0, 0, 0); // 0x8f63a3bc
    char v4 = *(char *)&g16; // 0x8f63a3c0
    if (v4 == 0) {
        // 0x8f63a3cc
        return print_log(1, (int32_t)"Waiting for display to be ready\n", g56, (int32_t)v4, a1, v2, g57, g58, g59, v1, v3, 0, 0);
    }
    // 0x8f63a3f8
    if (v2 == g35) {
        // 0x8f63a408
        sod_notify((int32_t)&g7, 0, v2, v2);
        return &g7;
    }
    // 0x8f63a42c
    __stack_chk_fail();
