...
// Address range: 0x8f65385c - 0x8f6539af
char * get_partition_by_name(char * a1) {
    int32_t v1 = g38; // 0x8f65385c
    int32_t v2 = g40; // 0x8f65385c
    g40 = &g29;
    int32_t v3 = (int32_t)a1; // R5
    int32_t str;
    int32_t v4 = &str; // 0x8f653870_0
    int32_t v5 = g29;
    memset((char *)&str, 0, 72);
    char * v6 = g18;
    g38 = (int32_t)v6;
    int32_t v7;
    int32_t v8; // 0x8f653928
    if (v6 == NULL) {
        // 0x8f653898
        print_log(1, (int32_t)"no partition defined!\n", 72, (int32_t)&g18, v7, str, 0, 0, 0, 0, 0, 0, 0);
        // branch -> 0x8f653928
        // 0x8f653928
        v8 = g38;
        // branch -> 0x8f653978
    ...
    int32_t v9 = v3; // 0x8f6538a8
    if (v9 == 0) {
        // 0x8f6538b0
        print_log(0, (int32_t)"Invalid partition name!\n", 72, (int32_t)&g18, v7, str, 0, 0, 0, 0, 0, 0, 0);
        // branch -> 0x8f653978
        // 0x8f653978
        if (v5 != g29) {
            // 0x8f653988
    ...
    // 0x8f6538c0
    v3 = 0;
    str_to_utf((char *)v9, v4, 72, (int32_t)&g18, v7, str, 0, 0);
    int32_t v10 = g17;
    int32_t v11 = v3; // 0x8f6538f44
    if (v11 < v10) {
        // 0x8f653974
        // branch -> 0x8f653978
    } else {
        // 0x8f6538fc
        int32_t str2;
        int32_t v12 = &str2; // 0x8f653904_0
        // branch -> 0x8f6538fc
        while (true) {
            // 0x8f6538fc
            g40 = 64 * v11 + (int32_t)&g24;
            memset((char *)&str2, 0, 72);
            if (memcmp((char *)&str, (char *)(g38 + 56), 72) == 0) {
                // 0x8f653928
                v8 = g38;
                // branch -> 0x8f653978
            } else {
                // 0x8f6538d8
                if (strlen((char *)g40) != 0) {
                    // 0x8f653930
                    str_to_utf((char *)g40, v12, 72, v10, v7, str, 0, 0);
                    if (memcmp((char *)&str, (char *)&str2, 72) == 0) {
                        // 0x8f653954
                        print_log(1, (int32_t)"Found alias %s for %s\n", g40, get_entry_name(g38, v12, 72, v10, v7, str, 0, 0), v7, str, 0, 0, 0, 0, 0, 0, 0);
                        // branch -> 0x8f653928
                        // 0x8f653928
                        v8 = g38;
                        // branch -> 0x8f653978
