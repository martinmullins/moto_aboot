...
// Address range: 0x8f626ec4 - 0x8f62701f
int32_t handle_fboot_oem_command_verified(int32_t a1, int32_t a2) {
    int32_t v1 = g34; // 0x8f626ec4
    g34 = &g25;
    int32_t v2 = g25;
    int32_t v3 = v2; // R3
    int32_t v4 = (int32_t)"Not found valid partition table!";
    int32_t v5;
    if (is_gpt_initialized(a1, a2) != 0) {
        // 0x8f626ee8
        v3 = 0;
        transit_to_state(6, 0, 0, 0, a1, v2, v1, 0, v5, 0, 0, 0, 0, 0);
        v4 = (int32_t)"Unexpected error, please reboot and try again!";
        // branch -> 0x8f626fc8
    }
    // 0x8f626fc8
    fboot_info((int32_t)"INFO", v4, 0, v3, a1, v2, v1, 0, v5, 0, 0);
    if (v2 != g25) {
        // 0x8f626fe0
        __stack_chk_fail();
        // branch -> 0x8f626fe4
