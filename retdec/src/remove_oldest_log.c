...
// Address range: 0x8f65703c - 0x8f6570c7
int32_t remove_oldest_log(int32_t result) {
    int32_t v1 = g36; // 0x8f657040
    int32_t v2 = g37; // 0x8f657040
    int32_t v3 = g27;
    g37 = &g27;
    int32_t v4 = (int32_t)g21;
    g36 = v4;
    int32_t v5 = v3;
    if (g21 != (char *)&g20) {
        int32_t v6 = *(int32_t *)(v4 + 4); // 0x8f657060
        *(int32_t *)v6 = *(int32_t *)g21;
        *(int32_t *)(*(int32_t *)g36 + 4) = v6;
        *(int32_t *)(g36 + 4) = 0;
        *(int32_t *)g36 = 0;
        free((char *)*(int32_t *)(v4 + 12));
        int32_t v7 = g36; // 0x8f657088
        result = v7;
        free((char *)v7);
        v5 = g27;
        // branch -> 0x8f657090
