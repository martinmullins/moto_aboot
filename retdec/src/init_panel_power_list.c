...
// Address range: 0x8f61882c - 0x8f618907
int32_t init_panel_power_list(int32_t a1, int32_t a2) {
    int32_t v1 = g34; // 0x8f61882c
    int32_t v2 = g35; // 0x8f61882c
    g34 = &g22;
    g35 = (int32_t)&g11;
    int32_t v3 = a1 + 476; // 0x8f618840
    int32_t v4 = g22;
    memcpy((char *)&g11, (char *)v3, 16);
    set_backlight_dev(g12, v3, 16, v4);
    memcpy((char *)&g23, (char *)(a1 + 104), 120);
    g5 = *(int32_t *)(a1 + 224);
    if (*(int32_t *)(a1 + 528) != 0) {
        // 0x8f618884
        memcpy((char *)&g25, (char *)(a1 + 228), 120);
        g4 = *(int32_t *)(a1 + 348);
        // branch -> 0x8f6188a0
    }
    char * dest_mem = memcpy((char *)&g24, (char *)(a1 + 352), 120); // 0x8f6188ac
    int32_t result = (int32_t)dest_mem; // 0x8f6188ac_7
    g29 = result;
    g3 = *(int32_t *)(a1 + 472);
    g13 = *(int32_t *)(a1 + 40);
    if (v4 != g22) {
