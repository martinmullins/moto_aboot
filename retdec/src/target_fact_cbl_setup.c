...
// Address range: 0x8f601144 - 0x8f6011af
int32_t target_fact_cbl_setup(char * a1, int32_t a2) {
    int32_t v1 = (int32_t)a1; // 0x8f601144_0
    g34 = v1;
    int32_t v2 = g31;
    g38 = v2;
    int32_t v3 = is_charger_smb1359(v1, a2, g37, v2, v1, v2, g39, g33); // 0x8f601154
    g34 = v3;
    int32_t v4;
    if (v3 != 0) {
        // 0x8f601160
        g34 = smb1359_config_for_fact_cbl(v3, a2, g37);
        // branch -> 0x8f60118c
        // 0x8f60118c
        g34 = 0;
        v4 = g31;
    ...
    int32_t v5 = is_charger_fan54046(0, a2, g37, v2); // 0x8f601168
    g34 = v5;
    if (v5 == 0) {
        int32_t v6 = is_charger_bq24296(0, a2, g37, v2, v1, v2, g39, g33); // 0x8f60117c
        g34 = v6;
        if (v6 != 0) {
            // 0x8f601188
            g34 = bq24296_config_for_fact_cbl(v6, a2, g37);
            // branch -> 0x8f60118c
        }
    } else {
        // 0x8f601174
        g34 = fan54046_ibuslim_unlimited(v5, a2, g37);
        // branch -> 0x8f60118c
    }
    // 0x8f60118c
    g34 = 0;
