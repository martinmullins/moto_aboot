...
// Address range: 0x8f638300 - 0x8f638393
int32_t stop_charging(int32_t a1, int32_t a2) {
    int32_t v1 = g65; // 0x8f638300
    g65 = &g57;
    g63 = (int32_t)"stop_charging";
    int32_t result3 = g57;
    int32_t v2;
    int32_t v3 = print_log(2, (int32_t)"%s called\n", (int32_t)"stop_charging", result3, a1, result3, v1, g58, v2, 0, 0, 0, 0); // 0x8f63831c
    int32_t v4 = is_charging_enabled(disable_charger_gone_irq(v3, (int32_t)"%s called\n", (int32_t)"stop_charging", result3), (int32_t)"%s called\n", (int32_t)"stop_charging", result3); // 0x8f638324
    g59 = v4;
    if (v4 != 0) {
        int32_t result = g47 | 0x40000000; // 0x8f63833c
        g47 = result;
        int32_t v5 = event_signal((int32_t)&g46, 1, (int32_t)"stop_charging", result, a1, result3, v1, g58); // 0x8f638344
        g59 = v5;
        return result;
    }
    // 0x8f638350
    ...
    g63 = (int32_t)"stop_charging";
    g65 = v1;
    g59 = print_log(2, (int32_t)"%s ended\n", (int32_t)"stop_charging", result3, v1, g58, v2, 0, 0, 0, 0, 0, 0);
    return result3;
}
