...
// Address range: 0x8f63ef28 - 0x8f63efcf
int32_t get_vertical_barcode_pos_isra_1_50(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g69; // 0x8f63ef28
    int32_t v2 = g73; // 0x8f63ef28
    char * v3 = g44;
    int32_t v4 = (int32_t)v3;
    uint32_t v5 = font_get_y(a1, a2, a3, v4); // 0x8f63ef3c
    int32_t result = v5 / 2; // 0x8f63ef44
    g69 = result;
    if (a1 != 0) {
        int32_t v6 = display_get_screen_height(v5, a2, a3, v4); // 0x8f63ef50
        int32_t v7 = font_get_y(v6, a2, a3, v4); // 0x8f63ef58
        int32_t v8 = get_barcode_scale(v7, a2, a3, v4, a1, v4, a3, v1); // 0x8f63ef60
        int32_t v9 = font_get_y(v8, a2, a3, v4); // 0x8f63ef68
        g73 = v9;
        int32_t v10 = font_get_y(v9, a2, a3, v4); // 0x8f63ef70
        int32_t v11 = v8 * v7 + v9; // 0x8f63ef74
        g73 = v11;
        int32_t v12 = font_get_y(v10, a2, a3, v4); // 0x8f63ef7c
        int32_t v13 = get_barcode_scale(v12, a2, a3, v4, a1, v4, a3, v1); // 0x8f63ef88
        int32_t v14 = g69 + (v13 * v12 + font_get_y(v13, a2, a3, v4) + (v6 - g69 - v10 + -4 * v11) / 3) * a1; // 0x8f63efac
        result = v14;
        // branch -> 0x8f63efb0
    }
    // 0x8f63efb0
