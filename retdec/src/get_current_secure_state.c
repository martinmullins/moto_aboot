...
// Address range: 0x8f674cc4 - 0x8f674d17
int32_t get_current_secure_state(int32_t a1, int32_t a2) {
    int32_t v1 = g47; // 0x8f674cc4
    int32_t v2 = g48; // 0x8f674cc4
    g45 = &g31;
    int32_t v3 = g31;
    g47 = &g31;
    char v4 = *(char *)&g29; // 0x8f674cdc
    g48 = (int32_t)&g29;
    char v5 = v4; // 0x8f674cf8
    int32_t v6 = v3;
    if (v4 == 0) {
        // 0x8f674cec
        detect_current_secure_state(a1, (int32_t)v4, (int32_t)&g31, (int32_t)&g29, a1, v3);
        v5 = *(char *)&g29;
        v6 = g31;
        // branch -> 0x8f674cf0
    }
