...
// Address range: 0x8f60788c - 0x8f60799f
int32_t sdhci_set_uhs_mode(int32_t * a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6) {
    int32_t v1 = g22; // 0x8f607894
    int32_t v2 = g25; // 0x8f607894
    int32_t v3 = g17; // 0x8f607894
    int32_t v4 = g16;
    int32_t v5 = (int32_t)a1; // R5
    int32_t v6 = v1 & -0x10000 | 0xfff8; // 0x8f6078a8
    g22 = v6;
    g25 = v3;
    int32_t v7 = *a1; // 0x8f6078b8
    int16_t * v8 = (int16_t *)(v7 + 44); // 0x8f6078bc_0
    int32_t v9 = (int32_t)*v8; // 0x8f6078bc
    int32_t result = v9; // R0
    *v8 = (int16_t)(v9 & (a2 & -0x10000 | 0xfffb));
    int32_t v10 = (int32_t)*(int16_t *)(v7 + 62); // 0x8f6078c8
    int32_t v11 = v10 & v6; // 0x8f6078cc
    g22 = v11;
    int32_t v12; // R1
    int32_t v13;
    int16_t v14;
    switch (a2) {
        default: {
            // 0x8f60791c
            int32_t v15;
            print_log(-1, (int32_t)"Error: Invalid UHS mode: %x\n", a2, v10, v15, 0, 0, v4, 0, v1, g23, g24, v2);
            int32_t v16 = _panic(g25, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm_shared/sdhci.c", (int32_t)&g7 & -0x10000 | 317, (int32_t)&g7, 0, 0); // 0x8f607940
            result = v16;
            v12 = 0;
            v14 = g22;
            // branch -> 0x8f607950
    ...
    *(int16_t *)(*(int32_t *)v5 + 62) = v14;
    ...
    g25 = v2;
    g17 = v3;
    return sdhci_clk_supply(v5, v12, v4, v4, v1, g23, g24, v2, v3, a5, a6, 0, 0, 0);
}
