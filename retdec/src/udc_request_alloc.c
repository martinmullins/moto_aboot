...
// Address range: 0x8f6050f0 - 0x8f605193
int32_t udc_request_alloc(void) {
    int32_t v1 = g34; // 0x8f6050f0
    int32_t v2 = g35; // 0x8f6050f0
    int32_t v3 = g36; // 0x8f6050f0
    g34 = &g22;
    g36 = g28;
    g35 = &g22;
    char * v4 = memalign(64, 64); // 0x8f605114
    int32_t result = (int32_t)v4; // 0x8f605114_5
    if (v4 == NULL) {
        // 0x8f605120
        _panic(g36, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm_shared/hsusb.c", 264, (int32_t)"req", 0, 0);
        // branch -> 0x8f60513c
    }
    // 0x8f60513c
    g34 = 0;
    *(int32_t *)result = 0;
    *(int32_t *)(result + 4) = g34;
    char * v5 = memalign(64, 64); // 0x8f605150
    *(int32_t *)(result + 16) = (int32_t)v5;
    memset(v5, g34, 64);
    // 0x8f60517c
    g34 = v1;
    g35 = v2;
