...
// Address range: 0x8f63c8c8 - 0x8f63c943
int32_t unlock_abort(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g60; // 0x8f63c8c8
    g60 = 0;
    int32_t v2 = g46;
    int32_t v3;
    print_log(6, (int32_t)"unlocking canceled", a3, v2, a1, v2, a3, v1, g61, g55, v3, 0, 0);
    int32_t v4 = g60; // 0x8f63c8ec
    *(char *)&g49 = (char)v4;
    event_signal((int32_t)&g48, v4, a3, (int32_t)&g49, a1, v2, a3, v1);
    int32_t result = show((int32_t)"fastboot_screen", g60, a3, (int32_t)&g3, a1, v2, a3, v1, g61, g55, v3, 0, 0, 0, 0); // 0x8f63c90c
    if (v2 != g46) {
        // 0x8f63c920
        __stack_chk_fail();
        // branch -> 0x8f63c924
