...
// Address range: 0x8f63b864 - 0x8f63ba1f
int32_t init_26(char * a1, int32_t a2) {
    int32_t v1 = (int32_t)a1; // 0x8f63b864_0
    int32_t v2 = g79; // 0x8f63b864
    int32_t v3 = g80; // 0x8f63b864
    g80 = (int32_t)&g40;
    int32_t result = g73;
    g45 = 0xff6040;
    g46 = 0;
    ...
    *(char *)&g40 = 1;
    g48 = *(int32_t *)&g16;
    g49 = (char *)*(int32_t *)&g18;
    int32_t str = get_console_string(v1, 0xffffff, (int32_t)&g53); // 0x8f63b8c8
    int32_t v4 = &g41; // R3
    g41 = g48;
    int32_t v5 = *(int32_t *)&g17; // 0x8f63b8dc
    int32_t v6 = str; // R2
    g50 = str;
    g42 = (char *)v5;
    g43 = str;
    int32_t len = strlen((char *)str); // 0x8f63b8ec
    g79 = &g51;
    g52 = &g51;
    g51 = &g51;
    int32_t v7; // 0x8f63b918
    int32_t v8; // 0x8f63b918
    if (len == 0) {
        // if_8f63b900_0_true
        v6 = 2;
        g26 = 0;
        ...
        v8 = &g23;
        v7 = 2;
        // branch -> after_if_8f63b914_0
    } else {
        // after_if_8f63b914_0.critedge
        v8 = v4;
        v7 = v6;
        // branch -> after_if_8f63b914_0
    }
    // after_if_8f63b914_0
    append_menu_item((int32_t)&g29, v5, v7, v8, v1, result, v2);
    append_menu_item((int32_t)&g24, v5, v6, v4, v1, result, v2);
    append_menu_item((int32_t)&g25, v5, v6, v4, v1, result, v2);
    append_menu_item((int32_t)&g27, v5, v6, v4, v1, result, v2);
    append_menu_item((int32_t)&g28, v5, v6, v4, v1, result, v2);
    append_menu_item((int32_t)&g19, v5, v6, v4, v1, result, v2);
    int32_t v9 = append_menu_item((int32_t)&g31, v5, v6, v4, v1, result, v2); // 0x8f63b948
    update_console_menu_name(v9, v5, v6, v4);
    append_menu_item((int32_t)&g32, v5, v6, v4, v1, result, v2);
    append_menu_item((int32_t)&g22, v5, v6, v4, v1, result, v2);
    append_menu_item((int32_t)&g21, v5, v6, v4, v1, result, v2);
    append_menu_item((int32_t)&g30, v5, v6, v4, v1, result, v2);
    append_menu_item((int32_t)&g20, v5, v6, v4, v1, result, v2);
    g47 = get_first_selected_menu(g79, 0, v6);
    *(char *)g80 = 0;
    if (result != g73) {
        // 0x8f63b9a4
        __stack_chk_fail();
