...
// Address range: 0x8f639c10 - 0x8f639c97
int32_t ondraw(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g45; // 0x8f639c10
    g45 = &g32;
    int32_t v2 = g32;
    int32_t result2 = display_logo((int32_t)*(char *)&g22, a2); // R0
    char v3 = *(char *)&g24; // 0x8f639c30
    if (v3 == 1) {
        int32_t v4 = g41 ? -0x709e6520 : 0; // 0x8f639c10
        int32_t result = timer_cancel((int32_t)&g23, a2, a3, (int32_t)v3, a1, v2, v1, v4); // 0x8f639c40
        return result;
    }
    // 0x8f639c58
    if (v2 == g32) {
        // 0x8f639c6c
        g45 = v1;
        return display_draw_text_at_line(0, 0, 1, v2);
    }
    // 0x8f639c68
    __stack_chk_fail();
    return result2;
