...
// Address range: 0x8f6464ec - 0x8f64653f
int32_t pm8x41_get_batt_voltage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g47;
    int32_t v2;
    int32_t result = pm8x41_adc_channel_read(6, a2, a3, v1, a1, v1, a3, g53, g54, g48, v2); // 0x8f646500
    if (result == 0) {
        // 0x8f64650c
        print_log(-1, (int32_t)"Error getting battery Voltage\n", a3, v1, a1, v1, a3, g53, g54, g48, v2, 0, 0);
        // branch -> 0x8f646518
    }
    // 0x8f646518
    if (v1 != g47) {
