...
// Address range: 0x8f6079a0 - 0x8f607a2b
int32_t sdhci_set_bus_width(int32_t * a1, int32_t a2) {
    int32_t v1 = g38;
    char * v2 = (char *)(*a1 + 40); // 0x8f6079c0_0
    int32_t v3 = (int32_t)*v2; // 0x8f6079c01
    switch (a2) {
        default: {
            // 0x8f6079d0
            int32_t result; // R0
            if (a2 == 2) {
                ...
                *v2 = (char)(32 | v3);
                ...
                // 0x8f6079d8
                int32_t v4;
                print_log(-1, (int32_t)"Bus width is invalid: %u\n", a2, (int32_t)&g38, (int32_t)a1, v1, g53, g46, v4, 0, 0, 0, 0);
                result = 1;
                // branch -> 0x8f607a08
            }
            // 0x8f607a08
