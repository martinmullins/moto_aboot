...
// Address range: 0x8f67b2cc - 0x8f67b38b
void function_8f67b2cc(void) {
    int32_t v1 = g15;
    int32_t v2 = g13;
    int32_t v3 = v2; // R3
    if (v2 == 0) {
        int32_t v4 = 0; // 0x8f67b318
        // branch -> 0x8f67b2f8
        while (true) {
            int32_t v5 = 8; // 0x8f67b3087
            int32_t v6 = v4; // 0x8f67b3105
            int32_t v7 = 0x80000000 * v6 >> 31 & -0x12477ce0 ^ v6 / 2; // 0x8f67b310
            // branch -> 0x8f67b300
            while (v5 != 1) {
                // 0x8f67b300
                v5--;
                v6 = v7;
                v7 = 0x80000000 * v6 >> 31 & -0x12477ce0 ^ v6 / 2;
                // continue -> 0x8f67b300
            }
            // 0x8f67b318
            *(int32_t *)((int32_t)&g14 + 4 * v4) = v7;
            int32_t v8 = v3 + 1; // 0x8f67b31c
            v3 = v8;
            if (v8 == 256) {
                // break -> 0x8f67b328
                break;
