...
// Address range: 0x8f6063a0 - 0x8f60642b
int32_t get_udc_device(char * a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g57;
    int32_t v2 = is_validation_enabled(a1, a2, a3, v1); // 0x8f6063b0
    int32_t v3 = target_product_name(v2, a2, a3, v1); // 0x8f6063cc
    char * v4 = v2 == 0 ? "NS" : (char *)&g14;
    snprintf((char *)&g35, 35, "Fastboot %s %s", (char *)v3, v4);
    g24 = (char *)&g35;
    if (v1 != g57) {
        // 0x8f606408
        __stack_chk_fail();
