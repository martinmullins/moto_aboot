...
// Address range: 0x8f650364 - 0x8f65040b
int32_t led_blink(int32_t a1, int32_t a2) {
    char * v1 = g40;
    int32_t v2 = g35;
    int32_t v3 = v2; // 0x8f65039c
    int32_t v4 = a2; // 0x8f65039c
    if (v2 == 0) {
        int32_t v5 = timer_initialize((int32_t)&g38, a2, g45, 0); // R1
        *(int32_t *)(int32_t)&g35 = 1;
        v3 = 1;
        v4 = v5;
        // branch -> 0x8f650398
    }
    int32_t result = timer_cancel((int32_t)&g38, v4, g45, v3, a1, (int32_t)v1, g47, g48); // 0x8f65039c
    *(char *)&g37 = *(char *)&g36;
    char * v6 = g40;
    if (a1 == 0) {
        // 0x8f6503e4
        ...
        if (v1 == v6) {
            // 0x8f6503c8
            timer_set_periodic((int32_t)&g38, a1, (int32_t)&g2, 0, g47, g48, g49);
            return &g38;
        }
    }
    // 0x8f6503ec
