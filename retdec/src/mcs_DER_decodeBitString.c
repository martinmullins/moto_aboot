...
// Address range: 0x8f664d9c - 0x8f664e2f
int32_t mcs_DER_decodeBitString(int32_t a1, uint32_t a2, int32_t a3) {
    int32_t v1 = g23;
    int32_t result;
    if (a2 == 0) {
        // after_if_8f664db0_0.thread
        // branch -> 0x8f664e08
        // 0x8f664e08
        *(int16_t *)(a3 + 2) = (int16_t)(a2 - 1);
        result = g23;
        if (v1 != result) {
            // 0x8f664e20
            __stack_chk_fail();
    ...
    int32_t v2 = *(int32_t *)(a3 + 4); // 0x8f664dbc
    if (v2 == 0 || *(int16_t *)(a3 + 2) != 2) {
        // 0x8f664e04
        // branch -> 0x8f664e08
        // 0x8f664e08
        *(int16_t *)(a3 + 2) = (int16_t)(a2 - 1);
        ...
        if (a2 > 1) {
            ...
            if (a2 >= 2) {
                ...
                if (a2 > 2) {
                    // if_8f664dfc_0_true
                    v5 = *(char *)(a1 + 2);
                    v4 = (int32_t)v5 | 256 * v3;
                    // branch -> after_if_8f664dfc_0
                } else {
                    // after_if_8f664df4_0
                    v4 = 256 * v3;
                    // branch -> after_if_8f664dfc_0
