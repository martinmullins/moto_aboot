...
// Address range: 0x8f6729b4 - 0x8f672a17
int32_t mot_sst_pal_write_token(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    // 0x8f6729b4
    if (a1 == 0) {
        // after_if_8f6729c0_0.thread
        // branch -> 0x8f6729f4
        // 0x8f672a08
        return 255;
    }
    int32_t v1 = g19;
    int32_t v2; // R0
    int32_t v3; // 0x8f672a0c_23
    int32_t v4;
    if (add_sp_block((int32_t)"sst_token", a2, 60, 0, a1, a2, a3, v1, g25, 0, v4, 0, 0, 0, 0, 0, 0) == 0) {
        // if_8f6729f0_0_true
        v2 = 0;
        v3 = 0;
        // branch -> 0x8f6729f4
