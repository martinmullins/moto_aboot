...
// Address range: 0x8f649a50 - 0x8f649ae7
int32_t heap_free(void) {
    int32_t v1 = g23;
    int32_t result; // 0x8f649a90
    if (g25 == 0) {
        // 0x8f649ad8
        return result;
        // 0x8f649ad4
    ...
    int32_t v2 = g7;
    int32_t v3 = &g7; // R5
    int32_t v4 = v2 + 1; // 0x8f649a74
    g7 = v4;
    int32_t v5 = g25; // 0x8f649a88
    if (v2 == 0) {
        // 0x8f649a84
        function_8f619448(g25);
        v5 = g25;
        // branch -> 0x8f649a88
    }
    int32_t v6 = *(int32_t *)(v5 - 8); // 0x8f649a88
    *(int32_t *)(v6 + 8) = *(int32_t *)(v5 - 4);
    result = heap_insert_free_chunk(v6, g26, v4);
    int32_t v7 = g7 - 1; // 0x8f649a98
    *(int32_t *)v3 = v7;
    if (v7 == 0) {
        // 0x8f649aa8
        if (v1 == g23) {
