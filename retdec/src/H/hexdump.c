...
// Address range: 0x8f64853c - 0x8f64860b
void hexdump(int32_t * a1, int32_t a2) {
    ...
    int32_t v4 = v2;
    if (a2 == 0) {
        int32_t v5 = v1; // 0x8f64856c
        while (true) {
            // 0x8f64856c
            printf("0x%08lx: ", v5);
            int32_t v6 = v3; // 0x8f648578
            int32_t v7 = *(int32_t *)(v6 + 12); // 0x8f648578
            int32_t v8 = 0; // R5
            int32_t v9 = *(int32_t *)(v6 + 4); // 0x8f648588
            int32_t v10 = *(int32_t *)(v6 + 8); // 0x8f648588
            printf("%08x %08x %08x %08x |", *(int32_t *)v6, v9, v10, v7);
            int32_t v11 = v8; // 0x8f648590
            // branch -> 0x8f648590
            while (true) {
                int32_t c = (int32_t)*(char *)(v3 + v11); // 0x8f648590
                int32_t v12 = c; // R7
                if (isprint(c) == 0) {
                    // 0x8f6485b4
                    printf(g2);
