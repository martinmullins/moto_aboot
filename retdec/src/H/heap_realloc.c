...
// Address range: 0x8f649ae8 - 0x8f649b7b
int32_t heap_realloc(char * a1) {
    int32_t v1 = (int32_t)a1;
    g28 = v1;
    int32_t v2 = g32; // 0x8f649aec
    int32_t v3 = g29; // 0x8f649af0
    g34 = v3;
    int32_t result = g24;
    g32 = v1;
    if (v3 == 0) {
    ...
    int32_t v4 = heap_alloc(v3, 0, result, (int32_t)&g24, v1, result, g30, v2); // 0x8f649b10
    if (v4 == 0) {
        // after_if_8f649b18_0.thread
        // branch -> 0x8f649b58
    } else {
        // after_if_8f649b18_0
        g33 = v4;
        if (g32 != 0) {
            uint32_t v5 = *(int32_t *)(g32 - 4); // 0x8f649b24
            g29 = g32;
            int32_t v6 = v5; // 0x8f649b34
            if (g34 < v5) {
                // if_8f649b30_0_true
                v6 = g34;
                // branch -> after_if_8f649b30_0
            }
            // after_if_8f649b30_0
            memcpy((char *)v4, (char *)g32, v6);
            g28 = g32;
            heap_free();
            // branch -> 0x8f649b58
        }
