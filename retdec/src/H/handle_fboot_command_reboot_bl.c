...
// Address range: 0x8f623eec - 0x8f623f53
int32_t handle_fboot_command_reboot_bl(int32_t a1, int32_t a2) {
    int32_t v1 = g20; // 0x8f623eec
    int32_t v2 = g11;
    int32_t v3;
    print_log(1, (int32_t)"rebooting the device to fastboot mode\n", g18, v2, a1, v2, v1, g15, v3, 0, 0, 0, 0);
    fboot_ack((int32_t)"OKAY", (int32_t)"rebooting to bootloader", g18, v2, a1, v2, v1, g15, v3, 0);
    mdelay(100, (int32_t)"rebooting to bootloader", g18, v2);
    reboot_bootloader(0, (int32_t)"rebooting to bootloader", g18, v2);
    g18 = v2;
    g16 = 1;
    if (v2 != g11) {
        // 0x8f623f38
