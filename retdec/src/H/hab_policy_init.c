...
// Address range: 0x8f675c08 - 0x8f675ca7
int32_t hab_policy_init(void) {
    int32_t v1 = g52; // 0x8f675c08
    g52 = (int32_t)&g41;
    int16_t * v2 = g41;
    int32_t v3 = (int32_t)v2;
    int32_t v4 = 0; // R0
    int32_t v5; // 0x8f675c84_22
    int32_t v6;
    if (hab_rsa_init(g46, g47, g50, v3, g46, v3, v1, g45, v6) > -1) {
        // 0x8f675c38
        g19 = &g43;
        g20 = g40;
        g17 = &g44;
        ...
        // 0x8f675c24
        print_log(0, (int32_t)"Failed to init hab rsa\n", g50, v3, g46, v3, v1, g45, v6, 0, 0, 0, 0);
        v4 = -1;
        v5 = -1;
        // branch -> 0x8f675c6c
    }
    // 0x8f675c6c
    int32_t result; // 0x8f675c84_2
    if (v2 != g41) {
        // 0x8f675c7c
        __stack_chk_fail();
        result = v4;
