...
// Address range: 0x8f66dc7c - 0x8f66de4b
int32_t hab_csf_check(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g36; // 0x8f66dc7c
    g36 = &g15;
    g32 = 0;
    int32_t v2 = g15;
    g31 = (int32_t)memset((char *)&g16, 0, 1000);
    if ((a1 + 255) % 256 <= 1) {
        // 0x8f66dcbc
        if (a2 != 0) {
            // 0x8f66dcc4
            if (a1 == 0) {
                int32_t v3 = *(int32_t *)a2; // 0x8f66dcd8
                g32 = v3;
                *(int32_t *)&g21 = v3;
                int32_t v4 = 141;
                if (v3 != 0) {
          ...
          lab_0x8f66de00_2:;
            int32_t v5 = hab_su_type(); // 0x8f66de00
            g32 = &g15;
            g34 = v2;
            int32_t v6 = g15;
            g35 = v6;
            int32_t result = g36 % 256 | 256 * v5; // 0x8f66de20
            g31 = result;
            if (v2 == v6) {
                // 0x8f66de34
                g36 = v1;
