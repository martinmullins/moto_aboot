...
// Address range: 0x8f636478 - 0x8f6364db
int32_t sod_ramdump_flag_pulled(int32_t a1, int32_t a2) {
    // 0x8f636478
    g34 = a1;
    int32_t v1 = g31;
    g38 = v1;
    int32_t v2;
    int32_t result = sod_init(a1, a2, g37, v1, a1, v1, g39, g33, v2, 0, 0, 0, 0, 0, 0); // 0x8f636488
    g34 = result;
    g38 = result;
    if (result == 0) {
        int32_t v3 = g31;
        ...
        int32_t * v4 = (int32_t *)(result + 4); // 0x8f636494_0
        *v4 = *v4 & -17;
        int32_t v5 = g31;
        g38 = v5;
        if (v1 == v5) {
            int32_t result2 = sh_flash(result, a2, v1, v1, g39, g33, v2, 0, 0); // 0x8f6364b8
            g34 = result2;
            return result2;
        }
    }
