...
// Address range: 0x8f6757ac - 0x8f675883
int32_t validate_hab_sparse_partition(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g14;
    int32_t v2 = get_entry_name(a2, a2, a3, v1, a1, a2, a3, v1); // 0x8f6757c8
    int32_t v3 = (int32_t)"Validating sparse partition %s...\n"; // R1
    int32_t v4;
    int32_t v5 = print_log(1, (int32_t)"Validating sparse partition %s...\n", v2, v1, a1, a2, a3, v1, g23, g24, g25, g17, v4); // 0x8f6757d8
    int32_t v6; // 0x8f6757f0
    int32_t v7; // 0x8f675800
    int32_t v8; // 0x8f675840
    int32_t v9; // R5
    int32_t result;
    int32_t v10; // 0x8f6757f4
    if (is_factory_product(v5, v3, v2, v1) != 0) {
        int32_t str = get_entry_name(a2, v3, v2, v1, a1, a2, a3, v1); // 0x8f675814
        v3 = (int32_t)"system";
        if (strcmp((char *)str, "system") == 0) {
            // 0x8f675828
            if (factory_otv_bypass(0, v3, v2, v1) != 0) {
                // 0x8f675858
                if (v1 != g14) {
                    // 0x8f675868
                    __stack_chk_fail();
            ...
            // 0x8f6757e8
            v9 = 0;
            v6 = get_entry_name(a2, v3, v2, v1, a1, a2, a3, v1);
            v10 = v9;
            v7 = get_sp_block(v6, v3, 0, 0, v10, a2, a3, v1, g23, g24, g25, g17, v4, 0, 0);
            result = 0;
            if (v7 != v9) {
                // 0x8f67583c
                v8 = get_entry_name(a2, v3, 0, 0, v10, a2, a3, v1);
                print_log(v9, (int32_t)"Failed to find PIV entry from SP for %s\n", v8, 0, v10, a2, a3, v1, g23, g24, g25, g17, v4);
                result = -1;
                // branch -> 0x8f675858
            }
            // 0x8f675858
