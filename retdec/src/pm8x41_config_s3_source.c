...
// Address range: 0x8f6455a0 - 0x8f645607
int32_t pm8x41_config_s3_source(uint32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g15;
    int32_t v2;
    if (a1 < 4) {
        // 0x8f6455ec
        return pm8x41_reg_write(a1 & -0x10000 | 2164, a1 % 256, v1, v1, g19, v2, 0, 0, 0, 0, 0);
    }
    // 0x8f6455cc
    return print_log(-1, (int32_t)"Invalid reset source!\n", v1, v1, g19, v2, 0, 0, 0, 0, 0, 0, 0);
}
