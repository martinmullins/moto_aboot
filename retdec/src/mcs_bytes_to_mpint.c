...
// Address range: 0x8f66a82c - 0x8f66a8d7
int32_t mcs_bytes_to_mpint(int32_t a1) {
    int32_t v1 = g45; // 0x8f66a830
    int32_t v2 = g47; // 0x8f66a830
    int32_t v3 = g43 & -0x7ffffffd; // 0x8f66a840
    int32_t v4 = v3 < 0; // 0x8f66a844
    int32_t v5 = v4 + v3;
    if (v3 < 0) {
        // if_8f66a848_0_true
        v5 = (v4 + g43 | -4) + 1;
        // branch -> after_if_8f66a850_0
    }
    int32_t v6 = g43 + 3; // 0x8f66a854
    int32_t v7; // 0x8f66a870
    if (v6 < 0) {
        // after_if_8f66a85c_0.thread
        v7 = g43 + 6;
        // branch -> after_if_8f66a860_0
    } else {
        // after_if_8f66a85c_0
        if (v6 > 0) {
            // if_8f66a860_0_true
    ...
    int32_t v8 = (4 - v5) % 4; // 0x8f66a864
    int32_t v9 = 0; // R12
    int32_t v10 = v7 / 4; // 0x8f66a870
    g45 = 0;
    int32_t result = 4 * v10 + a1; // R0
    if (v7 > 3) {
        int32_t v11 = g42 - v8;
        int32_t v12 = 0; // 0x8f66a8a0
        while (true) {
            int32_t v13 = v9;
            int32_t v14; // 0x8f66a8ac
            int32_t v15; // 0x8f66a87c
            char v16; // 0x8f66a89c
            if (v8 != 3) {
                int32_t v17 = v8; // 0x8f66a88c25
                int32_t v18 = (int32_t)*(char *)(v11 + v17); // 0x8f66a888
                g47 = v18;
                int32_t v19 = v17 + 1; // 0x8f66a88c
                int32_t v20 = 256 * (v18 | v13); // 0x8f66a894
                v9 = v20;
                while (v19 != 3) {
                    // after_if_8f66a894_0
                    v17 = v19;
                    v18 = (int32_t)*(char *)(v11 + v17);
                    g47 = v18;
                    v19 = v17 + 1;
                    v20 = 256 * (v18 | v20);
                    v9 = v20;
                    // continue -> after_if_8f66a894_0
                }
                // 0x8f66a89c
                v16 = *(char *)(v11 + 3);
                g45 = v12 + 1;
