...
// Address range: 0x8f6118d4 - 0x8f611987
int32_t write_wdata_from_array(int32_t a1, int32_t a2, int32_t a3, char * a4) {
    int32_t v1 = (int32_t)a4;
    int32_t v2 = (int32_t)g18;
    int32_t v3; // bp-52
    int32_t v4 = &v3; // R12
    int32_t result = g4; // R1
    int32_t v5 = 0; // R4
    int32_t v6 = 0; // R5
    v3 = g3;
    int32_t v7 = (int32_t)&g18; // R3
    int32_t v8 = 0; // 0x8f6119384
    // branch -> 0x8f611914
    while (true) {
        int32_t v9 = (int32_t)*(char *)v1; // 0x8f611914
        int32_t v10 = v8; // 0x8f611938
        int32_t v11; // 0x8f611940
        int32_t v12; // 0x8f611934
        if (v9 < a3) {
          lab_0x8f611950:;
            int32_t v13 = v5; // 0x8f611950
            if (v13 == 16) {
                // 0x8f611950
                // branch -> 0x8f611920
                // 0x8f611920
                v12 = 0x8000 * g14 + 0x2400010 + 4 * a2;
                a2 = v12;
                *(int32_t *)v12 = v6;
                v11 = *(int32_t *)v7;
                v7 = v11;
            ...
            result = (int32_t)*(char *)(v9 + a1);
            v5 = v13 + 4;
            *(char *)v1 = (char)(v9 + 1);
            int32_t v14 = result; // 0x8f61196c
            uint32_t v15 = *(int32_t *)(v4 + v13) % 256; // 0x8f61196c
            int32_t v16 = v15 == 0 ? v14 : v15 < 32 ? v14 << v15 : 0; // 0x8f61196c
            int32_t v17 = v16 | v6; // 0x8f61196c
            v6 = v17;
            v8 = v17;
            // branch -> 0x8f611914
            continue;
