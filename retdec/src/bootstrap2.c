...
// Address range: 0x8f61adc8 - 0x8f61ae4b
int32_t bootstrap2(int32_t a1, int32_t a2) {
    int32_t v1 = g27 ? -0x709d4b24 : 0; // 0x8f61adc8
    int32_t v2 = g24;
    int32_t v3;
    int32_t v4 = print_log(2, (int32_t)"top of bootstrap2()\n", g30, v2, a1, v2, g32, v1, v3, 0, 0, 0, 0); // 0x8f61ade0
    int32_t v5 = arch_init(v4, (int32_t)"top of bootstrap2()\n", g30); // 0x8f61ade4
    platform_init(print_log(2, (int32_t)"initializing platform\n", v5, v2, a1, v2, g32, v1, v3, 0, 0, 0, 0), (int32_t)"initializing platform\n", v5, v2);
    target_init(print_log(2, (int32_t)"initializing target\n", v5, v2, a1, v2, g32, v1, v3, 0, 0, 0, 0), (int32_t)"initializing target\n", v5, v2, a1, v2);
    apps_init(print_log(2, (int32_t)"calling apps_init()\n", v5, v2, a1, v2, g32, v1, v3, 0, 0, 0, 0), (int32_t)"calling apps_init()\n", v5, v2, a1, v2, g32, v1, v3);
    if (v2 != g24) {
        // 0x8f61ae2c
        __stack_chk_fail();
        // branch -> 0x8f61ae30
