...
// Address range: 0x8f64b21c - 0x8f64b2bf
int32_t strlcat(char * str, char * a2, int32_t max_len) {
    int32_t str2 = (int32_t)a2; // R5
    int32_t v1 = &g44; // R4
    int32_t v2 = max_len; // R6
    int32_t v3 = strnlen(str, max_len); // 0x8f64b240
    int32_t v4 = v2; // 0x8f64b244
    int32_t v5; // R0
    int32_t len;
    int32_t v6; // 0x8f64b274
    int32_t v7; // 0x8f64b2a8
    char v8; // 0x8f64b29c
    if (v4 == 0) {
        // 0x8f64b250
        ...
        // branch -> 0x8f64b284
      lab_0x8f64b284:;
        int32_t result = v3 + len; // 0x8f64b288
        v5 = result;
        // 0x8f64b2b4
        return result;
        // 0x8f64b298
        ...
        // 0x8f64b25c
        v5 = (int32_t)str + v3;
        int32_t v9 = v4 - 1; // 0x8f64b260
        v2 = v9;
        int32_t v10 = v9; // 0x8f64b268
        int32_t v11 = 0;
        // branch -> 0x8f64b268
      lab_0x8f64b268:
        // 0x8f64b268
        ...
        if (v11 >= v10) {
          ...
          lab_0x8f64b270_2:
            // 0x8f64b270
            *(char *)(v5 + v6) = 0;
            int32_t v12 = v1 + strlen((char *)(str2 + v1)); // 0x8f64b280
            len = v12;
            // branch -> 0x8f64b284
            goto lab_0x8f64b284;
        } else {
