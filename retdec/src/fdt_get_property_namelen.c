...
// Address range: 0x8f64c2bc - 0x8f64c393
int32_t fdt_get_property_namelen(int32_t a1, int32_t a2, char * a3, int32_t a4) {
    int32_t str3 = (int32_t)a3;
    int32_t v1 = g34; // 0x8f64c2bc
    int32_t v2 = g35; // 0x8f64c2bc
    g37 = a4;
    g36 = a1;
    int32_t v3;
    g35 = v3;
    int32_t v4 = g25;
    int32_t v5 = fdt_first_property_offset(a1, a2, str3); // 0x8f64c2f4
    // branch -> 0x8f64c2e8
    while (true) {
        // 0x8f64c2e8
        g34 = v5;
        int32_t v6 = v5; // 0x8f64c35c
        int32_t v7; // 0x8f64c350
        if (v5 >= 0) {
            int32_t v8 = fdt_get_property_by_offset(g36, v5, (int32_t *)g35); // 0x8f64c2fc
            int32_t result = v8; // R8
            int32_t v9;
            if (v8 == 0) {
                // 0x8f64c34c
                g34 = -13;
                ...
                v7 = g35;
                if (v7 != 0) {
                  lab_if_8f64c358_0_true:
                    // if_8f64c358_0_true
                    *(int32_t *)v7 = v6;
                    // branch -> 0x8f64c360
                }
            } else {
                int32_t v10 = *(int32_t *)(v8 + 8); // 0x8f64c308
                int32_t v11 = fdt32_to_cpu_100(v10, v5, g32, g33, a1, v4, str3, v1); // 0x8f64c30c
                int32_t str = fdt_string(g36, v11, g32, g33, a1, v4, str3, v1); // 0x8f64c318
                int32_t str2 = str; // R11
                int32_t len = strlen((char *)str); // 0x8f64c320
                if (len == g37) {
                    // 0x8f64c32c
                    g32 = len;
                    if (memcmp((char *)str2, (char *)str3, len) == 0) {
                        // branch -> 0x8f64c360
                        // 0x8f64c360
                        g32 = v4;
                        v9 = g25;
                ...
                // 0x8f64c374
                v5 = fdt_next_property_offset(g36, g34, g32, g33, a1, v4, str3);
                // branch -> 0x8f64c2e8
                continue;
            }
          lab_0x8f64c360:
