...
// Address range: 0x8f62ddd4 - 0x8f62de5b
int32_t show_locked_command_restriction(int32_t a1) {
    int32_t v1 = g31;
    int32_t v2;
    fboot_info((int32_t)"INFO", (int32_t)"Command restricted in locked mode!", g35, v1, a1, v1, g37, g32, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"Please switch to verified or unlocked mode with commands:", g35, v1, a1, v1, g37, g32, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"    fastboot oem verified", g35, v1, a1, v1, g37, g32, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"or", g35, v1, a1, v1, g37, g32, v2, 0, 0);
    int32_t result = fboot_info((int32_t)"INFO", (int32_t)"    fastboot oem unlock", g35, v1, a1, v1, g37, g32, v2, 0, 0); // 0x8f62de1c
    if (v1 == g31) {
        // 0x8f62de34
        return clear_flash_fail(result, (int32_t)"    fastboot oem unlock", v1);
    }
    // 0x8f62de30
    __stack_chk_fail();
    return result;
