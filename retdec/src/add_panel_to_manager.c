...
// Address range: 0x8f6337f8 - 0x8f633873
int32_t add_panel_to_manager(int32_t * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g26; // 0x8f6337f8
    g26 = v1;
    int32_t result = g15;
    int32_t v3;
    print_log(2, (int32_t)"%s is called\n", (int32_t)"add_panel_to_manager", result, v1, result, a3, v2, g27, g19, v3, 0, 0);
    int32_t v4 = &g17; // R3
    *(int32_t *)g26 = g17;
    *(int32_t *)(g26 + 4) = v4;
    *(int32_t *)v4 = g26;
    *(int32_t *)(g17 + 4) = g26;
    *(int32_t *)(int32_t)&g13 = g13 + 1;
    if (result != g15) {
        // 0x8f633854
        __stack_chk_fail();
        // branch -> 0x8f633858
