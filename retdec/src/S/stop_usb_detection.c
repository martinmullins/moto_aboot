...
// Address range: 0x8f634c0c - 0x8f634c5f
int32_t stop_usb_detection(int32_t a1, int32_t a2) {
    int32_t v1 = g33; // 0x8f634c0c
    g33 = &g22;
    int32_t v2 = g22;
    int32_t v3 = is_charger_smb1359(a1, a2, g32, v2, a1, v2, v1, g28); // 0x8f634c1c
    if (v3 == 0) {
        // 0x8f634c38
        g29 = disable_usbin_valid_irq(0, a2);
        // branch -> 0x8f634c3c
    } else {
        int32_t v4 = smb135x_disable_usbin_valid_irq(v3, a2); // 0x8f634c28
        g29 = v4;
        disable_fastchg_irq(v4, a2);
        disable_source_detect_irq(g29, a2);
        // branch -> 0x8f634c3c
    }
    // 0x8f634c3c
    if (v2 != g22) {
    ...
    // 0x8f634c50
    g33 = v1;
    int32_t result = disable_shutdown_timer(g29, a2, v2); // 0x8f634c58
    g29 = result;
    return result;
}
