...
// Address range: 0x8f647204 - 0x8f64726f
int32_t smb1359_read_reg(int32_t a1, int32_t a2) {
    // 0x8f647204
    g38 = a2;
    int32_t v1 = g31;
    g34 = g14;
    int32_t v2; // 0x8f647264_22
    if (g14 == 0) {
        // 0x8f647248
        g34 = -3;
        v2 = -3;
        ...
        // 0x8f647230
        int32_t v3;
        qup_i2c_read_byte(g14, 28, a1, a2, a1, v1, g39, g33, v3, 0, 0, 0, 0, 0, 0);
        int32_t v4 = g34; // 0x8f647238
        int32_t v5 = v4; // 0x8f647264_23
        if (v4 > -1) {
            // if_8f64723c_0_true
            g34 = 0;
            v5 = 0;
            // branch -> after_if_8f64723c_0
        }
        // after_if_8f64723c_0
        if (v4 < 0) {
            // if_8f647240_0_true
