...
// Address range: 0x8f647080 - 0x8f64710b
int32_t smb1359_power_source_detected(int32_t a1) {
    int32_t v1 = g51; // 0x8f647084
    int32_t v2 = g53; // 0x8f647084
    int32_t v3 = g54; // 0x8f647084
    int32_t result = g38;
    int32_t v4 = 0; // bp-21
    g47 = g33;
    int32_t v5;
    ...
    int32_t v6 = &v4; // 0x8f6470b4_0
    int32_t v7;
    qup_i2c_read_byte(g33, 28, 71, v6, a1, result, v1, v2, v3, g46, v7, 0, 0, 0, 0);
    if (g33 > -1) {
        // 0x8f6470d8
        g47 = v4 % 4 != 0;
        // branch -> 0x8f6470e4
        ...
        // 0x8f6470c4
        print_log(-1, (int32_t)"Read SMB1359(USB/DCIN) error %d\n", g33, v6, a1, result, v1, v2, v3, g46, v7, 0, 0);
        g47 = 0;
        // branch -> 0x8f6470e4
    }
    // 0x8f6470e4
