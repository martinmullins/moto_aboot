...
// Address range: 0x8f63a490 - 0x8f63a4eb
int32_t set_content_to_show(int32_t a1, int32_t a2) {
    int32_t v1 = g56; // 0x8f63a490
    int32_t v2 = g52 ? -0x709c73b8 : 0; // 0x8f63a490
    int32_t v3 = g35;
    int32_t v4;
    int32_t result = mutex_acquire((int32_t)&g33, a2, v1, v3, a1, v3, v1, g57, g58, v2, v4); // 0x8f63a4a8
    g56 = v3;
    g34 |= a1;
    if (v3 == g35) {
        // 0x8f63a4d0
        return mutex_release((int32_t)&g33, a2, v3, v3, g57, g58, v2);
    }
    // 0x8f63a4cc
    __stack_chk_fail();
    return result;
