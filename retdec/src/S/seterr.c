...
// Address range: 0x8f65b358 - 0x8f65b3df
int32_t seterr(int32_t * a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = (int32_t)a1;
    if (a1 == NULL) {
        // 0x8f65b378
        _panic(g20, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"lib/regex/regcomp.c", (int32_t)"p != ((void *)0)" & -0x10000 | 1211, (int32_t)"p != ((void *)0)", a2, a3);
        // branch -> 0x8f65b394
    }
    // 0x8f65b394
    *(int32_t *)v1 = (int32_t)&g18;
    *(int32_t *)(v1 + 4) = (int32_t)&g18;
    if (*(int32_t *)(v1 + 8) == 0) {
        // if_8f65b3b4_0_true
        *(int32_t *)(v1 + 8) = a2;
        // branch -> after_if_8f65b3b4_0
    }
    // after_if_8f65b3b4_0
