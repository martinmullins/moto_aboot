...
// Address range: 0x8f636aac - 0x8f636aff
int32_t sod_ramdump_pending_pull(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g11;
    int32_t v2;
    int32_t v3 = sod_init(a1, a2, a3, v1, a1, v1, a3, g18, g19, g12, v2, 0, 0, 0, 0); // 0x8f636abc
    int32_t v4 = sod_dump_to_sd(v3, a2, a3, v1, a1, v1, a3, g18); // 0x8f636ac4
    ...
    // 0x8f636ad4
    int32_t v5; // 0x8f636adc
    if (v3 != 0) {
        // if_8f636ad8_0_true
        v5 = *(int32_t *)(v3 + 4) / 16 % 2;
        result = v5;
        // branch -> 0x8f636ae0
    } else {
        v5 = 0;
