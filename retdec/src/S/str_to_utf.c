...
// Address range: 0x8f652788 - 0x8f6527f3
int32_t str_to_utf(char * str, int32_t a2) {
    int32_t v1 = g22; // 0x8f652788
    int32_t v2 = g24; // 0x8f652788
    g24 = a2;
    g22 = &g13;
    int32_t v3 = g13;
    int32_t len = strlen(str); // 0x8f6527a0
    if (len != 0) {
        char v4 = 0;
        int32_t v5 = 0; // 0x8f6527b84
        while (true) {
            int32_t v6 = v5 + 1; // 0x8f6527bc
            *(char *)(a2 + 1) = v4;
            int32_t v7 = a2; // 0x8f6527c8
            a2 = v7 + 2;
            *(char *)v7 = *(char *)((int32_t)str + v5);
            if (v6 == 36) {
                // 0x8f6527d4
                if (v3 != g13) {
                    // 0x8f6527e4
