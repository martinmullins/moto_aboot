...
// Address range: 0x8f634598 - 0x8f63462f
int32_t source_detect_status(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = a1; // R0
    int32_t v2 = g19;
    int32_t v3 = platform_detect_fact_cbl(a1, a2, a3, v2); // 0x8f6345a8
    int32_t result2; // 0x8f6345f8
    int32_t result; // 0x8f634624
    int32_t v4;
    if (v1 == 3) {
        // 0x8f6345f4
        set_accessory_type(3, a2);
        // branch -> 0x8f6345f8
        // 0x8f6345f8
        result2 = get_accessory_type(v1, a2);
        if (v2 == g19) {
            // 0x8f634614
            result = print_log(1, (int32_t)"set accessory type %d\n", result2, v2, g29, g24, v4, 0, 0, 0, 0, 0, 0);
            return result;
        }
        // 0x8f634610
        __stack_chk_fail();
    ...
    int32_t v5 = smb1359_get_power_source(v1, a2, v3) & 2; // 0x8f6345b8
    if (v5 == 0) {
        // 0x8f6345f4
        set_accessory_type(0, a2);
        // branch -> 0x8f6345f8
        // 0x8f6345f8
        result2 = get_accessory_type(v5, a2);
        if (v2 == g19) {
            // 0x8f634614
            result = print_log(1, (int32_t)"set accessory type %d\n", result2, v2, g29, g24, v4, 0, 0, 0, 0, 0, 0);
            return result;
    ...
    uint32_t v6 = smb1359_get_usbin_power_source_type(v5, a2, v3, v2); // 0x8f6345c4
    int32_t v7 = 1;
    if ((v6 & 16) == 0) {
        // 0x8f6345d8
        v7 = v6 / 128 % 2 + 1;
    ...
    int32_t v8 = set_accessory_type(v7, a2); // 0x8f6345e4
    // branch -> 0x8f6345f8
    // 0x8f6345f8
    result2 = get_accessory_type(start_charging(4000, a2, v8, v2, a1, v2), a2);
    if (v2 == g19) {
        // 0x8f634614
        result = print_log(1, (int32_t)"set accessory type %d\n", result2, v2, g29, g24, v4, 0, 0, 0, 0, 0, 0);
        return result;
