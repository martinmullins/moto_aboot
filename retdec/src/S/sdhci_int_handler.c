...
// Address range: 0x8f608218 - 0x8f60826f
int32_t sdhci_int_handler(int32_t * a1, int32_t a2) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g7;
    int32_t v3 = *a1; // 0x8f60822c
    int32_t v4 = (*(int32_t *)(v3 + 224) & 12) == 0 ? 1 : 5;
    *(int32_t *)(v3 + 232) = v4;
    event_signal(*(int32_t *)(v1 + 16), 0, v4, v3, v1, v2, g13, g8 ? -0x70987650 : 0);
    if (v2 != g7) {
        // 0x8f608260
        __stack_chk_fail();
        // branch -> 0x8f608264
