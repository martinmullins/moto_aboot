...
// Address range: 0x8f60dc34 - 0x8f60dcbf
int32_t set_restart_reason(int32_t a1) {
    int32_t v1 = g31;
    int32_t result = target_restart_reason_addr(a1, g34, g35); // 0x8f60dc48
    *(int32_t *)result = a1;
    if (a1 == 0x77665500) {
        // 0x8f60dc5c
        if (v1 == g31) {
            // 0x8f60dc6c
            return set_reboot_bl_flag(result, g34);
        }
        // 0x8f60dca8
        __stack_chk_fail();
        // branch -> 0x8f60dcac
    ...
    if (a1 == 0x77665505) {
        ...
        if (v1 == v2) {
            // 0x8f60dc94
            return set_ap_panic_flag(result, g34);
        }
    } else {
        // 0x8f60dca0
        if (v1 == v2) {
