...
// Address range: 0x8f677f04 - 0x8f677fa7
int32_t speedo_delete(int32_t a1, int32_t a2) {
    int32_t v1 = g36; // 0x8f677f04
    int32_t v2 = g27;
    g36 = &g27;
    int32_t v3 = speedo_find(a1, a2, g32, v2, a1, v2, g34, g35); // 0x8f677f18
    if (v3 != 0) {
        int32_t v4 = g9;
        int32_t v5 = &g9; // R5
        g9 = v4 + 1;
        int32_t v6 = v3; // 0x8f677f48
        if (v4 == 0) {
            // 0x8f677f40
        ...
        int32_t v7 = *(int32_t *)(v6 + 4); // 0x8f677f44
        *(int32_t *)v7 = *(int32_t *)v6;
        *(int32_t *)(*(int32_t *)v3 + 4) = v7;
        *(int32_t *)(v3 + 4) = 0;
        *(int32_t *)v3 = 0;
        free((char *)v6);
        int32_t v8 = g9 - 1; // 0x8f677f6c
        *(int32_t *)v5 = v8;
        if (v8 == 0) {
            // 0x8f677f7c
            function_8f619438();
