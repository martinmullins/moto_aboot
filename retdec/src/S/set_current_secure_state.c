...
// Address range: 0x8f674774 - 0x8f6747df
int32_t set_current_secure_state(char a1, int32_t a2, int32_t a3) {
    int32_t v1 = a1;
    g55 = v1;
    g56 = a2;
    int32_t v2 = g61; // 0x8f67477c
    int32_t v3 = g62; // 0x8f67477c
    g61 = v1;
    int32_t v4 = g49;
    g62 = &g49;
    int32_t result; // 0x8f6747d0_2
    if (a2 == 0) {
        // 0x8f6747b0
        *(char *)&g48 = (char)g61;
        if (v4 != g49) {
    ...
    int32_t v5 = cache_state_to_sp(); // 0x8f674794
    g55 = v5;
    int32_t v6; // 0x8f6747ac
    if (v5 != 0) {
        // 0x8f6747a0
        int32_t v7;
        v6 = print_log(0, (int32_t)"Failed to cache secure state: %d\n", 0x1000000 * g61 / 0x1000000, (int32_t)&g49, v1, v4, a3, v2, v3, g54, v7, 0, 0);
        g55 = v6;
        // branch -> 0x8f6747b0
    } else {
        v6 = 0;
