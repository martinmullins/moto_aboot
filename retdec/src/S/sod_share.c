...
// Address range: 0x8f63657c - 0x8f636603
int32_t sod_share(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1; // 0x8f63657c_0
    int32_t result = a2; // R1
    int32_t v2 = a3; // R2
    int32_t v3 = g27 ? -0x709d4b24 : 0; // 0x8f63657c
    int32_t v4 = g24;
    int32_t v5;
    int32_t v6 = sod_init(v1, a2, a3, v4, v1, v4, a3, g32, g33, v3, v5, 0, 0, 0, 0); // 0x8f63658c
    if (v6 == 0) {
        // 0x8f6365dc
        if (v4 != g24) {
            // 0x8f6365f0
    ...
    // 0x8f636598
    if (sod_ramdump_enabled((char *)v6, result, v2, v4) != 0) {
        // 0x8f6365a4
        result = (int32_t)"time.offset";
        int32_t v7 = __utag_sizeof(NULL, (int32_t)"time.offset", v2, v4, v1, v4, a3, g32, g33); // 0x8f6365ac
        int32_t v8 = v7; // 0x8f6365cc
        if (v7 == 8) {
            // 0x8f6365bc
            result = (int32_t)"time.offset";
            int32_t v9 = v6 + 40; // 0x8f6365c4
            v2 = v9;
            v8 = __utag_read(NULL, (int32_t)"time.offset", v9, 8, v1, v4, a3, g32, g33, v3, v5, 0, 0);
            // branch -> 0x8f6365cc
        }
        int32_t v10 = target_restart_reason_addr(v8, result, v2); // 0x8f6365cc
        *(int32_t *)(v6 + 48) = v10;
        sh_flash(v6, result, v2, v7, v1, v4, a3, g32, g33);
        // branch -> 0x8f6365dc
    }
    // 0x8f6365dc
    if (v4 != g24) {
