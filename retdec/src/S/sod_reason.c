...
// Address range: 0x8f636410 - 0x8f636477
int32_t sod_reason(int32_t a1, int32_t a2) {
    int32_t v1 = g16;
    int32_t v2;
    int32_t v3 = sod_init(a1, a2, g22, v1, a1, v1, g24, g17, v2, 0, 0, 0, 0, 0, 0); // 0x8f636420
    g18 = v3;
    int32_t result; // 0x8f636464_2
    if (v3 == 0) {
        // 0x8f63644c
        if (v1 != g16) {
            // 0x8f63645c
    ...
    int32_t v4 = *(int32_t *)(v3 + 4); // 0x8f63642c
    int32_t v5; // 0x8f636464_22
    if ((v4 & 8) == 0) {
        // 0x8f63643c
        g18 = (int32_t)"WATCHDOG RESET";
        if ((v4 & 128) != 0) {
            // if_8f636448_0_true
            g18 = (int32_t)"PMIC WATCHDOG RESET";
            v5 = (int32_t)"PMIC WATCHDOG RESET";
            // branch -> 0x8f63644c
        } else {
            v5 = (int32_t)"WATCHDOG RESET";
        }
    } else {
        // if_8f636434_0_true
        g18 = (int32_t)"KERNEL PANIC";
        v5 = (int32_t)"KERNEL PANIC";
        // branch -> 0x8f63644c
    }
    // 0x8f63644c
    if (v1 != g16) {
