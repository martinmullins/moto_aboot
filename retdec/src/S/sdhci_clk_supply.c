...
// Address range: 0x8f6077d4 - 0x8f60788b
int32_t sdhci_clk_supply(int32_t * a1, uint32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1;
    uint32_t v2 = *(int32_t *)(v1 + 24); // 0x8f6077e0
    int32_t v3 = 0;
    if (v2 <= a2) {
        int32_t v4 = g29 & -0x10000 | 2046; // 0x8f607804
        int32_t v5 = 2; // 0x8f60781c
        // branch -> 0x8f607808
        while (true) {
            // 0x8f607808
            if (v2 / v5 > a2) {
                int32_t v6 = v5 + 2; // 0x8f60781c
                if (v6 == v4) {
                    // break -> 0x8f607828
                    break;
                }
    ...
    int32_t v7 = *a1; // 0x8f607840
    int32_t v8 = v7 + 44; // 0x8f607844
    *(int16_t *)v8 = (int16_t)(256 * v3 & 0xff00 | 1 | v3 / 4 & 192);
    // branch -> 0x8f60784c
    while (((int32_t)*(int16_t *)v8 & 2) == 0) {
        // 0x8f60784c
        // continue -> 0x8f60784c
    }
    int16_t * v9 = (int16_t *)(v7 + 44); // 0x8f607858_0
    *v9 = *v9 | 4;
    *(int32_t *)(v1 + 4) = a2;
    // 0x8f607880
    return 0;
