...
// Address range: 0x8f605544 - 0x8f6055cf
int32_t setup_tx(char * a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7) {
    int32_t v1 = (int32_t)a1;
    memcpy((char *)*(int32_t *)g11, a1, a2);
    int32_t result = *(int32_t *)g11; // 0x8f605578
    platform_get_virt_to_phys_mapping(result, v1, a2, v1);
    *(int32_t *)g11 = result;
    *(int32_t *)(g11 + 8) = (int32_t)&g1;
    *(int32_t *)(g11 + 4) = a2;
    if (g40 != g40) {
        // 0x8f6055a4
        __stack_chk_fail();
    ...
    // 0x8f6055a8
    g45 = &g10;
    return udc_request_queue(g10, (int32_t *)g11);
}
