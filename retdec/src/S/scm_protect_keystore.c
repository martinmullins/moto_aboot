...
// Address range: 0x8f616d5c - 0x8f616f07
int32_t scm_protect_keystore(int32_t a1, int32_t a2, int32_t a3) {
    int32_t result = *(int32_t *)-0x708eed0c; // 0x8f616d78
    int32_t v1;
    int32_t v2 = &v1; // 0x8f616d88_0
    memset((char *)&v1, 0, 64);
    int32_t v3; // bp-88
    int32_t v4 = &v3; // 0x8f616da0_0
    v3 = 0;
    int32_t v5 = a1; // bp-96
    function_8f6193d4(a1, a2);
    int32_t v6; // R2
    int32_t v7;
    int32_t v8;
    if (*(char *)-0x70947380 == 1) {
        ...
        v1 = 0x2000705;
        v6 = v2;
        scm_call2(v2, v4, v2, v4, g28, g24);
        v8 = v3;
        // branch -> 0x8f616ecc
    } else {
        int32_t v9 = &v5; // 0x8f616e04_0
        v6 = v9;
        int32_t v10 = scm_call((char *)7, 5, v9, 8, (int32_t)&v8); // 0x8f616e28
        if (v10 == 0) {
            if (v8 == 0) {
                // 0x8f616e94
                print_log(1, -0x7097f36c, v6, 0, g28, g24, v7, 0, 0, 0, 0, 0, 0);
                // branch -> 0x8f616edc
            } else {
                // 0x8f616ea8
                print_log(1, -0x7097f348, v8, v8, g28, g24, v7, 0, 0, 0, 0, 0, 0);
                // branch -> 0x8f616edc
            }
            // 0x8f616edc
    ...
    // 0x8f616ecc
    print_log(1, -0x7097f324, v6, v2, g28, g24, v7, 0, 0, 0, 0, 0, 0);
    // branch -> 0x8f616edc
    // 0x8f616edc
    if (result != *(int32_t *)-0x708eed0c) {
        // 0x8f616efc
