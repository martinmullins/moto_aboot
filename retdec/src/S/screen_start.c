...
// Address range: 0x8f63c624 - 0x8f63c6df
int32_t screen_start(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = g60; // 0x8f63c624
    g60 = &g26;
    int32_t v2 = g46;
    *(char *)&g27 = 1;
    int32_t v3 = set_logger_status(2, 0, a3); // 0x8f63c648
    display_set_margin(0, 20, v3, v2, a1, v2);
    display_set_margin(2, 10, v3, v2, a1, v2);
    display_set_margin(3, 10, v3, v2, a1, v2);
    int32_t v4 = display_get_total_lines(display_set_margin(1, 40, v3, v2, a1, v2), 40, v3, v2, a1, v2); // 0x8f63c67c
    int32_t v5 = menu_lines(v4, 40, v3); // 0x8f63c68c
    g58 = &g29;
    g29 = v4 - 2 - v5;
    int32_t result = menu_start(v5, 40); // 0x8f63c6ac
    if (v2 == g46) {
        // 0x8f63c6c4
        g60 = v1;
        return set_content_to_show_33(-0x7d000000, 40, v2, v2, v1, g61, g62);
    }
    // 0x8f63c6c0
    __stack_chk_fail();
    return result;
