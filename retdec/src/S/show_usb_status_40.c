...
// Address range: 0x8f63d560 - 0x8f63d68b
char * show_usb_status_40(char a1) {
    int32_t v1 = g69; // 0x8f63d560
    g70 = (int32_t)&g44;
    g69 = a1;
    int32_t v2;
    int32_t v3 = &v2; // 0x8f63d578_0
    char * v4 = g44;
    char * set_mem = memset((char *)&v2, 0, 128); // 0x8f63d584
    int32_t v5 = is_fastboot_screen((int32_t)set_mem, 0, 128, (int32_t)v4); // 0x8f63d588
    if (v5 == 0) {
        // 0x8f63d648
        if (v4 != g44) {
            // 0x8f63d658
    ...
    // 0x8f63d594
    *(char *)&g24 = (char)g69;
    set_content_to_show_34(256, 0, 128, (int32_t)&g24);
    g68 = &g3;
    invalidate(0, 0, 128, (int32_t)&g3);
    int32_t v6;
    timer_cancel((int32_t)&g33, 0, 128, g68, v6, v2, 0, 0);
    int32_t v7; // 0x8f63d5fc
    int32_t v8;
    switch (g69) {
        case 0: {
            // 0x8f63d5d8
            int32_t v9;
            int32_t v10 = &v9; // 0x8f63d5d8_0
            g64 = (int32_t)"USB connected";
            // branch -> 0x8f63d5f8
            // 0x8f63d5f8
            g67 = 128;
            v7 = strlcat(v10, (int32_t)"USB connected", 128, g68, v6, v2, 0, 0, 0, 0, 0, 0);
            is_sufficient_pwr_for_flash((char *)v7, g64, 128, g68);
            show_battery_status_39((char)(int32_t)&v8);
            // branch -> 0x8f63d638
            break;
        }
        case 1: {
            ...
            // branch -> 0x8f63d61c
            // 0x8f63d61c
            strlcat(v3, (int32_t)"USB disconnected", 128, g68, v6, v2, 0, 0, 0, 0, 0, 0);
            g68 = 0;
            timer_set_oneshot((int32_t)&g33, 100, (int32_t)&g6, 0, v6, v2, 0);
            // branch -> 0x8f63d638
            break;
        }
        case 2: {
            // 0x8f63d5f0
            g64 = (int32_t)"Charger connected";
            // branch -> 0x8f63d5f8
            // 0x8f63d5f8
            g67 = 128;
            v7 = strlcat(v3, (int32_t)"Charger connected", 128, g68, v6, v2, 0, 0, 0, 0, 0, 0);
            is_sufficient_pwr_for_flash((char *)v7, g64, 128, g68);
            show_battery_status_39((char)(int32_t)&v8);
            // branch -> 0x8f63d638
            break;
        ...
        case 3: {
            ...
            // branch -> 0x8f63d61c
            // 0x8f63d61c
            strlcat(v3, (int32_t)"Charger disconnected", 128, g68, v6, v2, 0, 0, 0, 0, 0, 0);
            g68 = 0;
            timer_set_oneshot((int32_t)&g33, 100, (int32_t)&g6, 0, v6, v2, 0);
            // branch -> 0x8f63d638
            break;
    ...
    int32_t v11 = print_log(6, (int32_t)"%s", v3, g68, v6, v2, 0, 0, 0, 0, 0, 0, 0); // 0x8f63d644
    // branch -> 0x8f63d648
    // 0x8f63d648
    if (v4 != g44) {
        // 0x8f63d658
