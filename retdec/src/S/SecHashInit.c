...
// Address range: 0x8f6070ac - 0x8f60710b
int32_t SecHashInit(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g30;
    clock_ce_enable(1, a2, a3, v1, a1, v1, a3);
    int32_t v2;
    char * v3 = mot_tzbsp_call(4, a1, 0, v1, a1, v1, a3, g40, g41, g32, v2, 0, 0); // 0x8f6070d4
    int32_t result = (int32_t)v3; // 0x8f6070d4_14
    if (v3 == NULL) {
        // if_8f6070e0_0_true
        g19 = a1;
        // branch -> after_if_8f6070e8_0
    } else {
        // if_8f6070e4_0_true
        result = 16;
        // branch -> after_if_8f6070e8_0
