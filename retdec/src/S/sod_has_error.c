...
// Address range: 0x8f636e14 - 0x8f636e53
int32_t sod_has_error(int32_t a1, int32_t a2) {
    int32_t v1 = g29;
    int32_t v2;
    int32_t v3 = sod_init(a1, a2, g36, v1, a1, v1, g37, g31 ? -0x709c0700 : 0, v2, 0, 0, 0, 0, 0, 0); // 0x8f636e24
    int32_t result = v3; // R0
    int32_t v4 = 0; // 0x8f636e4c_22
    if (v3 != 0) {
        int32_t v5 = *(int32_t *)(v3 + 4) / 64 % 2; // 0x8f636e38
        result = v5;
        v4 = v5;
        // branch -> after_if_8f636e38_0
    }
    // after_if_8f636e38_0
    if (v1 != g29) {
        // 0x8f636e44
