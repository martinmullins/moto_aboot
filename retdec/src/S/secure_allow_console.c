...
// Address range: 0x8f6329ac - 0x8f632a23
int32_t secure_allow_console(int32_t a1, int32_t a2) {
    // 0x8f6329ac
    int32_t result; // bp-16
    int32_t v1 = &result; // 0x8f6329b0_1
    int32_t v2 = g31;
    result = 0;
    int32_t v3 = g4;
    if (v3 > -1) {
        // 0x8f6329e8
        get_int_prop((int32_t)"secure_allow_console", v3, v1, (int32_t)&g31, 0, v2, g37);
        // branch -> 0x8f6329f4
    } else {
        // 0x8f6329d8
        int32_t v4;
        print_log(-1, (int32_t)"No product setting\n", (int32_t)&g4, (int32_t)&g31, 0, v2, g37, g32, v4, 0, 0, 0, 0);
        // branch -> 0x8f6329f4
    }
    // 0x8f6329f4
    if (v2 != g31) {
