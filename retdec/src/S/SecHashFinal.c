...
// Address range: 0x8f60715c - 0x8f60721f
int32_t SecHashFinal(int32_t a1, int32_t a2) {
    int32_t v1 = g30; // 0x8f60715c
    int32_t v2 = g23;
    int32_t v3 = get_tz_buffer(a1); // 0x8f607174
    int32_t v4 = g17;
    char * v5; // 0x8f6071c8
    int32_t v6;
    int32_t result;
    int32_t v7; // 0x8f6071f0
    int32_t v8; // 0x8f6071e0
    int32_t v9; // 0x8f6071ec
    if (v4 == 1) {
        // 0x8f607190
        // branch -> 0x8f607194
        // 0x8f607194
        ...
        if (a2 <= 32) {
            // 0x8f6071b8
            g17 = 0;
            v5 = mot_tzbsp_call(6, v3, 0, v4, a1, v2, v1, g31, g32, g33, g34, g24, v6);
            if (v5 == NULL) {
                // 0x8f6071d4
                cache_inv_range(v3, a2, 0, v4);
                v8 = (int32_t)v5;
                if (v8 != a2) {
                    v9 = v8;
                    *(char *)(a1 + v9) = *(char *)(v3 + v9);
                    v7 = v8 + 1;
                    while (v7 != a2) {
                        // if_8f6071e8_0_true
                        v9 = v7;
