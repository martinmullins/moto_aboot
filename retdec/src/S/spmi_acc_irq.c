...
// Address range: 0x8f612078 - 0x8f612157
int32_t spmi_acc_irq(uint32_t a1, int32_t a2, int32_t result2, int32_t a4, int32_t a5, int32_t a6, int32_t a7) {
    int32_t v1 = a1 % 256; // 0x8f61207c
    int32_t v2 = 0x1000 * v1; // 0x8f6120841
    int32_t v3 = v2 | 0x3800000; // R5
    int32_t result = g24;
    int32_t v4 = *(int32_t *)(v2 | 0x3800004); // 0x8f6120a0
    *(int32_t *)(v2 | 0x3800008) = v4;
    function_8f61951c();
    int32_t * v5 = (int32_t *)v3; // 0x8f6120ac_0
    if (*v5 != 0) {
        // if_8f6120b4_0_true
        *v5 = 0;
        // branch -> after_if_8f6120b8_0
    }
    // after_if_8f6120b8_0
    function_8f61951c();
    int32_t * v6; // 0x8f612120_0
    if (g15 == (char *)&g14) {
        // 0x8f612120
        v6 = (int32_t *)v3;
        if (*v6 == 0) {
    ...
    int32_t v7 = (int32_t)g15; // 0x8f612118
    // branch -> 0x8f6120d4
    while (true) {
        // 0x8f6120d4
        if (v1 == *(int32_t *)(v7 + 8)) {
            uint32_t v8 = *(int32_t *)(v7 + 12); // 0x8f6120e0
            uint32_t v9 = v8 % 256; // 0x8f6120e4
            uint32_t v10 = v4 >> (v9 == 0 ? 0 : v9 > 31 ? 31 : v9); // 0x8f6120e4
            if (v10 % 2 != 0) {
                // 0x8f6120f0
                pm8x41_irq_mask_ack(*(int32_t *)(v7 + 16), v8, result2, v10, a1, result, result2, g32);
                return result2;
            }
        }
        int32_t v11 = *(int32_t *)(v7 + 4); // 0x8f612118
        if (v11 == (int32_t)&g14) {
            // break -> 0x8f612120
            break;
        }
