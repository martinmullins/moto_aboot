...
// Address range: 0x8f64710c - 0x8f647187
int32_t smb1359_get_power_source(void) {
    int32_t v1 = g38;
    int32_t v2 = 0; // bp-13
    if (g33 == 0) {
    ...
    int32_t v3 = &v2; // 0x8f647140_0
    int32_t v4;
    qup_i2c_read_byte(g33, 28, 71, v3, g47, v1, g53, g46, v4, 0, 0, 0, 0, 0, 0);
    if (g33 <= 0xffffffff) {
        // 0x8f647150
        print_log(-1, (int32_t)"Read SMB1359 error %d\n", g33, v3, g47, v1, g53, g46, v4, 0, 0, 0, 0);
        // branch -> 0x8f64715c
    }
    // 0x8f64715c
    if (v1 != g38) {
