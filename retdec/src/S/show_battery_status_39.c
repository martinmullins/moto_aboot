...
// Address range: 0x8f63d4b4 - 0x8f63d51b
int32_t show_battery_status_39(char a1) {
    int32_t v1 = a1;
    int32_t v2 = g69; // 0x8f63d4b4
    g69 = (int32_t)&g44;
    char * v3 = g44;
    int32_t v4 = is_fastboot_screen(v1, g64, g67, (int32_t)v3); // 0x8f63d4c8
    int32_t result = v4; // R0
    int32_t v5 = 0; // 0x8f63d50c_22
    if (v4 != 0) {
        // 0x8f63d4d4
        *(char *)&g31 = (char)v1;
        set_content_to_show_34(128, g64, g67, (int32_t)&g31);
        int32_t v6 = invalidate(0, g64, g67, (int32_t)&g3); // 0x8f63d4f0
        result = v6;
        v5 = v6;
        // branch -> 0x8f63d4f4
    }
