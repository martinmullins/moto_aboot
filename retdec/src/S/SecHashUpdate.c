...
// Address range: 0x8f60710c - 0x8f60715b
int32_t SecHashUpdate(int32_t a1, int32_t a2) {
    int32_t v1 = g40; // 0x8f60710c
    int32_t v2 = g30;
    int32_t v3;
    char * v4 = mot_tzbsp_call(5, a1, a2, a1, a1, v2, v1, g32, v3, 0, 0, 0, 0); // 0x8f60712c
    g38 = v2;
    int32_t v5 = v4 == NULL ? 0 : 16;
    g33 = v5;
    int32_t result; // 0x8f607154_2
    if (v2 != g30) {
        // 0x8f60714c
        __stack_chk_fail();
        result = g33;
