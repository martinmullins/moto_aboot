...
// Address range: 0x8f643b00 - 0x8f643c1b
int32_t get_panel_info(int32_t * a1, int32_t a2, uint32_t a3) {
    int32_t v1 = g47; // 0x8f643b00
    int32_t v2 = g48; // 0x8f643b00
    int32_t v3; // bp-64
    int32_t v4 = &v3; // 0x8f643b04_0
    g48 = &g7;
    int32_t v5 = g31;
    g47 = a3;
    int32_t v6;
    v3 = &v6;
    int32_t v7 = *(int32_t *)&g8; // 0x8f643b38
    *(char *)v7 = (char)a3;
    int32_t v8;
    int32_t v9 = mipi_dsi_cmds_tx((int32_t)&g7, 1, a3, v7, v3, v6, v8, 0, 0, 0, 0, v5); // 0x8f643b40
    if (v9 == 0) {
        // 0x8f643b4c
        if (mipi_dsi_cmds_tx(a2, 1, a3, v7, v3, v6, v8, 0, 0, 0, 0, v5) == 0) {
            // 0x8f643b60
            mipi_dsi_cmds_rx(v4, g47, a3, v7, v3, v6, v8, 0, 0, 0, 0, v5);
            int32_t v10 = v6; // 0x8f643b70
            if (v10 == 0) {
                // 0x8f643b7c
                print_log(-1, (int32_t)"Failed in reading panel info.\n", a3, 0, v3, 0, v8, 0, 0, 0, 0, v5, 0);
                // branch -> 0x8f643bf4
                // 0x8f643bf4
                if (v5 != g31) {
                    // 0x8f643c04
            ...
            int32_t v11 = v10; // 0x8f643bb0
            int32_t v12 = 0;
            switch ((char)v10) {
                case 28: {
                    // if_8f643ba8_0_true
                    // branch -> after_if_8f643ba8_0
                    v11 = v8;
                    v12 = 1;
                }
                default: {
                    uint32_t v13 = llvm_bswap_i32(v11); // 0x8f643bb0
                    int32_t v14 = v13 / 256; // 0x8f643bb4
                    switch (g47) {
                        case 1: {
                            // if_8f643bb8_0_true
                            v14 = v13 / 0x10000 % 256;
                    ...
                    // 0x8f643bd4
                    *(int32_t *)(int32_t)a1 = v14;
                    int32_t v15 = *(int32_t *)&g8; // 0x8f643bdc
                    *(char *)v15 = (char)(a3 % 256);
                    int32_t v16 = mipi_dsi_cmds_tx((int32_t)&g7, 1, v12, v15, v3, v6, v8, 0, 0, 0, 0, v5); // 0x8f643be8
                    // branch -> 0x8f643bf4
                    // 0x8f643bf4
                    if (v5 != g31) {
                        // 0x8f643c04
