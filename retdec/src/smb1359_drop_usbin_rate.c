...
// Address range: 0x8f647c28 - 0x8f647cbf
int32_t smb1359_drop_usbin_rate(void) {
    int32_t v1 = g16; // 0x8f647c28
    int32_t v2 = g20; // 0x8f647c28
    int32_t result = g11;
    int32_t v3 = 0; // bp-13
    int32_t v4 = smb1359_read_reg(12, (int32_t)&v3, g18, 0); // 0x8f647c48
    int32_t v5; // 0x8f647c90
    int32_t v6;
    if (v4 < 0) {
        // if_8f647c50_0_true
        // branch -> 0x8f647c90
        // 0x8f647c90
        v5 = print_log(-1, (int32_t)"Read IRQ G error %d\n", v4, 0, v1, result, v2, g15, v6, 0, 0, 0, 0);
        g16 = v5;
        if (result != g11) {
            // 0x8f647ca4
            __stack_chk_fail();
    ...
    uint32_t v7 = v3 % 32; // 0x8f647c68
    int32_t v8 = v7 == 0 ? 0 : v7 - 1; // 0x8f647c6c
    v3 = v8;
    int32_t v9 = smb1359_masked_write_reg(12, 31, v8, v8, v1, result, v2, g15, v6, 0, 0, 0); // 0x8f647c78
    int32_t v10; // 0x8f647c90
    if (v9 < 0) {
        v10 = (int32_t)"Input current set error %d\n";
        // branch -> 0x8f647c90
    } else {
        // if_8f647c88_0_true
        v9 = 0x1000000 * v3 / 0x1000000;
        v10 = (int32_t)"Input current set 0x%x\n";
        // branch -> 0x8f647c90
    }
    // 0x8f647c90
    v5 = print_log(-1, v10, v9, v8, v1, result, v2, g15, v6, 0, 0, 0, 0);
    g16 = v5;
    if (result != g11) {
        // 0x8f647ca4
        __stack_chk_fail();
