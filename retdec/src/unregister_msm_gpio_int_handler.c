...
// Address range: 0x8f603364 - 0x8f60345f
int32_t unregister_msm_gpio_int_handler(int32_t a1, int32_t a2) {
    // 0x8f603364
    g27 = a1;
    int32_t v1 = g31; // 0x8f603364
    int32_t result = g23;
    int32_t v2 = a1; // 0x8f6033d4
    if (a1 >= 173) {
        int32_t v3 = g26 ? -0x709fccd8 : 0; // 0x8f603384
        int32_t v4 = _panic(v3, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/gpio.c", g30 & -0x10000 | 258, (int32_t)"gpio < NR_GPIO_IRQS", a2, g29); // 0x8f603398
        g27 = v4;
        v2 = v4;
        // branch -> 0x8f60339c
    }
    ...
    while (true) {
        ...
        if (*(int32_t *)(v5 + 8) == a1) {
            int32_t v6 = g2;
            int32_t v7 = &g2; // R6
            int32_t result2 = v6 + 1; // 0x8f6033c4
            g2 = result2;
            if (v6 == 0) {
                // 0x8f6033d4
                g27 = function_8f619448(v2);
                return result2;
            }
            int32_t v8 = *(int32_t *)(v5 + 4); // 0x8f6033d8
            *(int32_t *)v8 = *(int32_t *)v5;
            *(int32_t *)(*(int32_t *)g31 + 4) = v8;
            int32_t v9 = 0; // R3
            *(int32_t *)g31 = 0;
            *(int32_t *)(g31 + 4) = v9;
            int32_t v10 = g2 - 1; // 0x8f6033fc
            *(int32_t *)v7 = v10;
            if (v10 == v9) {
                // 0x8f603408
                if (result == g23) {
