...
// Address range: 0x8f61017c - 0x8f610227
int32_t mipi_cmd_trigger(int32_t a1, int32_t a2) {
    int32_t v1 = g18 & -0x10000 | 0x2711; // R4
    int32_t v2 = g11;
    int32_t v3 = *(int32_t *)0x1a98110; // 0x8f610198
    int32_t v4 = v3; // R2
    if ((v3 & 256) == 0) {
        int32_t v5 = v3; // 0x8f6101ac
        int32_t v6; // 0x8f6101c8
        while (true) {
            // 0x8f6101a8
            udelay(10, (int32_t)&g11, v5, 0x1a98000);
            int32_t v7 = v1; // 0x8f6101b0
            v1 = v7 - 1;
            if (v7 == 1) {
                // 0x8f6101b8
                int32_t v8;
                print_log(-1, (int32_t)"MDP_DONE timeout!\n", v4, 0x1a98000, a1, v2, g18, g19, g20, g12, v8, 0, 0);
                // branch -> 0x8f6101e4
            } else {
                // 0x8f6101c8
                v6 = *(int32_t *)0x1a98110;
                v4 = v6;
                if ((v6 & 256) != 0) {
                    // break -> 0x8f6101d0
                    break;
        ...
        // 0x8f6101d0
        *(int32_t *)0x1a98110 = v6 & -0x11115702 | 768;
        // branch -> 0x8f6101e4
    } else {
        // 0x8f6101d0
        *(int32_t *)0x1a98110 = v3 & -0x11115702 | 768;
        // branch -> 0x8f6101e4
    }
    // 0x8f6101e4
    *(int32_t *)0x1a0201c = 1;
