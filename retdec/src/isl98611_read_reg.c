...
// Address range: 0x8f642aa0 - 0x8f642b13
int32_t isl98611_read_reg(int32_t a1, int32_t a2) {
    int32_t v1 = g15;
    int32_t v2 = g7; // R0
    int32_t v3; // 0x8f642b04_22
    if (g7 == 0) {
        // 0x8f642ae8
        v2 = -3;
        v3 = -3;
        ...
        char v4 = *(char *)&g8; // 0x8f642ad0
        int32_t v5;
        qup_i2c_read_byte(g7, (int32_t)v4, a1, a2, a1, v1, g22, g16, v5, 0, 0, 0, 0, 0, 0);
        int32_t v6 = v2; // 0x8f642ad8
        int32_t v7 = v6; // 0x8f642b04_23
        if (v6 > -1) {
            // if_8f642adc_0_true
            v2 = 0;
            v7 = 0;
            // branch -> after_if_8f642adc_0
        }
        // after_if_8f642adc_0
        if (v6 < 0) {
            // if_8f642ae0_0_true
