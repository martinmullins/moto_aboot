...
// Address range: 0x8f63f450 - 0x8f63f4ab
int32_t set_content_to_show_55(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = g15;
    int32_t result = mutex_acquire((int32_t)&g10, a2, a3, v1, a1, v1, a3, g26, g27, g22, a5); // 0x8f63f468
    g11 |= a1;
    if (v1 == g15) {
        // 0x8f63f490
        return mutex_release((int32_t)&g10, a2, v1, v1, g26, g27, g22);
    }
    // 0x8f63f48c
    __stack_chk_fail();
    return result;
