...
// Address range: 0x8f6652c8 - 0x8f665363
int32_t mcs_DER_decodeItem(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g34; // 0x8f6652cc
    int32_t v2 = g35; // 0x8f6652cc
    bool v3 = g28;
    int32_t v4 = v3 ? -0x709af928 : 0; // 0x8f6652cc
    // branch -> 0x8f6652d8
    while (true) {
        int32_t v5 = (int32_t)*(int16_t *)(a3 + 8); // 0x8f6652d8
        if ((v5 & 65) == 64) {
            // 0x8f6652e8
            if (*(int16_t *)(a3 + 2) != 1) {
                // 0x8f665358
            ...
            if ((v5 & 2) != 0) {
                ...
                g35 = v2;
                g28 = v3;
                return mcs_DER_recordLength(a1, a2);
            }
          lab_0x8f665318:
            // 0x8f665318
            if ((v5 & 65) != 64) {
                ...
                g28 = v3;
                int32_t v6;
                return mcs_DER_decodeContents(a1, a2, a3, g25, v1, v2, v4, v6, 0);
            }
            // if_8f66531c_0_true
            a3 += 4;
            // branch -> 0x8f6652d8
