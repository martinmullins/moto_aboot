...
// Address range: 0x8f6315cc - 0x8f631667
int32_t get_hw_rev(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g36; // 0x8f6315d0
    int32_t v2 = g37; // 0x8f6315d0
    int32_t v3; // bp-24
    int32_t v4 = &v3; // 0x8f6315d0_1
    int32_t v5 = -1; // R4
    int32_t v6 = g15;
    v3 = -1;
    int32_t v7 = g5;
    g32 = v7;
    int32_t result; // 0x8f631650_2
    int32_t v8;
    int32_t v9;
    if (v7 <= -1) {
        // 0x8f6315f8
        g32 = (int32_t)"Not found HW_REV specific setting\n";
    ...
    int32_t v10 = get_int_prop((int32_t)"rev", v7, v4, (int32_t)&g15, -1, v6, a3); // 0x8f631614
    g31 = v10;
    if (v10 != -1) {
        // 0x8f631620
        g32 = (int32_t)"get prop %s: 0x%x\n";
        print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"rev", v3, v3, v6, a3, v1, v2, g30, v8, 0, 0);
        g31 = v3;
        // branch -> 0x8f631638
    } else {
        v3 = -1;
