...
// Address range: 0x8f601a7c - 0x8f601adb
int32_t platform_uninit(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1; // 0x8f601a7c_0
    int32_t v2 = g45; // 0x8f601a7c
    int32_t v3 = g41 ? -0x709e6520 : 0; // 0x8f601a7c
    g45 = &g32;
    int32_t v4 = g32;
    int32_t v5 = is_udc_active(v1); // 0x8f601a8c
    int32_t v6 = 0; // 0x8f601a9c
    if (v5 != 0) {
        // 0x8f601a98
        v6 = udc_stop(v5, a2, a3, v4, v1);
        // branch -> 0x8f601a9c
    }
    int32_t v7 = qtimer_uninit(display_shutdown(v6, a2, a3, v4, v1, v4, v2)); // 0x8f601aa0
    int32_t result = is_charger_smb1359(pm8x41_uninit(v7, a2), a2, a3, v4, v1, v4, v2, v3); // 0x8f601aa8
    if (result != 0) {
        // 0x8f601ab4
        disable_smb1359_irq(result, a2);
        return result;
    }
    // 0x8f601ab8
    if (v4 == g32) {
        // 0x8f601acc
        g45 = v2;
        return msm_gpio_int_uninit(0, a2);
    }
    // 0x8f601ac8
    __stack_chk_fail();
    return 0;
