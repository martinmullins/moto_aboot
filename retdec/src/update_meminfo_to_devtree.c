...
// Address range: 0x8f615234 - 0x8f6152d3
int32_t update_meminfo_to_devtree(int32_t a1, int32_t a2) {
    char * v1 = g23;
    int32_t v2 = (int32_t)v1;
    int32_t v3 = &g9; // R5
    int32_t result; // 0x8f6152a0
    int32_t v4;
    if (g7 > 0) {
        int32_t v5 = 0; // 0x8f615270
        int32_t v6 = &g9; // 0x8f61526c
        while (true) {
            int32_t v7 = *(int32_t *)(v6 + 4); // 0x8f61526c
            int32_t v8;
            int32_t v9;
            int32_t v10 = fdt32_to_cpu(v7, a2, (int32_t)&g6, (int32_t)&g23, v9, v8, 0, v2, 0); // 0x8f615274
            int32_t v11 = v3 + 4; // 0x8f615278
            v3 = v11;
            *(int32_t *)v11 = v10;
            int32_t v12 = v5 + 1; // 0x8f615264
            if (v12 >= g7) {
                // 0x8f615264
                // branch -> 0x8f615280
                // 0x8f615280
                result = fdt_setprop_with_offset(a1, a2, (int32_t)"reg", 0, (int32_t)&g10, 4 * g7, 0, v2, 0, g30, g31, g32, g33, g34, g35, 0, v4, 0, 0, 0);
                if (v1 != g23) {
                    // 0x8f6152b4
                    __stack_chk_fail();
                    // branch -> 0x8f6152b8
