...
// Address range: 0x8f672950 - 0x8f6729b3
int32_t mot_sst_pal_read_token(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    // 0x8f672950
    if (a1 == 0) {
        // after_if_8f67295c_0.thread
        // branch -> 0x8f672990
        // 0x8f6729a4
        return 255;
    }
    int32_t v1 = g19;
    int32_t v2; // R0
    int32_t v3; // 0x8f6729a8_23
    int32_t v4;
    if (get_sp_block((int32_t)"sst_token", a2, 60, 0, a1, a2, a3, v1, g25, 0, v4, 0, 0, 0, 0) == 0) {
        // if_8f67298c_0_true
        v2 = 0;
        v3 = 0;
        // branch -> 0x8f672990
