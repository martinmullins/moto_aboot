...
// Address range: 0x8f61a68c - 0x8f61a7cf
int32_t target_set_raminfo(void) {
    char * v1 = g23;
    int32_t v2 = (int32_t)v1;
    int32_t result = target_ram_info(g25, g26); // 0x8f61a6a4
    if (result == 0) {
        // 0x8f61a6b0
        if (v1 == g23) {
            // 0x8f61a6c0
            return sprintf((char *)&g24, "Unknown");
        }
        // 0x8f61a794
        __stack_chk_fail();
        // branch -> 0x8f61a798
    ...
    uint32_t v3 = *(int32_t *)result; // 0x8f61a6d4
    uint32_t v4 = v3 % 256; // 0x8f61a6d8
    int32_t v5;
    int32_t chars_printed;
    uint32_t v6; // 0x8f61a71c
    uint32_t v7; // 0x8f61a70c
    int32_t v8; // 0x8f61a734
    int32_t v9; // 0x8f61a744
    int32_t v10; // 0x8f61a74c
    uint32_t v11; // 0x8f61a764
    int32_t v12; // 0x8f61a718
    if (v4 < 15) {
        int32_t v13 = *(int32_t *)(4 * v4 + (int32_t)&g1); // 0x8f61a6e4
        // branch -> 0x8f61a70c
        // 0x8f61a70c
        v7 = *(int32_t *)(result + 12);
        v12 = *(int32_t *)(4 * (v7 % 4) + (int32_t)&g2);
        v6 = v7 / 4 % 16;
        v5 = (int32_t)"reserved";
        if (v6 != 15) {
            // if_8f61a724_0_true
            v5 = *(int32_t *)(4 * v6 + (int32_t)&g3);
            // branch -> after_if_8f61a72c_0
        }
        // after_if_8f61a72c_0
        v8 = *(int32_t *)(result + 16);
        v9 = *(int32_t *)(result + 4);
        v10 = *(int32_t *)(result + 8);
        print_log(1, (int32_t)"RAM: %s, %s, %u MB, MR5:0x%02X, MR6:0x%02X, MR7:0x%02X, MR8:0x%02X\n", v13, v12, v8, v3, v9, v10, v7, 0, 0, v2, g30);
        v11 = *(int32_t *)(result + 16);
        chars_printed = snprintf((char *)&g24, 64, "%uGB %s %s DIE=%s", v11 / 1024, (char *)v13, (char *)v12, (char *)v5);
        if (v1 != g23) {
            // 0x8f61a794
            __stack_chk_fail();
            // branch -> 0x8f61a798
    ...
    v9 = *(int32_t *)(result + 4);
    v10 = *(int32_t *)(result + 8);
    print_log(1, (int32_t)"RAM: %s, %s, %u MB, MR5:0x%02X, MR6:0x%02X, MR7:0x%02X, MR8:0x%02X\n", v15, v12, v8, v3, v9, v10, v7, 0, 0, v2, g30);
    v11 = *(int32_t *)(result + 16);
    chars_printed = snprintf((char *)&g24, 64, "%uGB %s %s DIE=%s", v11 / 1024, (char *)v14, (char *)v12, (char *)v5);
    if (v1 != g23) {
        // 0x8f61a794
        __stack_chk_fail();
        // branch -> 0x8f61a798
