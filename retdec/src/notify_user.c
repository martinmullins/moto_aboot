...
// Address range: 0x8f6527f4 - 0x8f652887
char * notify_user(char * format, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)format;
    int32_t v2 = g22; // 0x8f6527fc
    g22 = &g13;
    g23 = v1;
    int32_t str;
    int32_t v3 = &str; // 0x8f652810_0
    memset((char *)&str, 0, 64);
    int32_t v4 = &a2; // 0x8f652820_0
    g20 = v1;
    vsnprintf((char *)&str, 64, format, v4);
    g18 = v3;
    g17 = print_log(1, v3, v1, v4, v4, str, 0, 0, 0, 0, 0, 0, 0);
    int32_t (*v5)(int32_t) = g6;
    g21 = (int32_t)v5;
    if (v5 != NULL) {
        // 0x8f652854
        g17 = v3;
