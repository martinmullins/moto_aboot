...
// Address range: 0x8f643c1c - 0x8f643ca7
int32_t mipi_mot_get_supplier_id(int32_t * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g52; // 0x8f643c20
    int32_t v3 = g54; // 0x8f643c20
    int32_t v4 = g55; // 0x8f643c20
    g55 = v1;
    g52 = &g15;
    g54 = (int32_t)&g41;
    int16_t * v5 = g41;
    ...
    int32_t v7 = g15;
    int32_t result; // 0x8f643c58
    int32_t v8;
    int32_t v9; // 0x8f643c7c
    if (v7 == (v6 || 0xffff)) {
        // 0x8f643c4c
        int32_t v10;
        result = get_panel_info((int32_t)&g15, (int32_t)&g14, 2, (int32_t)&g41, v1, v6, a3, v2, g53, v3, v4, g45, v10, 0);
        print_log(1, (int32_t)"MOT panel supplier_id=0x%04x\n", g15, (int32_t)&g41, v1, v6, a3, v2, g53, v3, v4, g45, v10);
        v9 = g55;
        v8 = g15;
        // branch -> 0x8f643c70
    } else {
