...
// Address range: 0x8f646b58 - 0x8f646c0b
int32_t pmic_set_iusb_max(void) {
    int32_t v1 = g23;
    int32_t v2 = v1 & -0x10000 | 1500; // 0x8f646b6c
    int32_t v3; // 0x8f646bc4
    int32_t v4; // 0x8f646bd4
    uint32_t v5;
    if (g27 > v2) {
        // 0x8f646b9c
        // branch -> 0x8f646ba4
        ...
        // branch -> 0x8f646bbc
        // 0x8f646bbc
        v3 = pm8x41_masked_reg_write(v5 & -0x10000 | 0x1344, 31, v5 % 256, v2, g27, v1, g29, g31, g32);
        v4 = pm8x41_masked_reg_write(v3 & -0x10000 | 0x1343, 128, 128, v2, g27, v1, g29, g31, g32);
        pm8x41_masked_reg_write(v4 & -0x10000 | 0x1351, 128, 128, v2, g27, v1, g29, g31, g32);
        if (v1 != g23) {
            // 0x8f646bfc
            __stack_chk_fail();
            // branch -> 0x8f646c00
    ...
    if (g27 < 100) {
        ...
        // branch -> 0x8f646bbc
        // 0x8f646bbc
        v3 = pm8x41_masked_reg_write(g27 & -0x10000 | 0x1344, 31, 0, v2, g27, v1, g29, g31, g32);
        v4 = pm8x41_masked_reg_write(v3 & -0x10000 | 0x1343, 128, 128, v2, g27, v1, g29, g31, g32);
        pm8x41_masked_reg_write(v4 & -0x10000 | 0x1351, 128, 128, v2, g27, v1, g29, g31, g32);
        if (v1 != g23) {
            // 0x8f646bfc
