...
// Address range: 0x8f61a7d0 - 0x8f61a80f
int32_t target_ram_size(int32_t a1, int32_t a2) {
    int32_t v1 = target_ram_info(a1, a2); // 0x8f61a7e0
    int32_t result = v1; // R0
    int32_t v2 = 0; // 0x8f61a808_22
    if (v1 != 0) {
        int32_t v3 = 0x100000 * *(int32_t *)(v1 + 16); // 0x8f61a7f4
        result = v3;
        v2 = v3;
        // branch -> after_if_8f61a7f4_0
    }
    // after_if_8f61a7f4_0
    if (g23 != g23) {
        // 0x8f61a800
