...
// Address range: 0x8f6472dc - 0x8f64735b
int32_t unlock_volatile_write_access(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g27;
    int32_t v2 = v1;
    int32_t result = -20;
    if (g8 != 0) {
        int32_t v3 = smb1359_write_reg(64, 65, g8, (int32_t)&g27); // 0x8f647308
        int32_t v4 = 0; // 0x8f647330
        if (v3 != 0) {
            // 0x8f647314
            int32_t v5;
            print_log(-1, (int32_t)"Unlock volatile write access error %d\n", v3, (int32_t)&g27, a1, v1, a3, g36, g37, g30, v5, 0, 0);
            v4 = v3;
            // branch -> 0x8f647330
        }
        // 0x8f647330
