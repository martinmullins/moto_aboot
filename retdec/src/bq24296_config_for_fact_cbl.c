...
// Address range: 0x8f64189c - 0x8f6419a7
int32_t bq24296_config_for_fact_cbl(void) {
    int32_t v1 = g31; // 0x8f64189c
    int32_t v2 = g32; // 0x8f64189c
    int32_t result = g25;
    if (g23 == 0) {
        // 0x8f64197c
        if (result != g25) {
    ...
    // 0x8f6418c0
    int32_t result2; // R2
    int32_t result3; // 0x8f641994_2
    int32_t v3;
    if (bq24296_modify(1, 0, 4, 1, g27, result, g29, v1, v2, g26, v3, 0, 0, 0, 0) > -1) {
        // 0x8f641900
        if (bq24296_modify(0, 7, 0, 3, g27, result, g29, v1, v2, g26, v3, 0, 0, 0, 0) >= 0) {
            // 0x8f64191c
            if (bq24296_modify(4, 43, 2, 6, g27, result, g29, v1, v2, g26, v3, 0, 0, 0, 0) >= 0) {
                // 0x8f641938
                if (bq24296_modify(5, 0, 4, 2, g27, result, g29, v1, v2, g26, v3, 0, 0, 0, 0) >= 0) {
                    int32_t v4 = print_log(1, (int32_t)"bq24296_config_for_fact_cbl\n", 4, 2, g27, result, g29, v1, v2, g26, v3, 0, 0); // 0x8f64195c
                    result2 = result;
                    if (result == g25) {
                        // 0x8f641970
                        g31 = v1;
                        g32 = v2;
                        bq24296_dump(v4, (int32_t)"bq24296_config_for_fact_cbl\n", result, result, v1, v2, g26, v3);
                        return result2;
                    }
                    // 0x8f64198c
                    __stack_chk_fail();
        ...
        if (result == g25) {
            ...
            g31 = v1;
            g32 = v2;
            print_log(-1, (int32_t)"BQ24296: Error setting chg disable\n", result, result, v1, v2, g26, v3, 0, 0, 0, 0, 0);
            return result2;
        }
        // 0x8f64198c
        __stack_chk_fail();
