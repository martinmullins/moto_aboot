...
// Address range: 0x8f60c3b8 - 0x8f60c45f
int32_t delay(uint32_t a1, uint32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g27;
    int32_t v2 = qtimer_get_phy_timer_cnt(a1, a2, a3, v1); // 0x8f60c3d0
    int32_t v3 = v2; // R0
    int32_t v4 = v2; // R6
    int32_t v5 = v2 + a1; // 0x8f60c3e0
    int32_t v6 = (int32_t)(v5 < a1) | 2 * a2 & 0xfffffe; // 0x8f60c3f4
    // branch -> 0x8f60c3f8
    while (true) {
        // 0x8f60c3f8
        int32_t v7; // 0x8f60c434
        bool v8; // 0x8f60c430
        bool v9; // 0x8f60c430
        int32_t v10; // 0x8f60c428
        if (v6 == a2) {
            // if_8f60c400_0_true
            if (v5 < v2) {
              lab_0x8f60c408:;
                bool v11 = false; // 0x8f60c414
                bool v12 = a2 >= a2; // 0x8f60c414
                // if_8f60c410_0_true
                v11 = v4 == v2;
                v12 = v4 >= v2;
                // branch -> after_if_8f60c410_0
                // after_if_8f60c410_0
                if (!v12 || !((v11 ^ true))) {
                    int32_t v13 = qtimer_get_phy_timer_cnt(v2, a2, v2, a2); // 0x8f60c418
                    v3 = v13;
                    v2 = v13;
                    // branch -> 0x8f60c3f8
                    continue;
                ...
                while (true) {
                    ...
                    v8 = v10 >= a2;
                    if (v10 == a2) {
                      lab_if_8f60c42c_0_true_3:
                        // if_8f60c42c_0_true
                        v9 = v5 == v7;
                        v8 = v5 >= v7;
                        // branch -> after_if_8f60c42c_0
                    }
                  lab_after_if_8f60c42c_0_3:
                    // after_if_8f60c42c_0
                    if (v9 || v8 ^ true) {
                        // 0x8f60c440
                        int32_t result; // 0x8f60c458_2
                        if (v1 != g27) {
                            // 0x8f60c450
                            __stack_chk_fail();
                            result = v3;
                    ...
                    int32_t v14 = qtimer_get_phy_timer_cnt(v7, a2, v7, a2); // 0x8f60c434
                    v3 = v14;
                    v10 = v6;
                    v7 = v14;
                    // branch -> 0x8f60c424
            ...
            while (true) {
                // 0x8f60c424
                if (v10 == a2) {
                    goto lab_if_8f60c42c_0_true_3;
                }
                v9 = false;
                v8 = v10 >= a2;
                goto lab_after_if_8f60c42c_0_3;
            }
        } else {
            // after_if_8f60c400_0
            if (v6 < a2) {
