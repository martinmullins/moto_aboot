...
// Address range: 0x8f66cb94 - 0x8f66cc47
int32_t hab_add_verified_blocks(char * a1, int32_t a2, int32_t a3) {
    int32_t result = (int32_t)a1 + 1; // R0
    char v1 = *a1; // 0x8f66cb9c
    int32_t v2 = v1; // 0x8f66cb9c
    int32_t v3 = g49;
    int32_t v4 = &g52; // R3
    int32_t v5 = v3;
    if (v1 != 0) {
        int32_t v6 = &g53; // 0x8f66cc1c5
        int32_t v7 = &g52; // 0x8f66cbf0
        while (true) {
            int32_t * v8 = (int32_t *)v7; // 0x8f66cbb8_0
            int32_t v9 = v6; // 0x8f66cc1c
            int32_t v10 = v7; // 0x8f66cc18
            if (*v8 == 0) {
                int32_t v11 = result; // 0x8f66cbc4
                char v12 = *(char *)(v11 + 1); // 0x8f66cbc4
                char v13 = *(char *)v11; // 0x8f66cbcc
                result = v11 + 8;
                v2 = (v2 - 1) % 0x10000;
                char v14 = *(char *)(v11 + 3); // 0x8f66cbe0
                char v15 = *(char *)(v11 + 2); // 0x8f66cbe8
                *v8 = 256 * (int32_t)v15 | 0x1000000 * (int32_t)v13 | 0x10000 * (int32_t)v12 | (int32_t)v14;
                int32_t v16 = result; // 0x8f66cbf4
                char v17 = *(char *)(v16 - 3); // 0x8f66cbf4
                char v18 = *(char *)(v16 - 4); // 0x8f66cbf8
                char v19 = *(char *)(v16 - 1); // 0x8f66cc04
                char v20 = *(char *)(v16 - 2); // 0x8f66cc0c
                *(int32_t *)(v4 + 4) = 256 * (int32_t)v20 | 0x1000000 * (int32_t)v18 | 0x10000 * (int32_t)v17 | (int32_t)v19;
                v9 = &g53;
                v10 = v4;
                // branch -> 0x8f66cc18
            }
            int32_t v21 = v10 + 8; // 0x8f66cc18
            v4 = v21;
            if (v21 < v9) {
                if (v2 == 0) {
                    // break -> 0x8f66cc24
