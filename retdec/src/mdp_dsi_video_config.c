...
// Address range: 0x8f60ee04 - 0x8f60ef7b
int32_t mdp_dsi_video_config(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = a2; // bp-28
    int32_t v2 = a3; // bp-24
    char * v3 = g23;
    int32_t v4 = (int32_t)v3;
    mdss_intf_tg_setup(a1, 0x1a12700, a3, v4, a1, a2, a3, v4, g30, g31, g32, 0);
    int32_t v5 = 0x1a12700; // R1
    int32_t v6 = mdss_intf_fetch_start_config(a1, 0x1a12700, a3, v4, a1, a2, a3, v4); // 0x8f60ee2c
    char v7 = *(char *)(a1 + 255); // 0x8f60ee30
    int32_t v8 = v7; // 0x8f60ee30
    int32_t v9 = a3; // 0x8f60ee54
    int32_t v10 = a2; // 0x8f60ee54
    if (v7 != 0) {
        // 0x8f60ee3c
        mdss_intf_tg_setup(a1, 0x1a12900, a3, v8, a1, a2, a3, v4, g30, g31, g32, 0);
        v5 = 0x1a12900;
        v9 = v2;
        v10 = v1;
        v6 = mdss_intf_fetch_start_config(a1, 0x1a12900, a3, v8, a1, v1, v2, v4);
        // branch -> 0x8f60ee54
    }
    // 0x8f60ee54
    mdp_clk_gating_ctrl(v6, v5, a3, v8, a1, v10, v9, v4);
    int32_t v11 = *(int32_t *)(a1 + 28); // 0x8f60ee58
    int32_t v12 = &v1; // 0x8f60ee5c_0
    int32_t v13 = &v2; // 0x8f60ee60_0
    mdss_vbif_setup(mdp_select_pipe_type_isra_0(v11, v12, v13), v12, v13, v8, a1, v1);
    int32_t v14 = v1; // 0x8f60ee6c
    int32_t v15 = v2; // 0x8f60ee6c
    int32_t v16;
    mdss_qos_remapper_setup(mdss_smp_setup(a1, v14, v15, v8, a1, v14, v15, v4, g30, g31, g32, 0, v16, 0), v14, v15, v8);
    mdss_vbif_qos_remapper_setup(a1, v14, v15, v8, a1, v1, v2, v4, g30, g31, g32);
    int32_t v17 = v1; // 0x8f60ee8c
    int32_t v18 = v17; // R2
    mdss_source_pipe_config(a2, a1, v17, v8, a1, v17, v2, v4, g30, g31);
    char v19 = *(char *)(a1 + 112); // 0x8f60ee94
    int32_t v20 = v19; // 0x8f60ee94
    int32_t v21 = a1; // 0x8f60eeb4
    if (v19 != 0) {
        int32_t v22 = v2; // 0x8f60eea8
        v18 = v22;
        mdss_source_pipe_config(a2, a1, v22, v20, a1, v1, v22, v4, g30, g31);
        v21 = a1;
        // branch -> 0x8f60eeb0
    }
    // 0x8f60eeb0
    mdss_layer_mixer_setup(a2, v21, v18, v20, a1, v1, v2, v4);
    int32_t v23 = *(char *)(a1 + 114) == 0 ? 0x1f20 : 0x1f30;
    *(int32_t *)0x1a02014 = v23;
    int32_t v24 = *(int32_t *)(a1 + 116); // 0x8f60eed8
    int32_t v25 = a1; // 0x8f60ef08
    if (v24 != 0) {
        // 0x8f60eee4
        mdss_fbc_cfg(a1, v21, v23, v24, a1, v1, v2, v4, g30, g31);
        v25 = a1;
        // branch -> 0x8f60eeec
    }
    int32_t v26 = 256;
    if (*(char *)(v25 + 255) != 0) {
        ...
        if (*(char *)(v25 + 115) == 0) {
            // 0x8f60ef08
            *(int32_t *)0x1a02214 = *(char *)(v25 + 114) == 0 ? 0x1f30 : 0x1f20;
            v26 = 0x10100;
            // branch -> 0x8f60ef28
        } else {
            v26 = 0x10100;
    ...
    int32_t v27 = 0x1a01000; // R3
    *(int32_t *)0x1a01004 = v26;
    *(int32_t *)(v27 + 736) = v26 & -0x10000 | 0x1111;
    *(int32_t *)(v27 + 492) = 1;
    *(int32_t *)(v27 + 1016) = 1;
    if (v3 != g23) {
        // 0x8f60ef58
