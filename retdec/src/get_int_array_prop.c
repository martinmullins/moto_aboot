...
// Address range: 0x8f630ba0 - 0x8f630c2f
int32_t get_int_array_prop(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = a1; // bp-24
    int32_t v2 = g27 ? -0x709a999c : 0; // 0x8f630ba0
    int32_t v3 = g23;
    int32_t v4;
    int32_t v5 = fdt_get_property((int32_t)&g3, a2, a1, (int32_t)&v1, a1, v3, g33, g34, g35, v2, v4, 0, 0); // 0x8f630bc8
    if (v5 != 0) {
        if (a4 == v1) {
            int32_t v6 = v5 + 12; // 0x8f630be0
            if (v1 == 0) {
                // 0x8f630c0c
                if (v3 != g23) {
                    // 0x8f630c1c
            ...
            // if_8f630bec_0_true.preheader
            *(int32_t *)a3 = llvm_bswap_i32(*(int32_t *)v6);
            int32_t v7 = 4; // 0x8f630bf820
            if (a4 == v7) {
                // 0x8f630c0c
                if (v3 != g23) {
                    // 0x8f630c1c
            ...
            int32_t v8 = *(int32_t *)(v6 + v7); // 0x8f630bec
            *(int32_t *)(a3 + v7) = llvm_bswap_i32(v8);
            int32_t v9 = v7 + 4; // 0x8f630bf8
            while (a4 != v9) {
                // if_8f630bec_0_true.if_8f630bec_0_true_crit_edge
                v7 = v9;
                v8 = *(int32_t *)(v6 + v7);
                *(int32_t *)(a3 + v7) = llvm_bswap_i32(v8);
                v9 += 4;
                // continue -> if_8f630bec_0_true.if_8f630bec_0_true_crit_edge
            }
            // 0x8f630c0c
            if (v3 != g23) {
                // 0x8f630c1c
