...
// Address range: 0x8f6673b4 - 0x8f6673fb
int32_t mcs_memclear(char * a1, int32_t a2, int32_t a3) {
    ...
    int32_t v3 = result;
    if (a2 != 0) {
        // if_8f6673d4_0_true.preheader
        *a1 = 0;
        int32_t v4 = v1 + 1; // 0x8f6673d012
        if (v4 != v2) {
            *(char *)v4 = (char)0;
            while (v4 + 1 != v2) {
                // if_8f6673d4_0_true.if_8f6673d4_0_true_crit_edge
                v4++;
                *(char *)v4 = (char)0;
                // continue -> if_8f6673d4_0_true.if_8f6673d4_0_true_crit_edge
            }
            // 0x8f6673d0
            // branch -> 0x8f6673dc
            // 0x8f6673dc
