...
// Address range: 0x8f632a24 - 0x8f632acf
int32_t get_verified_enabled(void) {
    int32_t result = g3;
    int32_t v1 = g31;
    if (result != -1) {
    ...
    if (v2 > -1) {
        // 0x8f632a64
        get_int_prop((int32_t)"verified_enabled", v2, (int32_t)&g3, (int32_t)&g4, g33, v1, g35);
        // branch -> 0x8f632a70
    } else {
        // 0x8f632a58
        print_log(-1, (int32_t)"No verified_enabled setting\n", v1, (int32_t)&g4, g33, v1, g35, g37, g38, g32, v3, 0, 0);
        // branch -> 0x8f632a70
    }
    int32_t v4 = g3;
    int32_t result2;
    if (v4 == -1) {
        ...
        // 0x8f632a7c
        print_log(2, (int32_t)"verified_enabled defined: %d\n", v4, (int32_t)&g4, g33, v1, g35, g37, g38, g32, v3, 0, 0);
        result2 = g3;
        // branch -> 0x8f632a98
    }
    // 0x8f632a98
