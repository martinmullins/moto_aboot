...
// Address range: 0x8f6199c0 - 0x8f619a53
int32_t arm_mmu_init(int32_t a1) {
    int32_t v1 = g26; // 0x8f6199c0
    g26 = &g15;
    int32_t result = g15;
    function_8f6194cc();
    int32_t v2 = a1 & -0x30000002; // 0x8f6199d8
    function_8f6194d4(v2);
    int32_t v3;
    if (platform_use_identity_mmu_mappings(v2, g21) == 0) {
        // 0x8f6199f0
        int32_t v4; // 0x8f6199f02
        platform_init_mmu_mappings(0, v4, 3072, result, a1, result, g24, v1, g27, g19, v3, 0, 0, 0, 0, 0, 0);
        function_8f6194f0((int32_t)&g11);
        function_8f6194f8(1);
        function_8f6194cc();
        if (result != g15) {
            // 0x8f619a18
    ...
    // if_8f6199e8_0_true
    g26 = 0;
    int32_t v5 = 0; // 0x8f619a2c
    int32_t v6 = 0x100000 * v5; // 0x8f619a2c
    g26 = v5 + 1;
    int32_t v7 = arm_mmu_map_section(v6, v6, 3072, result); // 0x8f619a3c
    // branch -> 0x8f619a2c
    while (g26 != 0x1000) {
        // 0x8f619a2c
        v5 = g26;
        v6 = 0x100000 * v5;
        g26 = v5 + 1;
        v7 = arm_mmu_map_section(v6, v6, 3072, result);
        // continue -> 0x8f619a2c
    }
    // 0x8f6199f0
    platform_init_mmu_mappings(v7, v6, 3072, result, a1, result, g24, v1, g27, g19, v3, 0, 0, 0, 0, 0, 0);
    function_8f6194f0((int32_t)&g11);
    function_8f6194f8(1);
    function_8f6194cc();
    if (result != g15) {
