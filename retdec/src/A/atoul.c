...
// Address range: 0x8f649d58 - 0x8f649e13
int32_t atoul(char * a1, int32_t a2) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g16;
    int32_t v3 = v1 + 1; // 0x8f649d88
    int32_t result; // R4
    int32_t v4; // R5
    if (*a1 == 48) {
        // 0x8f649d88
        if (*(char *)v3 == 120) {
            ...
            int32_t c = v5; // 0x8f649d9c9
            while (true) {
                // 0x8f649da8
                if (isxdigit(c) != 0) {
                    char v6 = *(char *)(v4 - 1); // 0x8f649db4
                    result = hexval((int32_t)v6, a2) + 16 * result;
                    int32_t v7 = v4; // 0x8f649d9c
                    v4 = v7 + 1;
                    char v8 = *(char *)v7; // 0x8f649d9c
                    if (v8 == 0) {
                        // break -> 0x8f649df0
                        break;
                    }
    ...
    int32_t c2 = v9; // 0x8f649de416
    while (true) {
        // 0x8f649dc8
        if (isdigit(c2) != 0) {
            int32_t v10 = v4; // 0x8f649dd8
            char v11 = *(char *)(v10 - 1); // 0x8f649dd8
            result = 10 * result - 48 + (int32_t)v11;
            v4 = v10 + 1;
            char v12 = *(char *)v10; // 0x8f649de4
            if (v12 == 0) {
                // break -> 0x8f649df0
                break;
            }
