...
// Address range: 0x8f648e48 - 0x8f648ecb
int32_t fillrect32(int32_t * a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = 4 * a4; // 0x8f648e50
    int32_t v2 = g26;
    int32_t v3 = *(int32_t *)((int32_t)a1 + 24); // 0x8f648e64
    int32_t v4 = *a1; // 0x8f648e68
    int32_t result = v4; // R0
    int32_t v5 = 0; // R1
    int32_t v6 = 4 * (v3 - a4); // 0x8f648e78
    int32_t v7 = 4 * (v3 * a3 + a2) + v4; // 0x8f648e7c
    int32_t v8 = v2;
    if (a5 != 0) {
        int32_t v9 = a5; // 0x8f648e8019
        int32_t v10 = v6; // 0x8f648ea417
        int32_t v11 = 0; // 0x8f648ea015
        int32_t v12 = v1; // 0x8f648e9c12
        // branch -> 0x8f648e8c
        int32_t v13; // bp+223
        while (true) {
            // 0x8f648e8c
            result = 0;
            v13 = 0;
            int32_t v14 = v9; // 0x8f648e80
            int32_t v15 = v10; // 0x8f648ea4
            int32_t v16 = v11; // 0x8f648ea0
            int32_t v17 = v7; // 0x8f648e9c
            int32_t v18 = v12; // 0x8f648e9c
            int32_t v19; // 0x8f648ea0
            if (a4 != 0) {
                // if_8f648e90_0_true.preheader
                int32_t v20;
                *(int32_t *)v7 = v20;
                int32_t v21 = result + 1; // 0x8f648e9430
                result = v21;
                int32_t v22;
                int32_t v23;
                if (v21 != a4) {
                    *(int32_t *)(4 * v21 + v7) = v20;
                    int32_t v24 = result + 1; // 0x8f648e94
                    result = v24;
                    while (v24 != a4) {
                        // if_8f648e90_0_true.if_8f648e90_0_true_crit_edge
                        *(int32_t *)(4 * v24 + v7) = v20;
                        v24 = result + 1;
                        result = v24;
                        // continue -> if_8f648e90_0_true.if_8f648e90_0_true_crit_edge
                    }
                    // 0x8f648e8c
                    v13 = a4;
                    v14 = a5;
