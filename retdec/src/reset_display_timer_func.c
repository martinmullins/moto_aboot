...
// Address range: 0x8f639090 - 0x8f6390e3
int32_t reset_display_timer_func(int32_t a1, int32_t a2) {
    int32_t v1 = g52 ? -0x709c73b8 : 0; // 0x8f639090
    int32_t v2 = g35;
    int32_t v3;
    print_log(1, (int32_t)"Display Timed out!\n", g56, v2, a1, v2, g57, v1, v3, 0, 0, 0, 0);
    event_signal((int32_t)&g26, 0, g56, v2, a1, v2, g57, v1);
    if (v2 != g35) {
        // 0x8f6390cc
        __stack_chk_fail();
        // branch -> 0x8f6390d0
