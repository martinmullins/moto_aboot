...
// Address range: 0x8f600cc8 - 0x8f600d33
int32_t target_uninit(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g47; // 0x8f600cc8
    int32_t v2 = g48; // 0x8f600cc8
    g47 = &g31;
    g48 = &g30;
    int32_t v3 = g31;
    mmc_put_card_to_sleep(g30, a2, a3, v3, a1, v3, a3, v1);
    int32_t v4 = g30;
    sdhci_mode_disable(v4, a2);
    int32_t result = target_is_ssd_enabled(v4); // 0x8f600cec
    g41 = result;
    int32_t v5 = g31;
    if (result == 0) {
        // 0x8f600d18
        ...
        if (v3 == v5) {
            ...
            g48 = v2;
            int32_t v6;
            clock_ce_disable(1, a2, v3, v3, v1, v2, g40, v6, 0);
            return 1;
        }
    }
    // 0x8f600d20
