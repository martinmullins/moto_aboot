...
// Address range: 0x8f63d68c - 0x8f63d78f
int32_t type_atoi_41(char * str, int32_t a2, int32_t a3) {
    int32_t result = (int32_t)str; // 0x8f63d68c_0
    int32_t v1 = g69; // 0x8f63d690
    g69 = result;
    char * v2 = g44;
    char * v3;
    if (str == NULL) {
    ...
    // 0x8f63d734
    int32_t v4; // R0
    int32_t v5; // 0x8f63d76c_28
    if (strcmp((char *)g69, "ullong") == 0) {
        // if_8f63d748_0_true
        v4 = 7;
        v5 = 7;
        // branch -> 0x8f63d754
