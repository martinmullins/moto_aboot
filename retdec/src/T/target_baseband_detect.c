...
// Address range: 0x8f6009d8 - 0x8f600adf
int32_t target_baseband_detect(int32_t * a1) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g27 ? -0x709a999c : 0; // 0x8f6009dc
    int32_t result = g23;
    uint32_t v3 = *a1; // 0x8f6009f4
    if (v3 <= 243) {
        // 0x8f600a00
        // branch -> 0x8f600a80
        // 0x8f600a80
        *(int32_t *)(v1 + 24) = (int32_t)(v3 > 241);
        // branch -> 0x8f600ab0
        // 0x8f600ab0
        if (result != g23) {
            // 0x8f600ac0
    ...
    if (v3 > ((int32_t)&g23 & -0x10000 || 263)) {
        ...
        if (v3 >= 268) {
            // 0x8f600a58
            v6 = 0;
            if (v3 > (((int32_t)&g23 & -0x10000 || 263) & -0x10000 || 270)) {
                // 0x8f600a64
                if (v3 != (((int32_t)&g23 & -0x10000 || 263) & -0x10000 || 270) + 1) {
                    // 0x8f600a88
                    print_log(-1, (int32_t)"Platform type: %u is not supported\n", v3, g32, v5, 0, 0, result, 0, g33, g34, v2, v4);
                    _panic(v2, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"target/msm8916/init.c", (int32_t)&g4 & -0x10000 | 422, (int32_t)&g4, 0, 0);
                    // branch -> 0x8f600ab0
                    // 0x8f600ab0
                    if (result != g23) {
                        // 0x8f600ac0
