...
// Address range: 0x8f61be90 - 0x8f61bf73
int32_t thread_unblock_from_wait_queue(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g34; // 0x8f61be90
    int32_t v2 = g35; // 0x8f61be90
    g34 = a1;
    int32_t v3 = g25;
    int32_t v4 = g8;
    g35 = &g8;
    g8 = v4 + 1;
    int32_t v5 = a1; // 0x8f61bee0
    if (v4 == 0) {
        // 0x8f61becc
        function_8f619448((int32_t)&g25);
        v5 = g34;
        // branch -> 0x8f61bed0
    }
    int32_t result = -12;
    if (*(char *)(v5 + 24) == 3) {
        int32_t v6 = *(int32_t *)(v5 + 16); // 0x8f61bee0
        int32_t v7 = 0; // R0
        *(int32_t *)v6 = *(int32_t *)(v5 + 12);
        *(int32_t *)(*(int32_t *)(g34 + 12) + 4) = v6;
        int32_t v8 = g34; // 0x8f61bef8
        *(int32_t *)(v8 + 16) = v7;
        *(int32_t *)(g34 + 12) = v7;
        int32_t * v9 = (int32_t *)(*(int32_t *)(v8 + 36) + 12); // 0x8f61bf04_0
        int32_t v10 = *v9 - 1; // 0x8f61bf08
        *v9 = v10;
        *(int32_t *)(g34 + 36) = v7;
        *(int32_t *)(g34 + 40) = a3;
        int32_t v11 = g34; // 0x8f61bf1c
        *(char *)(v11 + 24) = 1;
        int32_t v12 = insert_in_run_queue_head(v11, a2, v10); // 0x8f61bf24
        if (a2 != 0) {
            // 0x8f61bf30
            thread_resched(v12, a2, v10, 1, a1, v3, v1, v2, g36, g37, g38, 0);
            // branch -> 0x8f61bf34
        }
        int32_t v13 = g8 - 1; // 0x8f61bf38
        g34 = v13;
        *(int32_t *)g35 = v13;
        if (g34 == 0) {
            // 0x8f61bf48
