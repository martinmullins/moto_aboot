...
// Address range: 0x8f60100c - 0x8f60106f
int32_t target_fastboot_init(int32_t a1, int32_t a2) {
    char * v1 = g23;
    int32_t v2 = (int32_t)v1;
    int32_t v3 = target_is_ssd_enabled(pm8x41_set_boot_done(a1, a2)); // 0x8f601020
    ...
    if (v3 == 0) {
        ...
        int32_t v4 = clock_ce_enable(1, a2, g29, v2, a1, v2, g30); // 0x8f601030
        result = v4;
        char * v5 = g23;
        if (v1 == v5) {
            // 0x8f601044
            int32_t v6;
            return target_load_ssd_keystore(v4, a2, v2, (int32_t)v5, g30, 0, v6, 0, 0);
        }
    }
    // 0x8f601060
    __stack_chk_fail();
