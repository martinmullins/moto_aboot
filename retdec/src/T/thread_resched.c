...
// Address range: 0x8f61b308 - 0x8f61b3e7
int32_t thread_resched(int32_t a1) {
    int32_t v1 = g30; // 0x8f61b308
    int32_t v2 = g31; // 0x8f61b308
    int32_t v3 = g16;
    int32_t v4 = g20;
    int32_t v5 = 31 - llvm_ctlz_i32(v3, false); // 0x8f61b328
    int32_t v6 = 8 * v5 + (int32_t)&g17; // 0x8f61b330
    g31 = v6;
    g30 = g24;
    int32_t result = list_remove_head(v6); // 0x8f61b33c
    int32_t v7 = g31; // 0x8f61b340
    int32_t v8 = result == 0 ? 0 : result - 12;
    if (*(int32_t *)(v7 + 4) == v7) {
        uint32_t v9 = v5 % 256; // 0x8f61b3583
        int32_t v10 = v9 == 0 ? -2 : v9 < 32 ? (-1 << v9) - 1 : -1; // 0x8f61b358
        *(int32_t *)(int32_t)&g16 = v10 & v3;
        // branch -> after_if_8f61b35c_0
    }
    // after_if_8f61b35c_0
    *(char *)(v8 + 24) = 2;
    if (v8 == g30) {
        ...
        // 0x8f61b370
        *(int32_t *)(int32_t)&g24 = v8;
        if (*(int32_t *)(v8 + 32) < 1) {
            // if_8f61b37c_0_true
            *(int32_t *)(v8 + 32) = 5;
            // branch -> after_if_8f61b380_0
        }
        // after_if_8f61b380_0
        *(int32_t *)(g30 + 28) = g10;
        *(int32_t *)(int32_t)&g10 = *(int32_t *)(v8 + 28);
        int32_t v12 = g20;
        g29 = v12;
        if (v4 == v12) {
            int32_t v13 = g30; // 0x8f61b3a8
            g30 = v1;
            g31 = v2;
            return arch_context_switch(v13, v8, v4, v4);
        }
    }
    // 0x8f61b3c8
    __stack_chk_fail();
