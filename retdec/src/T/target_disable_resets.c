...
// Address range: 0x8f6006ec - 0x8f60077b
int32_t target_disable_resets(char * a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = (int32_t)a1; // 0x8f6006ec_0
    int32_t v2 = g27 ? -0x709cc008 : 0; // 0x8f6006ec
    int32_t v3 = g16;
    int32_t result = is_kung_pow_enabled(v1, a2, a3, v3, v1, v3, a3); // 0x8f600700
    if (result == 0) {
        // 0x8f60070c
        if (v1 != 0) {
            // 0x8f600714
            int32_t v4;
            int32_t v5;
            return print_log(1, (int32_t)"User-Resets are being disabled\n", a3, v3, v1, v3, a3, g31, g32, v2, v4, v5, 0);
        }
        // 0x8f60073c
        if (v3 == g16) {
            // 0x8f60074c
            return pm8x41_config_s3_source(0, a2, v3, v3);
        }
    } else {
        // 0x8f600758
        if (v3 == g16) {
