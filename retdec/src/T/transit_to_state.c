...
// Address range: 0x8f6752bc - 0x8f6753af
int32_t transit_to_state(int32_t a1, int32_t a2, int32_t (*a3)(int32_t), int32_t a4) {
    // 0x8f6752bc
    g31 = a1;
    g32 = a2;
    int32_t v1 = g36; // 0x8f6752bc
    int32_t v2 = g37; // 0x8f6752bc
    int32_t v3 = g38; // 0x8f6752bc
    int32_t v4 = g39; // 0x8f6752bc
    int32_t v5 = g40; // 0x8f6752bc
    int32_t v6 = g41; // 0x8f6752bc
    int32_t v7 = g33; // 0x8f6752bc
    g33 = a4;
    g40 = &g15;
    g39 = (int32_t)a3;
    g36 = a1;
    ...
    int32_t v8 = g15;
    g35 = &g7;
    int32_t v9 = 8 * a1; // 0x8f6752e0
    int32_t v10 = v9 + (int32_t)&g7; // 0x8f6752e0
    g38 = v10;
    if (*(int32_t *)(v9 + (int32_t)&g7 + 4) == 0) {
        // 0x8f6752f0
        print_log(0, (int32_t)"Not allowed state transition to %d\n", a1, (int32_t)&g7, a1, v8, v1, v2, v3, v4, v5, v6, v7);
        g31 = 12;
        // branch -> 0x8f675380
        // 0x8f675380
        if (v8 != g15) {
    ...
    int32_t v11 = *(int32_t *)v10; // 0x8f675308
    g34 = v11;
    int32_t v12; // 0x8f675320
    if (v11 == 0) {
        // 0x8f675314
        v12 = state_transition_validate(a1, a2, 0, (int32_t)&g7, a1, v8);
        // branch -> 0x8f675320
    } else {
        // 0x8f67531c
        g30 = -0x7098ace0;
    ...
    g37 = v12;
    if (v12 == 0) {
        int32_t v13 = g39; // 0x8f675344
        if (v13 != 0) {
            int32_t v14 = g33; // 0x8f67534c
            g31 = v14;
            g30 = -0x7098acac;
            ((int32_t (*)(int32_t))v13)(v14);
            int32_t v15 = g31; // 0x8f675354
            g39 = v15;
            if (v15 != 0) {
                // 0x8f67535c
                print_log(g37, (int32_t)"Failed to pass user validator to state %d\n", g36, (int32_t)&g7, a1, v8, v1, v2, v3, v4, v5, v6, v7);
                g31 = g39;
                // branch -> 0x8f675380
                // 0x8f675380
                if (v8 != g15) {
        ...
        int32_t v16 = *(int32_t *)(g38 + 4); // 0x8f675374
        g35 = v16;
        int32_t v17 = g41; // 0x8f675378
        g31 = v17;
        g30 = -0x7098ac80;
        ((int32_t (*)(int32_t, int32_t))v16)(v17, v16);
        // branch -> 0x8f675380
    } else {
        // 0x8f67532c
        print_log(0, (int32_t)"Failed to pass validation to new state %d\n", g36, (int32_t)&g7, a1, v8, v1, v2, v3, v4, v5, v6, v7);
        g31 = g37;
        // branch -> 0x8f675380
    }
    // 0x8f675380
