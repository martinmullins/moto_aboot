...
// Address range: 0x8f61b5c4 - 0x8f61b65b
int32_t thread_exit(int32_t a1, int32_t a2, int32_t a3) {
    // 0x8f61b5c4
    g20 = a1;
    int32_t v1 = g17;
    ...
    *(char *)(g18 + 24) = 5;
    int32_t v3;
    int32_t v4 = dpc_queue((int32_t)&g4, g18, 1, 5, a1, v1, g24, g25, g26, g19, v3); // 0x8f61b618
    int32_t result = thread_resched((int32_t)&g4, g18, v4, 5, a1, v1, g24, g25, g26, g19, v3, 0); // 0x8f61b61c
    g20 = result;
    if (v1 != g17) {
        // 0x8f61b630
        __stack_chk_fail();
    ...
    // 0x8f61b634
    g20 = g19;
    int32_t result2 = _panic(g19, (int32_t)"somehow fell through thread_exit()\n", v1, v1, g24, g25, g26); // 0x8f61b644
    g20 = result2;
    return result2;
}
