...
// Address range: 0x8f637270 - 0x8f6372f3
int32_t test_ProcUID(void) {
    // 0x8f637270
    int32_t v1;
    ...
    int32_t v4 = v3; // R3
    int32_t v5;
    int32_t v6 = SecProcessorUID((int32_t)&v2, 15, g38, v3, v5, 0, 0, v1, 0, 0, 0); // 0x8f63728c
    int32_t v7 = (int32_t)"SecProcessorUID failed";
    int32_t v8; // 0x8f6372a8
    if (v6 == 0) {
        // 0x8f6372a0
        int32_t v9;
        int32_t v10 = 0x1000000 * v9 / 0x1000000; // 0x8f6372a0
        v8 = 0x1000000 * v2 / 0x1000000;
        int32_t v11;
        int32_t v12 = 0x1000000 * v11 / 0x1000000; // 0x8f6372ac
        v4 = v12;
        int32_t str;
        sprintf((char *)&str, "3 proc uid bytes... %X,%X,%X", v8, v12, v10);
        v5 = v10;
        v7 = &str;
        // branch -> 0x8f6372c4
    }
    // 0x8f6372c4
    g36 = v7;
    int32_t result = fboot_info((int32_t)"INFO", v7, v8, v4, v5, 0, 0, v2, 0, 0, 0); // 0x8f6372c4
    int32_t v13 = g32;
    g39 = v13;
    if (v3 != v13) {
        // 0x8f6372d8
