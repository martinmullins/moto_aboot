...
// Address range: 0x8f61a60c - 0x8f61a68b
int32_t target_product_name(void) {
    int32_t v1 = g18;
    int32_t v2 = (int32_t)&g11; // R4
    if (*(char *)&g11 == 0) {
        // 0x8f61a630
        int32_t v3;
        int32_t v4 = __utag_gets_constprop_4("device", (int32_t)&g11, 33, (int32_t)&g18, g20, v1, g22, g24, g25, g19, v3, 0); // 0x8f61a63c
        if (v4 == 0) {
            int32_t v5 = get_product_name(0, (int32_t)&g11, 33, (int32_t)&g18, g20, v1, g22); // 0x8f61a648
            if (v5 != 0) {
                // 0x8f61a654
                strlcat(v2, v5, 33, (int32_t)&g18, g20, v1, g22, g24, g25, g19, v3, 0);
                // branch -> 0x8f61a660
            }
            // 0x8f61a660
            if (v1 != g18) {
