...
// Address range: 0x8f61b3e8 - 0x8f61b48f
int32_t thread_cleanup_dpc(char * a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g30; // 0x8f61b3ec
    int32_t v3 = g31; // 0x8f61b3ec
    g30 = v1;
    int32_t v4 = g10;
    g31 = &g10;
    g10 = v4 + 1;
    if (v4 == 0) {
        // 0x8f61b41c
        return function_8f619448(v1);
    }
    int32_t v5 = *(int32_t *)(v1 + 8); // 0x8f61b420
    *(int32_t *)v5 = *(int32_t *)(v1 + 4);
    *(int32_t *)(*(int32_t *)(g30 + 4) + 4) = v5;
    int32_t v6 = 0; // R3
    *(int32_t *)(g30 + 8) = 0;
    int32_t v7 = g10 - 1; // R2
    *(int32_t *)(g30 + 4) = v6;
    *(int32_t *)g31 = v7;
    ...
    int32_t result2 = g30; // 0x8f61b454
    int32_t result = *(int32_t *)(result2 + 48); // 0x8f61b454
    if (result != 0) {
        // 0x8f61b460
        free((char *)result);
        return result;
