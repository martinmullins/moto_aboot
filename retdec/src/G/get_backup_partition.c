...
// Address range: 0x8f6736c4 - 0x8f67376b
int32_t get_backup_partition(void) {
    int32_t v1 = g28;
    int32_t v2 = 0; // R4
    int32_t v3 = 0; // 0x8f6736f4
    // branch -> 0x8f6736e4
    while (true) {
        int32_t v4 = v3 + (int32_t)&g4; // 0x8f6736e4
        int32_t v5 = v4; // R6
        int32_t v6 = *(int32_t *)(v4 + 4); // 0x8f6736e8
        int32_t v7 = v6; // R8
        int32_t v8; // 0x8f673734
        if (v6 == 0) {
            v8 = v3;
          lab_0x8f673734:;
            int32_t v9 = v8 + 8; // 0x8f673734
            v2 = v9;
            if (v9 != 40) {
                // 0x8f673734
                v3 = v9;
        ...
        int32_t str = *(int32_t *)v4; // 0x8f6736f4
        int32_t len = strlen((char *)str); // 0x8f6736fc
        if (strncmp((char *)g31, (char *)str, len) == 0) {
            // 0x8f673718
            print_log(1, (int32_t)"Found backup (%s) for primary (%s)\n", v7, g31, g31, v1, g37, g38, g39, g40, g41, g42, g33);
            // branch -> 0x8f673744
        } else {
            // 0x8f6736f4
            v8 = v2;
