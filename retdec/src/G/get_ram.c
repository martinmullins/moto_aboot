...
// Address range: 0x8f6558e8 - 0x8f65597b
char * get_ram(char * a1, int32_t a2) {
    int32_t v1 = g22; // 0x8f6558e8
    int32_t v2 = g24; // 0x8f6558e8
    g22 = (int32_t)a1;
    g24 = a2;
    int32_t v3;
    int32_t v4 = &v3; // 0x8f655904_0
    int32_t v5 = g13;
    memset((char *)&v3, 0, 16);
    int32_t v6 = g22; // 0x8f655928
    int32_t v7;
    char * v8 = for_each_token((char *)&g14, (int32_t)&g5, (int32_t)&g1, v4, v7, v3, 0, v6, a2, v5, v1, g23, v2); // 0x8f65592c
    g24 = (int32_t)v8;
    int32_t * v9 = &g22;
    if (v8 == NULL) {
        // 0x8f65593c
        print_log(-1, (int32_t)"failed to autodetect RAM size", (int32_t)&g1, v4, v7, v3, 0, v6, a2, v5, v1, g23, v2);
        v9 = &g24;
        // branch -> 0x8f65594c
    }
    // 0x8f65594c
