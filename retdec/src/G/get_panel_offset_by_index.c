...
// Address range: 0x8f631c84 - 0x8f631d2b
int32_t get_panel_offset_by_index(int32_t a1, int32_t a2) {
    // 0x8f631c84
    int32_t v1;
    int32_t str = v1; // bp-36
    int32_t v2 = g34; // 0x8f631c8c
    int32_t v3 = g35; // 0x8f631c8c
    int32_t v4 = g25;
    g34 = a1;
    int32_t v5;
    int32_t * v6;
    if (a1 == -1) {
        // 0x8f631cac
        print_log(-1, (int32_t)"Invalid panels node offset\n", (int32_t)&g25, a2, v5, v1, 0, 0, 0, v4, v2, v3, g36);
        v6 = &g34;
        // branch -> 0x8f631cfc
    } else {
        int32_t v7 = &str; // 0x8f631cc4_0
        snprintf((char *)&str, 16, "panel@%d", a2);
        int32_t v8 = fdt_subnode_offset((char *)&g4, g34, v7, a2, v5, str, 0, 0, 0); // 0x8f631cd8
        g35 = v8;
        if (v8 == -1) {
            // 0x8f631ce8
            print_log(-1, (int32_t)"Failed to get %s at node@0x%x\n", v7, g34, v5, str, 0, 0, 0, v4, v2, v3, g36);
            v6 = &g35;
            // branch -> 0x8f631cfc
        } else {
            v6 = &g35;
