...
// Address range: 0x8f638d54 - 0x8f638ffb
int32_t get_ui_coordinates(int32_t a1, int32_t a2) {
    int32_t v1 = a2; // R4
    int32_t v2 = g57;
    char v3 = *(char *)&g50; // 0x8f638d78
    if (v3 == 0) {
        // 0x8f638d8c
        if (a1 != 0 && a2 != 0) {
            int32_t v4 = get_offset_ui_setting(a1, a2, (int32_t)v3, (int32_t)&g50); // 0x8f638da0
            if (v4 >= 0) {
                // 0x8f638dac
                if (*(int32_t *)(a1 + 504) == 0) {
                    // 0x8f638db8
                    _panic(g58, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"app/screenmanager/screen_manager.c", (int32_t)"panel->mipi_fb_cfg" & -0x10000 | 302, (int32_t)"panel->mipi_fb_cfg", 0, 0);
                    // branch -> 0x8f638dd4
                }
                int32_t v5 = *(int32_t *)(a1 + 504); // 0x8f638dd4
                int32_t v6 = 0; // R6
                int32_t str;
                int32_t v7 = &str; // 0x8f638de4_0
                int32_t v8 = *(int32_t *)(v5 + 8); // 0x8f638de8
                int32_t v9 = *(int32_t *)(v5 + 4); // 0x8f638df4
                snprintf((char *)&str, 63, "coordinates@%d,%d", v9, v8);
                if (get_subnode_offset(v7, v4, (int32_t)"coordinates@%d,%d", v9) >= 0) {
                    // 0x8f638e10
                    if (get_int_array_prop((int32_t)"droid_operation", v7, v1, 8, v8, 0, 0, str, 0, 0) < v6) {
                        // 0x8f638e2c
                        print_log(v6, (int32_t)"Failed to get droid_operation\n", v1, 8, v8, 0, 0, str, 0, 0, 0, 0, 0);
                        // branch -> 0x8f638e38
                    }
                    int32_t v10 = v1 + 20; // 0x8f638e40
                    if (get_int_array_prop((int32_t)"arrows", v7, v10, 8, v8, 0, 0, str, 0, 0) <= 0xffffffff) {
                        // 0x8f638e54
                        print_log(0, (int32_t)"Failed to get arrows\n", v10, 8, v8, 0, 0, str, 0, 0, 0, 0, 0);
                        // branch -> 0x8f638e60
                    }
                    int32_t v11 = v1 + 8; // 0x8f638e68
                    if (get_int_array_prop((int32_t)"start", v7, v11, 12, v8, 0, 0, str, 0, 0) <= 0xffffffff) {
                        // 0x8f638e7c
                        print_log(0, (int32_t)"Failed to get start\n", v11, 12, v8, 0, 0, str, 0, 0, 0, 0, 0);
                        // branch -> 0x8f638e88
                    }
                    int32_t v12 = v1 + 28; // 0x8f638e90
                    if (get_int_array_prop((int32_t)"text", v7, v12, 12, v8, 0, 0, str, 0, 0) <= 0xffffffff) {
                        // 0x8f638ea4
                        print_log(0, (int32_t)"Failed to get text\n", v12, 12, v8, 0, 0, str, 0, 0, 0, 0, 0);
                        // branch -> 0x8f638eb0
                    }
                    int32_t v13 = v1 + 40; // 0x8f638eb8
                    if (get_int_array_prop((int32_t)"yes", v7, v13, 8, v8, 0, 0, str, 0, 0) <= 0xffffffff) {
                        // 0x8f638ecc
                        print_log(0, (int32_t)"Failed to get yes\n", v13, 8, v8, 0, 0, str, 0, 0, 0, 0, 0);
                        // branch -> 0x8f638ed8
                    }
                    int32_t v14 = v1 + 48; // 0x8f638ee0
                    if (get_int_array_prop((int32_t)"no", v7, v14, 8, v8, 0, 0, str, 0, 0) <= 0xffffffff) {
                        // 0x8f638ef4
                        print_log(0, (int32_t)"Failed to get no\n", v14, 8, v8, 0, 0, str, 0, 0, 0, 0, 0);
                        // branch -> 0x8f638f00
                    }
                    int32_t v15 = v1 + 56; // 0x8f638f08
                    if (get_int_array_prop((int32_t)"ic_unlocked_bootloader", v7, v15, 8, v8, 0, 0, str, 0, 0) <= 0xffffffff) {
                        // 0x8f638f1c
                        print_log(0, (int32_t)"Failed to get ic_unlocked_bootloader\n", v15, 8, v8, 0, 0, str, 0, 0, 0, 0, 0);
                        // branch -> 0x8f638f28
                    }
                    int32_t v16 = v1 + 64; // 0x8f638f30
                    if (get_int_array_prop((int32_t)"warning", v7, v16, 8, v8, 0, 0, str, 0, 0) <= 0xffffffff) {
                        // 0x8f638f44
                        print_log(0, (int32_t)"Failed to get warning\n", v16, 8, v8, 0, 0, str, 0, 0, 0, 0, 0);
                        // branch -> 0x8f638f50
                    }
                    int32_t v17 = v1 + 72; // 0x8f638f58
                    if (get_int_array_prop((int32_t)"keystore_id", v7, v17, 8, v8, 0, 0, str, 0, 0) <= 0xffffffff) {
                        // 0x8f638f6c
                        print_log(0, (int32_t)"Failed to get keystore_id\n", v17, 8, v8, 0, 0, str, 0, 0, 0, 0, 0);
                        // branch -> 0x8f638f78
                    }
                    // 0x8f638f78
                    g59 = 1;
