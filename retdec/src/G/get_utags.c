...
// Address range: 0x8f6788e4 - 0x8f678953
int32_t get_utags(int32_t a1, int32_t a2) {
    int32_t v1 = g13; // 0x8f6788ec
    int32_t v2 = g7;
    g10 = v2;
    int32_t result;
    int32_t v3;
    if (a1 < 2) {
        // 0x8f67891c
        v3 = v2;
        result = 96 * a1 + (int32_t)&g6;
        // branch -> 0x8f678928
    } else {
        int32_t v4 = g8 ? -0x70987650 : 0; // 0x8f6788ec
        g10 = (int32_t)"%s: failed uspace = [%d]\n";
        int32_t v5;
        print_log(-1, (int32_t)"%s: failed uspace = [%d]\n", (int32_t)"get_utags", a1, a1, v2, v1, v4, v5, 0, 0, 0, 0);
        v3 = g7;
        result = 0;
        // branch -> 0x8f678928
    }
