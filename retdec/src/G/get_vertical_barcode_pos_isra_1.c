...
// Address range: 0x8f63bef0 - 0x8f63bf97
int32_t get_vertical_barcode_pos_isra_1(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g51; // 0x8f63bef0
    int32_t v2 = g47;
    uint32_t v3 = font_get_y(a1, a2, a3, v2); // 0x8f63bf04
    int32_t result = v3 / 2; // 0x8f63bf0c
    if (a1 != 0) {
        int32_t v4 = display_get_screen_height(v3, a2, a3, v2); // 0x8f63bf18
        int32_t v5 = font_get_y(v4, a2, a3, v2); // 0x8f63bf20
        int32_t v6 = get_barcode_scale(v5, a2, a3, v2, a1, v2, a3, v1); // 0x8f63bf28
        int32_t v7 = font_get_y(v6, a2, a3, v2); // 0x8f63bf30
        int32_t v8 = font_get_y(v7, a2, a3, v2); // 0x8f63bf38
        int32_t v9 = font_get_y(v8, a2, a3, v2); // 0x8f63bf44
        int32_t v10 = get_barcode_scale(v9, a2, a3, v2, a1, v2, a3, v1); // 0x8f63bf50
        int32_t v11 = result + (v10 * v9 + font_get_y(v10, a2, a3, v2) + (v4 - result - v8 + -4 * (v6 * v5 + v7)) / 3) * a1; // 0x8f63bf74
        result = v11;
        // branch -> 0x8f63bf78
    }
    // 0x8f63bf78
