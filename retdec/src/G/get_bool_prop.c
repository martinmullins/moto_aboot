...
// Address range: 0x8f630b54 - 0x8f630b9f
int32_t get_bool_prop(int32_t a1, int32_t a2) {
    int32_t v1 = g27 ? -0x709a999c : 0; // 0x8f630b54
    int32_t v2 = g23;
    int32_t v3;
    int32_t v4 = fdt_get_property((int32_t)&g3, a2, a1, 0, a1, v2, g33, v1, v3, 0, 0, 0, 0); // 0x8f630b70
    if (v2 != g23) {
        // 0x8f630b8c
        __stack_chk_fail();
        // branch -> 0x8f630b90
