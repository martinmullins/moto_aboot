...
// Address range: 0x8f63284c - 0x8f6328fb
int32_t get_root_detect_disabled(void) {
    int32_t v1 = g33; // 0x8f632850
    int32_t v2; // bp-16
    int32_t v3 = &v2; // 0x8f632850_1
    int32_t v4 = g23;
    v2 = -1;
    int32_t v5 = g9;
    int32_t v6;
    int32_t v7; // 0x8f6328ac
    int32_t result; // 0x8f6328c4
    if (v5 <= -1) {
        // 0x8f632878
        print_log(-1, (int32_t)"No product setting\n", (int32_t)&g9, (int32_t)&g23, -1, v4, v1, g26, v6, 0, 0, 0, 0);
        // branch -> 0x8f6328ac
        // 0x8f6328ac
        v7 = v2;
        result = -1;
        if (v7 != -1) {
            int32_t v8 = &g23; // 0x8f6328c0
            print_log(2, (int32_t)"root_detect_disabled defined: %d\n", v7, v8, v7, v4, v1, g26, v6, 0, 0, 0, 0);
            result = v2;
            // branch -> 0x8f6328c4
        }
        // 0x8f6328c4
    ...
    int32_t v9 = get_int_prop((int32_t)"root_detect_disabled", v5, v3, (int32_t)&g23, -1, v4, v1); // 0x8f63288c
    int32_t result2 = v9; // R0
    int32_t v10; // 0x8f6328e0_24
    if (v9 != -1) {
        int32_t v11 = v2; // 0x8f6328a4
        print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"root_detect_disabled", v11, v11, v4, v1, g26, v6, 0, 0, 0, 0);
        // branch -> 0x8f6328ac
        // 0x8f6328ac
        v7 = v2;
        result = -1;
        if (v7 != -1) {
            // 0x8f6328b8
            print_log(2, (int32_t)"root_detect_disabled defined: %d\n", v7, v11, v7, v4, v1, g26, v6, 0, 0, 0, 0);
            result = v2;
            // branch -> 0x8f6328c4
        }
        // 0x8f6328c4
