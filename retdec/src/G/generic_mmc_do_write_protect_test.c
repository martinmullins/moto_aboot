...
// Address range: 0x8f651240 - 0x8f6512d7
int32_t generic_mmc_do_write_protect_test(int32_t a1) {
    // 0x8f651240
    int32_t v1;
    int32_t v2 = v1; // bp-532
    int32_t v3 = g80; // 0x8f651240
    int32_t v4 = &v2; // 0x8f651250_0
    int32_t v5 = g73;
    int32_t v6;
    generic_mmc_read_sector(a1, 1, v4, v5, v6, v1, 0, 0, 0, 0);
    int32_t v7 = 0x1000000 * v2 / 0x1000000; // 0x8f651264
    g80 = v7;
    int32_t v8 = v7 + 1; // 0x8f651274
    int32_t v9 = 0x1000000 * v8 / 0x1000000; // 0x8f651278_0
    v2 = v9;
    generic_mmc_write_sector(a1, 1, v4, v8, v6, v9, 0, 0, 0);
    generic_mmc_read_sector(a1, 1, v4, v8, v6, v2, 0, 0, 0, 0);
    int32_t v10 = 0x1000000 * v2 / 0x1000000; // 0x8f651290
    int32_t result = 0;
    if (v10 != g80) {
        int32_t v11 = 0x1000000 * g80 / 0x1000000; // 0x8f6512ac_0
        v2 = v11;
        generic_mmc_write_sector(a1, 1, v4, v10, v6, v11, 0, 0, 0);
        result = 1;
        // branch -> 0x8f6512b8
    }
    // 0x8f6512b8
