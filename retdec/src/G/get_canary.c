...
// Address range: 0x8f617320 - 0x8f61739f
int32_t get_canary(int32_t a1) {
    int32_t v1 = g33; // 0x8f617320
    int32_t v2 = g30; // bp-4
    g33 = &v2;
    int32_t v3;
    int32_t v4 = &v3; // 0x8f617328_0
    scm_random(v4, 4);
    int32_t v5;
    print_log(-1, -0x7097f294, g34, v4, v1, v2, v5, 0, 0, 0, 0, 0, 0);
    int32_t result = rand(); // 0x8f617368
    v3 = result;
