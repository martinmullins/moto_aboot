...
// Address range: 0x8f6730f0 - 0x8f67319b
int32_t get_boot_component_version(int32_t a1) {
    int32_t v1 = g61; // 0x8f6730f0
    int32_t v2 = g62; // 0x8f6730f0
    int32_t v3 = g63; // 0x8f6730f0
    int32_t v4 = g54; // 0x8f6730f0
    g61 = a1;
    g63 = &g49;
    int32_t v5 = g49;
    int32_t v6;
    g62 = (int32_t)get_partition_by_name(a1, g56, g59, v5, a1, v5, v1, v2, v3, v4, v6);
    int32_t v7 = get_policy_executor((char *)g61); // 0x8f673110
    g55 = v7;
    int32_t v8 = g62; // 0x8f673114
    int32_t result; // 0x8f673188_2
    if (v8 == 0) {
        // after_if_8f673118_0.thread
        // branch -> 0x8f673164
        // 0x8f673164
        print_log(5, (int32_t)"Invalid boot component %s", g61, v7, a1, v5, v1, v2, v3, v4, v6, 0, 0);
        // branch -> 0x8f67313c
        // 0x8f67313c
        g55 = -1;
        // branch -> 0x8f673170
    ...
    // 0x8f673128
    int32_t v9; // 0x8f673188_27
    if (v7 == 0) {
        // 0x8f673130
        print_log(5, (int32_t)"System error!", g59, 0, a1, v5, v1, v2, v3, v4, v6, 0, 0);
        // branch -> 0x8f67313c
        // 0x8f67313c
        g55 = -1;
        v9 = -1;
        ...
        int32_t v10 = *(int32_t *)(v7 + 24); // 0x8f673144
        g60 = v10;
        g56 = v8;
        g54 = -0x7098ceb0;
        ((int32_t (*)(int32_t, int32_t))v10)(v8, v10);
        int32_t v11 = g55; // 0x8f673150
        if (v11 == -1) {
            // 0x8f67315c
            // branch -> 0x8f673164
            // 0x8f673164
            print_log(5, (int32_t)"Failed to read %s's version", g61, g60, a1, v5, v1, v2, v3, v4, v6, 0, 0);
            // branch -> 0x8f67313c
            // 0x8f67313c
            g55 = -1;
            v9 = -1;
