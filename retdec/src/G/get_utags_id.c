...
// Address range: 0x8f679358 - 0x8f6793df
int32_t get_utags_id(char * str, int32_t a2) {
    int32_t str2 = (int32_t)str;
    int32_t v1 = g26 ? -0x709fccd8 : 0; // 0x8f679358
    int32_t v2 = g23;
    int32_t strcmp_rc = strcmp(str, (char *)*(int32_t *)&g6); // 0x8f679374
    int32_t result; // 0x8f6793cc_2
    if (strcmp_rc == 0) {
        // 0x8f6793b4
        if (v2 != g23) {
            // 0x8f6793c4
    ...
    // 0x8f679380
    int32_t v3; // R0
    int32_t v4; // 0x8f6793cc_22
    if (strcmp((char *)str2, (char *)*(int32_t *)&g7) == 0) {
        // 0x8f6793b0
        v3 = 1;
        v4 = 1;
        // branch -> 0x8f6793b4
        ...
        // 0x8f679394
        int32_t v5;
        print_log(-1, (int32_t)"%s: failed uspace name = [%s]\n", (int32_t)"get_utags_id", str2, str2, v2, g31, g32, g33, v1, v5, 0, 0);
        v3 = -1;
        v4 = -1;
        // branch -> 0x8f6793b4
    }
