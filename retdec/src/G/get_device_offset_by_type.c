...
// Address range: 0x8f632c94 - 0x8f632d0b
int32_t get_device_offset_by_type(int32_t a1, char * a2) {
    int32_t str = (int32_t)a2;
    int32_t v1 = g41; // 0x8f632c94
    int32_t v2 = g42; // 0x8f632c94
    g42 = &g32;
    int32_t v3 = g32;
    int32_t v4 = get_device_setting_offset(a1, str, g39, v3, a1, v3, v1, v2); // 0x8f632ca8
    g35 = v4;
    g41 = v4;
    if (v4 < 0) {
        // 0x8f632ccc
    ...
    int32_t str2 = get_device_type(); // 0x8f632cb4
    if (str2 == 0) {
        // 0x8f632cc0
        int32_t v5;
        print_log(-1, (int32_t)"Not found battery device type!\n", g39, v3, a1, v3, v1, v2, g43, g34, v5, 0, 0);
        // branch -> 0x8f632ccc
    } else {
        // 0x8f632cd4
