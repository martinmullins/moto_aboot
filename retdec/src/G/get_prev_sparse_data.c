...
// Address range: 0x8f67622c - 0x8f67629b
int32_t get_prev_sparse_data(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g17;
    if (a1 == 0) {
        // 0x8f67627c
    ...
    int32_t * v2 = (int32_t *)(a1 - 4); // 0x8f676250_0
    int32_t v3 = *v2; // 0x8f676250
    if (v3 == 0) {
        // 0x8f67627c
        if (v1 != g17) {
            // 0x8f67628c
    ...
    int32_t v4 = *(int32_t *)v3; // 0x8f676260
    int32_t result;
    if (v4 == a1 - 20) {
        // after_if_8f676268_0.thread
        *v2 = 0;
        result = 0;
        // branch -> 0x8f67627c
    } else {
