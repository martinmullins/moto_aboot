...
// Address range: 0x8f6496a4 - 0x8f649703
int32_t gfx_create_surface_from_display(int32_t * a1) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g15;
    char v3 = *(char *)(v1 + 4); // 0x8f6496c0
    int32_t v4 = *(int32_t *)(v1 + 20); // 0x8f6496c8
    int32_t v5 = *(int32_t *)(v1 + 8); // 0x8f6496d0
    int32_t v6 = *(int32_t *)(v1 + 12); // 0x8f6496d0
    int32_t v7 = *(int32_t *)(v1 + 16); // 0x8f6496d0
    int32_t v8 = *a1; // 0x8f6496d4
    int32_t v9;
    int32_t result = gfx_create_surface(v8, v5, v6, v7, (int32_t)v3, v4, 0, v2, 0, g23, g24, g16, v9, 0, 0, 0); // 0x8f6496d8
    *(int32_t *)(result + 52) = *(int32_t *)(v1 + 24);
    if (v2 != g15) {
        // 0x8f6496f4
        __stack_chk_fail();
        // branch -> 0x8f6496f8
