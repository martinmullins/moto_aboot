...
// Address range: 0x8f657d44 - 0x8f657deb
int32_t get_first_ram_log(int32_t a1, int32_t a2, int32_t a3) {
    // 0x8f657d44
    g26 = (int32_t)&g19;
    g28 = &g15;
    ...
    int32_t v1 = g15;
    g29 = v1;
    int32_t v2 = target_get_scratch_address(a1, a2); // 0x8f657d60
    g21 = v2;
    *(int32_t *)g27 = v2;
    flush_all_ram_log();
    uint32_t v3 = *(int32_t *)(v1 + 24); // 0x8f657d6c
    int32_t v4 = v3; // 0x8f657d9c
    if (v3 < 0x1ffe00) {
        // if_8f657d80_0_true
        v4 = 0x1ffe00;
        // branch -> after_if_8f657d80_0
    }
    // after_if_8f657d80_0
    g10 = v4;
    g9 = 0;
    memcpy(g8, (char *)(g15 + 512), v4);
    int32_t v5; // R0
    int32_t v6; // 0x8f657dcc_24
    if (get_log_line_from_buffer() == 0) {
        // if_8f657db0_0_true
        v5 = (int32_t)&g16;
        v6 = (int32_t)&g16;
        // branch -> after_if_8f657db8_0
    } else {
        // if_8f657db8_0_true.critedge
        v5 = 0;
        v6 = 0;
        // branch -> after_if_8f657db8_0
    }
    // after_if_8f657db8_0
    int32_t result; // 0x8f657dcc_2
