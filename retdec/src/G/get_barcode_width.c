...
// Address range: 0x8f631a70 - 0x8f631b23
int32_t get_barcode_width(void) {
    int32_t v1 = &g4; // R4
    int32_t result = g19;
    if (g4 != -1) {
    ...
    int32_t v2 = 3; // R5
    int32_t v3 = get_device_setting_offset((int32_t)"barcode_setting", g22, result, (int32_t)&g19, g21, result, g25, g26); // 0x8f631a9c
    int32_t v4;
    if (v3 > -1) {
        // 0x8f631ac0
        *(int32_t *)v1 = v2;
        int32_t v5 = get_int_prop((int32_t)"line_width", v3, v1, (int32_t)&g19, g21, result, g25); // 0x8f631acc
        if (v5 != -1) {
            // 0x8f631ad8
            print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"line_width", g4, g21, result, g25, g26, g27, 0, v4, 0, 0);
            // branch -> 0x8f631af0
        }
    } else {
        // 0x8f631aa8
        print_log(1, (int32_t)"No barcode setting, use default width 3\n", result, (int32_t)&g19, g21, result, g25, g26, g27, 0, v4, 0, 0);
        *(int32_t *)v1 = v2;
        // branch -> 0x8f631af0
    }
    // 0x8f631af0
