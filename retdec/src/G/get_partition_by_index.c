...
// Address range: 0x8f65360c - 0x8f65367b
int32_t get_partition_by_index(uint32_t a1, int32_t a2) {
    int32_t v1 = g22; // 0x8f653614
    int32_t v2 = g13;
    int32_t v3;
    int32_t v4;
    if (g11 > a1) {
        ...
        // 0x8f653640
        int32_t v5;
        print_log(0, (int32_t)"invalid index %d\n", a1, (int32_t)&g13, a1, v2, v1, g15, v5, 0, 0, 0, 0);
        v4 = g13;
        v3 = 0;
        // branch -> 0x8f653650
    }
