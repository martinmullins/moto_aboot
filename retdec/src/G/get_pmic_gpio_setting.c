...
// Address range: 0x8f631d2c - 0x8f631f2b
int32_t get_pmic_gpio_setting(int32_t a1, int32_t * a2, int32_t a3) {
    int32_t v1 = (int32_t)a2;
    int32_t v2 = g34; // 0x8f631d2c
    int32_t v3 = g35; // 0x8f631d2c
    g35 = a1;
    g34 = v1;
    int32_t v4 = g25;
    if (get_int_prop((int32_t)"gpio", a1, v1, v4, a1, v4, a3) == -1) {
        // 0x8f631ee4
        if (v4 != g25) {
            // 0x8f631ef4
            __stack_chk_fail();
    ...
    int32_t v5 = g34; // 0x8f631d68
    int32_t v6 = *(int32_t *)v5; // 0x8f631d70
    int32_t v7;
    print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"gpio", v6, a1, v4, a3, v2, v3, g36, g37, 0, v7);
    if (get_int_prop((int32_t)"mode", g35, v5 + 4, v6, a1, v4, a3) == -1) {
        // 0x8f631ee4
        if (v4 != g25) {
            // 0x8f631ef4
            __stack_chk_fail();
    ...
    int32_t v8 = *(int32_t *)(g34 + 4); // 0x8f631da4
    print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"mode", v8, a1, v4, a3, v2, v3, g36, g37, 0, v7);
    if (get_int_prop((int32_t)"pull", g35, g34 + 8, v8, a1, v4, a3) == -1) {
        // 0x8f631ee4
        if (v4 != g25) {
            // 0x8f631ef4
            __stack_chk_fail();
    ...
    int32_t v9 = *(int32_t *)(g34 + 8); // 0x8f631dd0
    print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"pull", v9, a1, v4, a3, v2, v3, g36, g37, 0, v7);
    if (get_int_prop((int32_t)"vin-sel", g35, g34 + 12, v9, a1, v4, a3) == -1) {
        // 0x8f631ee4
        if (v4 != g25) {
            // 0x8f631ef4
            __stack_chk_fail();
    ...
    int32_t v10 = *(int32_t *)(g34 + 12); // 0x8f631dfc
    print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"vin-sel", v10, a1, v4, a3, v2, v3, g36, g37, 0, v7);
    if (get_int_prop((int32_t)"output-type", g35, g34 + 16, v10, a1, v4, a3) == -1) {
        // 0x8f631ee4
        if (v4 != g25) {
            // 0x8f631ef4
            __stack_chk_fail();
    ...
    int32_t v11 = *(int32_t *)(g34 + 16); // 0x8f631e28
    print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"output-type", v11, a1, v4, a3, v2, v3, g36, g37, 0, v7);
    if (get_int_prop((int32_t)"output-strength", g35, g34 + 20, v11, a1, v4, a3) == -1) {
        // 0x8f631ee4
        if (v4 != g25) {
            // 0x8f631ef4
            __stack_chk_fail();
    ...
    int32_t v12 = *(int32_t *)(g34 + 20); // 0x8f631e54
    print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"output-strength", v12, a1, v4, a3, v2, v3, g36, g37, 0, v7);
    if (get_int_prop((int32_t)"output", g35, g34 + 24, v12, a1, v4, a3) == -1) {
        // 0x8f631ee4
        if (v4 != g25) {
            // 0x8f631ef4
            __stack_chk_fail();
    ...
    int32_t v13 = *(int32_t *)(g34 + 24); // 0x8f631e80
    print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"output", v13, a1, v4, a3, v2, v3, g36, g37, 0, v7);
    if (get_int_prop((int32_t)"pre_delay", g35, g34 + 28, v13, a1, v4, a3) == -1) {
        // 0x8f631ee4
        if (v4 != g25) {
            // 0x8f631ef4
            __stack_chk_fail();
    ...
    int32_t v14 = *(int32_t *)(g34 + 28); // 0x8f631eac
    print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"pre_delay", v14, a1, v4, a3, v2, v3, g36, g37, 0, v7);
    int32_t result;
    if (get_int_prop((int32_t)"post_delay", g35, g34 + 32, v14, a1, v4, a3) != -1) {
        int32_t v15 = *(int32_t *)(g34 + 32); // 0x8f631ed8
        print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"post_delay", v15, a1, v4, a3, v2, v3, g36, g37, 0, v7);
        result = 0;
        // branch -> 0x8f631ee4
    } else {
        result = -1;
