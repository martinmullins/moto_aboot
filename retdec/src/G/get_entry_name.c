...
// Address range: 0x8f6537f0 - 0x8f65385b
int32_t get_entry_name(int32_t a1, int32_t a2) {
    int32_t v1 = g47; // 0x8f6537f0
    int32_t v2 = g48; // 0x8f6537f0
    int32_t v3 = g49; // 0x8f6537f0
    g48 = a1;
    g47 = &g31;
    int32_t v4 = g31;
    int32_t v5 = v4;
    ...
    int32_t v6 = get_entry_index(a1, a2, g45, v4, a1, v4, v1, v2); // 0x8f65380c
    g41 = v6;
    if (v6 == -1) {
        // if_8f653814_0_true
        v5 = g31;
        ...
        if (v4 == v7) {
            ...
            g48 = v2;
            g49 = v3;
            int32_t result3 = partition_get_name(v6, a2); // 0x8f653834
            g41 = result3;
            return result3;
        }
    }
