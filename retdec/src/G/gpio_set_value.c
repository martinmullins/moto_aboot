...
// Address range: 0x8f602fb8 - 0x8f60302b
int32_t gpio_set_value(uint32_t a1, int32_t a2, int32_t a3) {
    uint32_t v1 = a1 / 32; // 0x8f602fd0
    uint32_t v2 = a1 % 32; // 0x8f602fd4
    *(int32_t *)(4 * ((a2 == 0 ? 0x480008 : 0x480010) + v1)) = 1 << v2;
    uint32_t v3 = v2 % 256; // 0x8f603004
    int32_t result = v3 == 0 ? 1 : v3 < 32 ? 1 << v3 : 0; // 0x8f603004
    *(int32_t *)(4 * v1 + 0x12000c0) = result;
    // 0x8f603020
    return result;
}
