...
// Address range: 0x8f64942c - 0x8f649487
int32_t gfx_flush(int32_t * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1;
    g29 = v1;
    g30 = &g18;
    int32_t v2 = *a1; // 0x8f649438
    g22 = v2;
    g27 = function_8f6193b0(v2, *(int32_t *)(v1 + 32));
    int32_t v3 = g29; // 0x8f64944c
    int32_t v4 = *(int32_t *)(v3 + 52); // 0x8f64944c
    g28 = v4;
    if (v4 != 0) {
        // 0x8f649458
        g22 = 0;
        int32_t v5 = *(int32_t *)(v3 + 20) - 1; // 0x8f649460
        g23 = v5;
        g21 = -0x709b6b98;
        ((int32_t (*)(int32_t, int32_t))v4)(0, v5);
        // branch -> 0x8f649468
    }
    // 0x8f64947c
    return g22;
