...
// Address range: 0x8f653578 - 0x8f65360b
int32_t get_entry_index(void) {
    int32_t v1 = g13;
    if (g16 == 0) {
        // 0x8f6535f8
    ...
    int32_t str = g16 + 56; // 0x8f653598
    int32_t v2;
    int32_t result2; // 0x8f6535d020
    if (g11 != 0) {
        int32_t v3 = g12 + 184; // R5
        result2 = 0;
        if (memcmp((char *)str, (char *)(g12 + 56), 72) != 0) {
            int32_t result;
            while (true) {
                int32_t v4 = result2 + 1; // 0x8f6535d8
                if (v4 != g11) {
                    int32_t str2 = v3;
                    v3 = str2 + 128;
