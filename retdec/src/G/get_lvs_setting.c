...
// Address range: 0x8f632574 - 0x8f632653
int32_t get_lvs_setting(int32_t a1, int32_t * a2, int32_t a3) {
    int32_t v1 = (int32_t)a2;
    int32_t v2 = v1; // R4
    int32_t v3 = g32;
    if (get_int_prop((int32_t)"lvs", a1, v1, v3, a1, v3, a3) == -1) {
        // 0x8f632624
        if (v3 != g32) {
            // 0x8f632634
            __stack_chk_fail();
    ...
    int32_t v4 = *(int32_t *)v2; // 0x8f6325b8
    int32_t v5;
    print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"lvs", v4, a1, v3, a3, g41, g42, g43, g44, g34, v5);
    if (get_int_prop((int32_t)"pre_delay", a1, v2 + 4, v4, a1, v3, a3) == -1) {
        // 0x8f632624
        if (v3 != g32) {
            // 0x8f632634
            __stack_chk_fail();
    ...
    int32_t v6 = *(int32_t *)(v2 + 4); // 0x8f6325ec
    print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"pre_delay", v6, a1, v3, a3, g41, g42, g43, g44, g34, v5);
    int32_t result;
    if (get_int_prop((int32_t)"post_delay", a1, v2 + 8, v6, a1, v3, a3) != -1) {
        int32_t v7 = *(int32_t *)(v2 + 8); // 0x8f632618
        print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"post_delay", v7, a1, v3, a3, g41, g42, g43, g44, g34, v5);
        result = 0;
        // branch -> 0x8f632624
    } else {
        result = -1;
