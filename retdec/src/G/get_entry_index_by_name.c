...
// Address range: 0x8f676a08 - 0x8f676a77
int32_t get_entry_index_by_name(char * str, int32_t a2, int32_t a3) {
    int32_t v1 = g27; // 0x8f676a0c
    int32_t v2 = g17;
    g27 = &g16;
    g20 = &g16;
    int32_t strncmp_rc = strncmp((char *)&g16, str, 16); // 0x8f676a3410
    g20 = strncmp_rc;
    int32_t v3 = 0; // 0x8f676a3c12
    int32_t result; // 0x8f676a6c_2
    if (strncmp_rc == 0) {
        // 0x8f676a54
        g20 = v3;
        if (v2 != g17) {
    ...
    while (true) {
        int32_t v4 = v3 + 1; // 0x8f676a44
        if (v4 != 16) {
            int32_t str2 = 32 * v4 + g27; // 0x8f676a28
            g20 = str2;
            int32_t strncmp_rc2 = strncmp((char *)str2, (char *)(int32_t)str, 16); // 0x8f676a34
            g20 = strncmp_rc2;
            if (strncmp_rc2 == 0) {
                v3 = v4;
                // break -> 0x8f676a54
