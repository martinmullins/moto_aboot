...
// Address range: 0x8f6326f8 - 0x8f63279b
int32_t get_srk_name(char * a1, int32_t a2) {
    int32_t v1 = (int32_t)a1; // 0x8f6326f8_0
    int32_t v2 = g33; // 0x8f6326fc
    int32_t v3 = g34; // 0x8f6326fc
    int32_t v4 = g35; // 0x8f6326fc
    g34 = v1;
    int32_t v5 = g22;
    g35 = &g22;
    int32_t v6 = g7;
    ...
    if (v6 <= -1) {
        // 0x8f632720
        print_log(-1, (int32_t)"No product setting\n", (int32_t)&g7, (int32_t)&g22, v1, v5, v2, v3, v4, g28, v7, 0, 0);
        // branch -> 0x8f632754
        // 0x8f632754
        if (v5 != g22) {
            goto lab_0x8f632764;
    ...
    int32_t v8 = get_string_prop(v1, v6, (int32_t)&g7, (int32_t)&g22, v1, v5, v2, v3); // 0x8f632734
    g33 = v8;
    int32_t v9; // 0x8f632774
    if (v8 == 0) {
        // 0x8f632740
        print_log(2, (int32_t)"Not found setting for %s\n", g34, (int32_t)&g22, v1, v5, v2, v3, v4, g28, v7, 0, 0);
        // branch -> 0x8f632750
      lab_0x8f632750:
        // 0x8f632750
        // branch -> 0x8f632754
    ...
    // 0x8f632768
    print_log(1, (int32_t)"%s defined: %s\n", g34, v9, v1, v5, v2, v3, v4, g28, v7, 0, 0);
    // branch -> 0x8f632750
    goto lab_0x8f632750;
}
