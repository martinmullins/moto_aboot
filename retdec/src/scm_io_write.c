...
// Address range: 0x8f617658 - 0x8f617767
char * scm_io_write(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1;
    int32_t v2 = &v1; // 0x8f61767c_0
    memset((char *)&v1, 0, 64);
    int32_t v3; // bp-88
    int32_t v4 = &v3; // 0x8f617694_0
    v3 = 0;
    uint32_t v5;
    int32_t v6;
    if (v5 % 256 == 1) {
        // 0x8f6176f8
        v1 = 0x2000502;
        v6 = scm_call2(v2, v4, v2, v4, g27, 0);
        // branch -> 0x8f61773c
    } else {
        // 0x8f6176d8
        v6 = scm_call_atomic2(5, 2, a1, a2, g27);
        // branch -> 0x8f61773c
    }
    // 0x8f61773c
