...
// Address range: 0x8f624304 - 0x8f6243b3
int32_t oem_pmic_usage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g29; // 0x8f624304
    g29 = &g14;
    int32_t v2 = g14;
    fboot_info("INFO", "usage: fastboot oem pmic [options]", a3, v2);
    fboot_info("INFO", (char *)&g9, a3, v2);
    fboot_info("INFO", "options:", a3, v2);
    fboot_info("INFO", "  info                 show chip info", a3, v2);
    fboot_info("INFO", "  rd <reg>             read from a register", a3, v2);
    fboot_info("INFO", "  wr <reg> <value>     write to a register", a3, v2);
    int32_t result = fboot_info("INFO", "  help                 show usage", a3, v2); // 0x8f624364
    if (v2 != g14) {
        // 0x8f624378
        __stack_chk_fail();
        return result;
