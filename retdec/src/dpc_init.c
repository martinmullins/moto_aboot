...
// Address range: 0x8f61aa20 - 0x8f61aa8b
int32_t dpc_init(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t result = g38;
    event_init((int32_t)&g19, 0, 0, result);
    int32_t v1;
    int32_t v2 = thread_create((int32_t)"dpc", (int32_t)&g2, 0, 30, 0x2000, a2, a3, result, g42, 0, v1, 0, 0, 0, 0, 0); // 0x8f61aa58
    if (result == g38) {
        // 0x8f61aa70
        thread_resume(v2, (int32_t)&g2, result, result, g42, 0, v1, 0);
        return result;
    }
    // 0x8f61aa6c
    __stack_chk_fail();
