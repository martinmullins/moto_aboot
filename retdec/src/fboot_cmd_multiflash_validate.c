...
// Address range: 0x8f630638 - 0x8f63072b
int32_t fboot_cmd_multiflash_validate(int32_t a1, int32_t a2) {
    int32_t v1 = g37;
    int32_t str = *(int32_t *)(a1 + 12) + 3; // 0x8f630648
    int32_t v2 = partition_get_index(str, a2, g48, v1, a1, v1); // 0x8f630654
    int32_t v3;
    int32_t result;
    if (strcmp((char *)str, "system") == 0) {
        // 0x8f630684
        is_write_protect_supported(str, 1, g48, v1, a1, v1, g49, g50, g51, g43, v3, 0, 0, 0, 0, 0, 0, 0);
        // branch -> 0x8f630690
        // 0x8f630690
        ...
        if (strcmp((char *)str, "motoboot") != 0) {
            // 0x8f6306b8
            if (strcmp((char *)str, "cid_prov") != 0 && v2 == -1) {
                // 0x8f6306d4
                fboot_info((int32_t)"INFO", (int32_t)"Unkown partition name %s", str, v1, a1, v1, g49, g50, g51, g43, v3);
                result = 3;
                // branch -> 0x8f6306f0
            } else {
                result = 1;
    ...
    // 0x8f630670
    int32_t strcmp_rc; // 0x8f630698
    if (strcmp((char *)str, "oem") != 0) {
        // 0x8f630690
        strcmp_rc = strcmp((char *)str, "partition");
        result = 1;
        if (strcmp_rc != 0) {
            // 0x8f6306a4
            if (strcmp((char *)str, "motoboot") != 0) {
