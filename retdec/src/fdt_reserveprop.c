...
// Address range: 0x8f64cd54 - 0x8f64cddf
int32_t fdt_reserveprop(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    // 0x8f64cd54
    int32_t v1;
    int32_t v2 = v1; // bp-40
    int32_t v3 = g23;
    int32_t v4;
    int32_t v5 = _fdt_rw_check_header(a1, a2, a3, v3, v4, 0, v1); // 0x8f64cd78
    int32_t result = v5; // R0
    int32_t v6 = v5; // 0x8f64cdd8_23
    if (v5 == 0) {
        int32_t v7 = g27 ? -0x709a999c : 0; // 0x8f64cd54
        int32_t v8;
        int32_t v9 = _fdt_add_property(a1, a2, a3, a4, (int32_t)&v2, 0, v1, v3, 0, g33, g34, g35, g36, g37, g38, v7, v8, 0, 0); // 0x8f64cd9c
        int32_t v10 = v9; // 0x8f64cdbc
        if (v9 == 0) {
            // 0x8f64cda8
            memset((char *)(v2 + 12), 0, a4);
            v10 = v9;
            // branch -> 0x8f64cdbc
        }
        // 0x8f64cdbc
