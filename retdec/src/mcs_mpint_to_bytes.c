...
// Address range: 0x8f66a8d8 - 0x8f66a973
int32_t mcs_mpint_to_bytes(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g45; // 0x8f66a8d8
    int32_t v2 = g47; // 0x8f66a8d8
    int32_t v3 = a3 & -0x7ffffffd; // 0x8f66a8e4
    int32_t v4 = (int32_t)(v3 < 0) + v3;
    int32_t v5 = a3 / 64; // 0x8f66a8f0
    int32_t v6 = v4; // 0x8f66a904
    if (v3 < 0) {
        // if_8f66a8f4_0_true
        v6 = (v4 | -4) + 1;
        // branch -> after_if_8f66a8fc_0
    }
    int32_t result2 = 4 * v5 + a2; // 0x8f66a90c
    int32_t v7 = -((-v6 % 4)); // 0x8f66a910
    g47 = &g32;
    int32_t v8 = 0; // R12
    if (a3 > 63) {
        int32_t v9 = result2; // 0x8f66a928
        while (true) {
            int32_t v10 = v9 - 4; // 0x8f66a928
            int32_t result = v10; // R1
            int32_t v11 = *(int32_t *)v10; // 0x8f66a928
            g45 = v11;
            int32_t v12 = v7 + a1; // R7
            int32_t v13 = 3; // R3
            int32_t v14 = 3; // 0x8f66a938
            // branch -> 0x8f66a934
            while (true) {
                int32_t v15 = v11; // 0x8f66a940
                int32_t v16 = v14; // 0x8f66a93c
                if (v7 + v14 >= 0) {
                    // if_8f66a938_0_true
                    *(char *)(v12 + v14) = (char)v11;
                    v15 = g45;
                    v16 = v13;
                    // branch -> after_if_8f66a938_0
                }
                int32_t v17 = v16 - 1; // 0x8f66a93c
                v13 = v17;
                int32_t v18 = v15 / 256; // 0x8f66a940
                g45 = v18;
                if (v16 == 0) {
                    int32_t v19 = v8 + 1; // 0x8f66a948
                    v8 = v19;
                    if (v19 >= v5) {
                        // 0x8f66a920
                        // branch -> 0x8f66a954
                    ...
                    // after_if_8f66a938_0.dec_label_pc_8f66a934_crit_edge
                    v11 = v18;
                    v14 = v17;
                    // branch -> 0x8f66a934
                    continue;
