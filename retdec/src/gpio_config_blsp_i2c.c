...
// Address range: 0x8f6030e0 - 0x8f60321f
int32_t gpio_config_blsp_i2c(int32_t a1, int32_t a2) {
    int32_t v1 = g80; // 0x8f6030e0
    int32_t v2 = g75 ? -0x709aede4 : 0; // 0x8f6030e0
    g80 = &g73;
    int32_t result = g73;
    int32_t v3;
    int32_t v4;
    if (a1 != 1) {
        // 0x8f6031ac
        print_log(-1, (int32_t)"Incorrect BLSP id %d\n", a1, a2, v4, 0, 0, result, 0, g79, v1, v2, v3);
        // branch -> 0x8f6031d0
        // 0x8f6031d0
        _panic(v2, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/gpio.c", 162, (int32_t)&g15, 0, 0);
        // branch -> 0x8f6031d4
        // 0x8f6031d4
        if (result != g73) {
            // 0x8f6031e4
    ...
    int32_t v5; // R2
    int32_t v6; // R3
    int32_t * v7; // 0x8f603170
    int32_t v8; // 0x8f603170
    switch (a2) {
        default: {
            // 0x8f603180
            print_log(-1, (int32_t)"Configure gpios for QUP instance: %u\n", a2, a2, v4, 0, 0, result, 0, g79, v1, v2, v3);
            // branch -> 0x8f6031d0
            // 0x8f6031d0
            _panic(v2, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/gpio.c", 158, (int32_t)&g15, 0, 0);
            // branch -> 0x8f6031d4
            // 0x8f6031d4
            if (result != g73) {
                // 0x8f6031e4
