...
// Address range: 0x8f67305c - 0x8f6730ef
int32_t get_policy_executor(char * a1) {
    int32_t str = (int32_t)a1;
    int32_t v1 = g59; // 0x8f67305c
    int32_t v2 = g61; // 0x8f67305c
    int32_t v3 = g62; // 0x8f67305c
    int32_t v4 = g49;
    int32_t v5;
    int32_t v6 = is_bootloader_partition(str, g56, v1, v4, str, v4, v1, v2, v3, g54, v5); // 0x8f673070
    int32_t result = &g2;
    if (v6 == 0) {
        // 0x8f673080
        if (strcmp((char *)str, "primary_gpt") != 0) {
            // 0x8f673094
            if (strcmp((char *)str, "backup_gpt") != 0) {
                // 0x8f6730bc
                g59 = v4;
                if (v4 != g49) {
                    // 0x8f6730cc
        ...
        // 0x8f6730a8
        print_log(1, (int32_t)"GPT image %s detected\n", str, v4, str, v4, v1, v2, v3, g54, v5, 0, 0);
        result = &g1;
        // branch -> 0x8f6730bc
    }
    // 0x8f6730bc
