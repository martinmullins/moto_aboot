...
// Address range: 0x8f6763ac - 0x8f676447
int32_t remove_sparse_data(int32_t a1, int32_t a2) {
    // 0x8f6763ac
    if (a1 == 0) {
        // 0x8f676428
    ...
    int32_t result = a2 - 8; // 0x8f6763c8
    if (a2 == 8) {
        // 0x8f676428
        // branch -> 0x8f67643c
        // 0x8f67643c
    ...
    int32_t * v1 = (int32_t *)(a1 - 4); // 0x8f6763d4_0
    int32_t * v2 = (int32_t *)(a2 - 4); // 0x8f6763e0_0
    if (*v1 == result) {
        int32_t v3 = *v2; // 0x8f6763e0
        *v1 = v3 == a1 - 20 ? 0 : v3;
        // branch -> 0x8f6763f0
    }
    int32_t * v4 = (int32_t *)result; // 0x8f6763f0_1
    int32_t v5 = *v2; // 0x8f6763f0
    *(int32_t *)v5 = *v4;
    *(int32_t *)(*v4 + 4) = v5;
    *v2 = 0;
    *v4 = 0;
    // 0x8f67641c
    return free_sparse_data((char *)result, a2);
    // 0x8f676438
    __stack_chk_fail();
    // branch -> 0x8f67643c
    // 0x8f67643c
