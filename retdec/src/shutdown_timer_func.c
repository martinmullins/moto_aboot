...
// Address range: 0x8f634630 - 0x8f634677
int32_t shutdown_timer_func(int32_t a1, int32_t a2) {
    int32_t v1 = g29; // 0x8f634630
    int32_t v2 = g19;
    int32_t v3;
    int32_t v4 = print_log(-1, (int32_t)"Auto shutdown without USB connected for 5 minutes!", g27, v2, a1, v2, v1, g24, v3, 0, 0, 0, 0); // 0x8f634648
    trigger_to_power_off(v4, (int32_t)"Auto shutdown without USB connected for 5 minutes!", g27);
    if (v2 != g19) {
        // 0x8f634664
        __stack_chk_fail();
        // branch -> 0x8f634668
