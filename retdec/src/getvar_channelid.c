...
// Address range: 0x8f62cb90 - 0x8f62cc07
int32_t getvar_channelid(char * a1, int32_t a2, int32_t a3) {
    int32_t str = (int32_t)a1;
    int32_t v1 = check_cid_provisioned(str); // 0x8f62cba4
    if (v1 == 0) {
        // 0x8f62cbcc
        snprintf((char *)str, 64, "0xDEAD");
        // branch -> 0x8f62cbdc
    } else {
        // 0x8f62cbb0
        snprintf((char *)str, 64, "0x%02x", get_db_channelid_feature_flag_byte(v1));
        // branch -> 0x8f62cbdc
    }
    // 0x8f62cbf4
    return 1;
