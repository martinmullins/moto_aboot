...
// Address range: 0x8f671f8c - 0x8f671fd7
int32_t mot_sst_is_warranty_void(int32_t a1) {
    int32_t v1 = -1; // bp-13
    int32_t v2 = mot_sst_pal_get_sbd_en_otp_bit((int32_t)&v1, g18, g20, -1); // 0x8f671fa8
    int32_t result = 255;
    if (v2 == 0) {
        // if_8f671fb8_0_true
        result = 0x1000000 * v1 / 0x1000000;
        // branch -> after_if_8f671fbc_0
    }
    // 0x8f671fcc
    return result;
}
