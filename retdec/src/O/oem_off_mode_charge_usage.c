...
// Address range: 0x8f62b180 - 0x8f62b21f
int32_t oem_off_mode_charge_usage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g20; // 0x8f62b180
    int32_t v2 = g15 ? -0x709d4b24 : 0; // 0x8f62b180
    g20 = &g14;
    int32_t v3 = g14;
    int32_t v4;
    fboot_info((int32_t)"INFO", (int32_t)"usage: fastboot oem off_mode_charge [options]", a3, v3, a1, v3, v1, v2, v4, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)&g9, a3, v3, a1, v3, v1, v2, v4, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"                            Show current status", a3, v3, a1, v3, v1, v2, v4, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  help                      Show usage", a3, v3, a1, v3, v1, v2, v4, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  false,off,no,disable,0    Don't use charger mode", a3, v3, a1, v3, v1, v2, v4, 0, 0);
    g17 = (int32_t)"  true,on,yes,enable,1      Default (charger)";
    int32_t result = fboot_info((int32_t)"INFO", (int32_t)"  true,on,yes,enable,1      Default (charger)", a3, v3, a1, v3, v1, v2, v4, 0, 0); // 0x8f62b1d4
    g16 = result;
    g18 = v3;
    int32_t v5 = g14;
    g19 = v5;
    ...
    g17 = &g9;
    g20 = v1;
    int32_t result2 = fboot_info((int32_t)"INFO", (int32_t)&g9, v3, v3, v1, v2, v4, 0, 0, 0, 0); // 0x8f62b1fc
    g16 = result2;
    return result2;
}
