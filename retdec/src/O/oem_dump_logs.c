...
// Address range: 0x8f6253a4 - 0x8f62544b
int32_t oem_dump_logs(int32_t a1, int32_t a2, int32_t a3) {
    // 0x8f6253a4
    g25 = a3;
    int32_t v1 = g27; // 0x8f6253a4
    int32_t v2 = g28; // 0x8f6253a4
    int32_t v3 = g22; // 0x8f6253a4
    g28 = (int32_t)&g15;
    int32_t (*v4)() = g15;
    int32_t v5 = (int32_t)v4;
    int32_t v6 = get_logger_iterator(1, a2); // 0x8f6253b8
    g27 = v6;
    if (v6 != 0) {
        // 0x8f6253c4
        int32_t v7;
        fboot_info((int32_t)"INFO", (int32_t)"Dumping Boot Logs:", a3, v5, a1, v5, a3, v1, v2, v3, v7);
        g24 = (int32_t)"==============================";
        g23 = fboot_info((int32_t)"INFO", (int32_t)"==============================", a3, v5, a1, v5, a3, v1, v2, v3, v7);
        int32_t v8 = *(int32_t *)(g27 + 8);
        g26 = v8;
        g22 = -0x709dac1c;
        ((int32_t (*)())v8)();
        int32_t v9 = g23; // 0x8f6253e44
        if (v9 != 0) {
            int32_t v10 = *(int32_t *)(v9 + 4); // 0x8f6253f4
            g24 = v10;
            g23 = fboot_info((int32_t)"INFO", v10, a3, v9, a1, v5, a3, v1, v2, v3, v7);
            int32_t v11 = *(int32_t *)(g27 + 12);
            g26 = v11;
            g22 = -0x709dac1c;
            ((int32_t (*)())v11)();
            while (g23 != 0) {
            ...
            // 0x8f625404
            fboot_info((int32_t)"INFO", (int32_t)"==============================", a3, 0, a1, v5, a3, v1, v2, v3, v7);
            fboot_info((int32_t)"INFO", (int32_t)"All Boot Logs have been dumped", a3, 0, a1, v5, a3, v1, v2, v3, v7);
            // branch -> 0x8f625418
            // 0x8f625418
            if (v4 != g15) {
                // 0x8f62542c
