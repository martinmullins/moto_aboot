...
// Address range: 0x8f6241b4 - 0x8f624253
int32_t oem_test_sp_usage(int32_t a1) {
    int32_t v1 = g29; // 0x8f6241b4
    g29 = &g14;
    int32_t v2 = g14;
    fboot_info("INFO", "usage: fastboot oem sp_test [options]", g27, v2);
    fboot_info("INFO", (char *)&g9, g27, v2);
    fboot_info("INFO", "options:", g27, v2);
    fboot_info("INFO", "  add <name> <size>   add a new SP block", g27, v2);
    fboot_info("INFO", "  remove <name>   remove a SP block", g27, v2);
    int32_t result = fboot_info("INFO", "  help        show usage", g27, v2); // 0x8f624208
    g24 = result;
    g27 = v2;
    int32_t v3 = g14;
    g28 = v3;
    ...
    // 0x8f624220
    g29 = v1;
    int32_t result2 = fboot_info("INFO", (char *)&g9, v2, v2); // 0x8f624230
    g24 = result2;
    return result2;
}
