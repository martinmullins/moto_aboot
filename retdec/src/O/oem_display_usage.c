...
// Address range: 0x8f6246c4 - 0x8f624773
int32_t oem_display_usage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g29; // 0x8f6246c4
    g29 = &g14;
    int32_t v2 = g14;
    fboot_info("INFO", "usage: fastboot oem display [options]", a3, v2);
    fboot_info("INFO", (char *)&g9, a3, v2);
    fboot_info("INFO", "options:", a3, v2);
    fboot_info("INFO", "  on            turn on display", a3, v2);
    fboot_info("INFO", "  off           turn off display", a3, v2);
    fboot_info("INFO", "  info          show display info", a3, v2);
    int32_t result = fboot_info("INFO", "  help          show usage", a3, v2); // 0x8f624724
    if (v2 != g14) {
        // 0x8f624738
        __stack_chk_fail();
        return result;
