...
// Address range: 0x8f624868 - 0x8f624937
int32_t oem_partition_usage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t (*v1)() = g15;
    int32_t v2 = (int32_t)v1;
    int32_t v3;
    fboot_info((int32_t)"INFO", (int32_t)"usage: fastboot oem partition [options]", a3, v2, a1, v2, g27, g22, v3, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)&g10, a3, v2, a1, v2, g27, g22, v3, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"options:", a3, v2, a1, v2, g27, g22, v3, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  (none given)                     list all partitions", a3, v2, a1, v2, g27, g22, v3, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  <name>                           list a partition", a3, v2, a1, v2, g27, g22, v3, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  dump <name> [<offset> [size]]    dump a partition", a3, v2, a1, v2, g27, g22, v3, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  md5 <name> [<offset> [size]]     md5 of a partition", a3, v2, a1, v2, g27, g22, v3, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  sha256 <name> [<offset> [size]]  sha256 of a partition", a3, v2, a1, v2, g27, g22, v3, 0, 0);
    int32_t result2 = fboot_info((int32_t)"INFO", (int32_t)"  help                             show usage", a3, v2, a1, v2, g27, g22, v3, 0, 0); // 0x8f6248e0
    int32_t (*v4)() = g15;
    if (v1 == v4) {
        int32_t result = fboot_info((int32_t)"INFO", (int32_t)&g10, v2, (int32_t)v4, g27, g22, v3, 0, 0, 0, 0); // 0x8f624908
        return result;
    }
    // 0x8f6248f4
    __stack_chk_fail();
