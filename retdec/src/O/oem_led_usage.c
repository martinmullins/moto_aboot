...
// Address range: 0x8f624254 - 0x8f624303
int32_t oem_led_usage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g29; // 0x8f624254
    g29 = &g14;
    int32_t v2 = g14;
    fboot_info("INFO", "usage: fastboot oem led [options]", a3, v2);
    fboot_info("INFO", (char *)&g9, a3, v2);
    fboot_info("INFO", "options:", a3, v2);
    fboot_info("INFO", "  on      turn LED off", a3, v2);
    fboot_info("INFO", "  off     turn LED on", a3, v2);
    fboot_info("INFO", "  blink   blink the led every half a second", a3, v2);
    int32_t result = fboot_info("INFO", "  help    show usage", a3, v2); // 0x8f6242b4
    if (v2 != g14) {
        // 0x8f6242c8
        __stack_chk_fail();
        return result;
