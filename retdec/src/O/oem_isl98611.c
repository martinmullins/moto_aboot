...
// Address range: 0x8f641084 - 0x8f6411b3
int32_t oem_isl98611(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g14; // 0x8f641088
    int32_t v2 = g17 ? (int32_t)&g12 : 0; // 0x8f641088
    int32_t v3 = a1 - 1; // 0x8f64108c
    int32_t v4 = g12;
    g14 = a2;
    int32_t v5 = 0; // bp-29
    if (v3 <= 0) {
        // 0x8f6410c8
        oem_isl98611_usage(a1, a2, 0);
        // branch -> 0x8f64117c
        // 0x8f64117c
        // branch -> 0x8f641180
        // 0x8f641180
    ...
    int32_t str = *(int32_t *)(a2 + 4); // 0x8f6410b0
    int32_t result;
    if (strcmp((char *)str, "help") == 0) {
        // 0x8f6410b0
        // branch -> 0x8f6410c8
        // 0x8f6410c8
        oem_isl98611_usage(0, (int32_t)"help", 0);
        // branch -> 0x8f64117c
        // 0x8f64117c
        result = 1;
        // branch -> 0x8f641180
        ...
        int32_t v7; // 0x8f6410ec
        if (strcmp((char *)str, "rd") == 0) {
            // 0x8f6410e4
            if (v3 != 1) {
                int32_t v8 = atol((char *)*(int32_t *)(g14 + 8)) % 256; // 0x8f641100
                int32_t v9 = isl98611_read_reg(v8, (int32_t)&v5, 0, (int32_t)&g12); // 0x8f641108
                result = 3;
                if (v9 == 0) {
                    // 0x8f64111c
                    fboot_info((int32_t)"INFO", (int32_t)"0x%02X = 0x%02X", v8, 0x1000000 * v5 / 0x1000000, a1, v4, a3, v1, g15, g16, v2);
                    // branch -> 0x8f64117c
                    // 0x8f64117c
                    result = 1;
                    // branch -> 0x8f641180
            ...
            // 0x8f641134
            v6 = (int32_t)"wr";
            int32_t strcmp_rc = strcmp((char *)str, "wr"); // 0x8f64113c
            if (strcmp_rc == 0 && v3 >= 3) {
                uint32_t str_as_l = atol((char *)*(int32_t *)(g14 + 8)); // 0x8f641154
                uint32_t str_as_l2 = atol((char *)*(int32_t *)(g14 + 12)); // 0x8f641160
                v5 = 0x1000000 * str_as_l2 / 0x1000000;
                int32_t v10 = isl98611_write_reg(str_as_l % 256, str_as_l2 % 256, 0, (int32_t)&g12); // 0x8f641170
                result = 3;
                if (v10 == 0) {
                    // 0x8f64117c
                    result = 1;
