...
// Address range: 0x8f6272a0 - 0x8f627387
int32_t oem_regex(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = a1 - 1; // 0x8f6272a8
    int32_t v2 = g8;
    if (v1 < 1) {
        // 0x8f6272dc
        oem_regex_usage(a1, a2, v2, (int32_t)&g8);
        // branch -> 0x8f62733c
        // 0x8f62733c
        // branch -> 0x8f627350
        // 0x8f627350
    ...
    int32_t str = *(int32_t *)(a2 + 4); // 0x8f6272c4
    if (strcmp((char *)str, "help") == 0) {
        // 0x8f6272c4
        // branch -> 0x8f6272dc
        // 0x8f6272dc
        oem_regex_usage(0, (int32_t)"help", v2, (int32_t)&g8);
        // branch -> 0x8f62733c
        // 0x8f62733c
        // branch -> 0x8f627350
        // 0x8f627350
    ...
    int32_t strcmp_rc = strcmp((char *)str, "match"); // 0x8f6272ec
    if (strcmp_rc == 0 && v1 > 2) {
        int32_t v3 = *(int32_t *)(a2 + 8); // 0x8f627310
        int32_t v4 = *(int32_t *)(a2 + 12); // 0x8f627314
        fboot_info((int32_t)"INFO", (int32_t)"matching \"%s\" against \"%s\"", v3, v4, a1, v2, a3, g12, g13, g14, g15);
        int32_t v5 = *(int32_t *)(a2 + 8); // 0x8f62731c
        int32_t v6 = *(int32_t *)(a2 + 12); // 0x8f627320
        int32_t result;
        if (regex_match(v5, v6, v3, v4, a1, v2, a3, g12, g13, g14, g15) == 0) {
            // 0x8f627344
            fboot_info((int32_t)"INFO", (int32_t)"No. It does not match!", v3, v4, a1, v2, a3, g12, g13, g14, g15);
            result = 3;
            // branch -> 0x8f627350
        } else {
            // 0x8f627334
            fboot_info((int32_t)"INFO", (int32_t)"Yes. It matches!", v3, v4, a1, v2, a3, g12, g13, g14, g15);
            // branch -> 0x8f62733c
            // 0x8f62733c
            result = 1;
            // branch -> 0x8f627350
    ...
    // 0x8f627300
    oem_regex_usage(strcmp_rc, (int32_t)"match", v2, (int32_t)&g8);
    // branch -> 0x8f627350
    // 0x8f627350
    if (v2 != g8) {
        // 0x8f627360
