...
// Address range: 0x8f628288 - 0x8f6282eb
int32_t oem_boot_mode_set(int32_t a1) {
    int32_t v1 = g12; // 0x8f628288
    g10 = a1;
    g12 = &g8;
    int32_t v2 = g8;
    if (__utag_puts(0, "bootmode") == NULL) {
        // if_8f6282ac_0_true
        // branch -> 0x8f6282c8
        // 0x8f6282c8
        if (v2 != g8) {
    ...
    // 0x8f6282b4
    int32_t v3; // R0
    int32_t v4; // 0x8f6282e0_23
    if (__utags_flush(0, (int32_t)"bootmode", a1, v2, a1, v2, v1, 0) == 0) {
        // if_8f6282c4_0_true
        v3 = 1;
        v4 = 1;
        // branch -> 0x8f6282c8
