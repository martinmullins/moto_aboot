...
// Address range: 0x8f63be54 - 0x8f63beef
int32_t onkey_31(uint32_t result, int32_t a2) {
    int32_t v1 = g47;
    if (result < 277 || a2 == 0) {
        // 0x8f63bedc
    ...
    int32_t v2 = v1 & -0x10000; // 0x8f63be78
    uint32_t v3 = v2 | 278; // 0x8f63be78
    if (v3 >= result) {
        // 0x8f63be94
        int32_t v4;
        int32_t result2 = show((int32_t)"fastboot_screen", 0, v3, (int32_t)&g3, result, v1, g51, 0, v4, 0, 0, 0, 0, 0, 0); // 0x8f63bea4
        return result2;
    }
    // 0x8f63be84
    if ((v2 || 510) == result) {
        // 0x8f63bebc
        return trigger_to_power_off(result, a2, v1);
    }
    // 0x8f63bedc
    return result;
}
