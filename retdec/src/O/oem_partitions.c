...
// Address range: 0x8f625ab0 - 0x8f625b17
int32_t oem_partitions(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g4;
    int32_t v2 = v1; // 0x8f625ad0
    int32_t v3 = 0; // 0x8f625ac8
    // branch -> 0x8f625ac8
    while (true) {
        int32_t v4 = partition_get_name(v3, a2, v2, (int32_t)&g4, a1, v1, a3, g10, g11, 0); // 0x8f625ad0
        if (v4 == 0) {
            // 0x8f625aec
            if (v1 != (int32_t)g4) {
                // 0x8f625b00
        ...
        // 0x8f625adc
        int32_t v5;
        fboot_info((int32_t)"INFO", (int32_t)"%s", v4, (int32_t)&g4, a1, v1, a3, g10, g11, 0, v5);
        v2 = v4;
        a2 = (int32_t)"%s";
        v3++;
        // branch -> 0x8f625ac8
