...
// Address range: 0x8f64032c - 0x8f6403cb
int32_t oem_bd65060_usage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g11;
    int32_t v2;
    fboot_info((int32_t)"INFO", (int32_t)"usage: fastboot oem bd65060 [options]", a3, v1, a1, v1, g13, 0, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)&g1, a3, v1, a1, v1, g13, 0, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"options:", a3, v1, a1, v1, g13, 0, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  rd <reg>          read a register", a3, v1, a1, v1, g13, 0, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  wr <reg> <value>  write a register", a3, v1, a1, v1, g13, 0, v2, 0, 0);
    int32_t result2 = fboot_info((int32_t)"INFO", (int32_t)"  help              show usage", a3, v1, a1, v1, g13, 0, v2, 0, 0); // 0x8f640380
    if (v1 == g11) {
        int32_t result = fboot_info((int32_t)"INFO", (int32_t)&g1, v1, v1, g13, 0, v2, 0, 0, 0, 0); // 0x8f6403a8
        return result;
    }
    // 0x8f640394
    __stack_chk_fail();
