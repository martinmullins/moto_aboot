...
// Address range: 0x8f64507c - 0x8f6451b3
int32_t panel_init_96(int32_t * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1;
    panel_common_init(v1);
    *(int32_t *)(v1 + 72) = 52;
    *(int32_t *)(v1 + 88) = 8;
    *(int32_t *)v1 = g8;
    char v2 = *(char *)&g14; // 0x8f6450bc
    int32_t result = v2; // 0x8f6450bc
    *(int32_t *)(v1 + 4) = g9;
    int32_t v3 = 0; // R3
    *(int32_t *)(v1 + 8) = g10;
    *(int32_t *)(v1 + 68) = 84;
