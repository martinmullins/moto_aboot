...
// Address range: 0x8f601e1c - 0x8f601e6f
int32_t qtmr_irq(int32_t a1, int32_t a2) {
    // 0x8f601e1c
    g34 = a1;
    int32_t result = g31;
    g38 = result;
    int32_t v1 = platform_is_msm8939(a1, a2, g37, result); // 0x8f601e2c
    g34 = v1;
    int32_t v2;
    if (v1 != 0) {
        // if_8f601e34_0_true
    ...
    int32_t v3 = platform_is_msm8929(0, a2, g37, result); // 0x8f601e3c
    g34 = v3;
    int32_t v4 = result & -0x10000 | 289; // 0x8f601e40
    g38 = v4;
    if (v3 == 0) {
        // if_8f601e4c_0_true
        g34 = 40;
