...
// Address range: 0x8f65af38 - 0x8f65afeb
int32_t get_piv_image_size(int32_t a1, int32_t a2, int32_t a3) {
    // 0x8f65af38
    g38 = &g31;
    int32_t v1 = g31;
    char v2 = *(char *)&g23; // 0x8f65af50
    int32_t v3 = v2; // 0x8f65af50
    g34 = v3;
    int32_t result; // 0x8f65afd4_2
    int32_t v4;
    int32_t v5;
    if (v2 == 0) {
        // 0x8f65af84
        int32_t v6;
        print_log(v3, (int32_t)"PIV image is not initialized\n", (int32_t)&g23, (int32_t)&g31, a1, v1, a3, g39, g40, g33, v6, 0, 0);
        v5 = g31;
        v4 = 0;
        // branch -> 0x8f65afbc
        // 0x8f65afbc
    ...
    // 0x8f65af5c
    g38 = g24;
    int32_t v7 = 48 * *(int32_t *)(g24 + 60); // 0x8f65af78
    g38 = 0;
    if (v7 != 0) {
        int32_t v8 = 0; // 0x8f65afa8
        int32_t v9 = g28; // 0x8f65afa4
        int32_t v10 = *(int32_t *)(v9 + 8); // 0x8f65afa0
        g34 = v10;
        int32_t v11 = v9 + 48; // 0x8f65afa4
        int32_t v12 = v10 + v8; // 0x8f65afa8
        int32_t v13 = *(int32_t *)(v9 + 12) + (int32_t)(v12 < v8); // 0x8f65afac
        g38 = v13;
        while (v11 != v7 + g28) {
            // 0x8f65afa0
            v8 = v12;
            ...
            v10 = *(int32_t *)(v9 + 8);
            g34 = v10;
            int32_t v14 = *(int32_t *)(v9 + 12); // 0x8f65afa0
            v11 = v9 + 48;
            v12 = v10 + v8;
            v13 = v14 + v13 + (int32_t)(v12 < v8);
            g38 = v13;
            // continue -> 0x8f65afa0
        }
        // 0x8f65af98
