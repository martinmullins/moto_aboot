...
// Address range: 0x8f608660 - 0x8f60870b
int32_t sdhci_msm_set_mci_clk(int32_t * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1;
    int32_t result = g25;
    int32_t v2 = *(int32_t *)(v1 + 40); // R2
    int32_t * v3 = (int32_t *)(*a1 + 268); // 0x8f608688_0
    int32_t v4 = *v3; // 0x8f608688
    if (*(int32_t *)(v1 + 8) != 3) {
        // 0x8f6086d0
        *v3 = v4 & -0x380001;
        int32_t v5 = *a1; // 0x8f6086dc
        // branch -> 0x8f6086e8
        // 0x8f6086e8
        *(int32_t *)(v5 + 268) = *(int32_t *)(v5 + 268) & -0x40001;
        // branch -> 0x8f6086ec
        // 0x8f6086ec
        if (result != g25) {
            // 0x8f6086fc
    ...
    *v3 = v4 | 768;
    if (*(char *)(v2 + 8) != 0) {
        // 0x8f6086a0
        if (*(char *)(v2 + 9) == 0) {
            int32_t * v6 = (int32_t *)(*a1 + 268); // 0x8f6086b0_0
            *v6 = *v6 & -0x380001 | 0x300000;
            int32_t v7 = *a1; // 0x8f6086c0
            // branch -> 0x8f6086e8
            // 0x8f6086e8
            *(int32_t *)(v7 + 268) = *(int32_t *)(v7 + 268) | 0x40000;
            // branch -> 0x8f6086ec
        }
    }
    // 0x8f6086ec
