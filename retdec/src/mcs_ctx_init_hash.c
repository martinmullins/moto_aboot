...
// Address range: 0x8f666590 - 0x8f66663f
int32_t mcs_ctx_init_hash(char a1, char * a2) {
    ...
    if (a1 == 13 && a2 != NULL) {
        // 0x8f6665b8
        mcs_memset(v1, 0, 96, (int32_t)&g15);
        *(char *)v1 = (char)(int32_t)a1;
        int32_t v4 = (int32_t)&g1; // 0x8f6665d8
        char v5 = *(char *)v4; // 0x8f6665d8
        int32_t v6 = v4 + 4; // 0x8f6665dc
        char v7 = *(char *)(v4 - 1); // 0x8f6665e0
        char v8 = *(char *)(v4 + 2); // 0x8f6665ec
        char v9 = *(char *)(v4 + 1); // 0x8f6665f4
        int32_t v10 = 72 + v1; // 0x8f666600
        *(int32_t *)v10 = 256 * (int32_t)v9 | 0x1000000 * (int32_t)v7 | 0x10000 * (int32_t)v5 | (int32_t)v8;
        // branch -> 0x8f6665d8
        while (v6 != (int32_t)&g2) {
            // 0x8f6665d8
            v4 = v6;
