...
// Address range: 0x8f647a28 - 0x8f647a9f
int32_t smb1359_config_fastchg_current(int32_t a1, int32_t a2) {
    // 0x8f647a28
    g32 = a2;
    int32_t v1 = g38; // 0x8f647a28
    int32_t v2 = g28;
    int32_t v3; // 0x8f647a4c
    if (target_hwrev(a1, a2, g36, v2) < 0x8300) {
        // if_8f647a44_0_true
        g32 = 124;
        v3 = 124;
        // branch -> after_if_8f647a48_0
    } else {
        // 0x8f647a28
        v3 = g32;
        // branch -> after_if_8f647a48_0
    }
    int32_t result = smb1359_write_reg(28, v3, g36, v2); // 0x8f647a4c
    g31 = result;
    g36 = result;
    if (result > -1) {
        // 0x8f647a7c
        ...
        if (v2 == g28) {
            // 0x8f647a68
            g32 = (int32_t)"Fast Chrg config hvdcp error %d\n";
            g38 = v1;
            int32_t v4;
            int32_t result2 = print_log(-1, (int32_t)"Fast Chrg config hvdcp error %d\n", result, v2, v1, g30, v4, 0, 0, 0, 0, 0, 0); // 0x8f647a78
            g31 = result2;
            return result2;
        }
    }
