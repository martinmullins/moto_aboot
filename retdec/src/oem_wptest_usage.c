...
// Address range: 0x8f624444 - 0x8f624573
int32_t oem_wptest_usage(int32_t a1) {
    int32_t v1 = g29; // 0x8f624444
    g29 = &g14;
    int32_t v2 = g14;
    fboot_info("INFO", "usage: fastboot oem wptest [options]", g27, v2);
    fboot_info("INFO", (char *)&g9, g27, v2);
    fboot_info("INFO", "options:", g27, v2);
    fboot_info("INFO", "  enable         enable writeprotect", g27, v2);
    fboot_info("INFO", "  disable        disable writeprotect", g27, v2);
    fboot_info("INFO", "  test <number>  run a test", g27, v2);
    fboot_info("INFO", "                 1 - display system image info", g27, v2);
    fboot_info("INFO", "                 2 - enable write protect", g27, v2);
    fboot_info("INFO", "                 3 - reset eMMC", g27, v2);
    fboot_info("INFO", "                 4 - hash system image", g27, v2);
    fboot_info("INFO", "                 5 - enable enhance erase", g27, v2);
    fboot_info("INFO", "                 6 - check if system partition is writable", g27, v2);
    fboot_info("INFO", "                 7 - enable hw_test (OTP) and print error code", g27, v2);
    fboot_info("INFO", "                 <sector> - check if specified sector is writable", g27, v2);
    int32_t result = fboot_info("INFO", "  help           show usage", g27, v2); // 0x8f624504
    g24 = result;
    g27 = v2;
    int32_t v3 = g14;
    g28 = v3;
    ...
    // 0x8f62451c
    g29 = v1;
    int32_t result2 = fboot_info("INFO", (char *)&g9, v2, v2); // 0x8f62452c
    g24 = result2;
    return result2;
}
