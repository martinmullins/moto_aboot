...
// Address range: 0x8f624c0c - 0x8f624d07
int32_t handle_fboot_oem_command_prod_fuse(int32_t a1, int32_t a2) {
    int32_t v1 = g18;
    int32_t v2 = get_model_id(a1, a2); // 0x8f624c1c
    int32_t v3 = (int32_t)"MODEL_ID not defined";
    int32_t v4;
    if (v2 != -1) {
        // 0x8f624c30
        make_product_phone(v2, a2, g23, v1, a1, v1);
        fboot_info((int32_t)"INFO", (int32_t)"Failed to make product phone.", g23, v1, a1, v1, g25, g19, v4, 0, 0);
        v3 = (int32_t)"Please reboot and try it again.";
        // branch -> 0x8f624cbc
    }
    // 0x8f624cbc
    fboot_info((int32_t)"INFO", v3, g23, v1, a1, v1, g25, g19, v4, 0, 0);
    if (v1 != g18) {
        // 0x8f624cd4
        __stack_chk_fail();
        // branch -> 0x8f624cd8
