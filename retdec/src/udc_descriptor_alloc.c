...
// Address range: 0x8f604d60 - 0x8f604def
int32_t udc_descriptor_alloc(char a1, uint32_t a2, int16_t a3) {
    int32_t v1 = a3;
    int32_t v2 = g27;
    int32_t v3 = a1; // R4
    ...
    bool v4 = false; // 0x8f604d9c
    bool v5 = a1 < 0; // 0x8f604d9c
    if (a1 > -1) {
        // if_8f604d90_0_true
        v4 = a2 == 255;
        v5 = a2 > 254;
        // branch -> after_if_8f604d90_0
    }
    // after_if_8f604d90_0
    if (v4 || v5 ^ true) {
        // if_8f604d94_0_true
        g51 = 0;
        // branch -> after_if_8f604d94_0
    }
    // after_if_8f604d94_0
    int32_t result; // R0
    if (v5 && v4 ^ true) {
        // after_if_8f604d98_0.thread
        // branch -> 0x8f604dcc
        // 0x8f604dcc
        result = 0;
        // branch -> 0x8f604dd0
    } else {
        char * mem = malloc(v1 + 8); // 0x8f604da4
        result = (int32_t)mem;
        if (mem != NULL) {
            // 0x8f604db0
            *(int32_t *)mem = g51;
            *(int16_t *)(result + 4) = (int16_t)(a2 | 256 * v3);
            *(int16_t *)(result + 6) = (int16_t)v1;
            *(char *)(result + 8) = (char)v1;
            *(char *)(result + 9) = (char)v3;
            // branch -> 0x8f604dd0
        }
    }
    // 0x8f604dd0
