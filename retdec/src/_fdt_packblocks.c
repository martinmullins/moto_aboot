...
// Address range: 0x8f64cc70 - 0x8f64cd53
int32_t _fdt_packblocks(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = a4; // R6
    int32_t v2 = *(int32_t *)(a1 + 16); // 0x8f64cc80
    int32_t v3 = a3 + 40; // 0x8f64cc88
    char * v4 = g24;
    int32_t v5 = (int32_t)v4;
    int32_t v6 = v3 + a4; // R8
    int32_t v7 = a1 + fdt32_to_cpu_101(v2, a2, a3, v5, a1, v5, g34, g35, g36, g37); // 0x8f64cca8
    memcpy((char *)(a2 + 40), (char *)v7, a3);
    *(int32_t *)(a2 + 16) = fdt32_to_cpu_101(40, v7, a3, v5, a1, v5, g34, g35, g36, g37);
    int32_t v8 = *(int32_t *)(a1 + 8); // 0x8f64ccc0
    int32_t v9 = a1 + fdt32_to_cpu_101(v8, v7, a3, v5, a1, v5, g34, g35, g36, g37); // 0x8f64cccc
    memcpy((char *)(a2 + v3), (char *)v9, v1);
    int32_t v10 = fdt32_to_cpu_101(v3, v9, v1, v5, a1, v5, g34, g35, g36, g37); // 0x8f64ccdc
    *(int32_t *)(a2 + 8) = v10;
    int32_t v11 = fdt32_to_cpu_101(v1, v9, v1, v5, a1, v5, g34, g35, g36, g37); // 0x8f64ccec
    *(int32_t *)(a2 + 36) = v11;
    int32_t v12 = *(int32_t *)(a1 + 12); // 0x8f64ccf4
    int32_t v13 = a1 + fdt32_to_cpu_101(v12, v9, v1, v5, a1, v5, g34, g35, g36, g37); // 0x8f64ccfc
    int32_t v14 = *(int32_t *)(a1 + 32); // 0x8f64cd00
    int32_t v15 = fdt32_to_cpu_101(v14, v9, v1, v5, a1, v5, g34, g35, g36, g37); // 0x8f64cd04
    memcpy((char *)(a2 + v6), (char *)v13, v15);
    int32_t v16 = fdt32_to_cpu_101(v6, v13, v15, v5, a1, v5, g34, g35, g36, g37); // 0x8f64cd1c
    *(int32_t *)(a2 + 12) = v16;
    int32_t v17 = *(int32_t *)(a1 + 32); // 0x8f64cd24
    int32_t result = fdt32_to_cpu_101(fdt32_to_cpu_101(v17, v13, v15, v5, a1, v5, g34, g35, g36, g37), v13, v15, v5, a1, v5, g34, g35, g36, g37); // 0x8f64cd2c
    *(int32_t *)(a2 + 32) = result;
    if (v4 != g24) {
        // 0x8f64cd44
        __stack_chk_fail();
        // branch -> 0x8f64cd48
