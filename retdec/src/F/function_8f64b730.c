...
// Address range: 0x8f64b730 - 0x8f64b7ef
void function_8f64b730(void) {
    int32_t v1 = g52; // 0x8f64b734
    int32_t v2 = g54; // 0x8f64b734
    int32_t v3 = g55; // 0x8f64b734
    int16_t * v4 = g41;
    g55 = (int32_t)&g41;
    int32_t v5 = g46; // 0x8f64b7585
    if (g46 == 0) {
        int32_t v6 = *(int32_t *)g50; // 0x8f64b74c
        if (v6 == 0) {
            // 0x8f64b7d0
            if (v4 != g41) {
                // 0x8f64b7e0
    ...
    // branch -> 0x8f64b758
    while (true) {
        int32_t v7 = v5 + 1; // 0x8f64b760
        char v8 = *(char *)v5; // 0x8f64b760
        int32_t v9 = g47; // 0x8f64b764
        // branch -> 0x8f64b764
        while (true) {
            char v10 = *(char *)v9; // 0x8f64b764
            g52 = v10;
            if (v10 == 0) {
                // 0x8f64b780
                if (v8 == 0) {
                    ...
                    *(int32_t *)g50 = 0;
                    ...
                    int32_t v11 = v7; // 0x8f64b7b4
                    while (true) {
                        char * v12 = (char *)v11;
                        g54 = g47;
                        int32_t v13 = v11 + 1; // 0x8f64b798
                        int32_t v14 = v13; // R12
                        char v15 = *v12; // 0x8f64b798
                        g52 = v15;
                        int32_t v16 = g47; // 0x8f64b79c
                        // branch -> 0x8f64b79c
                        while (true) {
                            int32_t v17 = v16 + 1; // 0x8f64b79c
                            g54 = v17;
                            char v18 = *(char *)v16; // 0x8f64b79c
                            if (v18 == v15) {
                                // 0x8f64b7a8
                                int32_t v19; // 0x8f64b7b8
                                if (v15 == 0) {
                                    // if_8f64b7b0_0_true
                                    v19 = 0;
                                    // branch -> after_if_8f64b7b4_0
                                } else {
                                    // if_8f64b7ac_0_true
                                    *v12 = 0;
                                    v19 = v14;
