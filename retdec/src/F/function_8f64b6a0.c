...
// Address range: 0x8f64b6a0 - 0x8f64b72f
void function_8f64b6a0(void) {
    int32_t v1 = g15;
    int32_t len = strlen((char *)g18); // 0x8f64b6c0
    if (len == 0) {
        // 0x8f64b710
        if (v1 != g15) {
            // 0x8f64b720
    ...
    int32_t len2 = strlen((char *)g17); // 0x8f64b6d0
    if (len2 < len) {
        // 0x8f64b70c
        // branch -> 0x8f64b710
    } else {
        int32_t str = g17; // 0x8f64b6e012
        int32_t v2 = len2; // 0x8f64b6f410
        while (true) {
            // 0x8f64b6e8
            if (memcmp((char *)str, (char *)g18, len) == 0) {
                // 0x8f64b704
                // branch -> 0x8f64b710
            } else {
                int32_t v3 = v2 - 1;
