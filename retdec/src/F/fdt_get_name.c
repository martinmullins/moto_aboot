...
// Address range: 0x8f64c0e8 - 0x8f64c18b
int32_t fdt_get_name(int32_t a1, int32_t a2, int32_t * a3) {
    int32_t v1 = (int32_t)a3;
    int32_t v2 = g55; // 0x8f64c0e8
    int32_t v3 = g56; // 0x8f64c0e8
    g56 = a1;
    g58 = &g33;
    g57 = a2;
    g55 = v1;
    int32_t v4 = g33;
    g59 = fdt32_to_cpu_100(*(int32_t *)(a1 + 8), a2, v1, v4, a1, v4, v2, v3);
    int32_t v5 = fdt_check_header((int32_t *)g56, a2, v1); // 0x8f64c114
    int32_t v6; // 0x8f64c15c
    if (v5 != 0) {
        // 0x8f64c15c
        v6 = g55;
        if (v6 == 0) {
    ...
    int32_t v7 = _fdt_check_node_offset(g56, g57, v1, v4, a1); // 0x8f64c128
    if (v7 >= 0) {
        int32_t str = g59 + g57 + 4 + g56; // 0x8f64c140
        if (g55 != 0) {
            // 0x8f64c148
            *(int32_t *)g55 = strlen((char *)str);
            // branch -> 0x8f64c154
        }
        // 0x8f64c154
        // branch -> 0x8f64c16c
