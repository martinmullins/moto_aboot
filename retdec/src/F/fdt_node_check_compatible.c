...
// Address range: 0x8f64c620 - 0x8f64c6d7
int32_t fdt_node_check_compatible(int32_t a1, int32_t a2, char * a3) {
    int32_t v1 = (int32_t)a3;
    int32_t result = a1; // bp-40
    int32_t v2 = g22; // 0x8f64c620
    int32_t v3 = g25; // 0x8f64c620
    g25 = v1;
    g22 = &g16;
    int32_t v4 = g16;
    int32_t v5 = fdt_getprop(a1, a2, (int32_t)"compatible", (int32_t)&result, a1, v4, v1, v2, g23, g24); // 0x8f64c640
    int32_t str = v5; // R5
    if (v5 == 0) {
        // if_8f64c64c_0_true
        // branch -> 0x8f64c6b4
    ...
    // 0x8f64c654
    g22 = result;
    int32_t len = strlen((char *)g25); // 0x8f64c65c
    int32_t n = len + 1; // 0x8f64c660
    int32_t v6; // R0
    int32_t result2; // 0x8f64c6cc_2
    int32_t v7; // bp+226
    if (g22 < len) {
        // 0x8f64c6b0
        v6 = 1;
        ...
        int32_t memcmp_rc = memcmp((char *)g25, (char *)str, n); // 0x8f64c67c36
        v6 = memcmp_rc;
        if (memcmp_rc != 0) {
            while (true) {
                char * found_byte_pos = memchr((char *)str, 0, g22); // 0x8f64c694
                int32_t v8 = (int32_t)found_byte_pos; // 0x8f64c694_6
                if (found_byte_pos != NULL) {
                    int32_t v9 = g22 + str - v8 - 1; // 0x8f64c6a4
                    g22 = v9;
                    int32_t str2 = v8 + 1; // 0x8f64c6a8
                    str = str2;
                    if (v9 >= len) {
                        int32_t memcmp_rc2 = memcmp((char *)g25, (char *)str2, n); // 0x8f64c67c
                        v6 = memcmp_rc2;
                        if (memcmp_rc2 == 0) {
                            // break -> 0x8f64c6b4
                            break;
