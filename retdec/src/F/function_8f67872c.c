...
// Address range: 0x8f67872c - 0x8f6787c7
void function_8f67872c(void) {
    int32_t v1 = g34; // 0x8f67872c
    g34 = g30;
    int32_t v2 = *(int32_t *)(g29 + 24); // 0x8f67873c
    int32_t v3 = *(int32_t *)(g29 + 16); // 0x8f678740
    int32_t v4 = *(int32_t *)(g29 + 12); // 0x8f67874c
    int32_t v5 = *(int32_t *)(g29 + 8); // 0x8f678754
    int32_t v6 = *(int32_t *)(g29 + 4); // 0x8f67875c
    int32_t v7 = *(int32_t *)g29; // 0x8f678764
    int32_t v8 = *(int32_t *)(g29 + 20); // 0x8f67876c
    sprintf((char *)g30, "%.3s %.3s%3d %.2d:%.2d:%.2d UTC %d", (char *)(4 * v2 + (int32_t)"Sun"), (char *)(4 * v3 + (int32_t)"Jan"), v4, v5, v6, v7, v8 + 1900);
    // 0x8f6787b0
    g34 = v1;
}
