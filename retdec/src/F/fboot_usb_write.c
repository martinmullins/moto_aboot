...
// Address range: 0x8f62d948 - 0x8f62da8f
int32_t fboot_usb_write(int32_t a1, int32_t a2) {
    int32_t v1 = &g10; // R9
    int32_t v2 = a2; // R4
    int32_t v3 = g25;
    ...
    if (a2 == 0) {
        ...
        while (true) {
            int32_t v6 = v5; // R1
            *(int32_t *)(int32_t)&g7 = g31 & -0x10000 | 0xea60;
            *(int32_t *)(v6 + 4) = a2 < 0x8000 ? a2 : 0x8000;
            int32_t v7 = &g3; // R3
            *(int32_t *)v6 = a1;
            *(int32_t *)(v6 + 8) = v7;
            int32_t v8;
            int32_t v9;
            if (udc_request_queue(g8, v6, g32, v7, v9, v8, 0, v3, 0, g34) < 0) {
                // if_8f62d9c0_0_true
                // branch -> 0x8f62da14
                // 0x8f62da14
                print_log(1, (int32_t)"usb_write() queue failed\n", g32, v7, v9, v8, 0, v3, 0, g34, g35, g36, g37);
                // branch -> 0x8f62da3c
                // 0x8f62da3c
                *(int32_t *)v1 = 2;
                // branch -> 0x8f62da48
            ...
            int32_t v10 = g7;
            int32_t v11 = event_wait_timeout((int32_t)&g15, v10, g32, v7, v9, v8); // 0x8f62d9d4
            if (v11 == -13) {
                // 0x8f62d9e4
                udc_request_dequeue(g8, v10, g32, -13, v9, -13, 0, v3, 0, g34, g35, g36, g37, g38, g39);
                // branch -> 0x8f62da48
                // 0x8f62da48
                if (v3 != g25) {
                    // 0x8f62da5c
            ...
            if (g12 > -1) {
                int32_t v12 = g9;
                int32_t v13 = *(int32_t *)(v12 + 4); // 0x8f62da20
                int32_t result = v4 + v13; // 0x8f62da24
                v4 = result;
                a1 += v13;
                int32_t v14 = v2; // 0x8f62da2c
                int32_t v15 = v14 - v13; // 0x8f62da2c
                v2 = v15;
                if (v14 == v13) {
                    // 0x8f62da34
                    // branch -> 0x8f62da48
                ...
                // branch -> 0x8f62da14
                // 0x8f62da14
                print_log(1, (int32_t)"usb_write() transaction failed\n", g32, g12, v9, v8, 0, v3, 0, g34, g35, g36, g37);
                // branch -> 0x8f62da3c
                // 0x8f62da3c
                *(int32_t *)v1 = 2;
                // branch -> 0x8f62da48
