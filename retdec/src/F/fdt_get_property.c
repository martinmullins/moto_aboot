...
// Address range: 0x8f64c394 - 0x8f64c3f3
int32_t fdt_get_property(int32_t a1, int32_t a2, char * str, int32_t a4) {
    int32_t v1 = g25; // 0x8f64c394
    int32_t v2 = g27; // 0x8f64c394
    g29 = a4;
    g25 = (int32_t)&g19;
    g27 = a1;
    g28 = a2;
    g26 = (int32_t)str;
    int32_t result = fdt_get_property_namelen(a1, a2, str, strlen(str)); // 0x8f64c3d0
    if (g19 != g19) {
        // 0x8f64c3e4
        __stack_chk_fail();
        // branch -> 0x8f64c3e8
