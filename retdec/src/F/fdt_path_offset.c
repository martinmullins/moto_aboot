...
// Address range: 0x8f64c50c - 0x8f64c61f
int32_t fdt_path_offset(char * a1, char * str, int32_t a3) {
    int32_t v1 = (int32_t)a1; // 0x8f64c50c_0
    int32_t v2 = (int32_t)str;
    int32_t v3 = g41; // 0x8f64c50c
    int32_t v4 = g42; // 0x8f64c50c
    int32_t v5 = g43; // 0x8f64c50c
    int32_t v6 = g44; // 0x8f64c50c
    int32_t v7 = g45; // 0x8f64c50c
    int32_t v8 = g46; // 0x8f64c50c
    g43 = v1;
    g46 = &g32;
    g41 = v2;
    int32_t v9 = g32;
    ...
    int32_t v10;
    int32_t result = fdt_check_header(g43, v2, a3, v9, v1, v9, a3, v3, v4, v5, v6, v7, v8, g34, v10); // 0x8f64c534
    if (result != 0) {
        // 0x8f64c600
        if (v9 != g32) {
            // 0x8f64c610
    ...
    int32_t v11 = g41; // 0x8f64c540
    char * str2 = (char *)v11; // 0x8f64c540_0
    g44 = len + v11;
    int32_t v12; // R5
    int32_t v13; // 0x8f64c598
    int32_t v14; // 0x8f64c5c0
    if (*str2 != 47) {
        char * found_char_pos = strchr(str2, 47); // 0x8f64c558
        int32_t v15 = g41; // 0x8f64c55c
        int32_t v16 = found_char_pos == NULL ? g44 : (int32_t)found_char_pos;
        g45 = v16;
        int32_t v17 = v16 - v15; // 0x8f64c570
        int32_t v18 = fdt_get_alias_namelen((char *)g43, v15, v17); // 0x8f64c574
        if (v18 == 0) {
            // 0x8f64c5f4
            // branch -> 0x8f64c600
        } else {
            ...
            // branch -> 0x8f64c598
            // 0x8f64c598
            v12 = fdt_path_offset((char *)g43, (char *)v18, v17);
            // branch -> 0x8f64c598
            while (true) {
                // 0x8f64c598
                v13 = g41;
    ...
    while (true) {
        ...
        if (*(char *)v13 != 0) {
          ...
          lab_0x8f64c5a4:;
            ...
            // 0x8f64c5b4
            if (v20 != 0) {
                char * found_char_pos2 = strchr(str3, 47); // 0x8f64c5c4
                int32_t v21 = found_char_pos2 == NULL ? g44 : (int32_t)found_char_pos2;
                g41 = v21;
                result2 = fdt_subnode_offset_namelen(g43, v12, v19, v21 - v19, v1, v9, a3, v3, v4, v5, v6, v7, v8, g34, v10, 0);
                v12 = result2;
