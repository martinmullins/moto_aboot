...
// Address range: 0x8f64b39c - 0x8f64b417
void function_8f64b39c(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = g38;
    if (a3 == 0) {
        // 0x8f64b3f8
    ...
    int32_t v2 = (int32_t)a1; // 0x8f64b3bc
    char v3 = *(char *)v2; // 0x8f64b3c4
    int32_t v4 = v3; // 0x8f64b3c4
    int32_t v5 = v4; // R3
    // branch -> 0x8f64b3bc
    while (v3 != 0) {
        // 0x8f64b3bc
    ...
    char v6 = *(char *)(v4 + a2); // 0x8f64b3d08
    int32_t v7 = v4 + v2; // 0x8f64b3d410
    int32_t v8 = v7; // R6
    *(char *)v7 = v6;
    if (v6 == 0) {
        // 0x8f64b3f8
    ...
    while (true) {
        ...
        if (v9 == a3) {
            ...
            *(char *)(v8 + 1) = 0;
            ...
            char v10 = *(char *)(v9 + a2); // 0x8f64b3d0
            int32_t v11 = v9 + v2; // 0x8f64b3d4
            v8 = v11;
            *(char *)v11 = v10;
            if (v10 == 0) {
                // break -> 0x8f64b3f8
