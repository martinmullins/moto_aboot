...
// Address range: 0x8f652354 - 0x8f65244b
int32_t fti_serialno(int32_t a1, int32_t a2, int32_t a3) {
    char * v1 = (char *)a1;
    int32_t v2 = g31 ? -0x709c0700 : 0; // 0x8f652358
    int32_t v3 = (int32_t)&g17; // R4
    char * v4 = g17;
    ...
    if (v4 != NULL) {
        ...
        // 0x8f6523e8
        *(char *)&g18 = 0;
        strlcat((int32_t)&g18, (int32_t)v4 + 21, 11, 0, (int32_t)v1, a2, a3, v6, g37, g38, g39, g40);
        // branch -> 0x8f65240c
        // 0x8f65240c
        if (v6 == g29) {
            // 0x8f652428
    ...
    char * mem = malloc(63); // 0x8f652384
    int32_t v7 = (int32_t)mem; // 0x8f652384_3
    *(int32_t *)v3 = v7;
    if (mem == NULL) {
        // 0x8f65240c
        if (v6 == g29) {
    ...
    char * v8 = g17;
    int32_t result;
    if (__utag_read((char *)v5, (int32_t)"fti", v7, 63, a1, a2, a3, v6, g37, g38, g39, g40, g41) == 63) {
        char * v9 = v8;
        char * v10 = v1;
        if (v8 == NULL) {
            // 0x8f6523cc
            _panic(v2, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"lib/fti/fti.c", 60, (int32_t)"fti_cache && sizeof(sn)>sizeof(fti_cache->serial)", a2, a3);
            v9 = g17;
            v10 = "fti_cache && sizeof(sn)>sizeof(fti_cache->serial)";
            // branch -> 0x8f6523e8
        }
        // 0x8f6523e8
        *(char *)&g18 = 0;
        strlcat((int32_t)&g18, (int32_t)v9 + 21, 11, 0, (int32_t)v10, a2, a3, v6, g37, g38, g39, g40);
        result = (int32_t)&g18;
        // branch -> 0x8f65240c
    } else {
        // 0x8f6523b0
