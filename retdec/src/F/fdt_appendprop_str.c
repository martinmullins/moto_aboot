...
// Address range: 0x8f64cfb0 - 0x8f64d0cf
int32_t fdt_appendprop_str(int32_t a1, int32_t a2, int32_t a3, char * a4) {
    // 0x8f64cfb0
    int32_t v1;
    int32_t v2 = v1; // bp-44
    int32_t v3;
    int32_t v4 = v3; // bp-40
    int32_t v5 = (int32_t)a4; // R6
    int32_t v6 = a1; // R5
    int32_t v7 = g16;
    int32_t v8;
    int32_t result = _fdt_rw_check_header(a1, a2, a3, v7, v8, 0, 0); // 0x8f64cfd8
    if (result != 0) {
        // 0x8f64d0b0
        if (v7 != g16) {
            // 0x8f64d0c0
    ...
    int32_t v9 = fdt_get_property(v6, a2, a3, (int32_t)&v4, v8, 0, 0, v1, v3, v7, 0, g24, g25); // 0x8f64cff4
    v2 = v9;
    int32_t v10;
    int32_t result2; // 0x8f64d0ac
    if (v9 == 0) {
        int32_t v11 = _fdt_add_property(v6, a2, a3, v10, (int32_t)&v2, 0, 0, 0, v4, v7, 0, g24, g25, g26, g27, g28, g29, g17, v10); // 0x8f64d080
        result2 = v11;
        if (v11 == 0) {
            // 0x8f64d08c
            memcpy((char *)(v2 + 12), (char *)v5, v10);
            result2 = v11;
            // branch -> 0x8f64d0ac
        }
        // branch -> 0x8f64d0b0
    } else {
        int32_t v12 = v4; // 0x8f64d008
        int32_t v13 = v9 + 12; // 0x8f64d010
        int32_t v14 = v10 + v12; // 0x8f64d014
        int32_t v15 = v12 + 3 & -4; // 0x8f64d020
        int32_t v16 = v14 + 3 & -4; // 0x8f64d024
        int32_t v17 = _fdt_splice_struct(v6, v13, v15, v16, v8, 0, 0, v9, v12, v7, 0, g24, g25); // 0x8f64d028
        if (v17 == 0) {
            v6 = v2;
            int32_t v18 = fdt32_to_cpu_101(v14, v13, v15, v16, v8, 0, 0, v2, v4, v7); // 0x8f64d03c
            *(int32_t *)(v6 + 4) = v18;
            int32_t v19 = v6 + v4; // 0x8f64d050
            *(char *)(v19 + 11) = 32;
            memcpy((char *)(v19 + 12), (char *)v5, v10);
            // branch -> 0x8f64d0a4
        }
        // 0x8f64d0a4
        result2 = v17;
