...
// Address range: 0x8f64d548 - 0x8f64d5d7
int32_t fdt_pack(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g23; // 0x8f64d548
    int32_t v2 = g25; // 0x8f64d548
    int32_t v3 = a1; // R4
    g23 = &g15;
    int32_t v4 = g15;
    int32_t result = _fdt_rw_check_header(a1, a2, a3, v4, a1, v4, a3); // 0x8f64d55c
    if (result == 0) {
        int32_t v5 = fdt_num_mem_rsv(v3, a2, a3, v4, a1, v4, a3); // 0x8f64d56c
        g25 = v5;
        int32_t v6 = *(int32_t *)(v3 + 36); // 0x8f64d574
        int32_t v7 = fdt32_to_cpu_101(v6, a2, a3, v4, a1, v4, a3, g22, v1, g24); // 0x8f64d578
        int32_t v8 = 16 * v5 + 16; // 0x8f64d584
        int32_t v9;
        _fdt_packblocks(v3, v3, v8, v7, a1, v4, a3, g22, v1, g24, v2, g16, v9, 0, 0, 0, 0, 0);
        int32_t v10 = *(int32_t *)(v3 + 12); // 0x8f64d594
        int32_t v11 = fdt32_to_cpu_101(v10, v3, v8, v7, a1, v4, a3, g22, v1, g24); // 0x8f64d598
        g25 = v11;
        int32_t v12 = *(int32_t *)(v3 + 32); // 0x8f64d5a0
        int32_t v13 = fdt32_to_cpu_101(fdt32_to_cpu_101(v12, v3, v8, v7, a1, v4, a3, g22, v1, g24) + v11, v3, v8, v7, a1, v4, a3, g22, v1, g24); // 0x8f64d5ac
        *(int32_t *)(v3 + 4) = v13;
        // branch -> 0x8f64d5b4
    }
    // 0x8f64d5b4
