...
// Address range: 0x8f64c23c - 0x8f64c2bb
int32_t fdt_get_property_by_offset(int32_t a1, int32_t a2, int32_t * a3) {
    // 0x8f64c23c
    g31 = a2;
    int32_t v1 = (int32_t)a3;
    g32 = v1;
    int32_t v2 = g34; // 0x8f64c23c
    int32_t v3 = g35; // 0x8f64c23c
    g35 = a2;
    g34 = v1;
    int32_t v4 = g25;
    int32_t v5 = _fdt_check_prop_offset(a1); // 0x8f64c258
    int32_t v6;
    if (v5 <= -1) {
        int32_t v7 = g34; // 0x8f64c264
        if (v7 != 0) {
            // if_8f64c268_0_true
            *(int32_t *)v7 = v5;
            // branch -> 0x8f64c29c
    ...
    int32_t v8 = *(int32_t *)(a1 + 8); // 0x8f64c274
    int32_t v9 = a1 + g35 + fdt32_to_cpu_100(v8, a2, v1, v4, a1, v4, v1, v2); // 0x8f64c284
    g35 = v9;
    int32_t result;
    if (g34 != 0) {
        int32_t v10 = *(int32_t *)(v9 + 4); // 0x8f64c28c
        *(int32_t *)g34 = fdt32_to_cpu_100(v10, a2, v1, v4, a1, v4, v1, v2);
        result = g35;
        // branch -> 0x8f64c29c
    } else {
        result = v9;
