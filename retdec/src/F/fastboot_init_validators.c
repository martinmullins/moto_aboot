...
// Address range: 0x8f63072c - 0x8f63084b
int32_t fastboot_init_validators(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = &g39; // R4
    int32_t v2 = g37;
    g40 = &g39;
    ...
    g42 = &g41;
    g41 = &g41;
    register_pre_cmd_validator(0, (int32_t)&g1, a3);
    register_pre_cmd_validator(5, (int32_t)&g6, a3);
    register_pre_cmd_validator(4, (int32_t)&g4, a3);
    register_pre_cmd_validator(1, (int32_t)&g7, a3);
    register_pre_cmd_validator(1, (int32_t)&g5, a3);
    register_pre_cmd_validator(1, (int32_t)&g11, a3);
    register_pre_cmd_validator(2, (int32_t)&g3, a3);
    register_pre_cmd_validator(2, (int32_t)&g12, a3);
    register_cmd_validator(v1, 1, (int32_t)&g10, (int32_t)&g41, a1, v2, a3, g49, g50, g43);
    register_cmd_validator(v1, 1, (int32_t)&g9, (int32_t)&g41, a1, v2, a3, g49, g50, g43);
    int32_t result2 = register_cmd_validator(v1, 2, (int32_t)&g2, (int32_t)&g41, a1, v2, a3, g49, g50, g43); // 0x8f6307e0
    if (v2 == g37) {
        int32_t result = register_cmd_validator(v1, 4, (int32_t)&g8, v2, g49, g50, g43, a5, 0, 0); // 0x8f63080c
        return result;
    }
    // 0x8f6307f4
    __stack_chk_fail();
