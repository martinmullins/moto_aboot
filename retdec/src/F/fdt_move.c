...
// Address range: 0x8f64bcf8 - 0x8f64bd6b
int32_t fdt_move(char * a1, char * a2, int32_t a3) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = (int32_t)a2;
    int32_t v3 = g31 ? -0x709c0700 : 0; // 0x8f64bcf8
    int32_t v4 = g29;
    int32_t v5;
    int32_t result = fdt_check_header(v1, v2, a3, v4, v1, v4, g37, g38, g39, g40, g41, v3, v5, 0, 0); // 0x8f64bd14
    if (result != 0) {
        // 0x8f64bd4c
        if (v4 != g29) {
            // 0x8f64bd5c
    ...
    uint32_t v6 = fdt32_to_cpu_99(*(int32_t *)(v1 + 4), v2, a3, v4, v1, v4, g37, g38); // 0x8f64bd24
    int32_t result2;
    if (v6 <= a3) {
        // 0x8f64bd34
        memcpy((char *)v2, (char *)v1, v6);
        result2 = result;
        // branch -> 0x8f64bd4c
    } else {
        result2 = -3;
