...
// Address range: 0x8f64b1b0 - 0x8f64b21b
void function_8f64b1b0(char * str, int32_t a2, int32_t a3) {
    int32_t len = strlen(str); // 0x8f64b1c8
    int32_t v1 = a2; // 0x8f64b1cc
    int32_t v2 = v1; // 0x8f64b1d4
    if (len < v1) {
        // if_8f64b1d0_0_true
        a2 = len;
        v2 = len;
        // branch -> after_if_8f64b1d0_0
    }
    char * mem = malloc(v2 + 1); // 0x8f64b1d8
    if (mem != NULL) {
        // 0x8f64b1e4
        memcpy(mem, (char *)(int32_t)str, a2);
        *(char *)(a2 + (int32_t)mem) = 0;
        // branch -> 0x8f64b1f8
    }
}
