...
// Address range: 0x8f64d2b4 - 0x8f64d30b
int32_t fdt_add_subnode(int32_t a1, int32_t a2, char * str, int32_t a4, int32_t a5, int32_t a6, int32_t a7) {
    int32_t len = strlen(str); // 0x8f64d2d4
    // 0x8f64d2f0
    return fdt_add_subnode_namelen(a1, a2, (int32_t)str, len, g25, g26, g27, g28, g17, a5, a6, a7, 0, 0, 0, 0);
    // 0x8f64d2ec
    __stack_chk_fail();
    return len;
}
