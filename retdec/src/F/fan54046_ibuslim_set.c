...
// Address range: 0x8f6423e8 - 0x8f642477
int32_t fan54046_ibuslim_set(int32_t a1, int32_t a2) {
    // 0x8f6423e8
    g20 = a1;
    int32_t v1 = g22; // 0x8f6423e8
    int32_t v2 = g24; // 0x8f6423e8
    int32_t v3 = g25; // 0x8f6423e8
    int32_t v4 = g18;
    int32_t v5 = v4;
    if (g17 == 0) {
        // 0x8f642450
    ...
    // 0x8f642410
    int32_t v6;
    int32_t v7 = fan54046_modify(1, a1 % 256, 6, 2, a1, v4, v1, v2, v3, g19, v6, 0, 0); // 0x8f642420
    g20 = v7;
    if (v7 == 0) {
        // 0x8f642410
        v5 = g18;
        ...
        if (v4 == v8) {
            ...
            g24 = v2;
            g25 = v3;
            int32_t result2 = print_log(-1, (int32_t)"fan540xx: Error setting Ibuslim\n", v4, v4, v2, v3, g19, v6, 0, 0, 0, 0, 0); // 0x8f64244c
            g20 = result2;
            return result2;
        }
    }
