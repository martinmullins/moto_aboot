...
// Address range: 0x8f656cb4 - 0x8f656d1b
int32_t flush_logs(int32_t a1, int32_t a2) {
    // 0x8f656cb4
    g36 = a2;
    g39 = 0;
    ...
    g40 = &g33;
    g41 = -0x7095018c;
    int32_t v1 = -0x7095018c; // 0x8f656cd0
    int32_t v2 = 0; // 0x8f656cd0
    // branch -> 0x8f656cd0
    while (true) {
        int32_t v3 = *(int32_t *)(v2 + v1); // 0x8f656cd0
        int32_t v4 = v2; // 0x8f656cec
        int32_t v5; // 0x8f656cec
        if (v3 != 0) {
            int32_t v6 = *(int32_t *)(v3 + 76); // 0x8f656cdc
            g38 = v6;
            if (v6 != 0) {
                // 0x8f656ce8
                g35 = -0x709a9314;
