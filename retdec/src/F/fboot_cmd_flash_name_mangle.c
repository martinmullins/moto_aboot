...
// Address range: 0x8f62e284 - 0x8f62e353
int32_t fboot_cmd_flash_name_mangle(int32_t a1, int32_t a2) {
    int32_t v1 = g12;
    int32_t str = *(int32_t *)(a1 + 12) + 1; // R4
    int32_t v2 = is_verified_boot_flow(a1, a2, g15, v1); // 0x8f62e2a0
    int32_t v3;
    if (v2 != 0) {
        int32_t result = get_current_secure_state(v2, a2, g15, v1, a1, v1); // 0x8f62e2ac
        if (result == 3) {
            int32_t strcmp_rc = strcmp((char *)str, "cid_prov"); // 0x8f62e2c4
            if (strcmp_rc != 0) {
                // 0x8f62e2d0
                show_locked_command_restriction(strcmp_rc, (int32_t)"cid_prov");
                // branch -> 0x8f62e320
                // 0x8f62e320
                if (v1 != g12) {
                    // 0x8f62e330
            ...
            // 0x8f62e2dc
            if (strcmp((char *)str, "bootloader") != 0) {
                // 0x8f62e2f0
                if (strcmp((char *)str, "radio") != 0) {
                    // 0x8f62e320
                    if (v1 != g12) {
                        // 0x8f62e330
                        __stack_chk_fail();
            ...
            // 0x8f62e304
            print_log(2, (int32_t)"override motoboot\n", g15, v1, a1, v1, g16, g17, g18, 0, v3, 0, 0);
            strcpy((char *)str, "motoboot");
            // branch -> 0x8f62e320
            // 0x8f62e320
            if (v1 != g12) {
                // 0x8f62e330
