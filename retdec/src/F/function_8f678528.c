...
// Address range: 0x8f678528 - 0x8f6786ef
void function_8f678528(void) {
    uint32_t v1 = *(int32_t *)g59; // 0x8f678534
    int32_t v2 = g57;
    int32_t v3 = v1 / 0x15180; // R4
    uint32_t v4 = v1 % 0x15180;
    int32_t v5 = &g17; // R7
    *(int32_t *)(g60 + 8) = v4 / 3600;
    int32_t v6 = v4 % 3600;
    *(int32_t *)(g60 + 4) = v6 / 60;
    int32_t v7 = v6 & -0x10000 | 1970; // R6
    *(int32_t *)g60 = v6 % 60;
    *(int32_t *)(g60 + 24) = (v3 + 4) % 7;
    int32_t * v8; // 0x8f678694_0
    int32_t * v9; // bp+051
    int32_t v10; // R1
    int32_t v11; // 0x8f678694
    int32_t v12; // 0x8f67869449
    int32_t v13; // 0x8f678694
    int32_t v14; // 0x8f67869452
    int32_t v15; // 0x8f67869c
    int32_t v16; // 0x8f67869c58
    int32_t v17; // 0x8f678698
    uint32_t v18; // 0x8f67869857
    if (v3 < 0) {
        uint32_t v19; // 0x8f67864c
        int32_t v20; // 0x8f678644
        while (true) {
            // 0x8f67864c
            v19 = v7 - 1;
            int32_t v21;
        ...
        // 0x8f678670
        *(int32_t *)(g60 + 28) = v20;
        v10 = 48 * v10 + (int32_t)&g16;
        *(int32_t *)(g60 + 20) = v19 - 1900;
        *(int32_t *)(g60 + 16) = 0;
        v12 = g60;
        v9 = (int32_t *)(v12 + 16);
        v14 = *v9;
        v18 = *(int32_t *)(4 * v14 + v10);
        v16 = v3;
        if (v16 < v18) {
            // 0x8f6786b0
            *(int32_t *)(v12 + 32) = 0;
        ...
        if (v7 % 4 == 0) {
            ...
            if (v7 % 100 != 0) {
              ...
              lab_0x8f678610:
                // 0x8f678610
                v10 = v23;
                int32_t v24 = *(int32_t *)(4 * v23 + v5); // 0x8f678610
                int32_t v25 = v3; // 0x8f678614
                if (v25 < v24) {
                    // 0x8f678670
                    *(int32_t *)(g60 + 28) = v25;
                    v10 = 48 * v10 + (int32_t)&g16;
                    *(int32_t *)(g60 + 20) = v7 - 1900;
                    *(int32_t *)(g60 + 16) = 0;
                    v12 = g60;
                    v9 = (int32_t *)(v12 + 16);
                    v14 = *v9;
