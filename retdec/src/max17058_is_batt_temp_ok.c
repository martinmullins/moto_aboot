...
// Address range: 0x8f643990 - 0x8f643a9b
int32_t max17058_is_batt_temp_ok(void) {
    int32_t v1 = g31;
    unsigned char v2 = *(char *)&g6; // 0x8f6439a8
    char v3 = v2; // 0x8f643a4c
    int32_t v4; // R0
    int32_t result; // 0x8f643a88_2
    int32_t v5;
    if (v2 < 4) {
        // 0x8f643a24
        char v6;
        if (g17 >= 250) {
            ...
            *(char *)&g6 = v6;
            // branch -> 0x8f643a44
            // 0x8f643a44
            print_log(-1, (int32_t)"Temp %d Temp State %d\n", 250, (int32_t)v6, g33, v1, g35, g37, g38, g32, v5, 0, 0);
            v4 = ((int32_t)&g5 & 255) == 1 ? 1 : ((int32_t)&g5 & 255) == 2 ? 0 : (int32_t)&g5 & 255;
            if (v1 != g31) {
                // 0x8f643a80
                __stack_chk_fail();
                result = v4;
                ...
                result = ((int32_t)&g5 & 255) == 1 ? 1 : ((int32_t)&g5 & 255) == 2 ? 0 : (int32_t)&g5 & 255;
            }
            // 0x8f643a84
            return result;
        }
    ...
    // 0x8f643a44
    print_log(-1, (int32_t)"Temp %d Temp State %d\n", 250, (int32_t)v3, g33, v1, g35, g37, g38, g32, v5, 0, 0);
    v4 = ((int32_t)&g5 & 255) == 1 ? 1 : ((int32_t)&g5 & 255) == 2 ? 0 : (int32_t)&g5 & 255;
    if (v1 != g31) {
        // 0x8f643a80
        __stack_chk_fail();
