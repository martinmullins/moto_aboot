...
// Address range: 0x8f61a280 - 0x8f61a2e7
int32_t target_mot_prod_id(char * a1, int32_t a2, int32_t a3) {
    char * v1 = g16;
    char result = (int32_t)v1; // 0x8f61a2c4
    if (v1 == (char *)-1) {
        int32_t v2 = (int32_t)*(char *)0x8600a96; // 0x8f61a2a8
        int32_t v3 = v2; // 0x8f61a2bc
        if ((v2 + 191) % 256 > 15) {
            // if_8f61a2b8_0_true
            v3 = 0;
            // branch -> after_if_8f61a2b8_0
        }
        // after_if_8f61a2b8_0
        *(int32_t *)&g16 = v3;
        result = v3;
