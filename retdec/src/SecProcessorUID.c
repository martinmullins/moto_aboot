...
// Address range: 0x8f606ff4 - 0x8f6070ab
int32_t SecProcessorUID(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1;
    int32_t v2 = g55;
    int32_t v3 = get_tz_buffer(v1); // 0x8f60700c
    uint32_t v4 = a2 - 8; // 0x8f607010
    if (v4 >= 25) {
        // 0x8f607020
        // branch -> 0x8f60708c
        // 0x8f60708c
    ...
    int32_t v5 = g57 ? -0x709aeed8 : 0; // 0x8f606ff4
    memset((char *)v3, 255, a2);
    int32_t v6;
    mot_tzbsp_call(10, v3, a2, v4, v1, v2, a3, g63, g64, g65, g66, v5, v6);
    cache_inv_range(v3, a2, a2, v4);
    memset((char *)v1, 0, a2);
    memcpy((char *)v1, (char *)v3, 4);
    uint16_t v7 = *(int16_t *)v3; // 0x8f607070
    int32_t v8 = v7; // 0x8f607070
    int32_t v9 = v8; // R0
    int32_t v10; // 0x8f6070a4_22
    if (v7 == 0) {
        // 0x8f607080
        if (*(int16_t *)(v3 + 2) == 0) {
            // 0x8f607020
