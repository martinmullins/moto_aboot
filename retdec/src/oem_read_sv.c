...
// Address range: 0x8f6250e8 - 0x8f6251d3
int32_t oem_read_sv(void) {
    int32_t str;
    int32_t v1 = &str; // 0x8f6250f8_0
    snprintf((char *)&str, 64, "Note: 0x%X indicates SV fuse read failure", -1);
    int32_t v2;
    fboot_info((int32_t)"INFO", v1, (int32_t)"Note: 0x%X indicates SV fuse read failure", -1, v2, 0, 0, 0, 0, 0, str);
    int32_t v3 = SecReadFuse(102, v1, (int32_t)"Note: 0x%X indicates SV fuse read failure"); // 0x8f625128
    snprintf((char *)&str, 64, "BOOTLOADER = 0x%X", v3);
    fboot_info((int32_t)"INFO", v1, (int32_t)"BOOTLOADER = 0x%X", v3, v2, 0, 0, 0, 0, 0, str);
    int32_t v4 = SecReadFuse(101, v1, (int32_t)"BOOTLOADER = 0x%X"); // 0x8f625150
    snprintf((char *)&str, 64, "AP = 0x%X", v4);
    fboot_info((int32_t)"INFO", v1, (int32_t)"AP = 0x%X", v4, v2, 0, 0, 0, 0, 0, str);
    int32_t v5 = SecReadFuse(104, v1, (int32_t)"AP = 0x%X"); // 0x8f625178
    snprintf((char *)&str, 64, "MODEM = 0x%X", v5);
    fboot_info((int32_t)"INFO", v1, (int32_t)"MODEM = 0x%X", v5, v2, 0, 0, 0, 0, 0, str);
    g23 = 1;
    if (g15 != g15) {
        // 0x8f6251b0
        __stack_chk_fail();
