...
// Address range: 0x8f632c34 - 0x8f632c93
int32_t get_device_type(void) {
    int32_t v1 = g39; // 0x8f632c34
    int32_t v2 = g41; // 0x8f632c34
    int32_t v3 = g32;
    int32_t result = get_string_prop((int32_t)"type", g35, v1, v3, g35, v3, v1, v2); // 0x8f632c4c
    if (result == 0) {
        // 0x8f632c58
        int32_t v4;
        print_log(2, (int32_t)"Not found setting for %s\n", (int32_t)"type", v3, g35, v3, v1, v2, g42, g34, v4, 0, 0);
        // branch -> 0x8f632c68
    }
    // 0x8f632c68
    g39 = v3;
