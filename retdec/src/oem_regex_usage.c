...
// Address range: 0x8f6243b4 - 0x8f624443
int32_t oem_regex_usage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g29; // 0x8f6243b4
    g29 = &g14;
    int32_t v2 = g14;
    fboot_info("INFO", "usage: fastboot oem regex [options]", a3, v2);
    fboot_info("INFO", (char *)&g9, a3, v2);
    fboot_info("INFO", "options:", a3, v2);
    fboot_info("INFO", "  match <pattern> <string>  match <patten> against <string>", a3, v2);
    int32_t result = fboot_info("INFO", "  help                      show usage", a3, v2); // 0x8f6243fc
    if (v2 != g14) {
        // 0x8f624410
        __stack_chk_fail();
        return result;
