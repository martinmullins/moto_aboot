...
// Address range: 0x8f62dd7c - 0x8f62ddd3
int32_t fboot_cmd_multiflash_disable(int32_t a1, int32_t a2) {
    int32_t v1 = g31;
    int32_t v2;
    fboot_info((int32_t)"INFO", (int32_t)"Multi-Flash is not supported any more!", g35, v1, a1, v1, g37, g32, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"Please download latest fastboot from: http://goo.gl/Qyzg2L", g35, v1, a1, v1, g37, g32, v2, 0, 0);
    if (v1 != g31) {
        // 0x8f62ddb8
        __stack_chk_fail();
        // branch -> 0x8f62ddbc
