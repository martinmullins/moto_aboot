...
// Address range: 0x8f61ee5c - 0x8f61eecb
int32_t update_ker_tags_rdisk_addr(int32_t a1, int32_t a2, int32_t a3) {
    // 0x8f61ee5c
    g32 = a2;
    int32_t v1 = g36; // 0x8f61ee64
    int32_t v2 = g37; // 0x8f61ee64
    int32_t v3 = g15;
    int32_t v4;
    int32_t v5 = get_ddr_start(a1, a2, v3, (int32_t)&g15, a1, v3, a3, v1, v2, g30, v4); // 0x8f61ee88
    int32_t v6;
    if (a2 == 0) {
        // 0x8f61ee88
        v6 = v5 + 0x8000;
    ...
    // 0x8f61ee90
    *(int32_t *)(a1 + 12) = v6;
    int32_t v7 = get_ddr_start(v6, a2, v3, (int32_t)&g15, a1, v3, a3, v1, v2, g30, v4); // 0x8f61ee94
    int32_t v8 = v7 + 0x2000000; // 0x8f61ee98
    *(int32_t *)(a1 + 20) = v8;
    int32_t v9 = get_ddr_start(v8, a2, v3, (int32_t)&g15, a1, v3, a3, v1, v2, g30, v4); // 0x8f61eea0
    g34 = v3;
    int32_t v10 = g15;
    g35 = v10;
    int32_t result = v9 + 0x1e00000; // 0x8f61eeb0
    g31 = result;
    *(int32_t *)(a1 + 32) = result;
    if (v3 != v10) {
        // 0x8f61eebc
        __stack_chk_fail();
        // branch -> 0x8f61eec0
