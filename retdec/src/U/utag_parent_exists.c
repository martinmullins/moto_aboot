...
// Address range: 0x8f629230 - 0x8f6292d3
int32_t utag_parent_exists(int32_t a1) {
    // 0x8f629230
    int32_t v1;
    int32_t str = v1; // bp-56
    int32_t v2 = g45; // 0x8f629230
    int32_t v3 = &str; // 0x8f629234_0
    g45 = &g32;
    int32_t v4 = g32;
    strlcpy(v3, g42, 33, v4, v1);
    int32_t v5 = strlen((char *)&str) + v3; // 0x8f62926c
    // branch -> 0x8f629268
    char * v6; // 0x8f629278_0
    int32_t v7;
    while (true) {
        int32_t v8 = v5 - 1; // 0x8f62926c
        int32_t v9;
        if (v5 == (int32_t)&v9) {
            // 0x8f6292ac
            // branch -> 0x8f6292b0
    ...
    // 0x8f629284
    *v6 = 0;
    int32_t v10 = __utags_walk_existing(a1, (int32_t)&g1, v3, v3, str, 0, 0, 0, 0, 0, 0, 0, 0, v4, 0); // 0x8f629298
    int32_t v11; // R0
    int32_t v12; // 0x8f6292c8_24
    if (v10 == -27) {
        // if_8f6292a4_0_true
        v11 = 1;
        v12 = 1;
