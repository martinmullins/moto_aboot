...
// Address range: 0x8f631704 - 0x8f6317c7
int32_t usb_cable_is_charger(int32_t a1, int32_t a2) {
    int32_t v1 = g29 ? -0x709a9838 : 0; // 0x8f631708
    int32_t v2; // bp-16
    int32_t v3 = &v2; // 0x8f631708_1
    int32_t v4 = g27;
    v2 = -1;
    int32_t v5 = &g14; // R2
    uint32_t v6 = g14;
    if (v6 >= 0) {
        // 0x8f631730
        v5 = v3;
        int32_t v7 = get_int_prop((int32_t)"usb_cable_is_charger", v6, v3, (int32_t)&g27, -1, v4, g34); // 0x8f631738
        if (v7 == 0) {
            // 0x8f631784
            // branch -> 0x8f631794
            // 0x8f631794
    ...
    if (v8 < 0) {
        ...
        // branch -> 0x8f631778
        // 0x8f631778
        print_log(1, (int32_t)"Fail to check if usb_cable_is_charger\n", v5, (int32_t)&g17, v2, v4, g34, v1, v9, 0, 0, 0, 0);
        // branch -> 0x8f631794
        // 0x8f631794
        if (v4 != g27) {
            // 0x8f6317a4
    ...
    int32_t v10 = get_int_prop((int32_t)"usb_cable_is_charger", v8, v3, (int32_t)&g17, v2, v4, g34); // 0x8f631764
    int32_t result;
    if (v10 == 0) {
        // 0x8f631784
        result = v2 == 1;
        ...
        // branch -> 0x8f631778
        // 0x8f631778
        print_log(2, (int32_t)"didn't find setting for usb_cable_is_charger\n", v3, (int32_t)&g17, v2, v4, g34, v1, v9, 0, 0, 0, 0);
        result = 0;
        // branch -> 0x8f631794
    }
    // 0x8f631794
