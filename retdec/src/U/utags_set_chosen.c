...
// Address range: 0x8f6556d4 - 0x8f655717
int32_t utags_set_chosen(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g22; // 0x8f6556d4
    int32_t v2 = g16 ? -0x709ad7a4 : 0; // 0x8f6556d4
    g22 = &g13;
    int32_t v3 = a2; // bp-20
    int32_t v4 = g13;
    int32_t v5;
    int32_t result = __utags_walk_existing(a1, (int32_t)&g2, (int32_t)&v3, v4, a1, a2, a3, v4, v1, v2, v5, 0, 0, 0, 0); // 0x8f6556f0
    if (v4 != g13) {
        // 0x8f655704
        __stack_chk_fail();
        // branch -> 0x8f655708
