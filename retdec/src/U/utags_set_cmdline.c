...
// Address range: 0x8f655718 - 0x8f65576f
int32_t utags_set_cmdline(char * a1, char * a2, int32_t a3, int32_t a4) {
    int32_t v1 = (int32_t)a1; // 0x8f655718_0
    int32_t result = v1; // R0
    char * v2 = a2; // bp-20
    int32_t v3 = g73;
    int32_t v4 = v1; // 0x8f655764_22
    int32_t v5 = v3;
    if (a2 != NULL) {
        int32_t v6 = g75 ? -0x709aede4 : 0; // 0x8f655718
        v2 = a2;
        *a2 = 0;
        int32_t v7;
        int32_t v8 = __utags_walk_existing(result, (int32_t)&g14, (int32_t)&v2, 0, v1, (int32_t)a2, a3, v3, g79, v6, v7, 0, 0, 0, 0); // 0x8f655748
        result = v8;
        v4 = v8;
        v5 = g73;
        // branch -> 0x8f65574c
