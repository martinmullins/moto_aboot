...
// Address range: 0x8f63c944 - 0x8f63c9bf
int32_t unlock_continue(int32_t a1, int32_t a2) {
    int32_t v1 = g60; // 0x8f63c944
    g60 = &g46;
    int32_t v2 = g46;
    int32_t v3;
    print_log(6, (int32_t)"unlocking bootloader...", g58, v2, a1, v2, v1, g55, v3, 0, 0, 0, 0);
    *(char *)&g49 = 1;
    event_signal((int32_t)&g48, 0, 1, (int32_t)&g49, a1, v2, v1, g55);
    int32_t result = show((int32_t)"fastboot_screen", 0, 1, (int32_t)&g3, a1, v2, v1, g55, v3, 0, 0, 0, 0, 0, 0); // 0x8f63c988
    if (v2 != g46) {
        // 0x8f63c99c
        __stack_chk_fail();
        // branch -> 0x8f63c9a0
