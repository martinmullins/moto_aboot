...
// Address range: 0x8f63b6d0 - 0x8f63b76b
int32_t update_console_menu_name(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g28;
    int32_t format; // 0x8f63b71c
    switch ((int32_t)v2) {
        default: {
            // if_8f63b714_0_true
    ...
    int32_t chars_printed = snprintf((char *)&g13, 64, (char *)format);
    if (v1 == g28) {
        // 0x8f63b734
        int32_t v3;
        int32_t result = print_log(1, (int32_t)"Kernel console menu item content: %s.\n", (int32_t)&g13, v1, g36, g31, v3, 0, 0, 0, 0, 0, 0); // 0x8f63b748
        return result;
    }
    // 0x8f63b730
    __stack_chk_fail();
