...
// Address range: 0x8f624938 - 0x8f624997
int32_t utag_shortnameof(void) {
    int32_t v1 = g23; // 0x8f624938
    int32_t v2 = (int32_t)g15;
    strlcpy((int32_t)&g13, v1, 32, v2, v1);
    char * found_char_pos = strrchr((char *)&g13, 58); // 0x8f624960
    if (found_char_pos != NULL) {
        // if_8f62496c_0_true
        *found_char_pos = 0;
        // branch -> after_if_8f624970_0
    }
    // after_if_8f624970_0
    g23 = (int32_t)&g13;
    if (v2 != (int32_t)g15) {
