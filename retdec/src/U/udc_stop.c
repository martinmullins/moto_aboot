...
// Address range: 0x8f6061e4 - 0x8f60626f
int32_t udc_stop(int32_t a1, int32_t a2) {
    int32_t v1 = g23; // 0x8f6061e4
    g23 = &g15;
    int32_t v2 = 0x78d9000; // R4
    *(int32_t *)0x78d91b4 = -1;
    int32_t * v3 = (int32_t *)(v2 + 320); // 0x8f606204_0
    *v3 = *v3 & -2;
    *(int32_t *)(v2 + 328) = 0;
    mask_interrupt(166, a2);
    target_usb_stop(166, a2);
    *(int32_t *)(v2 + 320) = 2;
    // branch -> 0x8f606228
    while ((*(int32_t *)(v2 + 320) & 2) != 0) {
        // 0x8f606228
        // continue -> 0x8f606228
    }
    // 0x8f606234
