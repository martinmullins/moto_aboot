...
// Address range: 0x8f64ff94 - 0x8f650067
int32_t display_turn_on(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = g20; // 0x8f64ff94
    int32_t v2 = g21; // 0x8f64ff94
    int32_t v3 = g22; // 0x8f64ff94
    int32_t v4 = g15; // 0x8f64ff94
    g17 = (int32_t)"%s is called\n";
    g18 = (int32_t)"display_turn_on";
    int32_t v5 = g11;
    g22 = &g11;
    g20 = &g7;
    int32_t v6 = get_current_panel(print_log(2, (int32_t)"%s is called\n", (int32_t)"display_turn_on", v5, a1, v5, v1, v2, v3, v4, a5, 0, 0), (int32_t)"%s is called\n", (int32_t)"display_turn_on", v5, a1, v5, v1, v2, v3, v4, a5); // 0x8f64ffbc
    g16 = v6;
    g21 = v6;
    int32_t result; // 0x8f65004c
    if (v6 == 0) {
        // 0x8f650020
        *(int32_t *)g20 = 2;
        if (v5 == g11) {
            // 0x8f650038
            result = print_log(2, (int32_t)"%s is done\n", (int32_t)"display_turn_on", v5, v1, v2, v3, v4, a5, 0, 0, 0, 0);
            return result;
        }
        // 0x8f650034
        __stack_chk_fail();
    ...
    int32_t v8 = display_init(v6, (int32_t)"%s is called\n", (int32_t)"display_turn_on", v7, a1, v5, v1); // 0x8f64ffd4
    int32_t v9 = g10;
    if (v9 != 0) {
        // 0x8f64ffe8
        mipi_cmd_trigger(v8, (int32_t)"%s is called\n", (int32_t)"display_turn_on", v9, a1, v5, v1, v2);
        // branch -> 0x8f64ffec
    }
    // 0x8f64ffec
    g16 = thread_sleep(34, (int32_t)"%s is called\n", (int32_t)"display_turn_on", v9, a1, v5, v1, v2);
    int32_t v10 = *(int32_t *)(g21 + 516); // 0x8f64fff4
    g19 = v10;
    if (v10 != 0) {
        // 0x8f650000
        g15 = -0x709afffc;
    ...
    int32_t v11 = *(int32_t *)(g21 + 508); // 0x8f650004
    g19 = v11;
    if (v11 != 0) {
        // 0x8f650010
        g15 = -0x709affec;
