...
// Address range: 0x8f6100dc - 0x8f61017b
int32_t mipi_dsi_off(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g47; // 0x8f6100dc
    int32_t v2 = g48; // 0x8f6100dc
    g47 = &g31;
    int32_t v3 = g31;
    int32_t v4 = target_cont_splash_screen(a1, a2, a3, v3); // 0x8f6100f4
    g48 = v4;
    if (v4 == 0) {
        // 0x8f610100
        g47 = 0x1a98000;
        *(int32_t *)0x1a9811c = 0;
        *(int32_t *)(g47 + 4) = v3 & -0x10000 | 497;
        mdelay(10, a2, a3);
        *(int32_t *)(g47 + 280) = 1;
        *(int32_t *)(g47 + 280) = g48;
        *(int32_t *)(g47 + 272) = 0x1115501;
        *(int32_t *)(g47 + 4) = g48;
        // branch -> 0x8f610130
    }
    // 0x8f610130
    g41 = 0;
    *(int32_t *)0x1a98110 = 0x1115501;
    if (*(char *)(a1 + 256) != 0) {
        // if_8f610148_0_true
        *(int32_t *)0x1aa0110 = 0x1115501;
        // branch -> after_if_8f61014c_0
    }
    // after_if_8f61014c_0
    if (v3 != g31) {
        // 0x8f610160
