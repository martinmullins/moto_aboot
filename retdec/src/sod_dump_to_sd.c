...
// Address range: 0x8f635424 - 0x8f63549f
int32_t sod_dump_to_sd(int32_t a1, int32_t a2) {
    char * v1 = g23;
    if (*(char *)&g13 == 0) {
        int32_t v2 = mbm_fdt_get_int((int32_t)"ramdump_setting", (int32_t)"dump_to_sdcard", (int32_t)&g23, (int32_t)&g13, a1, (int32_t)v1, g30); // 0x8f635458
        *(char *)(int32_t)&g13 = 1;
        if ((char)v2 == 1) {
            // if_8f635468_0_true
            *(char *)(int32_t)&g14 = 1;
