...
// Address range: 0x8f6409cc - 0x8f640a6b
int32_t oem_lp8556_usage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g11;
    int32_t v2;
    fboot_info((int32_t)"INFO", (int32_t)"usage: fastboot oem lp8556 [options]", a3, v1, a1, v1, g13, 0, v2, 0, 0);
    ...
    int32_t result2 = fboot_info((int32_t)"INFO", (int32_t)"  help              show usage", a3, v1, a1, v1, g13, 0, v2, 0, 0); // 0x8f640a20
    if (v1 == g11) {
        int32_t result = fboot_info((int32_t)"INFO", (int32_t)&g1, v1, v1, g13, 0, v2, 0, 0, 0, 0); // 0x8f640a48
        return result;
    }
    // 0x8f640a34
    __stack_chk_fail();
