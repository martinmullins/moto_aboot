...
// Address range: 0x8f672a60 - 0x8f672aa7
int32_t mot_sst_pal_delete_user_partition(int32_t a1, int32_t a2) {
    int32_t v1 = g47; // 0x8f672a60
    g47 = &g31;
    int32_t v2 = g31;
    int32_t v3 = erase_partition((int32_t)"userdata", a2, g45, v2, a1, v2, v1); // 0x8f672a74
    g45 = v2;
    int32_t v4 = g31;
    g46 = v4;
    int32_t v5 = v3 == 0 ? 0 : 255;
    g41 = v5;
    int32_t result; // 0x8f672a9c_2
    if (v2 != v4) {
        // 0x8f672a94
        __stack_chk_fail();
        result = g41;
