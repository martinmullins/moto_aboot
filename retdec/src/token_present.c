...
// Address range: 0x8f656184 - 0x8f65620b
char * token_present(char * str, char * a2, char * str3) {
    char * saveptr = str; // bp-32
    int32_t delim = (int32_t)a2; // R4
    int32_t v1 = g27;
    char * str2 = strdup(str); // 0x8f65619c
    int32_t v2 = (int32_t)str2; // R6
    char * v3 = strtok_r(str2, (char *)delim, &saveptr); // 0x8f6561ac13
    if (v3 == NULL) {
        // 0x8f6561e0
        free((char *)v2);
        if (v1 != g27) {
    ...
    char * str4 = v3; // 0x8f6561ac16
    int32_t v4; // 0x8f6561ac_7
    while (true) {
        // 0x8f6561bc
        if (strcmp((char *)(int32_t)str3, str4) != 0) {
            char * v5 = strtok_r(NULL, (char *)delim, &saveptr); // 0x8f6561ac
            v4 = (int32_t)v5;
            if (v5 == NULL) {
                // break -> 0x8f6561e0
                break;
