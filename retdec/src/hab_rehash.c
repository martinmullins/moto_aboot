...
// Address range: 0x8f66d588 - 0x8f66d663
int32_t hab_rehash(int32_t result, int32_t a2, char * a3) {
    int32_t v1 = g34; // 0x8f66d588
    int32_t v2 = g35; // 0x8f66d588
    g34 = (int32_t)&g16;
    g35 = (int32_t)a3;
    char * v3 = g16;
    if (a2 == 0) {
    ...
    int32_t v4 = (int32_t)*(char *)(a2 + 5); // 0x8f66d5b0
    uint32_t v5 = (result % 16 - 1) % 0x10000; // 0x8f66d5b4
    int32_t v6 = 0x10000 * (int32_t)*(char *)(a2 + 2); // 0x8f66d5b8
    int32_t v7; // R8
    int32_t result2;
    if (v5 < 3) {
        // if_8f66d5d0_0_true
        v7 = 1;
        char v8 = *(char *)(v5 + (int32_t)&g5); // 0x8f66d5d0
        result2 = v8;
        // branch -> after_if_8f66d5d0_0
    } else {
        // after_if_8f66d5cc_0
        v7 = 0;
        result2 = 13;
    ...
    char v9 = *(char *)(a2 + 1); // 0x8f66d5d4
    char v10 = *(char *)(a2 + 3); // 0x8f66d5d8
    char v11 = *(char *)(a2 + 4); // 0x8f66d5e0
    char v12 = *(char *)(a2 + 6); // 0x8f66d5e8
    char v13 = *(char *)(a2 + 8); // 0x8f66d5fc
    char v14 = *(char *)(a2 + 7); // 0x8f66d604
    int32_t dest_mem = (int32_t)memcpy((char *)((int32_t)v11 | 0x1000000 * (int32_t)v9 | v6 | 256 * (int32_t)v10), a3, 256 * (int32_t)v14 | 0x10000 * (int32_t)v12 | 0x1000000 * v4 | (int32_t)v13); // 0x8f66d60c_7
    if (v7 == 0) {
        // after_if_8f66d5d0_0.dec_label_pc_8f66d640_crit_edge
        // branch -> 0x8f66d640
        // 0x8f66d640
        if (v3 == g16) {
            // 0x8f66d654
        ...
        char * v15 = g16;
        if (v3 == v15) {
            int32_t v16 = g35; // 0x8f66d630
            g34 = v1;
            g35 = v2;
            int32_t v17;
            hab_digest(result2, a2, v16, (int32_t)v15, g33, v1, v2, g36, g37, g27, v17, 0, 0);
            return result2;
        }
    }
    // 0x8f66d650
