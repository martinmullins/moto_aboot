...
// Address range: 0x8f6454b4 - 0x8f64550f
int32_t pm8x41_gpio_set(int32_t a1, int32_t a2) {
    int32_t v1 = 256 * a1 + 0xbf00 | 64; // 0x8f6454c81
    int32_t v2 = g19;
    int32_t v3;
    int32_t v4 = pm8x41_reg_read(v1, a2, g23, v2, a1, v2, g25, g26, g27, 0, v3); // 0x8f6454d8
    pm8x41_reg_write(v1, v4 & 240 | a2, g23, v2, a1, v2, g25, g26, g27, 0, v3);
    if (v2 != g19) {
        // 0x8f645500
        __stack_chk_fail();
        // branch -> 0x8f645504
