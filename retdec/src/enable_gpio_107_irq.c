...
// Address range: 0x8f603674 - 0x8f6036e3
int32_t enable_gpio_107_irq(void) {
    int32_t v1 = g32;
    timer_initialize((int32_t)&g7, g36, g39, v1);
    *(int32_t *)0x106b000 = 3;
    gpio_set_intr_cfg_type(107, 3, g39, 0x106b000);
    int32_t v2;
    int32_t result = register_msm_gpio_int_handler(107, (int32_t)&g1, 0, 0x106b000, g35, v1, g41, g34, v2, 0, 0, 0); // 0x8f6036ac
    if (v1 == g32) {
        // 0x8f6036c4
        return msm_gpio_int_enable(107, (int32_t)&g1, v1, v1, g41, g34);
    }
    // 0x8f6036c0
    __stack_chk_fail();
    return result;
