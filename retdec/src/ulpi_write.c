...
// Address range: 0x8f605c0c - 0x8f605ca3
int32_t ulpi_write(uint32_t a1, int32_t a2) {
    int32_t v1 = g32;
    *(int32_t *)0x78d9170 = a1 % 256 | 0x10000 * a2 & 0xff0000 | 0x60000000;
    int32_t v2 = g41 & -0x10000 | 0x2711; // 0x8f605c401
    int32_t v3 = v2 - 1; // R4
    int32_t v4;
    int32_t v5; // 0x8f605c64
    int32_t v6; // 0x8f605c6c
    if (v2 == 1) {
        // 0x8f605c64
        v5 = *(int32_t *)0x78d9184;
        v6 = *(int32_t *)0x78d9140;
        print_log(1, (int32_t)"ulpi_write timeout (PORTSC: %08x USBCMD: %08x)\n", v5, v6, a1, v1, g41, g42, g43, g34, v4, 0, 0);
        // branch -> 0x8f605c7c
    } else {
        while (true) {
            int32_t v7 = *(int32_t *)0x78d9170 & 0x40000000; // 0x8f605c50
            int32_t result = v7; // R0
            if (v7 != 0) {
                // 0x8f605c58
                udelay(1, 0x78d9000, 0x78d9000, (int32_t)&g32);
                int32_t v8 = v3; // 0x8f605c40
                v3 = v8 - 1;
                if (v8 == 1) {
                    // break -> 0x8f605c64
                    break;
