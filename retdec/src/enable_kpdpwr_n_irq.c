...
// Address range: 0x8f645c50 - 0x8f645d03
int32_t enable_kpdpwr_n_irq(int32_t a1) {
    int32_t v1 = 0; // R4
    char * v2 = g21;
    int32_t v3 = (int32_t)v2;
    int32_t v4;
    int32_t v5 = pm8x41_reg_read(a1 & -0x10000 | 2065, g23, g24, v3, v4, 0, 0, v3, 0, g26, g27); // 0x8f645c6c
    int32_t v6 = v5 & 254 | 1; // 0x8f645c78
    int32_t v7 = pm8x41_reg_write(v5 & -0x10000 | 2065, v6, g24, v3, v4, 0, 0, v3, 0, g26, g27); // 0x8f645c7c
    int32_t v8 = pm8x41_reg_read(v7 & -0x10000 | 2066, v6, g24, v3, v4, 0, 0, v3, 0, g26, g27); // 0x8f645c84
    int32_t v9 = v8 & 254 | 1; // 0x8f645c90
    int32_t v10 = pm8x41_reg_write(v8 & -0x10000 | 2066, v9, g24, v3, v4, 0, 0, v3, 0, g26, g27); // 0x8f645c94
    int32_t v11 = pm8x41_reg_read(v10 & -0x10000 | 2067, v9, g24, v3, v4, 0, 0, v3, 0, g26, g27); // 0x8f645c9c
    pm8x41_reg_write(v11 & -0x10000 | 2067, v11 & 254 | 1, g24, v3, v4, 0, 0, v3, 0, g26, g27);
    int32_t v12;
    register_spmi_int_handler(1, v1, 64, (int32_t)&g1, v1, 0, 0, v3, 0, g26, g27, 0, v12, 0, 0);
    int32_t result = pm8x41_irq_mask_ack(64, v1, 64, (int32_t)&g1, v1, 0, 0, v3); // 0x8f645cd0
    char * v13 = g21;
    if (v2 == v13) {
        // 0x8f645ce8
        return pm8x41_reg_write(result & -0x10000 | 2069, 1, v3, (int32_t)v13, g26, g27, 0, v12, 0, 0, 0);
    }
    // 0x8f645ce4
    __stack_chk_fail();
    return result;
