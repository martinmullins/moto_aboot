...
// Address range: 0x8f60769c - 0x8f6076e7
int32_t SecHABTest(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    char * v1 = g40;
    int32_t v2 = (int32_t)v1;
    int32_t result = clock_ce_enable(1, a2, a3, v2, a1, v2, a3); // 0x8f6076b4
    char * v3 = g40;
    if (v1 == v3) {
        // 0x8f6076cc
        return (int32_t)mot_tzbsp_call(18, a1, 0, (int32_t)v3, g47, g48, g42, a5, 0, 0, 0, 0, 0);
    }
    // 0x8f6076c8
    __stack_chk_fail();
    return result;
