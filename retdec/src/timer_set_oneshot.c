...
// Address range: 0x8f61c28c - 0x8f61c2d7
int32_t timer_set_oneshot(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g20; // 0x8f61c28c
    g20 = &g10;
    int32_t v2 = a2; // 0x8f61c2b4
    if (a2 == 0) {
        // if_8f61c2a4_0_true
        v2 = 1;
        // branch -> after_if_8f61c2a4_0
    }
    int32_t v3 = g10;
    int32_t v4;
    int32_t result = timer_set(a1, v2, 0, a3, a4, a2, a3, v3, v1, g12, v4); // 0x8f61c2b4
    if (v3 != g10) {
        // 0x8f61c2c8
        __stack_chk_fail();
        // branch -> 0x8f61c2cc
