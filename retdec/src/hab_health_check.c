...
// Address range: 0x8f66dbd8 - 0x8f66dc7b
int32_t hab_health_check(int32_t a1, int32_t a2, int32_t a3) {
    // 0x8f66dbd8
    g31 = a1;
    g32 = a2;
    int32_t v1 = g36; // 0x8f66dbd8
    g36 = &g15;
    int32_t v2 = g15;
    int32_t v3 = hab_su_type(); // 0x8f66dbec
    g32 = 0;
    *(char *)&g23 = 0;
    *(char *)&g24 = 0;
    *(char *)&g25 = 0;
    ...
    *(int32_t *)(int32_t)&g29 = 0;
    ...
    int32_t v5 = hab_health_state_check(v3, 0, (int32_t)&g29); // 0x8f66dc28
    g31 = v5;
    g36 = v5;
    if (v5 == 240) {
        // 0x8f66dc38
    ...
    int32_t v6 = hab_su_type(); // 0x8f66dc3c
    g34 = v2;
    int32_t v7 = g15;
    g35 = v7;
    int32_t result = g36 % 256 | 256 * v6; // 0x8f66dc58
    g31 = result;
    if (v2 != v7) {
        // 0x8f66dc60
        __stack_chk_fail();
