...
// Address range: 0x8f635314 - 0x8f635423
int32_t kernel_log_find(char * str, char * a2, int32_t a3) {
    int32_t str4 = (int32_t)a2; // R5
    char * v1 = g23;
    int32_t v2 = (int32_t)g16; // R4
    int32_t len = strlen(str); // 0x8f635344
    int32_t v3 = v2; // 0x8f635348
    if (v3 == 0) {
        // 0x8f6353fc
        if (v1 != g23) {
            // 0x8f63540c
    ...
    int32_t result2;
    if (g15 != 0) {
        int32_t v4 = g15 - 1 + v3; // 0x8f635368
        char * v5 = (char *)v4; // 0x8f63536c_0
        int32_t v6 = (int32_t)*v5; // R8
        *v5 = 0;
        // branch -> 0x8f635374
        while (true) {
            int32_t str2 = v2; // 0x8f635374
            if (str2 != 0) {
                char * found_char_pos = strchr((char *)str2, 91); // 0x8f635384
                v2 = (int32_t)found_char_pos;
                if (found_char_pos != NULL) {
                    char * found_char_pos2 = strchr(found_char_pos, 93); // 0x8f635394
                    int32_t result = (int32_t)found_char_pos2; // 0x8f635394_4
                    if (found_char_pos2 == NULL) {
                        // 0x8f6353f0
                        // branch -> 0x8f6353f4
                    } else {
                        int32_t str3 = result + 2; // 0x8f6353a0
                        v2 = str3;
                        if (memcmp((char *)str3, (char *)(int32_t)str, len) == 0) {
                            // break -> 0x8f6353bc
                            break;
                        }
                        // continue -> 0x8f635374
        ...
        // 0x8f6353bc
        int32_t v7;
        strlcpy(str4, v2, a3, 0, v7);
        char * found_char_pos3 = strchr((char *)str4, 10); // 0x8f6353dc
