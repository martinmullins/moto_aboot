...
// Address range: 0x8f673cf8 - 0x8f673d6f
int32_t can_write_partition(int32_t a1, uint32_t a2, int32_t a3) {
    int32_t v1 = g47; // 0x8f673cf8
    char * v2 = g40;
    int32_t v3 = (int32_t)v2;
    int32_t v4 = partition_get_index(a1, a2, a3, v3, a1, v3); // 0x8f673d08
    int32_t v5 = partition_get_offset(v4, a2, a3) / 512 | 0x800000 * a2; // 0x8f673d18
    uint32_t v6 = a2 / 512; // 0x8f673d1c
    int32_t v7 = v5 | v6; // 0x8f673d1c
    int32_t v8 = v5 == v6;
    int32_t v9 = 0;
    if (v5 == v6 == v4 == -1) {
        int32_t v10 = generic_mmc_do_write_protect_test(v5, v7, a3, v8, a1, v3, a3, v1) == 1; // 0x8f673d4c
        v9 = v10;
        // branch -> 0x8f673d50
    }
    // 0x8f673d50
    g43 = v9;
    int32_t result; // 0x8f673d68_2
    if (v2 != g40) {
        // 0x8f673d60
        __stack_chk_fail();
        result = g43;
