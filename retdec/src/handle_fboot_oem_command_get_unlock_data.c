...
// Address range: 0x8f6249f0 - 0x8f624b53
int32_t handle_fboot_oem_command_get_unlock_data(void) {
    // 0x8f6249f0
    int32_t v1;
    int32_t str = v1; // bp-84
    int32_t v2; // bp-88
    int32_t v3 = &v2; // 0x8f6249f4_0
    int32_t v4 = 0; // R4
    v2 = 0;
    int32_t v5 = g31;
    int32_t v6; // R0
    int32_t v7; // 0x8f624b38_22
    if (is_gpe_product(g34, g35) == v4) {
        int32_t v8 = get_unlock_data(v3, g35, g36, v5, v2, v1, 0); // 0x8f624a30
        int32_t v9 = (int32_t)"System error, please reboot and try again!";
        if (v8 != 2) {
            // 0x8f624a3c
            if (v8 != 9) {
                int32_t v10 = v2; // 0x8f624a6c
                int32_t v11 = &str; // 0x8f624a70_0
                snprintf((char *)&str, 32, "%s", (char *)v10);
                fboot_info((int32_t)"INFO", v11, (int32_t)"%s", v10, v2, str, 0, 0, 0, 0, 0);
                int32_t v12 = v2 + 31; // 0x8f624a90
                snprintf((char *)&str, 32, "%s", (char *)v12);
                fboot_info((int32_t)"INFO", v11, (int32_t)"%s", v12, v2, str, 0, 0, 0, 0, 0);
                int32_t v13 = v2 + 62; // 0x8f624ab4
                snprintf((char *)&str, 32, "%s", (char *)v13);
                fboot_info((int32_t)"INFO", v11, (int32_t)"%s", v13, v2, str, 0, 0, 0, 0, 0);
                int32_t v14 = v2 + 93; // 0x8f624ad8
                snprintf((char *)&str, 32, "%s", (char *)v14);
                fboot_info((int32_t)"INFO", v11, (int32_t)"%s", v14, v2, str, 0, 0, 0, 0, 0);
                int32_t v15 = v2 + 124; // 0x8f624afc
                snprintf((char *)&str, 32, "%s", (char *)v15);
                fboot_info((int32_t)"INFO", v11, (int32_t)"%s", v15, v2, str, 0, 0, 0, 0, 0);
                free((char *)v2);
                // branch -> 0x8f624b20
                // 0x8f624b20
                if (v5 != g31) {
            ...
            v9 = (int32_t)"Failed to get unlock data, please try again!";
        }
        // 0x8f624a58
        fboot_info((int32_t)"INFO", v9, g36, v5, v2, v1, 0, 0, 0, 0, 0);
        v6 = 3;
        v7 = 3;
        // branch -> 0x8f624b20
    } else {
        // 0x8f624a18
        fboot_info((int32_t)"INFO", (int32_t)"This command is not needed to unlock.  Run fastboot oem unlock directly.", g36, v5, v2, v1, 0, 0, 0, 0, 0);
        v6 = v4;
        v7 = v4;
        // branch -> 0x8f624b20
    }
    // 0x8f624b20
    int32_t result; // 0x8f624b38_2
    if (v5 != g31) {
        // 0x8f624b30
        __stack_chk_fail();
        result = v6;
