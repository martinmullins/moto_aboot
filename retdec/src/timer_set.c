...
// Address range: 0x8f61c14c - 0x8f61c233
int32_t timer_set(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = a2; // R1
    int32_t v2 = g38; // 0x8f61c14c
    int32_t v3 = g39; // 0x8f61c14c
    int32_t v4 = g37; // 0x8f61c150
    g39 = &g30;
    g38 = a1;
    int32_t result = g30;
    int32_t v5 = *(int32_t *)(a1 + 4); // 0x8f61c170
    int32_t v6; // 0x8f61c198
    int32_t v7;
    int32_t v8;
    int32_t v9;
    int32_t v10; // 0x8f61c1b0
    int32_t v11; // 0x8f61c1d8
    int32_t v12; // 0x8f61c1ac
    if (v5 != 0) {
        // 0x8f61c200
        v1 = (int32_t)"timer %p already in list\n";
        _panic(g33, (int32_t)"timer %p already in list\n", a1, v5, v2, v3, g40);
        // branch -> 0x8f61c188
        // 0x8f61c188
        *(int32_t *)(g38 + 12) = get_schedule_abs_time(a2, v1);
        v6 = get_delay_abs_time(a3, v1, a1, v5);
        *(int32_t *)(g38 + 20) = v4;
        *(int32_t *)(g38 + 24) = v7;
        v8 = g21;
        v12 = &g21;
        ...
        *(int32_t *)(g38 + 16) = v6;
        if (v8 == 0) {
            // 0x8f61c1c4
            function_8f619448(v6);
            // branch -> 0x8f61c1c8
        }
        // 0x8f61c1c8
        insert_timer_in_queue(g38, v1, v10);
        v11 = g21 - 1;
        *(int32_t *)v12 = v11;
        v9 = g30;
        if (v11 == 0) {
    ...
    int32_t v13 = *(int32_t *)(a1 + 8); // 0x8f61c17c
    int32_t v14; // 0x8f61c18c
    if (v13 != 0) {
        // 0x8f61c200
        v1 = (int32_t)"timer %p already in list\n";
        a3 = a1;
    ...
    // 0x8f61c188
    *(int32_t *)(g38 + 12) = get_schedule_abs_time(a2, v14);
    v6 = get_delay_abs_time(a3, v1, a3, v13);
    *(int32_t *)(g38 + 20) = v4;
    *(int32_t *)(g38 + 24) = v7;
    v8 = g21;
    v12 = &g21;
