...
// Address range: 0x8f6522e8 - 0x8f652353
int32_t confession_gather(int32_t a1, int32_t a2) {
    // 0x8f6522e8
    g25 = a1;
    g26 = a2;
    int32_t v1 = g31; // 0x8f6522ec
    int32_t v2 = g32; // 0x8f6522ec
    int32_t v3 = g33; // 0x8f6522ec
    int32_t v4 = g22;
    g29 = v4;
    g32 = &g22;
    g31 = (int32_t)"SRK.CA614.wtls.crt";
    g33 = (int32_t)"SRK.CA614.wtls.crt";
    int32_t v5 = v4;
    if ((int32_t)"SRK.CA614.wtls.crt" - 8 != (int32_t)"SRK.CA614.wtls.crt") {
        int32_t v6 = (int32_t)"SRK.CA614.wtls.crt"; // 0x8f6523088
        int32_t v7 = (int32_t)"SRK.CA614.wtls.crt"; // 0x8f65231c
        while (true) {
            int32_t v8 = *(int32_t *)(v7 - 8); // 0x8f652310
            g30 = v8;
            int32_t v9 = v6; // 0x8f652308
            int32_t v10 = v7; // 0x8f652324
            if (v8 != 0) {
                int32_t v11 = *(int32_t *)(v7 - 4); // 0x8f65231c
                g25 = v11;
                g24 = -0x709adcdc;
                ((int32_t (*)(int32_t))v8)(v11);
                v9 = g33;
                v10 = g31;
                // branch -> 0x8f652324
            }
            int32_t v12 = v10 + 8; // 0x8f652324
            g31 = v12;
            if (v10 == v9) {
                // break -> 0x8f652304
                break;
