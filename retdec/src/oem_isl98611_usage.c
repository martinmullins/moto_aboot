...
// Address range: 0x8f640fe4 - 0x8f641083
int32_t oem_isl98611_usage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g12;
    int32_t v2;
    fboot_info((int32_t)"INFO", (int32_t)"usage: fastboot oem isl98611 [options]", a3, v1, a1, v1, g14, 0, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)&g1, a3, v1, a1, v1, g14, 0, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"options:", a3, v1, a1, v1, g14, 0, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  rd <reg>          read a register", a3, v1, a1, v1, g14, 0, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  wr <reg> <value>  write a register", a3, v1, a1, v1, g14, 0, v2, 0, 0);
    int32_t result2 = fboot_info((int32_t)"INFO", (int32_t)"  help              show usage", a3, v1, a1, v1, g14, 0, v2, 0, 0); // 0x8f641038
    if (v1 == g12) {
        int32_t result = fboot_info((int32_t)"INFO", (int32_t)&g1, v1, v1, g14, 0, v2, 0, 0, 0, 0); // 0x8f641060
        return result;
    }
    // 0x8f64104c
    __stack_chk_fail();
