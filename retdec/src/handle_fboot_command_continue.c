...
// Address range: 0x8f622270 - 0x8f622367
int32_t handle_fboot_command_continue(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = g23;
    int32_t v2;
    int32_t v3 = is_stick_to_fastboot_mode(print_log(1, (int32_t)"continue rebooting\n", a3, v1, a1, v1, a3, g29, g30, 0, v2, 0, 0), (int32_t)"continue rebooting\n", a3); // 0x8f62228c
    int32_t result;
    if (v3 == 0) {
        // 0x8f6222b8
        fboot_ack((int32_t)"OKAY", (int32_t)"Booting normally", a3, v1, a1, v1, a3, g29, g30, 0);
        int32_t v4 = mdelay(100, (int32_t)"Booting normally", a3, v1); // 0x8f6222c8
        int32_t v5 = clear_flash_fail(udc_stop(v4, (int32_t)"Booting normally", a3, v1, a1), (int32_t)"Booting normally", a3); // 0x8f6222d0
        int32_t v6 = stop(v5, (int32_t)"Booting normally", a3, (int32_t)&g3, a1, v1); // 0x8f6222dc
        stop_usb_detection(v6, (int32_t)"Booting normally", a3);
        backlight_set_brightness_level(100, (int32_t)"Booting normally");
        int32_t v7 = enable_cont_splash_screen(100, (int32_t)"Booting normally"); // 0x8f6222ec
        int32_t v8 = normal_mode(v3, (int32_t)"Booting normally", v7, (int32_t)&g3); // 0x8f6222f4
        int32_t v9 = g7;
        int32_t v10 = v9 + 1; // 0x8f622300
        g7 = v10;
        int32_t v11 = v8; // 0x8f622314
        if (v9 == 0) {
            // 0x8f622310
            v11 = function_8f619448(v8);
            // branch -> 0x8f622314
        }
        int32_t v12 = backlight_turn_off(v11, (int32_t)"Booting normally", (int32_t)&g7, v10, a1, v1); // 0x8f622314
        platform_uninit((char *)v12, (int32_t)"Booting normally", (int32_t)&g7, v10);
        reboot_device(g2, (int32_t)"Booting normally", (int32_t)&g7, v10, a1, v1, a3, g29, g30, 0);
        result = 1;
        // branch -> 0x8f622328
    } else {
        // 0x8f622298
        print_log(5, (int32_t)"Command not allowed", a3, v1, a1, v1, a3, g29, g30, 0, v2, 0, 0);
        fboot_info((int32_t)"INFO", (int32_t)"Command not allowed", a3, v1, a1, v1, a3, g29, g30, 0, v2);
        result = 3;
        // branch -> 0x8f622328
    }
    // 0x8f622328
