...
// Address range: 0x8f6435a8 - 0x8f6436c3
int32_t max17042_is_batt_temp_ok(void) {
    int32_t v1 = g33; // 0x8f6435a8
    int32_t v2 = g40; // 0x8f6435a8
    int32_t v3 = g41; // 0x8f6435a8
    int32_t v4 = g30;
    int32_t v5 = (int32_t)&g18; // R4
    int32_t v6;
    uint32_t v7 = max17042_get_battery_temperature((int32_t)&v6, g34, g38, v4, v1, v4, g38); // 0x8f6435c4
    int32_t v8 = 0x10000 * v6 / 0x10000; // 0x8f6435c8
    int32_t result; // 0x8f6436b0_2
    int32_t v9;
    char v10; // 0x8f643674
    if (v7 >= 0) {
        // 0x8f6435d4
        if (*(char *)&g18 < 4) {
            ...
            if (v8 <= g26) {
                ...
                *(char *)v5 = v11;
                ...
                // 0x8f643670
                v10 = *(char *)&g18;
                print_log(-1, (int32_t)"Temp %d Temp State %d\n", v8, (int32_t)v10, v1, v4, g38, v2, v3, g32, v9, 0, 0);
                g33 = ((int32_t)&g17 & 255) == 1 ? 1 : ((int32_t)&g17 & 255) == 2 ? 0 : (int32_t)&g17 & 255;
                if (v4 != g30) {
                    // 0x8f6436a8
                    __stack_chk_fail();
                    result = g33;
                    ...
                    result = ((int32_t)&g17 & 255) == 1 ? 1 : ((int32_t)&g17 & 255) == 2 ? 0 : (int32_t)&g17 & 255;
                }
                // 0x8f6436ac
                g40 = v2;
                g41 = v3;
