...
// Address range: 0x8f642b88 - 0x8f642c3b
int32_t isl98611_masked_write_reg(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g19;
    int32_t v2; // R0
    int32_t v3; // 0x8f642c2c_23
    if (g17 == 0) {
        // 0x8f642c10
        v2 = -3;
        v3 = -3;
        ...
        char v4 = *(char *)&g18; // 0x8f642bc4
        int32_t v5;
        int32_t v6;
        qup_i2c_read_byte(g17, (int32_t)v4, a1, (int32_t)&v6, a1, v1, a3, g25, g26, g27, g28, g29, g30, 0, v5);
        if (g17 > -1) {
            int32_t v7 = a3 & a2 | 0x1000000 * v6 / 0x1000000 & -1 - a2; // 0x8f642bf0
            char v8 = *(char *)&g18; // 0x8f642bf4
            v6 = 0x1000000 * v7 / 0x1000000;
            qup_i2c_write_byte(g17, (int32_t)v8, a1, v7, a1, v1, a3, g25, g26, g27, g28);
            if (g17 >= 0) {
                // 0x8f642c08
                // branch -> 0x8f642c14
                // 0x8f642c14
