...
// Address range: 0x8f657dec - 0x8f657e67
int32_t get_boot_seq(int32_t a1, int32_t a2, int32_t a3) {
    ...
    g38 = &g18;
    g18 = v1;
    int32_t strncmp_rc = strncmp(g7, "MBM_LOGGER", 16); // 0x8f657e14
    g34 = strncmp_rc;
    int32_t v3 = 0;
    if (strncmp_rc == 0) {
        // 0x8f657e24
        g34 = 2;
        int32_t v4 = *(int32_t *)(v1 + 16); // 0x8f657e2c
        int32_t v5;
        int32_t v6 = print_log(2, (int32_t)"boot seq = %d\n", v4, (int32_t)&g18, a1, v2, a3, g39, g40, g33, v5, 0, 0); // 0x8f657e30
        g34 = v6;
        v3 = *(int32_t *)(v1 + 16);
        // branch -> 0x8f657e38
    }
