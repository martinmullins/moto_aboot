...
// Address range: 0x8f6317c8 - 0x8f63188f
int32_t factory_kill_is_supported(char * a1, int32_t a2) {
    char * v1 = a1; // bp-24
    int32_t v2 = g36; // 0x8f6317cc
    int32_t v3 = g29 ? -0x709a9838 : 0; // 0x8f6317cc
    int32_t v4 = (int32_t)&v1;
    int32_t v5 = g27;
    int32_t v6 = (int32_t)&g20; // R4
    char v7 = *(char *)&g22; // 0x8f6317e4
    g36 = (int32_t)&g22;
    if (v7 == 0) {
        uint32_t v8 = get_device_setting_offset((int32_t)"factory_kill", (int32_t)v7, (int32_t)&g27, (int32_t)&g22, (int32_t)a1, v5, g34, g35); // 0x8f6317f8
        if (v8 >= 0) {
            int32_t v9 = get_int_prop((int32_t)"enabled", v8, v4, (int32_t)&g22, (int32_t)v1, v5, g34); // 0x8f63180c
            if (v9 == 0) {
                // 0x8f631818
                *(char *)v6 = (char)((int32_t)v1 == 1);
                // branch -> 0x8f63182c
            }
        }
        // 0x8f63182c
    ...
    int32_t v10 = (int32_t)"disabled"; // 0x8f631850
    if (*(char *)&g20 != 0) {
        // if_8f63184c_0_true
        v10 = (int32_t)"enabled";
        // branch -> after_if_8f63184c_0
    }
    // after_if_8f63184c_0
    int32_t v11;
    print_log(2, (int32_t)"Factory Kill is %s\n", v10, (int32_t)"enabled", (int32_t)v1, v5, g34, g35, v2, v3, v11, 0, 0);
    if (v5 != g27) {
        // 0x8f631868
        __stack_chk_fail();
        // branch -> 0x8f63186c
