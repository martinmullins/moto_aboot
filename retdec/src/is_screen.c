...
// Address range: 0x8f638c70 - 0x8f638cdb
int32_t is_screen(char * str) {
    int32_t v1 = g35;
    if (str == NULL) {
        // 0x8f638cb4
    ...
    int32_t result = g18; // R0
    int32_t v2; // 0x8f638ca8
    int32_t v3;
    if (g18 != 0) {
        uint32_t strncmp_rc = strncmp((char *)(g18 + 8), str, 32); // 0x8f638ca4
        v2 = strncmp_rc > 1 ? 0 : 1 - strncmp_rc;
        result = v2;
        v3 = g35;
        // branch -> 0x8f638cb8
    } else {
