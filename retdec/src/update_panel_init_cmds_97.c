...
// Address range: 0x8f6451b4 - 0x8f645263
int32_t update_panel_init_cmds_97(int32_t a1, int32_t a2) {
    int32_t v1 = a1; // bp-16
    int32_t v2 = g26;
    int32_t v3 = get_controller_drv_ver((int32_t)&v1, a2, g30, v2, a1); // 0x8f6451c8
    int32_t v4 = v3; // R0
    int32_t result; // 0x8f645244_2
    if (v3 != 0) {
        // 0x8f64522c
        if (v2 != g26) {
            // 0x8f64523c
    ...
    int32_t v5; // 0x8f645228
    int32_t v6; // 0x8f645244_26
    if (v1 > 67) {
        // 0x8f645200
        if (v1 <= 69) {
            // 0x8f645224
            *(int32_t *)&g16 = (int32_t)&g13;
            g17 = 10;
            v5 = strlcpy((int32_t)"qcom,mdss_dsi_mot_tianma_499_720p_video_v2", (int32_t)"qcom,mdss_dsi_mot_tianma_499_720p_video_v1", 64, (int32_t)&g14, v1);
            v4 = v5;
            v6 = v5;
            // branch -> 0x8f64522c
        } else {
        ...
        // 0x8f645224
        *(int32_t *)&g16 = (int32_t)&g12;
        g17 = 198;
        v5 = strlcpy((int32_t)"qcom,mdss_dsi_mot_tianma_499_720p_video_v2", (int32_t)"qcom,mdss_dsi_mot_tianma_499_720p_video_v0", 64, (int32_t)&g14, v1);
        v4 = v5;
        v6 = v5;
        // branch -> 0x8f64522c
    }
