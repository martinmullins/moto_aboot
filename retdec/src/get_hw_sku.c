...
// Address range: 0x8f63153c - 0x8f6315cb
int32_t get_hw_sku(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g15;
    int32_t v2 = g4;
    int32_t v3;
    int32_t result;
    if (v2 > -1) {
        int32_t v4 = get_string_prop((int32_t)"sku", v2, (int32_t)&g4, (int32_t)&g15, a1, v1, a3, g23); // 0x8f631578
        if (v4 == 0) {
            // 0x8f631588
            print_log(2, (int32_t)"Not found setting for %s\n", (int32_t)"sku", (int32_t)&g15, a1, v1, a3, g23, g24, g16, v3, 0, 0);
            result = 0;
            // branch -> 0x8f63159c
        } else {
            result = v4;
