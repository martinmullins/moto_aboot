...
// Address range: 0x8f61db1c - 0x8f61dc9f
int32_t is_fastboot_mode(int32_t a1, int32_t a2) {
    int32_t v1 = a2; // R1
    int32_t str;
    int32_t v2 = &str; // 0x8f61db20_0
    char * v3 = g21;
    int32_t v4 = (int32_t)v3; // R3
    int32_t v5 = keys_get_state(a1 & -0x10000 | 278, a2, g24); // 0x8f61db38
    int32_t v6; // 0x8f61dc00
    int32_t v7; // 0x8f61dbe8_0
    int32_t v8; // 0x8f61db70
    int32_t result; // 0x8f61db8c
    int32_t v9; // 0x8f61db98
    int32_t v10; // 0x8f61dbc0
    int32_t strcmp_rc; // 0x8f61dbd4
    int32_t v11; // 0x8f61dc00
    int32_t v12; // 0x8f61dc18
    int32_t v13; // 0x8f61dc2c
    int32_t v14; // R2
    int32_t result2; // R4
    int32_t result3; // R5
    int32_t str2;
    int32_t result4; // 0x8f61dc50
    if (v5 == 0) {
        // 0x8f61db70
        v8 = is_gpt_initialized(0, v1);
        result2 = v8;
        if (v8 == 0) {
            // 0x8f61db80
            fastboot_reason((int32_t)"Failed to initialize partition table", v1, g24);
            // branch -> 0x8f61dc4c
            // 0x8f61dc4c
            if (v3 != g21) {
                // 0x8f61dc60
        ...
        // 0x8f61db8c
        result = is_validation_enabled((char *)v8, v1, g24, v4);
        if (result != 0) {
            // 0x8f61db98
            v9 = validate_boot_components_version(result, v1, g24, v4, str, 0, 0, 0, 0);
            if (v9 != 0) {
                // if_8f61dba0_0_true
                *(char *)&g11 = 1;
                // branch -> 0x8f61dc10
                // 0x8f61dc10
                fastboot_reason((int32_t)"Invalid boot components' versions", v1, 1);
                // branch -> 0x8f61dc48
                // 0x8f61dc48
                // branch -> 0x8f61dc4c
                // 0x8f61dc4c
        ...
        v1 = v2;
        v14 = 17;
        v10 = __utag_gets_constprop_3_6((int32_t)"bootmode", v2, 17, v4, str, 0, 0, 0, 0, str2, 0, 0, 0);
        v6 = 0;
        if (v10 != 0) {
            // 0x8f61dbcc
            v1 = (int32_t)"fastboot";
            strcmp_rc = strcmp((char *)&str, "fastboot");
            if (strcmp_rc == 0) {
                // 0x8f61dbe0
                v7 = &str2;
                snprintf((char *)&str2, 63, "UTAG \"%s\" configured as fastboot", "bootmode");
                // branch -> 0x8f61dc40
                // 0x8f61dc40
                fastboot_reason(v7, 63, (int32_t)"UTAG \"%s\" configured as fastboot");
                // branch -> 0x8f61dc4c
                // 0x8f61dc4c
                if (v3 != g21) {
                    // 0x8f61dc60
        ...
        // 0x8f61dc00
        v11 = is_flash_fail(v6, v1, v14, v4);
        result3 = v11;
        if (v11 != 0) {
            // 0x8f61dc0c
            // branch -> 0x8f61dc10
            // 0x8f61dc10
            fastboot_reason((int32_t)"Last time flashing failed", v1, v14);
            // branch -> 0x8f61dc48
            // 0x8f61dc48
            // branch -> 0x8f61dc4c
            // 0x8f61dc4c
        ...
        // 0x8f61dc18
        v12 = check_reboot_mode(NULL, v1, v14, v4, str, 0, 0, 0, 0, str2, 0, 0);
        if (v12 == 0x77665500) {
            // if_8f61dc24_0_true
            // branch -> 0x8f61dc40
            // 0x8f61dc40
            fastboot_reason((int32_t)"Reboot mode set to fastboot", v1, v14);
            // branch -> 0x8f61dc4c
            // 0x8f61dc4c
            if (v3 != g21) {
                // 0x8f61dc60
        ...
        // 0x8f61dc2c
        v13 = check_reboot_mode((char *)v12, v1, v14, 0x77665500, str, 0, 0, 0, 0, str2, 0, 0);
        if (v13 == 0x7766550c) {
            // 0x8f61dc3c
            // branch -> 0x8f61dc40
            // 0x8f61dc40
            fastboot_reason((int32_t)"Exception happened in bootloader", v1, v14);
            result4 = result2;
            // branch -> 0x8f61dc4c
        } else {
            // 0x8f61dc48
    ...
    int32_t v15 = is_kpdpwr_n_asserted(v5, v1, g24); // 0x8f61db44
    if (v15 != 0) {
        // 0x8f61db58
        if (get_powerup_reason((char *)v15, v1, g24, v4, str, 0, 0, 0, 0, str2, 0, 0, 0, 0, 0, 0, 0) == 0x8000) {
            int32_t v16 = is_usb_attached(0x8000, v1); // 0x8f61db64
            if (v16 == 0) {
                // 0x8f61db80
                fastboot_reason((int32_t)"Volume down key pressed", v1, g24);
                // branch -> 0x8f61dc4c
                // 0x8f61dc4c
                if (v3 != g21) {
                    // 0x8f61dc60
