...
// Address range: 0x8f62d7e8 - 0x8f62d947
int32_t fboot_usb_read(int32_t a1, int32_t a2) {
    int32_t v1 = g41; // 0x8f62d7e8
    int32_t v2 = g42; // 0x8f62d7e8
    int32_t v3 = g43; // 0x8f62d7e8
    int32_t v4 = g44; // 0x8f62d7e8
    g42 = a1;
    g38 = a2;
    int32_t v5 = g32;
    int32_t v6 = g19;
    ...
    if (v6 == 2) {
        ...
        while (true) {
            ...
            // 0x8f62d82c
            *(int32_t *)g43 = a2 & -0x10000 | 0xea60;
            uint32_t v9 = g38; // 0x8f62d838
            g44 = v9 > 0x7fff ? 0x8000 : v9;
            int32_t v10 = g18;
            int32_t v11 = v10; // R1
            g45 = &g20;
            ...
            *(int32_t *)(v11 + 4) = g44;
            int32_t v12;
            int32_t v13;
            if (udc_request_queue(g20, (int32_t *)v11) < 0) {
                // if_8f62d864_0_true
                // branch -> 0x8f62d8b8
                // 0x8f62d8b8
                print_log(1, (int32_t)"usb_read() queue failed\n", v6, g40, v13, v12, 0, v5, 0, v1, v2, v3, v4);
                // branch -> 0x8f62d8f0
                // 0x8f62d8f0
                g19 = 2;
                // branch -> 0x8f62d900
            ...
            int32_t v14 = event_wait_timeout((int32_t)&g22, g17, v6, g40, v13, v12); // 0x8f62d878
            if (v14 == -13) {
                // 0x8f62d888
                udc_request_dequeue(g20, -13, v6);
                // branch -> 0x8f62d900
                // 0x8f62d900
                if (v5 != g32) {
                    // 0x8f62d914
            ...
            // 0x8f62d8a0
            if (g21 > -1) {
                int32_t v15 = *(int32_t *)(g18 + 4); // 0x8f62d8c4
                g41 += v15;
                g46 += v15;
                int32_t v16 = g38 - v15; // 0x8f62d8d4
                g38 = v16;
                if (v15 != g44) {
                    // break -> 0x8f62d8dc
                    break;
                ...
                // branch -> 0x8f62d8b8
                // 0x8f62d8b8
                print_log(1, (int32_t)"usb_read() transaction failed\n", v6, g40, v13, v12, 0, v5, 0, v1, v2, v3, v4);
                // branch -> 0x8f62d8f0
                // 0x8f62d8f0
                g19 = 2;
                // branch -> 0x8f62d900
