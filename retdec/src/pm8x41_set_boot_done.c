...
// Address range: 0x8f6453a0 - 0x8f6453eb
int32_t pm8x41_set_boot_done(int32_t a1) {
    int32_t v1 = g15;
    int32_t v2;
    uint32_t result = pm8x41_reg_read(a1 & -0x10000 | 0x1642, g18, g20, v1, a1, v1, g22, g16, v2, 0, 0); // 0x8f6453b4
    if (v1 == g15) {
        // 0x8f6453cc
        return pm8x41_reg_write(result & -0x10000 | 0x1642, result % 128 | 128, v1, v1, g22, g16, v2, 0, 0, 0, 0);
    }
    // 0x8f6453c8
    __stack_chk_fail();
    return result;
