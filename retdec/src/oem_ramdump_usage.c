...
// Address range: 0x8f625b90 - 0x8f625c6b
int32_t oem_ramdump_usage(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g4;
    int32_t v2;
    fboot_info((int32_t)"INFO", (int32_t)"usage: fastboot oem ramdump [options]", a3, v1, a1, v1, g10, 0, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)&g3, a3, v1, a1, v1, g10, 0, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"options:", a3, v1, a1, v1, g10, 0, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  (none given)        show status", a3, v1, a1, v1, g10, 0, v2, 0, 0);
    fboot_info((int32_t)"INFO", (int32_t)"  enable              enable RAM dumping", a3, v1, a1, v1, g10, 0, v2, 0, 0);
    int32_t v3 = fboot_info((int32_t)"INFO", (int32_t)"  disable             disable RAM dumping", a3, v1, a1, v1, g10, 0, v2, 0, 0); // 0x8f625be4
    if (sod_dump_to_sd(v3, (int32_t)"  disable             disable RAM dumping", a3, v1, a1, v1, g10, 0) == 0) {
        // 0x8f625bf4
        fboot_info((int32_t)"INFO", (int32_t)"  clear               clear existing RAM dumps", a3, v1, a1, v1, g10, 0, v2, 0, 0);
        fboot_info((int32_t)"INFO", (int32_t)"  pull [<all>|<name>] pull RAM dump files", a3, v1, a1, v1, g10, 0, v2, 0, 0);
        // branch -> 0x8f625c0c
    }
    int32_t result2 = fboot_info((int32_t)"INFO", (int32_t)"  help                usage", a3, v1, a1, v1, g10, 0, v2, 0, 0); // 0x8f625c14
    if (v1 == (int32_t)g4) {
        int32_t result = fboot_info((int32_t)"INFO", (int32_t)&g3, v1, v1, g10, 0, v2, 0, 0, 0, 0); // 0x8f625c3c
        return result;
    }
    // 0x8f625c28
    __stack_chk_fail();
