...
// Address range: 0x8f630a50 - 0x8f630acb
int32_t mbm_fdt_get_variant(int32_t a1) {
    int32_t v1 = g37; // 0x8f630a54
    int32_t v2 = g39; // 0x8f630a54
    int32_t v3 = g40; // 0x8f630a54
    int32_t v4 = g33;
    g40 = &g33;
    g39 = &g6;
    int32_t v5 = g6;
    ...
    if (v5 == -1) {
        // 0x8f630a74
        g37 = &g6;
        get_int_prop((int32_t)"dts_variant", g7);
        int32_t v7;
        print_log(1, (int32_t)"Read dts_variant: %x", g6, (int32_t)&g7, a1, v4, v1, v2, v3, g35, v7, 0, 0);
        result = g6;
        v6 = g33;
        // branch -> 0x8f630a98
    }
