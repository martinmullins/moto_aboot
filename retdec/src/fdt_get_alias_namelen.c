...
// Address range: 0x8f64c498 - 0x8f64c50b
int32_t fdt_get_alias_namelen(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = g12;
    int32_t v2;
    uint32_t v3 = fdt_path_offset(a1, (int32_t)"/aliases", a3, v1, v2, 0, 0, v1, 0, g16, g17, g18, g19); // 0x8f64c4bc
    int32_t result = 0;
    if (v3 >= 0) {
        // 0x8f64c4cc
        result = fdt_getprop_namelen((int32_t)a1, v3, a2, a3, 0, 0, 0, v1);
        // branch -> 0x8f64c4e8
    }
    // 0x8f64c4e8
    if (v1 != g12) {
