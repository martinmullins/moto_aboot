...
// Address range: 0x8f60cb64 - 0x8f60cbdf
int32_t clk_disable(int32_t a1, int32_t a2) {
    // 0x8f60cb64
    g27 = a1;
    g28 = a2;
    ...
    int32_t v2 = a1; // 0x8f60cbb4
    int32_t * v3; // 0x8f60cbb4_0
    switch (*(int32_t *)(a1 + 16)) {
        case 0: {
            // 0x8f60cbd4
            return g27;
            break;
        ...
        case 1: {
            int32_t v4 = *(int32_t *)(*(int32_t *)(a1 + 8) + 4); // 0x8f60cb98
            g30 = v4;
            if (v4 != 0) {
                // 0x8f60cba4
                g26 = -0x709f3458;
            ...
            // 0x8f60cba8
            g27 = clk_disable(clk_get_parent(a1, a2), a2);
            int32_t v5; // R4
            v2 = v5;
            // branch -> 0x8f60cbb4
            // 0x8f60cbb4
