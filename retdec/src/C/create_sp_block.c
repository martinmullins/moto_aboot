...
// Address range: 0x8f676a78 - 0x8f676aff
int32_t create_sp_block(int32_t a1, int32_t a2) {
    int32_t v1 = g22; // 0x8f676a78
    int32_t v2 = g23; // 0x8f676a78
    int32_t v3 = g24; // 0x8f676a78
    int32_t v4 = g25; // 0x8f676a78
    int32_t v5 = g26; // 0x8f676a78
    int32_t v6 = g17;
    char * mem = malloc(24); // 0x8f676a98
    int32_t result = (int32_t)mem; // 0x8f676a98_3
    if (mem == NULL) {
        // 0x8f676aa4
        int32_t v7;
        print_log(result, (int32_t)"%s: out of memory\n", (int32_t)"create_sp_block", v6, a1, v6, v1, v2, v3, v4, v5, 0, v7);
        // branch -> 0x8f676ad4
    } else {
        // 0x8f676ab4
        memset(mem, 0, 24);
