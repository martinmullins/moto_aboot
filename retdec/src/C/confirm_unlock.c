...
// Address range: 0x8f627020 - 0x8f6270d7
int32_t confirm_unlock(int32_t a1, int32_t a2) {
    int32_t v1 = g34; // 0x8f627020
    g34 = &g25;
    int32_t v2 = g25;
    int32_t v3;
    fboot_info((int32_t)"INFO", (int32_t)"Please select 'YES' on screen if you want to continue...", g32, v2, a1, v2, v1, 0, v3, 0, 0);
    event_init((int32_t)&g28, 0, 1, v2);
    show((int32_t)"unlock_screen", 1, 1, (int32_t)&g2, a1, v2, v1, 0, v3, 0, 0, 0, 0, 0, 0);
    event_wait((int32_t)&g28, 1);
    char v4 = *(char *)&g29; // 0x8f627070
    int32_t v5 = v4; // 0x8f627070
    int32_t result;
    if (v4 == 0) {
        // 0x8f62707c
        fboot_info((int32_t)"INFO", (int32_t)"Unlock canceled!\n", 1, v5, a1, v2, v1, 0, v3, 0, 0);
        result = 18;
        // branch -> 0x8f627098
    } else {
        // 0x8f62708c
        fboot_info((int32_t)"INFO", (int32_t)"Unlocking bootloader...\n", 1, v5, a1, v2, v1, 0, v3, 0, 0);
        result = 0;
        // branch -> 0x8f627098
    }
    // 0x8f627098
