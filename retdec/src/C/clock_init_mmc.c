...
// Address range: 0x8f6021b4 - 0x8f602253
int32_t clock_init_mmc(int32_t a1) {
    int32_t str;
    int32_t v1 = &str; // 0x8f6021c8_0
    snprintf((char *)&str, 64, "sdc%u_iface_clk", a1);
    int32_t v2;
    int32_t v3 = clk_get_set_enable(v1, 0, 1, a1, v2, 0, 0, str, 0, 0); // 0x8f6021ec
    int32_t result = v3; // R0
    int32_t v4 = 0; // 0x8f602238_22
    if (v3 != 0) {
        // 0x8f6021f8
        print_log(-1, (int32_t)"failed to set sdc1_iface_clk ret = %d\n", v1, a1, v2, 0, 0, str, 0, 0, 0, 0, 0);
        int32_t v5 = _panic(g24, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/acpuclock.c", 107, (int32_t)&g8, 0, 0); // 0x8f60221c
        result = v5;
        v4 = v5;
        // branch -> 0x8f602220
    }
