...
// Address range: 0x8f627640 - 0x8f627727
int32_t confirm_userdata_wipe(int32_t a1, int32_t a2) {
    int32_t v1 = (int32_t)&g7; // R4
    char v2 = *(char *)&g7; // 0x8f62764c
    int32_t v3 = g8;
    int32_t result; // R0
    if (v2 == 0) {
        // 0x8f62767c
        int32_t v4;
        fboot_info((int32_t)"INFO", (int32_t)"** IMPORTANT WARNING **", v3, (int32_t)&g8, a1, v3, g12, g13, g14, 0, v4);
        fboot_info((int32_t)"INFO", (int32_t)"=======================", v3, (int32_t)&g8, a1, v3, g12, g13, g14, 0, v4);
        fboot_info((int32_t)"INFO", (int32_t)"THIS ACTION WILL CAUSE YOU TO LOSE ALL PERSONAL DATA, INCLUDING CONTENT ON YOUR INTERNAL SD CARD!", v3, (int32_t)&g8, a1, v3, g12, g13, g14, 0, v4);
        fboot_info((int32_t)"INFO", (int32_t)&g5, v3, (int32_t)&g8, a1, v3, g12, g13, g14, 0, v4);
        fboot_info((int32_t)"INFO", (int32_t)"TO CONFIRM AND PROCEED, RUN THE SAME COMMAND AGAIN WITHIN %d SECONDS", 30, (int32_t)&g8, a1, v3, g12, g13, g14, 0, v4);
        *(char *)v1 = 1;
        int32_t v5 = timer_initialize((int32_t)&g6, (int32_t)"TO CONFIRM AND PROCEED, RUN THE SAME COMMAND AGAIN WITHIN %d SECONDS", 30, 1); // 0x8f6276c8
        timer_set_oneshot((int32_t)&g6, v5 & -0x10000 | 0x7530, (int32_t)&g1, v1, a1, v3, g12);
        result = v2;
        // branch -> 0x8f6276e4
    } else {
        // 0x8f627664
        timer_cancel((int32_t)&g6, a2, v3, (int32_t)&g8, a1, v3, g12, g13);
        result = 1;
        *(char *)v1 = 0;
        // branch -> 0x8f6276e4
    }
