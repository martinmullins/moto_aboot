...
// Address range: 0x8f61e278 - 0x8f61e2cb
int32_t charger_mode(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g15;
    int32_t v2;
    int32_t result = print_log(1, (int32_t)"Entering charging mode\n", a3, v1, a1, v1, g22, g16, v2, 0, 0, 0, 0); // 0x8f61e290
    *(char *)&g5 = 5;
    if (v1 == g15) {
        // 0x8f61e2b4
        return boot_linux_from_flash(result, (int32_t)"Entering charging mode\n", v1, v1, g22, g16, v2, 0, 0);
    }
    // 0x8f61e2b0
    __stack_chk_fail();
    return result;
