...
// Address range: 0x8f651d50 - 0x8f651db7
int32_t cmd_line_parse(int32_t a1, int32_t a2, int32_t a3) {
    // 0x8f651d50
    g27 = a1;
    g28 = a2;
    int32_t v1 = g34; // 0x8f651d50
    g34 = (int32_t)&g24;
    int32_t v2 = 0; // bp-20
    int32_t result = 0; // bp-16
    int32_t v3 = strtok_r_q_constprop_3(); // 0x8f651d6c
    if (v3 != 0) {
      lab_0x8f651d78:
        // 0x8f651d78
        cmd_token_append(&result, &v2, v3);
        // branch -> 0x8f651d84
    }
    // 0x8f651d84
    g27 = 0;
    int32_t v4 = strtok_r_q_constprop_3(); // 0x8f651d88
    if (v4 != 0) {
        v3 = v4;
        goto lab_0x8f651d78;
    }
