...
// Address range: 0x8f6232ac - 0x8f6233fb
int32_t cmd_multiflash_mmc_img(char * str, char * a2, int32_t a3, int32_t a4) {
    int32_t str2 = (int32_t)str;
    int32_t str3 = (int32_t)a2;
    int32_t v1 = &g28; // R7
    int32_t v2 = g37;
    int32_t v3 = g28;
    int32_t v4 = v3; // R3
    int32_t v5 = a3; // 0x8f62334c
    int32_t v6 = str3; // 0x8f623348
    int32_t v7;
    int32_t v8 = v7; // 0x8f623340
    int32_t v9; // 0x8f623354
    int32_t result; // R0
    int32_t v10; // 0x8f623368
    if (v3 != 0) {
        // 0x8f623340
        v4 = a4;
        v9 = multiflash_partition(str2, v6, v5, a4, v8, str3, a3, v2, g49, g50, g51, g52, g53, g54, g46, g43, v7, 0, 0, 0, 0);
        if (v9 == -1) {
            // 0x8f623360
            v10 = str2;
            print_log(0, (int32_t)"Failed to multiflash partition %s\n", v10, v4, v8, str3, a3, v2, g49, g50, g51, g52, g53);
            // branch -> 0x8f623378
            // 0x8f623378
            fboot_info((int32_t)"INFO", (int32_t)"Failed to write mmc", v10, v4, (int32_t)(char *)v8, str3, a3, v2, g49, g50, g51);
            result = 3;
            *(int32_t *)v1 = 0;
            // branch -> 0x8f6233b4
        } else {
            ...
            if (v7 != 0) {
                ...
                v4 = 0;
                *(int32_t *)v1 = 0;
                clear_flash_fail(v9, v6, v5);
                // branch -> 0x8f6233a0
            }
            // 0x8f6233a0
            print_log(1, (int32_t)"Succeeded to multiflash partition %s\n", str2, v4, v8, str3, a3, v2, g49, g50, g51, g52, g53);
            result = 1;
            // branch -> 0x8f6233b4
        }
        // 0x8f6233b4
    ...
    if (strcmp(str, "boot") != 0) {
        // 0x8f6232f0
        if (strcmp((char *)str2, "recovery") != 0) {
            // 0x8f623338
            *(int32_t *)v1 = 1;
            v5 = a3;
            v6 = str3;
    ...
    bool v11 = false; // 0x8f623314
    bool v12 = false; // 0x8f623314
    if (a4 == 0) {
        // if_8f623308_0_true
        v11 = a3 == 7;
        v12 = a3 < 7;
        // branch -> after_if_8f623308_0
    }
    // after_if_8f623308_0
    if (v11 || v12) {
        // after_if_8f623310_0.dec_label_pc_8f623378_crit_edge
        // branch -> 0x8f623378
        // 0x8f623378
        fboot_info((int32_t)"INFO", (int32_t)"multiflash buffer size too small", a3, v4, (int32_t)str, str3, a3, v2, g49, g50, g51);
        *(int32_t *)v1 = 0;
        // branch -> 0x8f6233b4
        // 0x8f6233b4
        if (v2 != g37) {
    ...
    // 0x8f623318
    if (memcmp((char *)str3, "ANDROID!", 8) != 0) {
        // if_8f62332c_0_true
        // branch -> 0x8f623378
        // 0x8f623378
        fboot_info((int32_t)"INFO", (int32_t)"Invalid boot image", 8, v4, (int32_t)str, str3, a3, v2, g49, g50, g51);
        *(int32_t *)v1 = 0;
        // branch -> 0x8f6233b4
        // 0x8f6233b4
        if (v2 != g37) {
