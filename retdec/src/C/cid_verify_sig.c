...
// Address range: 0x8f6624cc - 0x8f662563
char * cid_verify_sig(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = a2; // bp-28
    int32_t v2 = g15;
    memcpy((char *)&v1, (char *)&g4, 2);
    int32_t v3; // 0x8f66251c_0
    if (*(char *)&g12 == 0) {
        // 0x8f6624cc
        v3 = v1;
        // branch -> 0x8f66251c
    } else {
        uint16_t v4 = *(int16_t *)&g6; // 0x8f662510
        int32_t v5;
        int32_t v6 = hab_csf_check(a1, a2, (int32_t)v4, (int32_t)&g6, a1, v1, a3, v2, g25, g26, g27, g17, v5, 0, 0, 0, 0, 0, 0); // 0x8f662514
        int32_t v7 = 0x10000 * v6 / 0x10000; // 0x8f662518_0
        v1 = v7;
        v3 = v7;
        // branch -> 0x8f66251c
    }
