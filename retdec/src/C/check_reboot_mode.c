...
// Address range: 0x8f60dcc0 - 0x8f60dd73
int32_t check_reboot_mode(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = (int32_t)a1; // 0x8f60dcc0_0
    int32_t v2 = g13;
    char v3 = *(char *)&g8; // 0x8f60dcdc
    int32_t result; // R0
    int32_t v4;
    if (v3 == 0) {
        int32_t v5 = target_restart_reason_addr(v1, a2, (int32_t)&g13); // 0x8f60dcf0
        int32_t * v6 = (int32_t *)v5; // 0x8f60dcf8_0
        int32_t v7 = *v6; // 0x8f60dcf8
        int32_t v8 = v7; // R4
        int32_t v9 = print_log(1, (int32_t)"Reboot mode from IMEM: 0x%08X\n", v7, (int32_t)&g8, v1, v2, a3, g22, g23, g24, g25, g26, g27); // 0x8f60dd08
        *v6 = (int32_t)v3;
        int32_t v10 = is_reboot_bl_flag_set(v9, (int32_t)"Reboot mode from IMEM: 0x%08X\n", v7, (int32_t)&g8); // 0x8f60dd10
        if (v10 != 0) {
            int32_t v11 = print_log(1, (int32_t)"detect reboot_bl flag from extra_reset register\n", v7, (int32_t)&g8, v1, v2, a3, g22, g23, g24, g25, g26, g27); // 0x8f60dd24
            v8 = 0x77665500;
            clear_reboot_bl_flag(v11, (int32_t)"detect reboot_bl flag from extra_reset register\n", v7, (int32_t)&g8);
            // branch -> 0x8f60dd30
        }
        // 0x8f60dd30
        result = v8;
        *(int32_t *)(int32_t)&g7 = v8;
        *(char *)(int32_t)&g8 = 1;
        v4 = g13;
        // branch -> 0x8f60dd40
    } else {
