...
// Address range: 0x8f632654 - 0x8f6326f7
int32_t get_lcd_bias_setting(int32_t a1, int32_t * a2) {
    int32_t v1 = g34; // 0x8f632654
    int32_t v2 = g35; // 0x8f632654
    g34 = a1;
    g35 = &g22;
    int32_t v3 = (int32_t)a2; // R4
    int32_t v4 = g22;
    int32_t v5 = get_string_prop((int32_t)"chip", a1, g32, v4, a1, v4, g33, v1); // 0x8f632674
    *(int32_t *)v3 = v5;
    int32_t v6;
    if (v5 == 0) {
        // 0x8f632684
        print_log(1, (int32_t)"No chip setting for lcd_bias\n", g32, v4, a1, v4, g33, v1, v2, g28, v6, 0, 0);
        // branch -> 0x8f6326c8
        // 0x8f6326c8
        if (v4 != g22) {
            // 0x8f6326d8
    ...
    int32_t v7 = get_int_prop((int32_t)"address", g34, v3 + 4, v4, a1, v4, g33); // 0x8f6326a4
    int32_t result = v7; // R0
    int32_t v8; // 0x8f6326e0_22
    if (v7 != -1) {
        int32_t v9 = *(int32_t *)(v3 + 4); // 0x8f6326bc
        print_log(2, (int32_t)"get prop %s: 0x%x\n", (int32_t)"address", v9, a1, v4, g33, v1, v2, g28, v6, 0, 0);
        result = 0;
        v8 = 0;
        // branch -> 0x8f6326c8
    } else {
