...
// Address range: 0x8f645348 - 0x8f64539f
int32_t pm8x41_masked_reg_write(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = g34; // 0x8f645348
    int32_t v2 = g35; // 0x8f645348
    g34 = a2;
    g35 = &g25;
    int32_t v3 = g25;
    int32_t v4 = pm8x41_reg_read(a1, a2, a3, v3, a1, v3, a3, v1, v2, g36, g37); // 0x8f645364
    g32 = v3;
    int32_t v5 = g34; // 0x8f645374
    uint32_t result = v4 & -1 - v5; // 0x8f645374
    if (v3 != g25) {
        // 0x8f645380
        __stack_chk_fail();
        return result;
    ...
    // 0x8f645384
    g31 = a3 & v5 | result % 256;
    g34 = v1;
    g35 = v2;
    return pm8x41_reg_write(a1);
}
