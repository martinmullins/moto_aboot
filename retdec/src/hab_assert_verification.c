...
// Address range: 0x8f66de4c - 0x8f66dee7
int32_t hab_assert_verification(int32_t a1, int32_t a2, int32_t a3) {
    uint32_t v1 = a2 + a1; // 0x8f66de54
    int32_t v2 = g38;
    int32_t v3; // 0x8f66dea8
    int32_t v4; // 0x8f66decc
    int32_t result; // 0x8f66dec0
    if (v1 < 0x8001) {
        v4 = a1;
      lab_0x8f66decc:
        // 0x8f66decc
        v3 = hab_su_type(v4, v1);
        // branch -> 0x8f66dea8
        // 0x8f66dea8
        result = 240 | 256 * hab_su_type(v3, v1);
        if (v2 != g38) {
            goto lab_0x8f66dec8_3;
        }
        // 0x8f66ded8
        return result;
    }
    int32_t v5 = &g41; // 0x8f66de98
    // branch -> 0x8f66de74
    while (true) {
        uint32_t v6 = *(int32_t *)v5; // 0x8f66de74
        if (v6 != 0) {
            // 0x8f66de80
            if (v6 <= a1) {
                // 0x8f66de88
                if (*(int32_t *)(v5 + 4) + v6 < v1) {
                    // 0x8f66decc
                    v3 = hab_su_type(a1, v1);
                    // branch -> 0x8f66dea8
                    // 0x8f66dea8
                    result = 240 | 256 * hab_su_type(v3, v1);
                    if (v2 == g38) {
        ...
        // 0x8f66dea8
        result = 85 | 256 * hab_su_type(a1, v1);
        if (v2 != g38) {
            goto lab_0x8f66dec8_3;
        }
        // 0x8f66ded8
