...
// Address range: 0x8f6431fc - 0x8f6432ef
int32_t max17050_init(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    int32_t v1 = a2; // bp-28
    int32_t v2 = a3; // bp-24
    int32_t v3 = g31 ? -0x709c0700 : 0; // 0x8f6431fc
    int32_t v4 = g29;
    int32_t v5; // R0
    int32_t result; // 0x8f6432c8_2
    int32_t v6; // 0x8f6432c8_25
    if (g9 == 0) {
        int32_t v7 = get_battery_offset_by_type((int32_t)"max17050", a2, 0, (int32_t)&g29); // 0x8f64322c
        int32_t v8;
        if (v7 > -1) {
            int32_t v9 = get_int_prop((int32_t)"blsp", v7, (int32_t)&v1, (int32_t)&g29, a1, a2, a3); // 0x8f64325c
            if (v9 == 0) {
                int32_t v10 = get_int_prop((int32_t)"qup", v7, (int32_t)&v2, (int32_t)&g29, a1, v1, a3); // 0x8f643274
                if (v10 != 0) {
                    // 0x8f643268
                    // branch -> 0x8f643238
                    // 0x8f643238
                    print_log(-1, (int32_t)"DT settings for \"%s\" missing or incomplete\n", (int32_t)"max17050", (int32_t)&g29, a1, v1, v2, v4, g37, g38, g39, v3, v8);
                    // branch -> 0x8f6432b0
                    // 0x8f6432b0
                    if (v4 != g29) {
                        // 0x8f6432c0
                ...
                int32_t v11 = v1; // 0x8f643280_0
                int32_t v12 = v2; // 0x8f643284_0
                int32_t v13 = qup_blsp_i2c_init(0x1000000 * v11 / 0x1000000, 0x1000000 * v12 / 0x1000000, 0x61a80, 0x124f800, a1, v11, v12, v4, g37, g38, g39, v3, v8, 0, 0, 0, 0); // 0x8f643290
                *(int32_t *)(int32_t)&g9 = v13;
                if (v13 == 0) {
                    // 0x8f6432a0
                    print_log(-1, (int32_t)"Failed initializing I2C to MAX17050\n", 0x61a80, 0x124f800, a1, v1, v2, v4, g37, g38, g39, v3, v8);
                    v5 = -20;
                    v6 = -20;
                    // branch -> 0x8f6432b0
                } else {
        ...
        // 0x8f643238
        print_log(-1, (int32_t)"DT settings for \"%s\" missing or incomplete\n", (int32_t)"max17050", (int32_t)&g29, a1, v1, a3, v4, g37, g38, g39, v3, v8);
        v5 = -1;
        v6 = -1;
        // branch -> 0x8f6432b0
    } else {
