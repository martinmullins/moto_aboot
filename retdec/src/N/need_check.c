...
// Address range: 0x8f63a590 - 0x8f63a5f7
int32_t need_check(char * a1, int32_t a2, int32_t a3) {
    // 0x8f63a590
    g32 = a2;
    int32_t v1 = (int32_t)a1; // R4
    int32_t v2 = g28;
    int32_t v3 = is_validation_enabled(a1, a2, a3, v2); // 0x8f63a5a4
    int32_t result = 0;
    if (v1 <= 12) {
        int32_t v4 = 8 * v1; // 0x8f63a5c0
        int32_t v5 = v4 + (int32_t)&g9;
        if (v3 != 0) {
            // if_8f63a5bc_0_true
            v5 = v4 + (int32_t)&g9 + 4;
            // branch -> after_if_8f63a5c4_0
        }
        // after_if_8f63a5c4_0
        result = *(int32_t *)v5 == 1;
        // branch -> 0x8f63a5d4
