...
// Address range: 0x8f61e388 - 0x8f61e413
int32_t normal_mode(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g33;
    int32_t v2;
    int32_t result = print_log(1, (int32_t)"Entering normal Android mode\n", a3, v1, a1, v1, g39, g35, v2, 0, 0, 0, 0); // 0x8f61e3a0
    if (*(char *)&g14 == 0) {
        // 0x8f61e3d8
        *(char *)&g5 = 0;
        if (v1 == g33) {
            // 0x8f61e3f4
            return boot_linux_from_flash(result, (int32_t)"Entering normal Android mode\n", v1, v1, g39, g35, v2, 0, 0);
        }
    } else {
        // 0x8f61e3b4
        if (v1 == g33) {
            // 0x8f61e3c4
            return print_log(5, (int32_t)"Sticky to fastboot mode", v1, v1, g39, g35, v2, 0, 0, 0, 0, 0, 0);
        }
    }
    // 0x8f61e3f0
    __stack_chk_fail();
