...
// Address range: 0x8f63ad84 - 0x8f63ae1b
int32_t start_21(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    // 0x8f63ad84
    g36 = &g28;
    int32_t v1 = 0; // bp-20
    int32_t v2 = display_set_orientation(0, a2, a3); // 0x8f63ada4
    set_logger_ops(2, (int32_t)&v1, v2);
    int32_t v3 = set_logger_status(2, 1, v2); // 0x8f63adbc
    int32_t v4 = get_log_area_lines(2, 1, v3); // 0x8f63adc0
    set_logger_capacity(2, v4, v3, (int32_t)&g2);
    *(char *)&g16 = 1;
    int32_t result = set_content_to_show(-0x7fffea01, v4, start_23(2, v4, 1), 0x65726373); // 0x8f63adec
    // 0x8f63ae04
    return result;
}
