...
// Address range: 0x8f6008c0 - 0x8f60095f
int32_t shutdown_device(void) {
    int32_t v1 = g22; // 0x8f6008c0
    g22 = &g16;
    int32_t v2 = g16;
    int32_t v3;
    int32_t v4;
    print_log(-1, (int32_t)"Going down for shutdown.\n", g20, v2, v4, 0, 0, v2, 0, v1, g23, g17, v3);
    int32_t v5 = pm8x41_reset_configure(4, (int32_t)"Going down for shutdown.\n", g20, v2, v4, 0); // 0x8f6008e8
    *(int32_t *)0x4ab000 = 0;
    mdelay(v5 & -0x10000 | 0x1388, (int32_t)"Going down for shutdown.\n", 0);
    print_log(-1, (int32_t)"shutdown failed\n", 0, 0x4ab000, v4, 0, 0, v2, 0, v1, g23, g17, v3);
    int32_t result = _panic(g17, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"target/msm8916/init.c", (int32_t)&g7 & -0x10000 | 369, (int32_t)&g7, 0, 0); // 0x8f600924
    if (v2 != g16) {
        // 0x8f600938
        __stack_chk_fail();
        // branch -> 0x8f60093c
