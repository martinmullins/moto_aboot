...
// Address range: 0x8f677d10 - 0x8f677dd7
int32_t speedo_find(void) {
    int32_t v1 = g17;
    int32_t v2 = &g1; // R5
    int32_t v3 = g1;
    ...
    if (v3 == 0) {
        // 0x8f677d40
        function_8f619448(g18);
        // branch -> 0x8f677d44
    }
    int32_t result = g16; // R4
    int32_t v4; // 0x8f677d94
    if (g16 == (int32_t)&g15) {
        // 0x8f677d90
        v4 = g1 - 1;
        result = v4;
    ...
    int32_t v5 = g16; // 0x8f677d58
    while (true) {
        g19 = g18;
        if (strncmp((char *)(v5 + 8), (char *)g18, 32) == 0) {
            int32_t v6 = g1 - 1; // 0x8f677d74
            *(int32_t *)v2 = v6;
            if (v6 != 0) {
                // 0x8f677dac
                // branch -> 0x8f677db0
            ...
            int32_t v7 = *(int32_t *)(result + 4); // 0x8f677d88
            result = v7;
            if (v7 == (int32_t)&g15) {
                // break -> 0x8f677d90
                break;
