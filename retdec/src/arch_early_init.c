...
// Address range: 0x8f6190e8 - 0x8f61916b
int32_t arch_early_init(void) {
    int32_t v1 = g28 ? -0x709af928 : 0; // 0x8f6190ec
    int32_t v2 = g25;
    int32_t v3;
    int32_t v4 = function_8f6191cc(3, g30, g32, v2, g29, v2, g32, v1, v3, 0, 0, 0, 0, 0, 0, 0, 0); // 0x8f6190fc
    arm_mmu_init(v4, g30, g32);
    int32_t result = function_8f619234(3, g30, g32, (int32_t)&g1, g29, v2, g32, v1, v3); // 0x8f619110
    if (v2 != g25) {
        // 0x8f619158
        __stack_chk_fail();
        // branch -> 0x8f61915c
