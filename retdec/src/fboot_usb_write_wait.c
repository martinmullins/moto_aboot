...
// Address range: 0x8f62db60 - 0x8f62dc1b
int32_t fboot_usb_write_wait(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g28 ? -0x709af928 : 0; // 0x8f62db60
    int32_t v2 = g25;
    int32_t v3 = g7;
    int32_t result = event_wait_timeout((int32_t)&g15, v3, a3, (int32_t)&g7, a1, v2); // 0x8f62db7c
    int32_t v4;
    if (result == -13) {
        // 0x8f62db8c
        udc_request_dequeue(g8, v3, a3, (int32_t)&g8, a1, v2, a3, g34, g35, v1, v4, 0, 0, 0, 0);
        // branch -> 0x8f62dbdc
        // 0x8f62dbdc
        if (v2 != g25) {
            // 0x8f62dbec
    ...
    // 0x8f62dba0
    int32_t result2; // 0x8f62dbb4
    if (g12 > -1) {
        // if_8f62dbac_0_true
        result2 = *(int32_t *)(g9 + 4);
        // branch -> 0x8f62dbdc
    } else {
        // 0x8f62dbbc
        print_log(1, (int32_t)"%s: transaction failed\n", (int32_t)"fboot_usb_write_wait", g12, a1, v2, a3, g34, g35, v1, v4, 0, 0);
        g10 = 2;
        result2 = -1;
        // branch -> 0x8f62dbdc
    }
