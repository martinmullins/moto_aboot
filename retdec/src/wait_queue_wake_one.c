...
// Address range: 0x8f61bd10 - 0x8f61bdbf
int32_t wait_queue_wake_one(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g31;
    int32_t v2 = list_remove_head(a1 + 4, a2); // 0x8f61bd34
    if (v2 == 0) {
        // 0x8f61bd9c
        int32_t result; // 0x8f61bdb4_2
        if (v1 != g31) {
            // 0x8f61bdac
            __stack_chk_fail();
            result = v2;
    ...
    int32_t result2 = v2 - 12; // 0x8f61bd40
    if (v2 == 12) {
        // branch -> 0x8f61bd9c
    } else {
        int32_t * v3 = (int32_t *)(a1 + 12); // 0x8f61bd4c_0
        int32_t v4 = 0; // R2
        *v3 = *v3 - 1;
        *(int32_t *)(result2 + 40) = a3;
        *(char *)(result2 + 24) = 1;
        *(int32_t *)(result2 + 36) = v4;
        if (a2 != 0) {
            // 0x8f61bd74
            v4 = &g33;
            int32_t v5 = g33;
            *(char *)(v5 + 24) = 1;
            insert_in_run_queue_head(v5, a2, v4);
            // branch -> 0x8f61bd84
        }
        int32_t v6 = insert_in_run_queue_head(result2, a2, v4); // 0x8f61bd88
        if (a2 != 0) {
            // 0x8f61bd94
            thread_resched(v6, a2, v4, 1, a1, v1, g42, g43, g44, g45, g46, g37);
            // branch -> 0x8f61bd98
        }
        // 0x8f61bd98
        result2 = 1;
