...
// Address range: 0x8f60740c - 0x8f60745f
int32_t SecLockFuse(void) {
    int32_t v1 = g31 ? -0x709c0700 : 0; // 0x8f60740c
    int32_t v2 = g29;
    int32_t v3;
    char * v4 = mot_tzbsp_call(3, 0, 0, v2, g32, v2, g37, v1, v3, 0, 0, 0, 0); // 0x8f607428
    int32_t result = (int32_t)v4; // 0x8f607428_14
    if (v4 != NULL) {
        // 0x8f607434
        clock_ce_disable(1, 0, 0, v2, g32, v2, g37, v1, v3);
        result = 16;
        // branch -> 0x8f607440
    }
    // 0x8f607440
