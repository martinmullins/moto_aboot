...
// Address range: 0x8f647994 - 0x8f647a27
int32_t smb1359_config_aicl(int32_t a1) {
    // 0x8f647994
    int32_t v1; // R4
    int32_t v2; // 0x8f6479bc
    int32_t v3; // 0x8f6479b8
    if (a1 == 0) {
        // if_8f6479a8_0_true.critedge
        v1 = 0;
        v3 = g28;
        v2 = 0;
        // branch -> after_if_8f6479a8_0
    } else {
        // if_8f6479a0_0_true
        v1 = 4;
        v3 = g28;
    ...
    // after_if_8f6479a8_0
    int32_t v4;
    int32_t v5 = smb1359_masked_write_reg(11, 4, v2, (int32_t)&g28, a1, v3, g36, g38, g39, g30, v4, 0); // 0x8f6479c0
    if (v5 < 0) {
        // if_8f6479c8_0_true
        // branch -> 0x8f6479f8
        // 0x8f6479f8
        print_log(-1, (int32_t)"DCIN AICL configuration failed %d\n", v5, (int32_t)&g28, a1, v3, g36, g38, g39, g30, v4, 0, 0);
        // branch -> 0x8f647a00
        // 0x8f647a00
        if (v3 != g28) {
            // 0x8f647a10
    ...
    int32_t v6 = smb1359_masked_write_reg(13, 4, v1, (int32_t)&g28, a1, v3, g36, g38, g39, g30, v4, 0); // 0x8f6479e0
    int32_t result;
    if (v6 <= 0xffffffff) {
        // 0x8f6479f0
        // branch -> 0x8f6479f8
        // 0x8f6479f8
        print_log(-1, (int32_t)"USBIN AICL configuration failed %d\n", v6, (int32_t)&g28, a1, v3, g36, g38, g39, g30, v4, 0, 0);
        result = 0;
        // branch -> 0x8f647a00
    } else {
        result = 1;
