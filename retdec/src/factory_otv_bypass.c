...
// Address range: 0x8f631890 - 0x8f63192b
int32_t factory_otv_bypass(int32_t a1, int32_t a2) {
    // 0x8f631890
    int32_t v1; // bp-16
    int32_t v2 = &v1; // 0x8f631894_1
    int32_t v3 = g38;
    v1 = -1;
    int32_t v4 = g12;
    int32_t v5;
    if (v4 < 0) {
        int32_t v6 = &g12; // 0x8f6318e0
        // branch -> 0x8f6318e0
        // 0x8f6318e0
        print_log(1, (int32_t)"Fail to check if bypass\n", v6, (int32_t)&g38, -1, v3, g47, g43, v5, 0, 0, 0, 0);
        // branch -> 0x8f6318fc
        // 0x8f6318fc
        if (v3 != g38) {
            // 0x8f63190c
    ...
    int32_t v7 = get_int_prop((int32_t)"factory_otv_bypass", v4, v2, (int32_t)&g38, -1, v3, g47); // 0x8f6318cc
    int32_t result;
    if (v7 == 0) {
        // 0x8f6318ec
        result = v1 == 1;
        ...
        // branch -> 0x8f6318e0
        // 0x8f6318e0
        print_log(2, (int32_t)"didn't find setting for bypass\n", v2, (int32_t)&g38, v1, v3, g47, g43, v5, 0, 0, 0, 0);
        result = 0;
        // branch -> 0x8f6318fc
    }
    // 0x8f6318fc
