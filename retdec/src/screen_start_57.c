...
// Address range: 0x8f63f5b4 - 0x8f63f643
int32_t screen_start_57(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = g26; // 0x8f63f5b8
    int32_t v2 = g27; // 0x8f63f5b8
    int32_t v3 = g22; // 0x8f63f5b8
    int32_t v4 = g15;
    *(char *)&g8 = 0;
    *(char *)&g7 = 1;
    char v5 = *(char *)&g9; // 0x8f63f5e4
    if (v5 == 0) {
        int32_t result = get_current_panel(a1, 0, (int32_t)v5, (int32_t)&g15, a1, v4, v1, v2, g28, v3, a5); // 0x8f63f5f0
        return result;
    }
    // 0x8f63f620
    g26 = v1;
    g27 = v2;
    g22 = v3;
    return set_content_to_show_55(-0x7ffffffb, 0, v4, v4, v1);
}
