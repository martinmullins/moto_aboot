...
// Address range: 0x8f670e70 - 0x8f670ef7
int32_t mp_compare(int32_t a1, int32_t a2, int32_t a3) {
    uint16_t v1 = *(int16_t *)(a1 + 4); // 0x8f670e7c
    int32_t v2 = 4 * (int32_t)v1 - 4; // 0x8f670e8c
    int32_t v3 = v1; // 0x8f670ec8
    int32_t v4 = 0; // 0x8f670eb4
    // branch -> 0x8f670e9c
    while (true) {
        uint32_t v5 = *(int32_t *)(v4 + v2 + a2); // 0x8f670e9c
        uint32_t v6 = *(int32_t *)(v4 + v2 + a3); // 0x8f670ea0
        if (v5 < v6) {
            // 0x8f670ec8
            // branch -> 0x8f670eec
            // 0x8f670eec
        ...
        int32_t v7 = (v3 + 0xffff) % 0x10000; // 0x8f670eb8
        if (v7 == 0) {
            // break -> 0x8f670eec
            break;
        }
