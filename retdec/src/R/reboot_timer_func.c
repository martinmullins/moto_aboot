...
// Address range: 0x8f639e10 - 0x8f639e6b
int32_t reboot_timer_func(int32_t a1, int32_t a2, char * a3) {
    int32_t v1 = g35;
    int32_t v2 = g30 - 1; // 0x8f639e2c
    g30 = v2;
    int32_t v3 = v1;
    if (v2 <= 0) {
        int32_t v4 = g52 ? -0x709c73b8 : 0; // 0x8f639e14
        int32_t v5;
        reboot_device(a3, v2, (int32_t)a3, (int32_t)&g35, a1, v1, g57, v4, v5, 0);
        v3 = g35;
        // branch -> 0x8f639e44
    }
    // 0x8f639e44
