...
// Address range: 0x8f6620f8 - 0x8f66219b
int32_t regex_match(char * regex, char * str) {
    int32_t v1 = g15;
    int32_t preg;
    int32_t result;
    if (regcomp((struct re_pattern_buffer *)&preg, regex, 13) == 0) {
        int32_t v2 = regexec((struct re_pattern_buffer *)&preg, (char *)(int32_t)str, 0, {
        ...
        // 0x8f66212c
        int32_t v3;
        print_log(-1, (int32_t)"ERROR: could not compile regex: %s\n", (int32_t)regex, v1, v3, 0, 0, preg, 0, 0, 0, v1, 0);
        result = 0;
        // branch -> 0x8f662178
    }
    // 0x8f662178
