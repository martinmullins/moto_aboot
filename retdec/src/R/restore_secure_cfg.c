...
// Address range: 0x8f616c34 - 0x8f616d5b
char * restore_secure_cfg(int32_t a1, int32_t a2) {
    int32_t v1 = *(int32_t *)-0x708eed0c; // 0x8f616c4c
    int32_t v2;
    int32_t v3 = &v2; // 0x8f616c6c_0
    int32_t v4 = 64; // R2
    memset((char *)&v2, 0, 64);
    int32_t v5;
    if (*(char *)-0x70947380 == 1) {
        // 0x8f616d0c
        v2 = 0x2000c02;
        scm_call2(v3, 0, v4, v3, g48, g45);
        // branch -> 0x8f616d18
        // 0x8f616d18
        print_log(-1, -0x7097f408, v4, v3, g48, g45, v5, 0, 0, 0, 0, 0, 0);
        // branch -> 0x8f616d30
        // 0x8f616d30
    ...
    int32_t v6 = &a1; // 0x8f616ca0_0
    int32_t v7 = scm_call((char *)12, 2, v6, 8, 0); // 0x8f616cc4
    int32_t v8;
    if (v7 != 0) {
        // 0x8f616d18
        print_log(-1, -0x7097f408, v6, v7, g48, g45, v5, 0, 0, 0, 0, 0, 0);
        v8 = 1;
        // branch -> 0x8f616d30
    } else {
        v8 = 0;
