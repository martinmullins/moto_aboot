...
// Address range: 0x8f634ce4 - 0x8f634d97
int32_t register_usb_connection_callback(char * a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = (int32_t)a1; // 0x8f634ce4_0
    int32_t v2 = g33;
    usb_detection_init(v1, a2, a3, v2, v1, v2);
    char * mem = malloc(12); // 0x8f634d00
    int32_t result2 = (int32_t)mem; // 0x8f634d00_3
    if (mem == NULL) {
        // 0x8f634d0c
        if (v2 == g33) {
            // 0x8f634d1c
            return print_log(-1, (int32_t)"failed to allocate memory for usb connection event\n", v2, v2, g55, g56, g57, g48, a5, 0, 0, 0, 0);
        }
    } else {
        // 0x8f634d30
        print_log(2, (int32_t)"register callback %p\n", v1, v2, v1, v2, g55, g56, g57, g48, a5, 0, 0);
        *(int32_t *)(result2 + 8) = v1;
        int32_t v3 = mutex_acquire((int32_t)&g24, (int32_t)"register callback %p\n", v1, v2, v1, v2, g55, g56, g57, g48, a5); // 0x8f634d48
        result2 = v3;
        int32_t v4 = &g25; // R3
        int32_t v5 = g25;
        g25 = result2;
        *(int32_t *)result2 = v5;
        *(int32_t *)(result2 + 4) = v4;
        *(int32_t *)(v5 + 4) = result2;
        if (v2 == g33) {
            int32_t result = mutex_release((int32_t)&g24, (int32_t)"register callback %p\n", v2, v2, g55, g56, g57); // 0x8f634d80
            return result;
        }
    }
    // 0x8f634d70
