...
// Address range: 0x8f61e174 - 0x8f61e1c7
int32_t recovery_mode(int32_t a1, int32_t a2, int32_t a3) {
    int32_t v1 = g25;
    int32_t v2;
    int32_t result = print_log(1, (int32_t)"Entering recovery mode\n", a3, v1, a1, v1, g31, g26, v2, 0, 0, 0, 0); // 0x8f61e18c
    *(char *)&g7 = 1;
    if (v1 == g25) {
        // 0x8f61e1b0
        return boot_linux_from_flash(result, (int32_t)"Entering recovery mode\n", v1, v1, g31, g26, v2, 0, 0);
    }
    // 0x8f61e1ac
    __stack_chk_fail();
    return result;
