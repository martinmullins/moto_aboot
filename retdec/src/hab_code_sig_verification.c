...
// Address range: 0x8f66cd00 - 0x8f66cdc3
int32_t hab_code_sig_verification(int32_t a1, int32_t a2, int32_t a3, uint32_t a4) {
    // 0x8f66cd00
    g62 = a2;
    g64 = a3;
    ...
    int32_t v2 = g49;
    g63 = &g49;
    int32_t v3; // 0x8f66cd78
    int32_t v4; // 0x8f66cd6c
    int32_t v5; // 0x8f66cd70
    int32_t result; // 0x8f66cd94
    if (a4 == 0) {
        // 0x8f66cd2c
        if (hab_su_srk_selection(a1, (int32_t)&g49, v2) == 0) {
            // 0x8f66cd54
            if (*(char *)((int32_t)&g51 + 12) == 0) {
                // if_8f66cd5c_0_true
                result = 139;
                // branch -> 0x8f66cd90
            } else {
                ...
                v4 = g62;
                v5 = g65;
                v3 = hab_rsa_verification(g61, v4, v5, g64);
                g61 = v3;
                if (v3 == 240) {
                    // 0x8f66cd88
                    hab_add_verified_blocks((char *)g62, v4, v5);
                    result = g61;
                    // branch -> 0x8f66cd90
                } else {
                    result = v3;
        ...
        if (a4 <= 4) {
            ...
            // branch -> 0x8f66cd54
            // 0x8f66cd54
            if (*(char *)(16 * (a4 - 1) + (int32_t)&g50 + 12) == 0) {
                // if_8f66cd5c_0_true
                result = 139;
                // branch -> 0x8f66cd90
            } else {
