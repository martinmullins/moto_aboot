...
// Address range: 0x8f61c324 - 0x8f61c3e7
int32_t timer_cancel(int32_t result, int32_t a2) {
    int32_t v1 = g8;
    int32_t v2 = &g8; // R6
    g8 = v1 + 1;
    ...
    int32_t v3 = *(int32_t *)(result + 4); // 0x8f61c358
    int32_t v4 = *(int32_t *)(result + 8); // 0x8f61c35c
    if ((v4 || v3) != 0) {
        // 0x8f61c3b0
        *(int32_t *)v4 = v3;
        *(int32_t *)(*(int32_t *)(result + 4) + 4) = v4;
        *(int32_t *)(result + 8) = 0;
        *(int32_t *)(result + 4) = 0;
        // branch -> 0x8f61c370
    }
    ...
    *(int32_t *)(result + 24) = v5;
    int32_t v6 = g38; // R2
    int32_t v7 = g8 - 1; // 0x8f61c388
    *(int32_t *)v2 = v7;
    int32_t v8 = g38;
    if (v7 == 0) {
        // 0x8f61c39c
