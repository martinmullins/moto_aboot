...
// Address range: 0x8f642b14 - 0x8f642b87
int32_t isl98611_write_reg(int32_t a1, int32_t a2) {
    int32_t v1 = g19;
    int32_t v2 = g17; // R0
    int32_t v3; // 0x8f642b78_22
    if (g17 == 0) {
        // 0x8f642b5c
        v2 = -3;
        v3 = -3;
        ...
        char v4 = *(char *)&g18; // 0x8f642b44
        int32_t v5;
        qup_i2c_write_byte(g17, (int32_t)v4, a1, a2, a1, v1, g25, 0, v5, 0, 0);
        int32_t v6 = v2; // 0x8f642b4c
        int32_t v7 = v6; // 0x8f642b78_23
        if (v6 > -1) {
            // if_8f642b50_0_true
            v2 = 0;
            v7 = 0;
            // branch -> after_if_8f642b50_0
        }
        // after_if_8f642b50_0
        if (v6 < 0) {
            // if_8f642b54_0_true
