...
// Address range: 0x8f643950 - 0x8f64398f
int32_t max17058_get_temp_thresholds(char * a1, int32_t a2, int32_t a3) {
    int32_t v1 = g31 ? -0x709c0700 : 0; // 0x8f643954
    int32_t v2 = g29;
    int32_t v3;
    int32_t result = get_temperature_thresholds((int32_t)&g10, (int32_t)a1, v2, v2, v1, v3, 0, 0, 0); // 0x8f643984
    return result;
}
