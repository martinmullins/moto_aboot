...
// Address range: 0x8f60b5c4 - 0x8f60b647
int32_t mmc_get_eraseunit_size(int32_t a1, int32_t a2) {
    int32_t v1 = g19;
    int32_t v2 = platform_boot_dev_isemmc(a1, a2, g25, v1); // 0x8f60b5d4
    int32_t v3 = v2; // R0
    int32_t v4 = 0; // 0x8f60b640_25
    int32_t result; // 0x8f60b640_2
    if (v2 != 0) {
        int32_t v5 = target_mmc_device(v2); // 0x8f60b5e0
        int32_t v6; // 0x8f60b624
        if (*(int32_t *)(v5 + 72) <= 4) {
            int32_t v7 = *(int32_t *)(v5 + 80); // 0x8f60b5fc
            if (*(char *)(v7 + 175) == 0) {
                int32_t v8 = *(int32_t *)(v5 + 192) + 1; // 0x8f60b624
                // branch -> 0x8f60b624
                // 0x8f60b624
                v6 = (*(int32_t *)(v5 + 188) + 1) * v8;
                v3 = v6;
                v4 = v6;
                // branch -> 0x8f60b628
            } else {
                int32_t v9 = 1024 * (int32_t)*(char *)(v7 + 224); // 0x8f60b60c
                v3 = v9;
                v4 = v9;
                // branch -> 0x8f60b628
            }
        ...
        // branch -> 0x8f60b624
        // 0x8f60b624
        v6 = *(int32_t *)(v5 + 220) * *(int32_t *)(v5 + 224);
        v3 = v6;
        v4 = v6;
        // branch -> 0x8f60b628
    }
