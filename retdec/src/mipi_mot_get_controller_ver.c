...
// Address range: 0x8f643d34 - 0x8f643dbf
int32_t mipi_mot_get_controller_ver(void) {
    int32_t v1 = g28;
    int32_t v2 = g16;
    int32_t result; // 0x8f643d70
    int32_t v3;
    if (v2 == (v1 || 0xffff)) {
        // 0x8f643d64
        int32_t v4;
        result = get_panel_info((int32_t)&g16, (int32_t)&g18, 1, (int32_t)&g28, g31, v1, g36, g38, g39, g40, g41, g30, v4, 0);
        print_log(2, (int32_t)"MOT panel controller ver=0x%x\n", g16, (int32_t)&g28, g31, v1, g36, g38, g39, g40, g41, g30, v4);
        v3 = g16;
        // branch -> 0x8f643d88
    } else {
        // if_8f643d5c_0_true
