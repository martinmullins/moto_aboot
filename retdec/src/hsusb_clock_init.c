...
// Address range: 0x8f602008 - 0x8f6021b3
int32_t hsusb_clock_init(int32_t a1) {
    int32_t v1 = g57 ? -0x709aeed8 : 0; // R4
    int32_t v2 = g55;
    int32_t v3 = v2; // R3
    int32_t v4 = clk_get_set_enable((int32_t)"usb_iface_clk", 0, 1, v2, a1, g59, g61, v2, g63, g64); // 0x8f60202c
    int32_t v5 = a1;
    if (v4 != 0) {
        // 0x8f602038
        print_log(-1, (int32_t)"failed to set usb_iface_clk ret = %d\n", v4, v3, a1, g59, g61, v2, g63, g64, g65, g66, g67);
        v3 = 48;
        _panic(v1, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/acpuclock.c", 48, (int32_t)&g2, g59, g61);
        v5 = &g2;
        // branch -> 0x8f602060
    }
    int32_t v6 = 0x4c4b400; // R1
    int32_t v7 = clk_get_set_enable((int32_t)"usb_core_clk", 0x4c4b400, 1, v3, v5, g59, g61, v2, g63, g64); // 0x8f60206c
    int32_t v8 = v7; // R2
    int32_t v9 = 0; // 0x8f6020a8
    int32_t v10 = v5;
    if (v7 != 0) {
        // 0x8f602078
        print_log(-1, (int32_t)"failed to set usb_core_clk ret = %d\n", v7, v3, v5, g59, g61, v2, g63, g64, g65, g66, g67);
        v6 = (int32_t)"ASSERT FAILED at (%s:%d): %s\n";
        v8 = (int32_t)"platform/msm8916/acpuclock.c";
        v3 = 55;
        _panic(v1, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/acpuclock.c", 55, (int32_t)&g2, g59, g61);
        v9 = v8;
        v10 = &g2;
        // branch -> 0x8f6020a0
    }
    int32_t v11 = 0x1841000; // R7
    mdelay(20, v6, v9, v3);
    int32_t v12 = clk_get((int32_t)"usb_iface_clk", v6, v8, v3, v10, g59, g61); // R6
    int32_t v13 = clk_get((int32_t)"usb_core_clk", v6, v8, v3, v10, g59, g61); // R5
    clk_disable(v12, v6, v8, v3, v10, g59);
    clk_disable(v13, v6, v8, v3, v10, g59);
    mdelay(20, v6, v8, v3);
    *(int32_t *)v11 = 1;
    mdelay(20, v6, v8, 1);
    v3 = 0;
    *(int32_t *)v11 = 0;
    mdelay(20, v6, v8, v3);
    int32_t v14 = clk_enable(v12, v6, v8, v3, v10, g59, g61, v2, g63, g64); // 0x8f602100
    int32_t v15 = 0; // 0x8f602138
    int32_t v16 = v10;
    if (v14 != 0) {
        // 0x8f60210c
        print_log(-1, (int32_t)"failed to set usb_iface_clk after async ret = %d\n", v14, v3, v10, g59, g61, v2, g63, g64, g65, g66, g67);
        v6 = (int32_t)"ASSERT FAILED at (%s:%d): %s\n";
        v3 = 83;
        _panic(v1, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/acpuclock.c", 83, (int32_t)&g2, g59, g61);
        v15 = (int32_t)"platform/msm8916/acpuclock.c";
        v16 = &g2;
        // branch -> 0x8f602134
    }
    int32_t v17 = clk_enable(v13, v6, v15, v3, v16, g59, g61, v2, g63, g64); // 0x8f602138
    int32_t result = v17; // R0
    int32_t v18 = 0; // 0x8f602184_24
    if (v17 != 0) {
        // 0x8f602144
        print_log(-1, (int32_t)"failed to set usb_iface_clk after async ret = %d\n", v17, v3, v16, g59, g61, v2, g63, g64, g65, g66, g67);
        int32_t v19 = _panic(v1, (int32_t)"ASSERT FAILED at (%s:%d): %s\n", (int32_t)"platform/msm8916/acpuclock.c", 91, (int32_t)&g2, g59, g61); // 0x8f602168
        result = v19;
        v18 = v19;
        // branch -> 0x8f60216c
    }
