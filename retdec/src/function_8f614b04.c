...
// Address range: 0x8f614b04 - 0x8f614b4f
int32_t function_8f614b04(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    int32_t v1 = *(int32_t *)(g33 + 4);
    int32_t v2;
    int32_t result;
    int32_t v3;
    int32_t v4;
    if (v1 == g33) {
        // 0x8f614b20
        memcpy((char *)v4, (char *)g39, v2);
        g31 = v4;
        *(int32_t *)(result + v3) = 0;
        function_8f6140f8();
        return result;
    }
    int32_t v5 = *(int32_t *)v1; // 0x8f614b10
    g38 = v5;
    int32_t v6 = dt_entry_list_delete(v1, a2, a3, a4, a5, 0, 0); // 0x8f614b14
    ...
    while (v7 != g33) {
        ...
        v5 = *(int32_t *)v1;
        g38 = v5;
        v6 = dt_entry_list_delete(v1, a2, v6, a4, a5, 0, 0);
        v7 = *(int32_t *)(v5 + 4);
        // continue -> 0x8f614b10
    }
    // 0x8f614b20
